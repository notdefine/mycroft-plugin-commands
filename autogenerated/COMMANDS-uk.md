...
|tags/skill-alarm/Recurring.voc:4||every|
|tags/skill-alarm/Recurring.voc:5||daily|
|tags/skill-alarm/Recurring.voc:6||weekdays|
|tags/skill-alarm/Recurring.voc:7||weekends|
|tags/skill-alarm/Recurring.voc:8||mondays|
|tags/skill-alarm/Recurring.voc:9||tuesdays|
|tags/skill-alarm/Recurring.voc:10||wednesdays|
|tags/skill-alarm/Recurring.voc:11||thursdays|
|tags/skill-alarm/Recurring.voc:12||fridays|
|tags/skill-alarm/Recurring.voc:13||saturdays|
|tags/skill-alarm/Recurring.voc:14||sundays|
...
|tags/auto-volume/activate.dialog:2|Автоматичну гучність увімкнено|Auto volume activated|
|tags/auto-volume/activate.dialog:3|Я увімкнув автоматичну гучність|I have activated auto volume|
|tags/auto-volume/activate.intent:1|Активуй автоматичну гучність|Activate auto volume|
|tags/auto-volume/activate.intent:2|Активувати автоматичну гучність|Set auto volume to active|
|tags/auto-volume/activate.intent:3|Увімкни автоматичну гучність|Turn on auto volume|
|tags/auto-volume/activate.intent:4|Автоматична гучність активувати|Set auto volume (to) on|
|tags/auto-volume/deactivate.dialog:2|Автоматичну гучність вимкнено|Auto volume is deactivated|
|tags/auto-volume/deactivate.dialog:3|Я вимкнув автоматичну гучність|I have now deactivated auto volume|
|tags/auto-volume/deactivate.intent:1|Деактивуй автоматичну гучність|Deactivate auto volume|
|tags/auto-volume/deactivate.intent:2|Активувати автоматичну гучність|Set auto volume to inactive|
|tags/auto-volume/deactivate.intent:3|Відключи автоматичну гучність|Turn off auto volume|
|tags/auto-volume/deactivate.intent:4|Автоматична гучність вимкнути|Set auto volume (to) off|
|tags/auto-volume/reset.dialog:1|Я відновив початкові налаштування автоматичної гучності|I have now reset auto volume|
|tags/auto-volume/reset.intent:1|Зітри заміри автоматичної гучності|Clear auto volume measurements|
|tags/auto-volume/reset.intent:2|Зітри заміри автоматичної гучності|Delete auto volume measurements|
|tags/auto-volume/reset.intent:3|Зітри заміри автоматичної гучності|Reset auto volume measurements|

# bedtime-stories-skill-uk
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/decide-skill/Choice1.rx:1|(.* (?P<Choice1>.*) або (?P<dummy>.*))|(.* (?P<Choice1>.*) or (?P<dummy>.*))|
|tags/decide-skill/Choice1.rx:2|між ((?P<Choice1>.*) і (?P<dummy>.*))|between ((?P<Choice1>.*) and (?P<dummy>.*))|
|tags/decide-skill/Choice2.rx:1|(.* (?P<dummy2>.*) або (?P<Choice2>.*))|(.* (?P<dummy2>.*) or (?P<Choice2>.*))|
|tags/decide-skill/Choice2.rx:2|між ((?P<dummy2>.*) і (?P<Choice2>.*))|between ((?P<dummy2>.*) and (?P<Choice2>.*))|
|tags/decide-skill/DecideKeyword.voc:1|Вибери|Decide|
|tags/decide-skill/DecideKeyword.voc:2|Що мені одягнути|What should I wear|
|tags/decide-skill/DecideKeyword.voc:3|Що мені з'їсти|What should I eat|
|tags/decide-skill/DecideKeyword.voc:4|гра|game|
...
# mozilla-webthings-gateway-skill-uk
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/openhab-skill/CommunicationError.dialog:1|Вибачте. Проблеми з виконанням команди.|Sorry. Some problems with the command.|
|tags/openhab-skill/DimmerStatusKeyword.voc:1|встанови|set|
|tags/openhab-skill/DimmerStatusKeyword.voc:2|затіни | пригаси|dim|
|tags/openhab-skill/DimmerStatusKeyword.voc:3|яскраво|bright|
|tags/openhab-skill/ErrorDialog.dialog:1|Я не знаю, що робити|I don't know what to do|
|tags/openhab-skill/ErrorDialog.dialog:2|Я не розумію|I don't understand|
|tags/openhab-skill/ErrorDialog.dialog:3|Я розгубився|I'm lost|
|tags/openhab-skill/FoundItems.dialog:1|Знайшов такі речі: {{items}}|Found the following items: {{items}}|
|tags/openhab-skill/GetItemsListError.dialog:1|Вибачте будь ласка, не можу встановити список речей.|Sorry cannot get the items list.|
|tags/openhab-skill/ItemNotFoundError.dialog:1|Вибачте. Річ не знайдено у openHAB.|Sorry. Item not found in open hab.|
|tags/openhab-skill/ListItemsKeyword.voc:1|список речей openHAB|list open hab items|
|tags/openhab-skill/ListItemsKeyword.voc:2|перерахуй речі openHAB|list openhab items|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-spelling/Spell.voc:1|прочитай по літерах|spell|
|tags/skill-spelling/Spell.voc:2|прочитай по літерах слово|spell word|
|tags/skill-spelling/Spell.voc:3|написання|spelling of|
|tags/skill-spelling/Spell.voc:4|як написати слово|spelling of word|
...
# plasma-mycroft-applet-control-uk
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/chatbot/Memory.voc:1|мозок|brain|
|tags/chatbot/Memory.voc:2|пам'ять|memory|
|tags/chatbot/Memory.voc:3|розум|mind|
|tags/chatbot/Memory.voc:4|все|everything|
|tags/chatbot/Reset.voc:1|забудь|forget|
|tags/chatbot/Reset.voc:2|скинь|reset|
|tags/chatbot/reset.memory.dialog:1|Скидаю базу знань|Resetting knowledge database|
|tags/chatbot/reset.memory.dialog:2|Забуваю все|Forgetting everything|
|tags/chatbot/reset.memory.dialog:3|Добре, зараз скину свою пам'ять|Okay, I will now reset my memory|
|tags/chatbot/reset.memory.dialog:4|Почато стирання мозку|Brain erasure initiated|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-pairing/DeviceKeyword.voc:1|одиниця|unit|
|tags/skill-pairing/DeviceKeyword.voc:2|пристрій|device|
|tags/skill-pairing/DeviceKeyword.voc:3|майкрофт|mycroft|
|tags/skill-pairing/DeviceKeyword.voc:4|марк один|mark one|
|tags/skill-pairing/DeviceKeyword.voc:5|марк два|mark two|
|tags/skill-pairing/PairingKeyword.voc:1|з’єднай|pair|
|tags/skill-pairing/PairingKeyword.voc:2|з’єдную|pairing|
|tags/skill-pairing/PairingKeyword.voc:3|реєструй|register|
...
|tags/skill-pairing/connection.error.dialog:1|Під’єднання до mycroft dot a.i, не виконане, не вдалося отримати код з’єднання. Перевірте з’єднання з інтернет і спробуйте ще раз.|Connection to mycroft dot a.i, failed, pairing code could not be fetched. Check your internet connection and try again.|
|tags/skill-pairing/pairing.code.dialog:1|Ви можете зареєструвати мене перейшовши в Пристрої, обрати Додати пристрій і використати код {{code}}|You can register me by going to Devices, selecting Add Device then use the code. {{code}}|
|tags/skill-pairing/pairing.code.dialog:2|Зареєструй цей пристрій кодом {{code}}|Register this device with the code. {{code}}|
|tags/skill-pairing/pairing.code.dialog:3|Введи код {{code}}|Enter the code. {{code}}|
|tags/skill-pairing/pairing.intro.dialog:1|Я під’єднаний до інтернету і потребую активації. Відкрийте браузер і перейдіть на сторінку home крапка mycroft крапка A I щоб зареєструвати цей пристрій.|I'm connected to the internet and need to be activated.  Open your browser and visit home dot mycroft dot A I to register this device.|
|tags/skill-pairing/pairing.not.paired.dialog:1|Ваш пристрій не зареєстровано|Your device is not currently registered|
|tags/skill-pairing/pairing.not.paired.dialog:2|Ваш пристрій не з’єднано|Your device is not currently paired|
...
|tags/skill-pairing/unexpected.error.restarting.dialog:1|Вибачте будь ласка, сталося щось неочікуване. Мені потрібно перезапустити процес з’єднання.|My apologies, something unexpected has happened. I need to restart the pairing process.|
...
# fallback-recommendations-skill-uk
...
# picroft-google-aiy-voicekit-uk
...
# 00__skill_template-uk
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/00__skill_template/Count.voc:1|рахувати|count|
|tags/00__skill_template/Dir.voc:1|вверх|up|
|tags/00__skill_template/Dir.voc:2|вниз|down|
|tags/00__skill_template/Hello.voc:1|привіт|hello|
|tags/00__skill_template/Hello.voc:2|вітання|greetings|
|tags/00__skill_template/Hello.voc:3|привіт|howdy|
|tags/00__skill_template/World.voc:1|світ|world|
|tags/00__skill_template/World.voc:2|земля|earth|
|tags/00__skill_template/count.is.now.dialog:1|Зараз рахунок на числі {{count}}|The count is now {{count}}|
|tags/00__skill_template/count.is.now.dialog:2|Ми дорахували до {{count}}|We are now up to {{count}}|
|tags/00__skill_template/hello.world.dialog:1|Привіт|Hello|
|tags/00__skill_template/hello.world.dialog:2|І тобі привіт|Hi to you too|
