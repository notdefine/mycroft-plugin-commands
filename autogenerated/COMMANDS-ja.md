...
# fallback-recommendations-skill-ja
...
# mozilla-webthings-gateway-skill-ja
...
# 00__skill_template-ja
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/00__skill_template/Count.voc:1|カウント|count|
|tags/00__skill_template/Dir.voc:1|上へ|up|
|tags/00__skill_template/Dir.voc:2|下へ|down|
|tags/00__skill_template/Hello.voc:1|こんにちは|hello|
|tags/00__skill_template/Hello.voc:2||greetings|
|tags/00__skill_template/Hello.voc:3||howdy|
|tags/00__skill_template/World.voc:1|みなさん|world|
|tags/00__skill_template/World.voc:2||earth|
|tags/00__skill_template/count.is.now.dialog:1||The count is now {{count}}|
|tags/00__skill_template/count.is.now.dialog:2|もう{{count}}回に達しました|We are now up to {{count}}|
|tags/00__skill_template/hello.world.dialog:1|こんにちは|Hello|
|tags/00__skill_template/hello.world.dialog:2|どうも|Hi to you too|
...
# picroft-google-aiy-voicekit-ja
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/bark-skill/bark.dialog:1|ワン ワン ワン|Ruff ruff ruff|
|tags/bark-skill/bark.dialog:2|ワン|Ruff|
|tags/bark-skill/bark.dialog:3|ワンワン|Ruff ruff|
|tags/bark-skill/bark.dialog:4|ワンワンワンワン|Ruff ruff ruff ruff|
|tags/bark-skill/bark.dialog:5|ワンワンワンワンワン|Ruff ruff ruff ruff ruff|
|tags/bark-skill/bark.intent:1|ワン！|Bark|
|tags/bark-skill/bark.intent:2|犬はなんてなきますか|What does a dog say|
|tags/bark-skill/bark.intent:3|あの猫を見て|Look at that cat|
|tags/bark-skill/bark.intent:4|郵便屋さんがきました|Mailman is here|

# mycroft-release-test-ja
...
# plasma-mycroft-applet-control-ja
...
|tags/auto-volume/activate.dialog:2|自動音量が有効になりました|Auto volume activated|
|tags/auto-volume/activate.dialog:3|自動音量を有効にしました|I have activated auto volume|
|tags/auto-volume/activate.intent:1|自動音量を有効にする|Activate auto volume|
|tags/auto-volume/activate.intent:2|自動音量を有効に設定|Set auto volume to active|
|tags/auto-volume/activate.intent:3|自動音量をオンにする|Turn on auto volume|
|tags/auto-volume/activate.intent:4|自動音量をオンにする|Set auto volume (to) on|
|tags/auto-volume/deactivate.dialog:2|自動音量は無効です|Auto volume is deactivated|
|tags/auto-volume/deactivate.dialog:3|自動音量を無効にしました|I have now deactivated auto volume|
|tags/auto-volume/deactivate.intent:1|自動音量を無効にする|Deactivate auto volume|
|tags/auto-volume/deactivate.intent:2|自動音量を無効に設定|Set auto volume to inactive|
|tags/auto-volume/deactivate.intent:3|自動音量をオフにする|Turn off auto volume|
|tags/auto-volume/deactivate.intent:4|自動音量をオフにする|Set auto volume (to) off|
|tags/auto-volume/reset.dialog:1|自動音量をリセットしました|I have now reset auto volume|
|tags/auto-volume/reset.intent:1|自動音量検出を停止する|Clear auto volume measurements|
|tags/auto-volume/reset.intent:2|自動音量の測定値を削除する|Delete auto volume measurements|
|tags/auto-volume/reset.intent:3|自動音量の測定値をリセットする|Reset auto volume measurements|

# skill-configuration-ja
