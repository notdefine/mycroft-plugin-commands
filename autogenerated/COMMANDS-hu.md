...
# skill-audio-record-hu
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-audio-record/Delete.voc:1|töröld|delete|
|tags/skill-audio-record/Delete.voc:2|ürítsd|erase|
|tags/skill-audio-record/Delete.voc:3|távolítsd el|remove|
|tags/skill-audio-record/Delete.voc:4|töröld ki|clear|
|tags/skill-audio-record/Play.voc:1|játszd le|play|
|tags/skill-audio-record/Play.voc:2|(visszajátszás|játszd vissza)|replay|
|tags/skill-audio-record/Play.voc:3|lejátszás|playback|
|tags/skill-audio-record/Play.voc:4|játszd le|play back|
|tags/skill-audio-record/Play.voc:5|lejátszani|playing|
|tags/skill-audio-record/Play.voc:6|visszajátszani|replaying|
|tags/skill-audio-record/PlayRecording.intent:1|játszd le (a|az) (felvételt|hangfelvételt|hangot|audiót)|play (the|) (record|recording|audio)|
|tags/skill-audio-record/PlayRecording.intent:2|játszd vissza (a|az) (hangot|felvételt|hangfelvételt|audiót)|play back (the|) (recording|audio)|
|tags/skill-audio-record/PlayRecording.intent:3|felvétel|hangfelvétel|hang|audió (lejátszása|visszajátszása)|playback (the|) (recording|audio)|
|tags/skill-audio-record/Recording.voc:1|felvétel|felvételt|record|
|tags/skill-audio-record/Recording.voc:2|felvett|recorded|
|tags/skill-audio-record/Recording.voc:3|felvenni|recording|
|tags/skill-audio-record/Recording.voc:4|hang|hangot|audio|
|tags/skill-audio-record/StartRecording.intent:1|felvétel indítása|start recording|
|tags/skill-audio-record/StartRecording.intent:2|vegyél fel (engem|) {time} időre|ideig|hosszan|record (me|) (for|until) {time}|
|tags/skill-audio-record/StartRecording.intent:3|indítsd el a felvételt {time} időre|ideig|hosszan|start recording (me|audio|) for {time}|
|tags/skill-audio-record/StartRecording.intent:4|vegyél fel (hangot|engem|)|record (audio|me)|
|tags/skill-audio-record/audio.record.disk.full.dialog:1|Nincs elég hely a lemezen további hangfelvételek készítéséhez.|There is not enough free disk space to record any more audio.|
|tags/skill-audio-record/audio.record.no.recording.dialog:1|Nincs mentett hangfelvétel. Ha szeretnél egyet készíteni, mondd, hogy 'felvétel indítása'.|There is no saved recording.  Say 'start recording' to create one.|
|tags/skill-audio-record/audio.record.removed.dialog:1|Felvétel törölve|Recording deleted|
|tags/skill-audio-record/audio.record.removed.dialog:2|Felvétel elvetve|Recording discarded|
|tags/skill-audio-record/audio.record.start.duration.dialog:1|Hangfelvétel készítése {{duration}} ideig|Recording audio for {{duration}}|
|tags/skill-audio-record/audio.record.start.duration.dialog:2|Hangfelvétel folyamatban {{duration}} hosszan|Starting recording for {{duration}}|
|tags/skill-audio-record/audio.record.start.duration.dialog:3|Felvétel {{duration}} időtartamig|Recording for {{duration}}|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-stock/StockPriceKeyword.voc:1|áron|árfolyamon|stock price|
|tags/skill-stock/StockPriceKeyword.voc:2|kereskednek|trading at|
|tags/skill-stock/company.rx:1|(?P<Company>.*) ára|price of (?P<Company>.*)|
|tags/skill-stock/company.rx:2|kereskednek (a|az|) (?P<Company>.*) részvényeivel|részvényekkel|is (?P<Company>.*) trading at|
|tags/skill-stock/not.found.dialog:1|Sajnálom, nem találtam árfolyamot {{company}} nevű társasághoz.|Sorry, I couldn't find a stock price for {{company}}.|
|tags/skill-stock/not.found.dialog:2|{{company}} nem létezik vagy nincsen adat a részvényeiről.|{{company}} doesn't exist or has no stock price.|
|tags/skill-stock/stock.price.dialog:1|{{company}}, amely {{symbol}} néven található meg, jelenleg {{price}} dollárt ér részvényenként.|{{company}}, with ticker symbol {{symbol}} is currently trading at {{price}} dollars per share.|
|tags/skill-stock/stock.price.dialog:2|{{symbol}} azonosító alatt jegyzett {{company}} nevű társaság jelenlegi értéke {{price}} dollár részvényenként.|With ticker symbol {{symbol}}, the current price of {{company}} is {{price}} dollars per share.|
...
# picroft-google-aiy-voicekit-hu
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/picroft-google-aiy-voicekit/error.initialize.dialog:1|Gondok támadtak a Google A I Y voice kit képesség előkészítésével. A képesség nem fog betöltődni.|I am having problems initializing the Google A I Y voice kit Skill. The Skill will not load. |
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-alarm/Alarm.voc:1|ébresztő|riasztás|alarm|
|tags/skill-alarm/Alarm.voc:2|ébresztők|riasztások|alarms|
...
|tags/skill-alarm/All.voc:1|minden|all|
|tags/skill-alarm/All.voc:2|mindkét|both|
...
|tags/skill-alarm/Recurrence.voc:1|hétfő|monday|
|tags/skill-alarm/Recurrence.voc:2|kedd|tuesday|
|tags/skill-alarm/Recurrence.voc:3|szerda|wednesday|
|tags/skill-alarm/Recurrence.voc:4|csütürtök|thursday|
|tags/skill-alarm/Recurrence.voc:5|péntek|friday|
|tags/skill-alarm/Recurrence.voc:6|szombat|saturday|
|tags/skill-alarm/Recurrence.voc:7|vasárnap|sunday|
|tags/skill-alarm/Recurring.voc:1||# These values must also be supported in the recurring.value file|
|tags/skill-alarm/Recurring.voc:1|visszatérő|recurring|
|tags/skill-alarm/Recurring.voc:2|ismétlődő|repeating|
|tags/skill-alarm/Recurring.voc:4||each|
|tags/skill-alarm/Recurring.voc:3|minden|every|
|tags/skill-alarm/Recurring.voc:4|naponta|daily|
|tags/skill-alarm/Recurring.voc:5|hétköznap|hétköznaponként|weekdays|
|tags/skill-alarm/Recurring.voc:6|hétvégén|hétvégente|hétvégenként|weekends|
|tags/skill-alarm/Recurring.voc:7|hétfőnként|mondays|
|tags/skill-alarm/Recurring.voc:8|keddenként|tuesdays|
|tags/skill-alarm/Recurring.voc:9|szerdánként|wednesdays|
|tags/skill-alarm/Recurring.voc:10|csütörtökönként|thursdays|
|tags/skill-alarm/Recurring.voc:11|péntekenként|fridays|
|tags/skill-alarm/Recurring.voc:12|szombatonként|saturdays|
|tags/skill-alarm/Recurring.voc:13|vasárnaponként|sundays|
|tags/skill-alarm/Recurring.voc:15|hétköznap|hétköznaponként|work days|
|tags/skill-alarm/Recurring.voc:16|hétköznap|hétköznaponként|workdays|
...
|tags/skill-alarm/Set.voc:1|hozzáad|add|
|tags/skill-alarm/Set.voc:2|beállítva|set|
|tags/skill-alarm/Set.voc:3|indítása|indíts|start|
|tags/skill-alarm/Set.voc:4|létrehozás|create|
...
|tags/skill-alarm/WakeMe.voc:1|ébressz fel|wake me|
|tags/skill-alarm/WakeMe.voc:2|ébressz fel|wake me up|
...
|tags/skill-alarm/alarm.cancelled.desc.dialog:1|Leállítottam az ébresztést ehhez: {{desc}}|I've cancelled the alarm for {{desc}}|
|tags/skill-alarm/alarm.cancelled.desc.recurring.dialog:1|Leállítottam az ébresztést ehhez: {{desc}}|I've cancelled the recurring alarm for {{desc}}|
...
|tags/skill-alarm/alarm.scheduled.dialog:1|Riasztás beállítása|Alarm set|
...
|tags/skill-alarm/alarms.list.empty.dialog:1|Nincs ébresztő beállítva|No alarms have been set|
|tags/skill-alarm/alarms.list.empty.dialog:2|Nincs aktív ébresztő|There are no active alarms|
...
|tags/skill-alarm/ask.cancel.desc.alarm.dialog:1|Megerősítés:  Szeretné törölni a {{desc}} riasztást?|((Just|) Confirming:|)  Do you (wish|want) to cancel the alarm for {{desc}}?|
|tags/skill-alarm/ask.cancel.desc.alarm.recurring.dialog:1|Megerősítés: Szeretnéd törölni a következőre beállított ébresztőt: {{desc}}?|((Just|) Confirming:|)  Do you (wish|want) to cancel the recurring alarm for {{desc}}?|
...
|tags/skill-alarm/daytype.entity:1|(nap | hétköznap | hétköznaponta | minden hétköznap | hétvége | hétvégén | hétvégente | holnap | ma)|(day | weekday | weekdays | weekend | weekends | tomorrow | today)|
|tags/skill-alarm/daytype.entity:2|(hétfő  | kedd  | szerda  | csütörtök  | péntek  | szombat  | vasárnap )|(monday  | tuesday  | wednesday  | thursday  | friday  | saturday  | sunday )|
|tags/skill-alarm/daytype.entity:3|(hétfőnként  | keddenként  | szerdánként  | csütörtökönként  | péntekenként | szombatonként  | vasárnaponként )|(mondays  | tuesdays  | wednesdays  | thursdays  | fridays | saturdays  | sundays )|
...
|tags/skill-alarm/recurring.value:3|hétfőn,1|mondays,1|
|tags/skill-alarm/recurring.value:4|hétfő,1|monday,1|
|tags/skill-alarm/recurring.value:5|kedd,2|tuesdays,2|
|tags/skill-alarm/recurring.value:6|kedd,2|tuesday,2|
|tags/skill-alarm/recurring.value:7|szerda,3|wednesdays,3|
|tags/skill-alarm/recurring.value:8|szerda,3|wednesday,3|
|tags/skill-alarm/recurring.value:9|csütörtök,4|thursdays,4|
|tags/skill-alarm/recurring.value:10|csütürtök,4|thursday,4|
|tags/skill-alarm/recurring.value:11|péntek,5|fridays,5|
|tags/skill-alarm/recurring.value:12|péntek,5|friday,5|
|tags/skill-alarm/recurring.value:13|szombat,6|saturdays,6|
|tags/skill-alarm/recurring.value:14|szombat,6|saturday,6|
|tags/skill-alarm/recurring.value:15|vasárnap,0|sundays,0|
|tags/skill-alarm/recurring.value:16|vasárnap,0|sunday,0|
...
|tags/skill-playback-control/Track.voc:2|szám|song|
|tags/skill-playback-control/Music.voc:4||radio|
|tags/skill-playback-control/Next.voc:1|következő|next|
|tags/skill-playback-control/Next.voc:2|tovább|skip|
|tags/skill-playback-control/Pause.voc:1|szünet|pause|
|tags/skill-playback-control/Play.voc:1|lejátszás|play|
|tags/skill-playback-control/Play.voc:2|indítás|start|
|tags/skill-playback-control/Play.voc:3||bork|
|tags/skill-playback-control/PlayResume.voc:1|lejátszás folytatása|play resume|
|tags/skill-playback-control/PlayResume.voc:2|lejátszás folytatása|resume play|
|tags/skill-playback-control/Prev.voc:1|előző|previous|
|tags/skill-playback-control/Prev.voc:2|menj vissza|go back|
|tags/skill-playback-control/Prev.voc:3|menj vissza egyet|go back one|
|tags/skill-playback-control/Resume.voc:1|folytatás|resume|
|tags/skill-playback-control/Resume.voc:2|szünet vége|unpause|
|tags/skill-playback-control/Track.voc:1|sáv|track|
|tags/skill-playback-control/cant.play.dialog:1|Nem tudom hogyan kell lejátszani azt, hogy {{phrase}}|Sorry, I don't know how to play {{phrase}}|
|tags/skill-playback-control/cant.play.dialog:2|Nem tudom pontosan hogyan játsszam le azt, hogy {{phrase}}|I'm not sure how to play {{phrase}}|
|tags/skill-playback-control/converse_resume.voc:3|lejátszás folytatása|resume playing|
...
|tags/skill-playback-control/phrase.rx:1|lejátszás (?P<Phrase>.*)|play (?P<Phrase>.*)|
|tags/skill-playback-control/phrase.rx:2|indítás (?P<Phrase>.*)|start (?P<Phrase>.*)|
|tags/skill-playback-control/phrase.rx:3|indítás (?P<Phrase>.*)|bork (?P<Phrase>.*)|
...
# skill-version-checker-hu
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-version-checker/Check.voc:1|ellenőrizd|check|
|tags/skill-version-checker/Check.voc:2|mondd|find|
|tags/skill-version-checker/Check.voc:3|futó|running|
|tags/skill-version-checker/Check.voc:4|milyen|mi a|az|what is|
|tags/skill-version-checker/PlatformBuild.voc:1|platform kiadás|platform build|
|tags/skill-version-checker/PlatformBuild.voc:2|platform verzió|verziót|platform version|
|tags/skill-version-checker/PlatformBuild.voc:3|firmware verzió|verziót|firmware version|
|tags/skill-version-checker/Version.voc:1|verzió|version|
|tags/skill-version-checker/Version.voc:2|kód|code|
|tags/skill-version-checker/Version.voc:3|kiadás|release|
|tags/skill-version-checker/Version.voc:4|rendszer|szoftver|system software|
|tags/skill-version-checker/ask.upgrade.dialog:1|A jelenleg futó verzió elavult. A legújabb változat száma: {{major}} pont {{minor}}, kiadási száma: {{build}}.  Elindítsam a frissítést?|Your version is outdated. The latest version is {{major}} oh {{minor}}, release {{build}}.  Would you like me to start the upgrade?|
|tags/skill-version-checker/ask.upgrade.dialog:2|A jelenleg futó verzió elavult. A legújabb változat száma: {{major}} pont {{minor}}, kiadási száma: {{build}}.  Frissítsem a rendszert a legújabb verzióra?|Your version is outdated. The latest version is {{major}} oh {{minor}}, release {{build}}.  Would you like to update to the latest version?|
...
|tags/skill-version-checker/major.upgrade.declined.dialog:1|Rendben, akkor egyelőre a jelenlegi szoftveremet fogom használni.|No problem, I'll stay with my current software for now.|
|tags/skill-version-checker/major.upgrade.dialog:1|A Mycroft szoftver új főverziója elérhető.  Ennek telepítésével a {{major}} pont {{minor}} számú új ágra váltasz.  Az ágak közötti váltás általában problémamentes.  Mégis lehetséges, hogy a folyamat után néhány képesség nem lesz elérhető.  Elindítsam a frissítést?|A major Mycroft software update is available.  This will move you to the new {{major}} oh {{minor}} branch.  Changing branches is usually painless.  However, some skills might not be available under the new branch.  Would you like to start this upgrade?|
|tags/skill-version-checker/platform.build.dialog:1|A platformom kiadási száma: {{build}}.|My platform build is {{build}}.|
|tags/skill-version-checker/platform.build.none.dialog:1|Olyan eszközön futok, melynek nincsen hivatalos kiadási száma.|I'm running on a device that does not have an official platform build number.|
...
|tags/skill-version-checker/upgrade.cancelled.dialog:1|Rendben, továbbra is a régi változatot fogom használni|Alright, I'll remain on the older version|
|tags/skill-version-checker/upgrade.started.dialog:1|Elindítottam a frissítést a háttérben.  A letöltés és a frissítés eltarthat egy kis ideig, de hamarosan már az új kódot fogom futtatni.|I've started the update in the background.  It can take a while to download and upgrade, but I'll be running the latest code soon.|
|tags/skill-version-checker/version.dialog:1|A jelenleg futó mycroft-core verziószáma: {{major}} pont {{minor}}, kiadási szám: {{build}}|I am running mycroft-core version {{major}} oh {{minor}}, release {{build}}|
|tags/skill-version-checker/version.latest.dialog:1|A legfrissebb verziót használod.|You are on the latest version.|
...
|tags/skill-weather/ConfirmQuery.voc:6|lesz|going to|
...
|tags/skill-weather/E.dialog:1|kelet|east|
...
|tags/skill-weather/Forecast.voc:1|előrejelzés|forecast|
...
|tags/skill-weather/Query.voc:1|hogyan|how|
|tags/skill-weather/Humidity.voc:1|csapadékos|humid|
|tags/skill-weather/Humidity.voc:2|páratartalom|humidity|
|tags/skill-weather/Humidity.voc:3|párás|steamy|
|tags/skill-weather/Later.voc:1|következő óra|órában|next hour|
|tags/skill-weather/Later.voc:2|következő órákban|next hours|
|tags/skill-weather/Later.voc:3|néhány óra|órában|few hours|
|tags/skill-weather/Later.voc:4|következő néhány óra|órában|next few hours|
|tags/skill-weather/Later.voc:5|pár óra|órában|couple of hours|
|tags/skill-weather/Later.voc:6|következő pár óra|órában|next couple of hours|
|tags/skill-weather/Later.voc:7|később|later|
...
|tags/skill-weather/N.dialog:1|észak|north|
|tags/skill-weather/NE.dialog:1|északkelet|north east|
|tags/skill-weather/NW.dialog:1|északnyugat|north west|
|tags/skill-weather/Next.voc:1|következő|next|
|tags/skill-weather/Next.voc:2|újra|megint|again|
|tags/skill-weather/Now.voc:1||current|
|tags/skill-weather/Now.voc:2|hó|now|
|tags/skill-weather/Precipitation.voc:1|eső|rain|
|tags/skill-weather/Precipitation.voc:2|hó|snow|
|tags/skill-weather/Precipitation.voc:3|csapadék|precipitation|
|tags/skill-weather/Precipitation.voc:4|esős|rainy|
|tags/skill-weather/Precipitation.voc:5|havas|snowy|
|tags/skill-weather/Precipitation.voc:6|esik|raining|
|tags/skill-weather/Precipitation.voc:7|havazik|snowing|
|tags/skill-weather/Precipitation.voc:8||drizzle|
|tags/skill-weather/Query.voc:2|mi a|az|what is|
...
|tags/skill-weather/RelativeTime.voc:4|könnyű|night|
|tags/skill-weather/RelativeTime.voc:5||tonight|
|tags/skill-weather/RelativeTime.voc:6||overnight|
|tags/skill-weather/S.dialog:1|dél|south|
|tags/skill-weather/SE.dialog:1|délkelet|south east|
|tags/skill-weather/SW.dialog:1|délnyugat|south west|
...
|tags/skill-weather/Sunrise.voc:1|napkelte|sunrise|
|tags/skill-weather/Sunrise.voc:2|kel (fel|) a nap|sun rise|
|tags/skill-weather/Sunrise.voc:3|hajnal|dawn|
|tags/skill-weather/Sunrise.voc:4|virradat|pirkadat|daybreak|
|tags/skill-weather/Sunrise.voc:5|virrad|pirkad|day break|
|tags/skill-weather/Sunset.voc:1|napnyugta|naplemente|sunset|
|tags/skill-weather/Sunset.voc:2|megy|nyugszik le a nap|sun set|
|tags/skill-weather/Sunset.voc:3|alkony|dusk|
|tags/skill-weather/Weather.voc:2|hőmérséklet|temperature|
...
|tags/skill-weather/W.dialog:1|nyugat|west|
|tags/skill-weather/Weather.voc:1|időjárás|weather|
|tags/skill-weather/WeatherType.voc:1|eső|esik|rain|raining|
|tags/skill-weather/WeatherType.voc:2|hó|havazik|snow|snowing|
|tags/skill-weather/WeatherType.voc:3|dara|sleet|
|tags/skill-weather/WeatherType.voc:4|jég|jégeső|hail|hailing|
|tags/skill-weather/WeatherType.voc:5|napos|nap|sunny|sun|
|tags/skill-weather/WeatherType.voc:6|forró|meleg|hot|warm|
|tags/skill-weather/WeatherType.voc:7|hideg|hűvös|cold|cool|
|tags/skill-weather/Week.voc:1||week|
|tags/skill-weather/Week.voc:2||weekly|
|tags/skill-weather/Weekend.voc:1||weekend|
|tags/skill-weather/Next.voc:3|mikor|when|
...
|tags/skill-weather/Windy.voc:1|szél|wind|
|tags/skill-weather/Windy.voc:2|szeles|windy|
|tags/skill-weather/Windy.voc:3|szél|winds|
|tags/skill-weather/Windy.voc:4||wind speed|
|tags/skill-weather/Windy.voc:3|szellős|breezy|
|tags/skill-weather/Windy.voc:4|viharos|gusting|
|tags/skill-weather/Windy.voc:5|fúj|blowing|
...
|tags/skill-weather/at.time.local.weather.dialog:1|{{condition}} lesz, {{temp_max}} körüli hőmérséklettel|It will be {condition}, with temperatures near {temp} in the {time}|
|tags/skill-weather/at.time.local.weather.dialog:2|Később {{condition}} és körülbelül {{temp_max}} fok lesz|{time}, it will be {condition} and around {temp} degrees|
|tags/skill-weather/at.time.local.weather.dialog:3|Később {{condition}} lesz és {{temp_max}} fok|{time}, it will be {condition} and {temp} degrees|
...
|tags/skill-weather/condition.category.value:5|eső|esik|Rain,raining|
|tags/skill-weather/condition.category.value:6|hó|havazik|Snow,snowing|
...
|tags/skill-weather/current.weather.dialog:1|Jelenleg {{condition}} van és {{temp}} fok {{scale}} {{location}} településen. A mai előrejelzés szerint a hőmérséklet {{temp_min}} és {{temp_max}} között mozoghat.|It's currently {condition} and {temp} degrees {scale} in {location}. Today's forecast is for a high of {temp_max} and a low of {temp_min}.|
|tags/skill-weather/current.weather.dialog:2|Ebben a pillanatban {{condition}} és {{temp}} fok van {{location}} településen. A legalacsonyabb hőmérséklet {{temp_min}} körül alakul és legfeljebb {{temp_max}} fokra lehet számítani.|Right now, it's {condition} and {temp} degrees, for a high of {temp_max} and a low of {temp_min} in {location}.|
|tags/skill-weather/current.weather.dialog:3|{{temp_min}} fokos minimumhőmérséklettel és {{temp_max}} fokos legmagasabb nappali hőmérséklettel, {{location}} településen {{condition}} van és jelenleg {{temp}} fokot mérnek.|With a high of {temp_max} and a low of {temp_min}, {location} has {condition} and is currently {temp} degrees.|
|tags/skill-weather/do:|Attól tartok, erre nem tudok válaszolni|I'm afraid I don't know that|
|tags/skill-weather/do:|Ezt az információt nem ismerem|I don't have that information|
...
|tags/skill-weather/forecast.local.weather.dialog:1|{{day}} {{condition}} lesz, a legalacsonyabb hőmérséklet {{temp_min}}, a legmagasabb hőmérséklet {{temp_max}} körül várható|{day} expect {condition}, with a high of {temp_max} and a low of {temp_min}|
|tags/skill-weather/forecast.local.weather.dialog:2|{{day}} {{condition}} lesz, a legalacsonyabb hőmérséklet {{temp_min}}, a legmagasabb hőmérséklet {{temp_max}} körül várható|Expect {condition}, with a high of {temp_max} and a low of {temp_min} {day}|
|tags/skill-weather/forecast.local.weather.dialog:3|{{day}} {{temp_min}} és {{temp_max}} közötti hőmérsékletre számíthatunk, {{condition}} körülményekkel|{day} the high will be {temp_max} and the low {temp_min}, with {condition}|
|tags/skill-weather/forecast.local.weather.dialog:4|{{day}} {{condition}} lesz, a legalacsonyabb hőmérséklet {{temp_min}}, a legmagasabb hőmérséklet {{temp_max}} körül várható|{day} it will be {condition} with a high of {temp_max} and a low of {temp_min}|
...
|tags/skill-weather/forecast.weather.dialog:1|{{day}} {{condition}} lesz, a legalacsonyabb hőmérséklet {{temp_min}}, a legmagasabb hőmérséklet {{temp_max}} körül várható|{day} it will be {condition}, with a high of {temp_max} and a low of {temp_min} in {location}|
|tags/skill-weather/forecast.weather.dialog:2|A {{day}}i napon {{location}} településen {{temp_min}} és {{temp_max}} fok közötti hőmérséklet várható, {{condition}} körülményekkel|{day}, {location} will have a high of {temp_max} and a low of {temp_min}, with {condition}|
|tags/skill-weather/forecast.weather.dialog:3|Az előrejelzés a {{day}}i napra {{temp_min}} és {{temp_max}} fok közötti hőmérsékletet valószínűsít|The forecast {day} is {temp_max} for a high and {temp_min} for a low in {location}|
...
|tags/skill-weather/heavy.dialog:1|erős|heavy|
|tags/skill-weather/hour.local.weather.dialog:1|{{condition}} lesz, {{temp_max}} körüli hőmérséklettel|It will be {condition}, with temperatures near {temp}|
|tags/skill-weather/hour.local.weather.dialog:2|Később {{condition}} és körülbelül {{temp_max}} fok lesz|Later it will be {condition} and around {temp} degrees|
|tags/skill-weather/hour.local.weather.dialog:3|Később {{condition}} lesz és {{temp_max}} fok|Later it will be {condition} and {temp} degrees|
|tags/skill-weather/hour.local.weather.dialog:4|{{temp_max}} fok körül, {{condition}} körülményekkel|Around {temp} degrees with {condition}|
|tags/skill-weather/hour.weather.dialog:1|{{location}} időjárása a következő néhány órában {{condition}} lesz és {{temp_max}} fok várható|{location} weather in the next few hours will be {condition} and {temp} degrees|
|tags/skill-weather/hour.weather.dialog:2|Később {{condition}} lesz {{location}} településen, {{temp_max}} körüli hőmérséklettel|Later it will be {condition} in {location}, with temperatures around {temp}|
|tags/skill-weather/hour.weather.dialog:3|{{location}} településen körülbelül {{temp_max}} fok és {{condition}} várható|{location} will be around {temp} with {condition}|
|tags/skill-weather/hour.weather.dialog:4|{{location}} településen {{temp_max}} fok körüli hőmérséklet és {{condition}} várható|{location} will be about {temp} degrees with {condition}|
|tags/skill-weather/light.dialog:1|könnyű|light|
...
|tags/skill-weather/location.not.found.dialog:1|Nem tudom, hogy az merre található|I not sure where that is|
|tags/skill-weather/location.not.found.dialog:2|Nem ismerem ezt a helyet|I don't know that location|
|tags/skill-weather/location.not.found.dialog:3|Nem ismerem ezt a helységet|I don't know that place|
...
|tags/skill-weather/meters:|méter per másodperc|meters per second|
|tags/skill-weather/miles:|mérföld per óra|miles per hour|
...
|tags/skill-weather/no.forecast.dialog:1|Sajnálom, de {{day}}i előrejelzést nem tudok mondani|Sorry, I don't know the forecast {day}|
|tags/skill-weather/no.forecast.dialog:2|{{day}}i napra nem találtam előrejelzést|I don't have a forecast {day}|
...
|tags/skill-weather/tonight.local.weather.dialog:1|{{condition}} lesz, {{temp_max}} körüli hőmérséklettel|Tonight it will be {condition}, with temperatures near {temp}|
|tags/skill-weather/tonight.local.weather.dialog:2|Később {{condition}} és körülbelül {{temp_max}} fok lesz|Tonight it will be {condition} and around {temp} degrees|
|tags/skill-weather/tonight.local.weather.dialog:3|Később {{condition}} lesz és {{temp_max}} fok|Tonight it will be {condition} and {temp} degrees|
|tags/skill-weather/tonight.local.weather.dialog:4|{{temp_max}} fok körül, {{condition}} körülményekkel|Around {temp} degrees with {condition} tonight|
...
# bedtime-stories-skill-hu
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/bedtime-stories-skill/list.stories.dialog:1|Az elérhető esti mesék: {{stories}}|Here are the bedtime stories I have available. {{stories}}|
|tags/bedtime-stories-skill/list.stories.dialog:2|A könyvtárban elérhető esti mesék. {{stories}}|Here are the bedtime stories in my library. {{stories}}|
|tags/bedtime-stories-skill/list.stories.intent:1|Listázza az esti mesék|List bedtime stories|
|tags/bedtime-stories-skill/list.stories.intent:2|Milyen történeteid vannak|What stories do you have|
|tags/bedtime-stories-skill/list.stories.intent:3|Milyen esti mesék vannak|What bed time stories do you have|
|tags/bedtime-stories-skill/pick.story.dialog:1|Rendben, nézzük csak megvan-e ez a történet.|Okay, let me see if I have that story.|
|tags/bedtime-stories-skill/pick.story.intent:1|Meséld el nekem {title}|tell me {title}|
|tags/bedtime-stories-skill/pick.story.intent:2|olvasd el {title}|read me {title}|
|tags/bedtime-stories-skill/pick.story.intent:3|olvasdel {title}|readme {title}|
|tags/bedtime-stories-skill/pick.story.intent:4|Mond el {title}|Tell me {title}|
|tags/bedtime-stories-skill/stories.bedtime.dialog:1|Oké, rendben. Itt van egy nagyszerű választás a könyvtáramból|Okay, sure. Here is a great selection from my library.|
|tags/bedtime-stories-skill/stories.bedtime.dialog:2|Nem probléma, helyezd kényelembe magad, míg kiválasztok egy történetet.|No problem, get comfy while I pick a story.|
|tags/bedtime-stories-skill/stories.bedtime.intent:1|Mesélj egy történetet|Tell me a story|
|tags/bedtime-stories-skill/stories.bedtime.intent:2|Mondj nekem egy esti mesét|Tell me a bed time story|
|tags/bedtime-stories-skill/stories.bedtime.intent:3|Mondj nekem egy tündérmesét|Tell me a fairy tale|
|tags/bedtime-stories-skill/stories.bedtime.intent:4|Mondj nekünk egy történetet|Tell us a story|
|tags/bedtime-stories-skill/stories.bedtime.intent:5|Mondj egy jó történetet|Tell me a good story|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-installer/action.list:1|telepítése|installing|
|tags/skill-installer/action.list:2|eltávolítása|removing|
|tags/skill-installer/cancelled.dialog:1|Megszakítva.|Cancelled.|
|tags/skill-installer/cancelled.dialog:2|Művelet megszakítva.|Action cancelled.|
|tags/skill-installer/choose.skill.dialog:1|Több képességet találtam, melyikre gondoltál... {{skills}}|Multiple skills found, which would you like... {{skills}}|
|tags/skill-installer/error.already.beta.dialog:1|{{skill}} előnézeti változata már telepítve.|The preview version of {{skill}} has already been installed.|
|tags/skill-installer/error.already.installed.dialog:1|{{skill}} már telepítve van|{{skill}} has already been installed|
|tags/skill-installer/error.already.removed.dialog:1|{{skill}} nincs telepítve|{{skill}} is not installed|
|tags/skill-installer/error.already.removed.dialog:2|{{skill}} nem található meg ezen az eszközön|{{skill}} was not found on this device|
|tags/skill-installer/error.filesystem.dialog:1|{{skill}} {{action}} közben hiba lépett fel a fájlrendszerben.|A filesystem error occurred while {{action}} {{skill}}.|
|tags/skill-installer/error.multiple.skills.dialog:1|A kérésed több találatot eredményezett, kérlek pontosíts.|Your request had multiple matches, please be more specific.|
|tags/skill-installer/error.not.found.dialog:1|Nem találtam {{skill}} nevű képességet.|I didn't find any skill named {{skill}}.|
|tags/skill-installer/error.other.dialog:1|Ismeretlen hiba lépett fel {{skill}} telepítése közben.|An unknown error occurred while installing {{skill}}.|
|tags/skill-installer/error.pip.requirements.dialog:1|Hiba lépett fel {{skill}} képesség Python függőségeinek {{action}} során.|An error occurred while {{action}} the Python dependencies for {{skill}}.|
|tags/skill-installer/error.skill.requirements.dialog:1|Hiba lépett fel {{skill}} képesség előfeltételeinek {{action}} során.|An error occurred while {{action}} the skill requirements for {{skill}}.|
|tags/skill-installer/error.system.requirements.dialog:1|Hiba lépett fel {{skill}} képesség által igényelt rendszercsomagok {{action}} során.|An error occurred while {{action}} the system packages for {{skill}}.|
|tags/skill-installer/install.beta.complete.dialog:1|{{skill}} fejlesztői változata telepítve.  Ezt a változatot nem nézte át a közösség és minőségellenőrzésen sem esett át, ezért felelősen járj el, amikor egy hibát jelentesz a szerzőnek.  Ha a hivatalosan kiadott változatra szeretnél váltani, mondd azt, hogy: telepítés {{skill}}.|The development version of {{skill}} has been installed.  This version has not undergone any community review or quality control testing, so be responsible when reporting issues to the author.  To switch back to the officially released version, say: install {{skill}}.|
|tags/skill-installer/install.beta.confirm.dialog:1|Megerősítés: Szeretnél {{skill}} hivatalosan kiadott verziójáról fejlesztői verzióra váltani?|Confirming: Shall I switch from the officially released version of {{skill}} to the development version?|
|tags/skill-installer/install.beta.intent:1|telepítés|telepítsd {skill} béta (változatát|verzióját).|install {skill} (version|) beta.|
|tags/skill-installer/install.beta.intent:2|telepítés|telepítsd {skill} (béta|előnézeti) verzióját|változatát|install {skill} (beta|preview) version|
|tags/skill-installer/install.beta.intent:3|telepítés|telepítsd (a|az|) (béta|előnézeti) (változatát|verzióját|) (a|az|) {skill} (képességnek|). |install (the|) (beta|preview) (version|)(of|) {skill}.|
|tags/skill-installer/install.beta.upgrade.confirm.dialog:1|Megerősítés: Frissítsem {{skill}} képességet a legújabb fejlesztői változatra?|Confirming: Shall I upgrade {{skill}} to the latest development version?|
|tags/skill-installer/install.complete.dialog:1|{{skill}} telepítve és használatra kész|{{skill}} is now installed and ready for use|
|tags/skill-installer/install.confirm.dialog:1|Megerősítés: Megkezdjem {{skill}} telepítését, melynek szerzője {{author}}?|Confirming: Shall I install {{skill}} by {{author}}.|
|tags/skill-installer/install.custom.intent:1|Egyéni képesség letöltése|Download custom skill|
|tags/skill-installer/install.intent:1|telepítés|telepítsd (a|az|) {skill} (képességet|).|install {skill}.|
|tags/skill-installer/install.intent:2|telepítés|telepítsd (a|az|) {skill} (stabil|hivatalos) (változatát|).|install {skill} (version|) (stable|official).|
|tags/skill-installer/install.intent:3|telepítés|telepítsd (a|az|) (hivatalos|stabil) (verziójú|) {skill} (képességet|).|install (the|) (official|stable) (version|of|) {skill}.|
|tags/skill-installer/install.intent:4|telepítsd {skill} hivatalos (kiadását|verzióját|változatát).|install official release (version|) of {skill}.|
|tags/skill-installer/install.reinstall.confirm.dialog:1|Megerősítés: Újratelepítsem {{skill}} képesség hivatalos kiadású változatát?|Confirming: Shall I reinstall the official release version of {{skill}}?|
|tags/skill-installer/installed.dialog:1|igen, {skill} telepítve van|yes, {skill} is installed|
|tags/skill-installer/is.installed.intent:1|telepítve van (a|az|) {skill} (képesség|)|is {skill} installed|
|tags/skill-installer/list.skills.intent:1|(Mutasd|Mutass|Listázd|Listázz) (a|) (rendelkezésre álló|telepíthető) (képességet|képességeket)|(Show me|List) (available|installable) skills.|
|tags/skill-installer/list.skills.intent:2|Mit|milyen (képességeket|) (tudok|) (telepíteni|telepíthetek|telepíthetők|telepíthetőek)?|What (skills|) can I install?|
|tags/skill-installer/list.skills.intent:3|Mik a telepíthető (képességek|képességeid)?|What are some skills I can install?|
|tags/skill-installer/not.installed.dialog:1|nem, {skill} nincs telepítve|no, {skill} isn't installed|
|tags/skill-installer/not.installed.dialog:2|nem, {skill} még nincs telepítve|no, {skill} is not installed|
|tags/skill-installer/or.dialog:1|vagy|or|
|tags/skill-installer/remove.complete.dialog:1|{{skill}} eltávolítva|{{skill}} has been removed|
|tags/skill-installer/remove.confirm.dialog:1|Megerősítés: Megkezdjem {{skill}} eltávolítását, melynek szerzője {{author}}?|Confirming:  Shall I remove {{skill}} by {{author}}.|
|tags/skill-installer/remove.intent:1|{skill} (képesség|) eltávolítása|uninstall (skill|) {skill}|
|tags/skill-installer/remove.intent:3|töröld (a|az|) {skill} (képességet|)|uninstall {skill} (skill|)|
|tags/skill-installer/some.available.skills.dialog:1|Itt van néhány képesség, amit telepíthetsz: {{skills}}|Here are a few of the skills you can install... {{skills}}|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-stop/StopKeyword.voc:1|állj|i|stop|
|tags/skill-stop/StopKeyword.voc:2|csend|silence|
|tags/skill-stop/StopKeyword.voc:3|pofa be|shut up|
|tags/skill-stop/StopKeyword.voc:4|hallgass|be quiet|
...
# btotharye-home-assistant-hu
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:1|aktiváld|activate|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:2|tűz|fire|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:3|hívd fel|call up|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:4|kioldó|trigger|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:5|jelenet|scene|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:6|automatizálás|automation|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:7|szkript|script|
|tags/btotharye-home-assistant/DecreaseVerb.voc:1|csökkenteni|decrease|
|tags/btotharye-home-assistant/DecreaseVerb.voc:2|le|down|
|tags/btotharye-home-assistant/DeviceTrackerKeyword.voc:1|hol|where|
|tags/btotharye-home-assistant/DeviceTrackerKeyword.voc:2||locate|location|
|tags/btotharye-home-assistant/IncreaseVerb.voc:1|növelni|increase|
|tags/btotharye-home-assistant/IncreaseVerb.voc:2|fel|up|
|tags/btotharye-home-assistant/LightBrightenVerb.voc:1|világosítani|világosabb|világos|fel|brighten|brighter|bright|up|
|tags/btotharye-home-assistant/LightDimVerb.voc:1|halvány|halványabb|sötét|sötétít|lejjebb|le|dim|dimmer|dark|darken|lower|down|
|tags/btotharye-home-assistant/LightsKeyword.voc:1|fény|light|
|tags/btotharye-home-assistant/LightsKeyword.voc:2|fények|lights|
|tags/btotharye-home-assistant/LightsKeyword.voc:3|lámpa|lamp|
|tags/btotharye-home-assistant/LightsKeyword.voc:4|lámpák|lamps|
|tags/btotharye-home-assistant/LightsKeyword.voc:5|izzó|bulb|
|tags/btotharye-home-assistant/LightsKeyword.voc:6|izzók|bulbs|
|tags/btotharye-home-assistant/LightsKeyword.voc:7|LED|l.e.d.|
|tags/btotharye-home-assistant/LightsKeyword.voc:8|kapcsold fel|turn on|
|tags/btotharye-home-assistant/LightsKeyword.voc:9|kapcsold le|turn off|
|tags/btotharye-home-assistant/LightsKeyword.voc:10|kapcsoló|toggle|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:1|állapot|állapota|state|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:2|státusz|állapot|status|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:3|érzékelő|szenzor|sensor|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:4|detektor|érzékelő|detector|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:5|érték|value|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:6|olvasd fel|read out|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:7|mi a jelenlegi|what is the current|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:8|mi a jelenlegi|what is current|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:9|mondd meg a jelenlegi|tell me the current|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:10|mondd meg az aktuális|tell me current|
|tags/btotharye-home-assistant/SetVerb.voc:1|állítani|set|
|tags/btotharye-home-assistant/SwitchActionKeyword.voc:1|tekerd|turn|
|tags/btotharye-home-assistant/SwitchActionKeyword.voc:2|kapcsoló|switch|
|tags/btotharye-home-assistant/automation.rx:1|(aktiváld|gyújtsd|indítsd|hívd fel) (?<Entity>.*)|(activate|fire|trigger|call up) (?P<Entity>.*)|
|tags/btotharye-home-assistant/dimming.rx:1|(állítsd) (?:brightness of )?(?P<Entity>.*) (?P<BrightnessValue>\d*)(?: percent)? (ra) |(set) (?:brightness of )?(?P<Entity>.*) (to) (?P<BrightnessValue>\d*)(?: percent)?|
|tags/btotharye-home-assistant/dimming.rx:2|(halványítsd|világosítsd|növeld|csökkentsd) (?:brightness of )?(?P<Entity>.*?) (?:by)? (?P<BrightnessValue>\d*)?(?: percent)?|(dim|brighten|increase|decrease) (?:brightness of )?(?P<Entity>.*?) (?:by)? (?P<BrightnessValue>\d*)?(?: percent)?|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:1|{{dev_name}} készüléken az autómata mód elindítva.|triggered automation {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:2|{{dev_name}} elindítva.|triggered {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:3|{{dev_name}} elindítva.|{{dev_name}} was triggered.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:4|{{dev_name}} aktiválódott.|{{dev_name}} was activated.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:5|{{dev_name}} aktiválva.|activated {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.brightness.badreq.dialog:1|Kérlek válassz fényerőt 0 és 100 közötti értéken.|please request a brightness level between 0 and 100.|
|tags/btotharye-home-assistant/homeassistant.brightness.badreq.dialog:2|Mennyire legyen világos? Válassz egy értéket 0-tól 100-ig!|how bright? you can choose a level from 0 to 100.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.dimmable.dialog:1|{{dev_name}} fényereje nem állítható. |Can not dim {{dev_name}}. It is not dimmable.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.off.dialog:1|{{dev_name}} fényereje nem állítható, mert le van kapcsolva.|Can not dim {{dev_name}}. It is off.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.off.dialog:2|{{dev_name}} fényereje nem állítható. Kérlek, először kapcsold fel.|Can not dim {{dev_name}}. Please turn it on before.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.off.dialog:3|{{dev_name}} fényereje nem állítható. Csak a bekapcsolt készülékek fényereje állítható.|{{dev_name}} can not be dimmed. Only devices that are turned on can be.|
|tags/btotharye-home-assistant/homeassistant.brightness.decreased.dialog:1|{{dev_name}} fényereje {{brightness}} százalékra állítva.|Dimmed {{dev_name}} to {{brightness}} percent.|
|tags/btotharye-home-assistant/homeassistant.brightness.decreased.dialog:2|{{dev_name}} fényereje beállítva.|Dimmed {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.brightness.dimmed.dialog:1|Állítsd be (a| az) {{dev_name}} fényerejét {{brightness}} százalékra.|Set the brightness of {{dev_name}} to {{brightness}} percent.|
|tags/btotharye-home-assistant/homeassistant.brightness.increased.dialog:1|(A| Az) {{dev_name}} fényereje {{brightness}} százalékra emelkedett.|Increased brightness of {{dev_name}} to {{brightness}} percent.|
|tags/btotharye-home-assistant/homeassistant.brightness.increased.dialog:2|{{dev_name}} fényereje növelve.|Increased brightness of {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.already.dialog:1|{{dev_name}} már {{action}}.|{{dev_name}} already {{action}}.|
|tags/btotharye-home-assistant/homeassistant.device.already.dialog:2|Nem történt módosítás (a| az) {{dev_name}} készüléken.|No changes made to {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.off.dialog:1|{{dev_name}} lekapcsolva.|turned off {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.off.dialog:2|{{dev_name}} kikapcsolva.|turned {{dev_name}} off.|
|tags/btotharye-home-assistant/homeassistant.device.off.dialog:3|{{dev_name}} most már le van kapcsolva.|{{dev_name}} is now off.|
|tags/btotharye-home-assistant/homeassistant.device.on.dialog:1|{{dev_name}} bekapcsolva.|turned on {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.on.dialog:2|{{dev_name}} be lett kapcsolva.|{{dev_name}} was turned on.|
|tags/btotharye-home-assistant/homeassistant.device.on.dialog:3|{{dev_name}} bekapcsolva.|turned {{dev_name}} on.|
|tags/btotharye-home-assistant/homeassistant.device.toggle.dialog:1|{{dev_name}} átkapcsolva.|toggled {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.toggle.dialog:2|{{dev_name}} át lett kapcsolva.|{{dev_name}} was toggled.|
|tags/btotharye-home-assistant/homeassistant.device.unknown.dialog:1|Bocsánat, nem találom ezt a Home Assistant elemet.|Sorry, I can't find the Home Assistant entity |
|tags/btotharye-home-assistant/homeassistant.device.unknown.dialog:2|Elem|Entity |
|tags/btotharye-home-assistant/homeassistant.device.unknown.dialog:3|Bocsánat, objektum|Sorry, entity |
|tags/btotharye-home-assistant/homeassistant.device.unknown.dialog:4|Elnézést, nem találom |Excuse me, I wasn't able to find |
|tags/btotharye-home-assistant/homeassistant.error.offline.dialog:1|Úgy tűnik, hogy a Home Assistant szervere jelenleg nem elérhető.|The Home assistant server appears to be offline.|
|tags/btotharye-home-assistant/homeassistant.error.offline.dialog:2|A Home Assistant szervere nem elérhető.|Couldn't reach the home assistant server.|
|tags/btotharye-home-assistant/homeassistant.error.offline.dialog:3|A Home Assistant szervere nem válaszol.|The home assistant server did not respond.|
|tags/btotharye-home-assistant/homeassistant.error.setup.dialog:1|Kérlek, hogy a Home Assistant készségeket a home pont mycroft pont ai oldalon állítsd be.|Please configure the home assistant skill settings at home dot mycroft dot ai.|
|tags/btotharye-home-assistant/homeassistant.error.sorry.dialog:1|Nem tudom, hogy mit szeretnél tőlem.|I don't know what you want me to do.|
|tags/btotharye-home-assistant/homeassistant.error.sorry.dialog:2|Nem tudtam rájönni, hogy hogyan lehet egy Home Assistenttel beszélni.|Couldn't figure out how to talk to Home Assistant.|
|tags/btotharye-home-assistant/homeassistant.error.sorry.dialog:3|Nem értem, hogy mit kérdezel.|I don't understand what you are asking.|
|tags/btotharye-home-assistant/homeassistant.sensor.dialog:1|(A| Az) {{dev_name}} jelenleg {{value}} {{unit}}.|Currently {{dev_name}} is {{value}} {{unit}}.|
|tags/btotharye-home-assistant/homeassistant.sensor.dialog:2|{{dev_name}} jelenlegi állapota: {{value}} {{unit}}.|{{dev_name}} has the state: {{value}} {{unit}}.|
|tags/btotharye-home-assistant/homeassistant.sensor.dialog:3|{{dev_name}} ebben a pillanatban {{value}} {{unit}}.|{{dev_name}} is {{value}} {{unit}} at the moment.|
|tags/btotharye-home-assistant/homeassistant.sensor.dialog:4|{{dev_name}} jelenleg {{value}} {{unit}}.|{{dev_name}} is {{value}} {{unit}}.|
|tags/btotharye-home-assistant/homeassistant.tracker.found.dialog:1|(A| Az) {{dev_name}} utolsó ismert helye: {{location}}.|Last known location of {{dev_name}} is {{location}}.|
|tags/btotharye-home-assistant/homeassistant.tracker.found.dialog:2|{{dev_name}} jelenlegi helye: {{location}}.|{{dev_name}} is at {{location}}.|
|tags/btotharye-home-assistant/homeassistant.tracker.found.dialog:3|{{dev_name}} a következő helyszínen lett felfedezve: {{location}}.|{{dev_name}} has been detected at {{location}}.|
|tags/btotharye-home-assistant/numvalue.rx:1|(?P<Value>100?%|[1-9][0-9]?%?)(\D|$)|(?P<Value>100?%|[1-9][0-9]?%?)(\D|$)|
|tags/btotharye-home-assistant/sensor.rx:1|(melyik|milyen) (állapotban|státuszban|értéken) (van|van) (a| az) (?P<Entity>.*)|(in )?(what|which) (status|state|value) (is|has) (?P<Entity>.*)|
...
# fallback-recommendations-skill-hu
...
# skill-crystal-ball-hu
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-crystal-ball/CrystalBall.voc:1|Varázsgömb|Crystal Ball|
|tags/skill-crystal-ball/CrystalBall.voc:2|Tükröm tükröm|Mirror mirror|
|tags/skill-crystal-ball/Future.voc:1|jövő|jövőt|future|
|tags/skill-crystal-ball/Future.voc:2|holnap|holnapot|tomorrow|
|tags/skill-crystal-ball/Query.voc:1|Mondd (meg|)|Tell me|
|tags/skill-crystal-ball/Query.voc:2|Mi|mit|What|
|tags/skill-crystal-ball/random.answer.dialog:1|Igen|Yes|
|tags/skill-crystal-ball/random.answer.dialog:2|Nem|No|
|tags/skill-crystal-ball/random.answer.dialog:3|Kérdezz újra később|Try asking again later|
|tags/skill-crystal-ball/random.answer.dialog:4|Kétségtelenül|Definitely|
|tags/skill-crystal-ball/random.answer.dialog:5|Természetesen nem|Of course not|
|tags/skill-crystal-ball/random.answer.dialog:6|Nyilvánvalóan|Sure|
|tags/skill-crystal-ball/random.answer.dialog:7|Dehogy|Nope|
|tags/skill-crystal-ball/random.answer.dialog:8|Miért ne?|Why not?|
|tags/skill-crystal-ball/random.answer.dialog:9|Nem fogadnék rá|I wouldn't bet on it|
|tags/skill-crystal-ball/random.answer.dialog:10|Biztos lehetsz benne!|You bet!|
|tags/skill-crystal-ball/random.answer.dialog:11|Ne vegyél rá mérget|Don't hold your breath|
...
# skill-hello-world-hu
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-hello-world/HelloWorldKeyword.voc:1|helló világ|hello world|
|tags/skill-hello-world/HelloWorldKeyword.voc:2|üdv|greetings|
|tags/skill-hello-world/HowAreYouKeyword.voc:1|hogy vagy|how are you|
|tags/skill-hello-world/HowAreYouKeyword.voc:2|hogy telt a napod|how have you been|
|tags/skill-hello-world/HowAreYouKeyword.voc:3|milyen volt a napod|how has your day been|
|tags/skill-hello-world/ThankYouKeyword.voc:1|köszönöm|thank you|
|tags/skill-hello-world/ThankYouKeyword.voc:2|kösz|thanks|
|tags/skill-hello-world/hello.world.dialog:1|Helló világ|Hello world|
|tags/skill-hello-world/hello.world.dialog:2|Helló|Hello|
|tags/skill-hello-world/hello.world.dialog:3|Üdv neked is|Hi to you too|
|tags/skill-hello-world/how.are.you.dialog:1|Jól vagyok|I'm doing well|
|tags/skill-hello-world/how.are.you.dialog:2|Egész jól|Pretty well|
|tags/skill-hello-world/how.are.you.dialog:3|Megvagyok|Not bad|
|tags/skill-hello-world/how.are.you.dialog:4|Kiválóan|I'm doing excellent|
|tags/skill-hello-world/how.are.you.dialog:5|Lehetnék jobban is|Could be better|
|tags/skill-hello-world/how.are.you.dialog:6|Nagyon jól vagyok|I'm doing very well|
|tags/skill-hello-world/welcome.dialog:1|Máskor is.|Any time.|
|tags/skill-hello-world/welcome.dialog:2|Állok szolgálatodra.|Glad to be of service.|
|tags/skill-hello-world/welcome.dialog:3|Örülök, hogy segíthettem.|Glad to help.|
|tags/skill-hello-world/welcome.dialog:4|Örömmel segítek.|My Pleasure.|
|tags/skill-hello-world/welcome.dialog:5|Szívesen.|No problem.|
|tags/skill-hello-world/welcome.dialog:6|Kérem.|You're welcome.|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/rss-reader/check.feeds.intent:1|keress új (híreket|bejegyzéseket)|check for new feeds|
|tags/rss-reader/choice.error.dialog:1|Sajnálom, nem értettem a választásodat.|Sorry, I couldn't catch your choice.|
|tags/rss-reader/choice.options.value:1|#kulcsszó,érték|#key,value|
|tags/rss-reader/choice.options.value:2|stop,kilépés|stop,stop|
|tags/rss-reader/choice.options.value:3|next,következő|next,next|
|tags/rss-reader/choice.options.value:4|author,szerző|author,author|
|tags/rss-reader/choice.options.value:5|email,email|email,email|
|tags/rss-reader/choice.options.value:6|repeat,ismétlés|repeat,repeat|
|tags/rss-reader/choice.options.value:7|summary,összefoglalás|summary,summary|
|tags/rss-reader/choice.options.value:8|sync,szinkronizálás|sync,synchronize|
|tags/rss-reader/choice.prompt.dialog:1|Mit tegyek most?|What should I do now?|
|tags/rss-reader/feed.count.dialog:1|{{name}} nevű hírcsatornán {{number}} {{article}} olvasható.|The feed {{name}} has {{number}} {{article}} to read.|
|tags/rss-reader/feed.email.dialog:1|Email a kérésed szerint elküldve.|The email has been sent as instructed.|
|tags/rss-reader/feed.email.dialog:2|Az email elküldve.|The email has just been sent.|
|tags/rss-reader/feed.error.dialog:1|Hiba lépett fel a következő hírcsatorna feldolgozásakor: {{name}}. A kiszolgáló nem elérhető vagy a képesség beállításai pontatlanok.|There was a problem parsing the {{name}} feed. The host might be down or the skill settings inaccurate.|
|tags/rss-reader/feed.read.dialog:1|Jelenleg {{name}} nevű hírcsatornádat olvasom.|I'm now reading your {{name}} feed.|
|tags/rss-reader/new.article.value:1|singular,új cikk|singular,new article|
|tags/rss-reader/new.article.value:2|plural,új cikk|plural,new articles|
|tags/rss-reader/read.feeds.intent:1|olvasd fel az új (híreket|bejegyzéseket)|read my new feeds|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-volume/Decrease.voc:1|mérsékeld|lower|
|tags/skill-volume/Decrease.voc:2|vegyél vissza|reduce|
|tags/skill-volume/Decrease.voc:3|csökkentsd|decrease|
|tags/skill-volume/Decrease.voc:5|halkítsd|halkabbra|quieter|
...
|tags/skill-volume/Increase.voc:1|emeld|rise|
|tags/skill-volume/Increase.voc:4|növeld|increase|
|tags/skill-volume/Increase.voc:2|emeld meg|raise|
|tags/skill-volume/Increase.voc:3|erősítsd|fokozd|boost|
|tags/skill-volume/Increase.voc:6|hangosíts|hangosabbra|louder|
...
|tags/skill-volume/Level.voc:13|halk|quiet|
|tags/skill-volume/Level.voc:14|normál|normal|
|tags/skill-volume/Level.voc:15|hangos|loud|
...
|tags/skill-volume/Mute.voc:1|elnémítás|mute|
|tags/skill-volume/Mute.voc:2|csend|silence|
...
|tags/skill-volume/Unmute.voc:2|megszólaltatása|unmute|
|tags/skill-volume/Unmute.voc:1|(visszaállítás|állítsd vissza)|reset|
|tags/skill-volume/Unmute.voc:3|visszaállítása|restore|
|tags/skill-volume/Reset.voc:2||default|
|tags/skill-volume/Volume.voc:1|hangerő|hangerőt|volume|
|tags/skill-volume/Volume.voc:2|hangszóró|hangszórót|speaker|
|tags/skill-volume/Volume.voc:3|hang|hangot|sound|
|tags/skill-volume/Volume.voc:4||audio|
|tags/skill-volume/already.max.volume.dialog:1||Volume is already at maximum|
|tags/skill-volume/already.max.volume.dialog:2|Hangosabbra nem megy|I can't get any louder|
|tags/skill-volume/decrease.volume.dialog:1|A hangerő csökkentve. Új szint: {{volume}}|Volume reduced to {{volume}}|
|tags/skill-volume/decrease.volume.dialog:2|A hangerő lecsökkent a következő szintre: {{volume}}|Volume decreased to {{volume}}|
|tags/skill-volume/decrease.volume.dialog:3|A hangerő új szintje: {{volume}}|Volume is now {{volume}}|
|tags/skill-volume/increase.volume.dialog:2|A hangerő megnövelve. Új szint: {{volume}}|Volume increased to {{volume}}|
...
|tags/skill-volume/mute.volume.dialog:1|A hang elnémul|Audio is going to be muted|
|tags/skill-volume/mute.volume.dialog:2|A hang elnémítva|Sound is going to be muted|
|tags/skill-volume/reset.volume.dialog:1|A hangerő visszaállítva, értéke: {{volume}}|Volume reset to {{volume}}|
|tags/skill-volume/reset.volume.dialog:2|A hangerőt visszaállítottam, az új szint: {{volume}}|Volume restored to {{volume}}|
|tags/skill-volume/set.volume.dialog:1|A hangerő beállítva a következő szintre: {{volume}}|Volume set to {{volume}}|
|tags/skill-volume/set.volume.dialog:2|A hangerő megváltozott. Új értéke: {{volume}}|Volume updated to {{volume}}|
|tags/skill-volume/set.volume.dialog:3|A hangerő új értéke a következő: {{volume}}|Volume changed to {{volume}}|
...
|tags/skill-volume/volume.is.dialog:1|A hangerő szintje: {{volume}}|The volume is set to {{volume}}|
|tags/skill-volume/volume.is.dialog:2|A hangerő értéke {{volume}}|The volume is at {{volume}}|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-support/ask.description.dialog:1|Kérlek röviden írd le a problémát, amit tapasztalsz|Please briefly describe the problem you are experiencing|
|tags/skill-support/ask.description.dialog:2|Mi az észlelt probléma rövid leírása?|What's a brief description of the problem you are having?|
|tags/skill-support/cancelled.dialog:1|Rendben|Alright|
|tags/skill-support/complete.dialog:1|Elküldtem egy email-t a regisztrált fiókodra benne hibakeresést segítő adatokkal és útmutatással arról, hogyan veheted fel a kapcsolatot a támogatással.|I've sent an email to your registered account with debugging information and instructions for contacting support.|
|tags/skill-support/confirm.support.dialog:1|Szeretnél létrehozni egy hibaelhárító csomagot? Ennek során a hibanapló feltöltésre kerül a termbin pont com szolgáltatás oldalára és további információkat tartalmazó hivatkozást kapsz az email címedre.|Would you like to create a troubleshooting package? This will upload logs to the zero ex zero dot S T service and email a link to you with more information.|
|tags/skill-support/contact.support.intent:1|hibaelhárítást kérek|create a troubleshoot request|
|tags/skill-support/contact.support.intent:2|az eszköz hibásan működik|troubleshoot my device|
|tags/skill-support/contact.support.intent:3|támogatást kérek|contact support|
|tags/skill-support/contact.support.intent:4|támogatási jegyet|create a support ticket|
|tags/skill-support/one.moment.dialog:1|Egy pillanat.|One moment.|
|tags/skill-support/support.dialog:1|támogatás|support|
|tags/skill-support/support.email.template:1|<p>Alább találod a Mycroft által elkészített hibaelhárító csomagra mutató hivatkozást:</p>|<p>Below is a link to the troubleshooting package generated by Mycroft:</p>|
|tags/skill-support/support.email.template:3||<ul><tt>|
|tags/skill-support/support.email.template:4|<p><b>Eszköz neve:</b> {{device_name}}</p>|<p><b>Device Name:</b> {{device_name}}</p>|
|tags/skill-support/support.email.template:5|<p><b>Leírás:</b> {{description}}</p>|<p><b>Description:</b> {{description}}</p>|
...
|tags/skill-support/support.email.template:10|<a href='mailto:support@mycroft.ai?Subject=Troubleshooting%20Package&amp;body=Troubleshooting%20Package:%20{{url}}' target='_top'>Küldd el ezt a support@mycroft.ai címre</a>, hogy átadd ezt az információt a Mycroft csapatának további támogatás kérése céljából.|<a href='mailto:support@mycroft.ai?Subject=Troubleshooting%20Package&amp;body=Troubleshooting%20Package:%20{{url}}' target='_top'>Send this to support@mycroft.ai</a> to pass this information to the Mycroft team for further assistance.|
|tags/skill-support/support.title.dialog:1|Mycroft Hibaelhárító Segéd|Mycroft Troubleshooting Assistant|
...
|tags/skill-support/yes.list:1|igen|yes|
|tags/skill-support/yes.list:2|igen|yeah|
|tags/skill-support/yes.list:3|igen|yep|
|tags/skill-support/yes.list:4|igen|sure|
|tags/skill-support/yes.list:5|kérlek|please|

# skill-number-guess-hu
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-number-guess/NumberGuess.voc:1|Számkitalálós|számkitalálóst|Number Guess|
|tags/skill-number-guess/NumberGuess.voc:2|számkitalálós játék|játékot|number guessing game|
|tags/skill-number-guess/Play.voc:1|Játsszunk|játszunk|játszanánk|játszani|Play|
|tags/skill-number-guess/Play.voc:2|Játék indítása|Start a game|
|tags/skill-number-guess/Suggest.voc:1|Javaslom|Let's|
|tags/skill-number-guess/Suggest.voc:2|Jó lenne|Let us|
|tags/skill-number-guess/Suggest.voc:3|Miért nem|Why don't we|
|tags/skill-number-guess/Suggest.voc:4|Mi lenne ha|How about we|
|tags/skill-number-guess/Suggest.voc:5|Talán|We should|
|tags/skill-number-guess/correct.dialog:1|Helyes!|That's right!|
|tags/skill-number-guess/correct.dialog:2|Eltaláltad!|You got it!|
|tags/skill-number-guess/correct.dialog:3|Pontosan!|Correct!|
|tags/skill-number-guess/correct.dialog:4|Ez az a szám!|That's the number!|
|tags/skill-number-guess/correct.dialog:5|Szép munka!|Good job!|
|tags/skill-number-guess/correct.dialog:6|Nyertél!|You win!|
|tags/skill-number-guess/get.lower.dialog:1|Mi legyen az alsó határ?|What do you want the lower bound to be?|
|tags/skill-number-guess/get.upper.dialog:1|Mi legyen a felső határ?|What do you want the upper bound to be?|
|tags/skill-number-guess/guess.dialog:1|Találd ki a számot|Guess the number|
|tags/skill-number-guess/guess.dialog:2|Mit gondolsz, melyik az a szám|What do you think the number is|
|tags/skill-number-guess/guess.dialog:3|Találd ki|Guess|
|tags/skill-number-guess/input.error.dialog:1|Nem értettem, amit mondtál|I couldn't understand what you said|
|tags/skill-number-guess/input.error.dialog:2|Nem sikerült pontosan megértenem, amit mondtál|Something went wrong while I was trying to understand that|
|tags/skill-number-guess/input.error.dialog:3|Beviteli hiba történt|An input error occurred|
|tags/skill-number-guess/input.error.dialog:4|Megismételnéd?|Could you say that again?|
|tags/skill-number-guess/invalid.input.dialog:1|A válasz érvénytelen. Számot kérek szépen|That answer was invalid. I need a number|
|tags/skill-number-guess/invalid.input.dialog:2|Kérlek szám legyen a válaszod|Please reply with a number|
|tags/skill-number-guess/invalid.input.dialog:3|Számot adj meg a válaszodban|You need to reply with a number|
|tags/skill-number-guess/invalid.input.dialog:4|Ez nem szám|That's not a number|
|tags/skill-number-guess/start.game.dialog:1|Rendben, játsszunk|OK let's play|
|tags/skill-number-guess/start.game.dialog:2|Kezdődjön a játék|Let the game begin|
|tags/skill-number-guess/start.game.dialog:3|A játék elindul|Starting the game|
|tags/skill-number-guess/start.game.dialog:4|Kezdjük|Let's start|
|tags/skill-number-guess/start.game.dialog:5|Lássuk, mit tudsz|Let's see what you've got|
|tags/skill-number-guess/start.game.dialog:6|Rendben. Játsszunk számkitalálóst|Alright. Let's play Number Guess|
|tags/skill-number-guess/too.high.dialog:1|Túl nagy|Too high|
|tags/skill-number-guess/too.low.dialog:1|Túl kicsi|Too low|

# mycroft-release-test-hu
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-date-time/Date.voc:1|dátum|dátumot|date|
|tags/skill-date-time/Date.voc:2|nap|napot|day|
|tags/skill-date-time/Display.voc:1|mutasd|display|
|tags/skill-date-time/Display.voc:2|mutasd|show|
...
|tags/skill-date-time/Query.voc:1|milyen|hány|mennyi|what|
|tags/skill-date-time/Query.voc:2|mondd meg|tell|
...
|tags/skill-date-time/Time.voc:1|idő|időt|óra|time|
|tags/skill-date-time/Time.voc:2||clock|
|tags/skill-date-time/date.dialog:1|{{date}}|{{date}}|
|tags/skill-date-time/date.dialog:2|{{data}} van|It is {{date}}|
|tags/skill-date-time/date.dialog:3|{{date}} van|It's {{date}}|
...
|tags/skill-date-time/location.rx:1|(?P<Location>.*) \b(ban|ben|on|en|ett|ott)|\b(at|in|for) (?P<Location>.*)|
...
|tags/skill-date-time/time.current.dialog:2|{{time}} van|It is {{time}}|
|tags/skill-date-time/time.current.dialog:4|{{time}} van|It's {{time}}|
|tags/skill-date-time/time.current.dialog:5|Jelenleg {{time}}|Currently {{time}}|
|tags/skill-date-time/time.future.dialog:1|{time}|{time}|
|tags/skill-date-time/time.future.dialog:2||It will be {time}|
|tags/skill-date-time/time.tz.not.found.dialog:1|Nem találom az időzónát a következő tartózkodási helyhez: {{location}}|I could not find the time zone for {{location}}|
...
|tags/email-skill/check.email.intent:1|ellenőrizd az (email|e mail|emailemet|emailjeimet)|check my email|
|tags/email-skill/check.email.intent:2|ellenőrizd a leveleimet.|check my mail|
|tags/email-skill/check.email.intent:3|van új levelem?|do i have any new mail|
|tags/email-skill/check.email.intent:4|érkezett (új|) levelem?|do I have any email|
|tags/email-skill/check.email.intent:5|kaptam új levelet?|do i have any new emails|
...
|tags/email-skill/error.getting.mail.dialog:1|Hiba lépett fel a leveled fogadásakor. Kérlek ellenőrizd az azonosítóidat és a szerver beállításait.|There was an error getting your email Try checking your credentials and server information|
|tags/email-skill/error.getting.mail.dialog:2|Kérlek ellenőrizd az azonosítóidat és a szerver beállításait, mivel probléma történt a leveled fogadása során.|Check your credentials and server information because there was a problem getting your mail|
|tags/email-skill/error.getting.mail.dialog:3|Nem tudok kapcsolatot létrehozni a levelezésed kiszolgálójával. Ellenőrizd az azonosítóidat és a beállításokat.|I can not connect to your email server Check your password and server information|
|tags/email-skill/list.subjects.dialog:1|Üzenet száma: {message_num}, feladója: {sender}, tárgya: {subject}.|Your {message_num} email is from {sender} Its subject is {subject}|
|tags/email-skill/list.subjects.dialog:2|Üzenet száma: {message_num}, melynek tárgya: {subject}. A küldő személy: {sender}|The {message_num} email's subject is {subject} Its from {sender}|
|tags/email-skill/more.emails.dialog:1|szeretnél többet hallani?|would you like to hear more|
|tags/email-skill/more.emails.dialog:2|szeretnél többet hallani a leveleidről?|want to hear more of your emails|
|tags/email-skill/more.emails.dialog:3|szeretnéd, ha tovább olvasnám?|do you want to hear more|
...
|tags/email-skill/no.more.emails.dialog:1|rendben.|okay|
|tags/email-skill/no.new.email.dialog:1|Nincs új levél.|There is no new email|
|tags/email-skill/no.new.email.dialog:2|Nincs új leveled.|There's no new email|
|tags/email-skill/no.new.email.dialog:3|Nem érkezett új levél.|There's no new mail|
|tags/email-skill/no.new.email.dialog:4|Nem érkezett új leveled.|There is no new mail|
|tags/email-skill/no.new.email.dialog:5|Nem vár rád új levél.|There's no new email for you|
|tags/email-skill/no.new.email.dialog:6|Jelenleg nincs postád.|There's no new mail for you|
|tags/email-skill/no.new.email.dialog:7|Most nincs új postád.|You have no new mail|
|tags/email-skill/no.new.email.dialog:8|Jelenleg nincs új leveled.|You have no new email|
...
|tags/email-skill/setup.dialog:1|Ha szeretnéd beállítani az email-olvasó képességet, látogass el a home pont mycroft pont a i oldalra és add meg a levelezési adataidat.|To set the email skill up, please go to home dot mycroft dot a i to enter your email information|
|tags/email-skill/setup.dialog:2|Az email-olvasó képesség használatához további beállításra van szükség. Ehhez látogass el a home pont mycroft pont a i oldalra és add meg a levelezési adataidat.|You need to set the email skill up To do so, please go to home dot mycroft dot a i to enter your email information|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/bark-skill/bark.dialog:1|vau vau vau|Ruff ruff ruff|
|tags/bark-skill/bark.dialog:2|Vau|Ruff|
|tags/bark-skill/bark.dialog:3|vau vau|Ruff ruff|
|tags/bark-skill/bark.dialog:4|vau vau vau vau|Ruff ruff ruff ruff|
|tags/bark-skill/bark.dialog:5|vau vau vau vau vau|Ruff ruff ruff ruff ruff|
|tags/bark-skill/bark.intent:1|ugatás|Bark|
|tags/bark-skill/bark.intent:2|Mit mond a kutya|What does a dog say|
|tags/bark-skill/bark.intent:3|Nézd meg azt a macskát|Look at that cat|
|tags/bark-skill/bark.intent:4|Megjött a postás|Mailman is here|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-wiki/More.voc:1|még|more|
|tags/skill-wiki/More.voc:2|tovább|continue|
...
|tags/skill-wiki/Wikipedia.voc:3|mondj valamit|tell me about|
|tags/skill-wiki/Wikipedia.voc:4|mit tudunk|tell us about|
|tags/skill-wiki/Wikipedia.voc:5|mit mond a wikipédia|what does wikipedia say about|
|tags/skill-wiki/Wikipedia.voc:6|(keresés|keress rá|nézz utána)|search|
|tags/skill-wiki/article.title.rx:1||.*(wiki|for|about|wikipedia)(?! (for|about)) (?P<ArticleTitle>.+)|
|tags/skill-wiki/disambiguate.dialog:1|úgy értetted, hogy {{options}}?|did you mean {{options}}|
|tags/skill-wiki/disambiguate.dialog:2|miről szeretnél hallani ezek közül: {{options}}|would you like to hear about {{options}}|
|tags/skill-wiki/no:|Nem találtam kapcsolódó wikipédia cikket|I can't find a related Wikipedia article|
|tags/skill-wiki/no:|Attól tartok nem található erről szóló cikk|I'm afraid there isn't any article about that|
|tags/skill-wiki/or.dialog:1|vagy|or|
|tags/skill-wiki/searching.dialog:1|Azonnal rákeresek minden {{query}} nevű cikkre|Just a moment while I look up {{query}}|
|tags/skill-wiki/searching.dialog:2|{{query}} című cikkek keresése folyamatban|Let me look up {{query}}|
|tags/skill-wiki/searching.dialog:3|Keresek {{query}} témájú wikipédia cikkeket|I'm checking Wikipedia for {{query}}|
|tags/skill-wiki/thats:|Ez minden, amiről tudok|That's all I know|
|tags/skill-wiki/thats:|Ez minden, amit találtam|That's all I can find|
|tags/skill-wiki/wikipedia_lang.value:1|# Wikipédia nyelvkód, amely az aktív nyelvet kiszolgáló lekérdezésekhez használatos|# Wikipedia language code used to service queries in the active language|
|tags/skill-wiki/wikipedia_lang.value:2|code,hu|code,en|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/chatbot/Memory.voc:1||brain|
|tags/chatbot/Memory.voc:2||memory|
|tags/chatbot/Memory.voc:3||mind|
|tags/chatbot/Memory.voc:4||everything|
|tags/chatbot/Reset.voc:1||forget|
|tags/chatbot/Reset.voc:2||reset|
|tags/chatbot/reset.memory.dialog:1||Resetting knowledge database|
|tags/chatbot/reset.memory.dialog:2||Forgetting everything|
|tags/chatbot/reset.memory.dialog:3||Okay, I will now reset my memory|
|tags/chatbot/reset.memory.dialog:4||Brain erasure initiated|

# tronald-dump-skill-hu
...
# mozilla-webthings-gateway-skill-hu
...
# skill-configuration-hu
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-configuration/ConfigurationSkillKeyword.voc:1|konfiguráció|config|
|tags/skill-configuration/ConfigurationSkillKeyword.voc:2|konfiguráció|configuration|
|tags/skill-configuration/ConfigurationSkillKeyword.voc:3|beállítások|setting|
|tags/skill-configuration/Config.voc:4|beállítások|settings|
...
|tags/skill-configuration/ListenerKeyword.voc:1|figyelő|listener|
|tags/skill-configuration/ListenerKeyword.voc:2|hívószó figyelő|wake word listener|
|tags/skill-configuration/ListenerKeyword.voc:3|hívószó motor|wake word engine|
|tags/skill-configuration/ListenerKeyword.voc:4|hívószó|wake word|
|tags/skill-configuration/ListenerKeyword.voc:5|hívószó motor|hot word engine|
...
|tags/skill-configuration/ListenerType.voc:5|alapértelmezett|default|
|tags/skill-configuration/Name.voc:1|név|name|
|tags/skill-configuration/PreciseKeyword.voc:2|mycroft precise|mycroft precise|
|tags/skill-configuration/PreciseKeyword.voc:3|precise modell|precise model|
|tags/skill-configuration/PreciseKeyword.voc:4|modell|model|
|tags/skill-configuration/GetKeyword.voc:1|mi|what|
|tags/skill-configuration/GetKeyword.voc:2|mi a|az|what is|
|tags/skill-configuration/GetKeyword.voc:4|mondd meg|tell me|
|tags/skill-configuration/GetKeyword.voc:3|add meg|give me|
|tags/skill-configuration/What.voc:3|hol|where|
|tags/skill-configuration/SetKeyword.voc:1|állítsd be|set|
|tags/skill-configuration/SetKeyword.voc:2|legyen|make|
|tags/skill-configuration/SetKeyword.voc:3|rendelj hozzá|assign|
|tags/skill-configuration/SetKeyword.voc:4|változtasd meg|change|
|tags/skill-configuration/ConfigurationSkillUpdateVerb.voc:1|frissítsd|update|
|tags/skill-configuration/ConfigurationSkillUpdateVerb.voc:2|töltsd újra|reload|
|tags/skill-configuration/ConfigurationSkillUpdateVerb.voc:3|szinkronizáld|sync|
|tags/skill-configuration/Update.voc:4|szinkronizáld|synch|
|tags/skill-configuration/ConfigurationSkillUpdateVerb.voc:4|szinkronizáld|synchronize|
|tags/skill-configuration/Using.voc:1|használd|használata|using|
...
|tags/skill-configuration/config.no_change.dialog:1|A beállítások nem változtak|Configuration hasn't changed|
|tags/skill-configuration/config.no_change.dialog:2|Nincs változás, nincs mit beállítani|No changes to apply|
|tags/skill-configuration/config.not.paired.dialog:1|Nem tudom letölteni a konfigurációs adatokat, az eszköz nincs regisztrálva.|Could not fetch configuration, device is not paired.|
|tags/skill-configuration/config.not.paired.dialog:2|Nem lehet frissíteni a beállításokat, kérlek regisztráld az eszközödet|Couldn't update the config, please pair the device|
|tags/skill-configuration/config.updated.dialog:1|Beállítások frissültek.|Configuration updated.|
|tags/skill-configuration/config.updated.dialog:2|Az eszközöd beállításai frissültek.|Your device configuration has been updated.|
|tags/skill-configuration/config.updated.dialog:3|Az eszközöd beállítása sikerült.|Your device has been configured.|
|tags/skill-configuration/download.started.dialog:1|Letöltöm az új figyelőt, ez alatt az idő alatt nem tudsz majd használni engem. Várj egy percet, mielőtt újra szólítanál.|Downloading the new listener, this will take a bit and you won't be able to use me until it completes. Give me a minute before attempting to activate me again.|
|tags/skill-configuration/get.listener.dialog:1|A jelenlegi figyelő: {{listener}}.|The current listener is {{listener}}.|
|tags/skill-configuration/get.listener.dialog:2|A figyelő a következőre van állítva: {{listener}}.|The listener is set to {{listener}}.|
|tags/skill-configuration/i.am.at.dialog:1|A következő helyen vagyok: {{city}} {{state}} {{country}}|I'm in {{city}} {{state}} {{country}}|
|tags/skill-configuration/i.am.at.dialog:2|A beállításaim szerint ezen a helyen vagyok: {{city}} {{state}} {{country}}|My settings tell me I'm at {{city}} {{state}} {{country}}|
|tags/skill-configuration/listener.same.dialog:1|A figyelő már beállítva a következőre: {{listener}}.|The listener is already set to {{listener}}.|
|tags/skill-configuration/model.is.dialog:1|A jelenlegi precise modell azonosítója a következő: {{name}}.|The current precise model has an identifier of {{name}}.|
|tags/skill-configuration/model.is.dialog:2|A jelenlegi modell azonosítója a következő: {{name}}.|The current model has an identifier of {{name}}.|
|tags/skill-configuration/models.not.found.dialog:1|Egyetlen frissíthető modellt sem találtam.|I couldn't find any model files to update.|
|tags/skill-configuration/models.updated.dialog:1|Frissítettem a Precise modelleket.|I've updated the Precise models.|
|tags/skill-configuration/must.be.hey.mycroft.dialog:1|A precise használatához a "hey mycroft" hívószó beállítása szükséges. Ezt a home PONT mycroft PONT AI oldalon teheted meg.|The wake word needs to be set to "hey mycroft" to use precise. You can do this on home DOT mycroft DOT AI.|
|tags/skill-configuration/must.update.dialog:1|Kérlek először frissítsd a szoftveredet.|Please update your software first.|
|tags/skill-configuration/my.name.is.dialog:1|az eszköznevem: {{name}}|my device name is {{name}}|
|tags/skill-configuration/my.name.is.dialog:2|úgy hívnak, hogy {{name}}|I'm named {{name}}|
|tags/skill-configuration/not.precise.dialog:1|A figyelő nem a Precise.|The listener isn't set to Precise.|
...
|tags/skill-configuration/set.listener.dialog:1|A figyelő beállítva a következőre: {{listener}}.|I've set the listener to {{listener}}.|
...
# plasma-mycroft-applet-control-hu
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/plasma-mycroft-applet-control/MycroftPlasmoidReadNewsKeyword.voc:1|cikk|hír linkjének beszerzése|getarticle newsurl|
|tags/plasma-mycroft-applet-control/MycroftPlasmoidShowInstallerKeyword.voc:1|mutasd a telepíthető képességeket|képességeid|képességeidet|show list of installable skills|
|tags/plasma-mycroft-applet-control/MycroftPlasmoidShowKeyword.voc:1|mutasd magad|magadat|show yourself|
|tags/plasma-mycroft-applet-control/MycroftPlasmoidShowKeyword.voc:2|mutasd az elemet|show widget|
|tags/plasma-mycroft-applet-control/MycroftPlasmoidShowSkillsKeyword.voc:1|mutasd a legjobb képességeket|show the top skills|
|tags/plasma-mycroft-applet-control/MycroftPlasmoidShowSkillsKeyword.voc:2|mutass képességeket|show skills|

# 00__skill_template-hu
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/00__skill_template/Count.voc:1|mennyiség|count|
|tags/00__skill_template/Dir.voc:1|fel|up|
|tags/00__skill_template/Dir.voc:2|le|down|
|tags/00__skill_template/Hello.voc:1|helló|hello|
|tags/00__skill_template/Hello.voc:2|üdvözlet|greetings|
|tags/00__skill_template/Hello.voc:3|szevasz|howdy|
|tags/00__skill_template/World.voc:1|világ|world|
|tags/00__skill_template/World.voc:2|föld|earth|
|tags/00__skill_template/count.is.now.dialog:1|A számláló jelenlegi állása {{count}} |The count is now {{count}}|
|tags/00__skill_template/count.is.now.dialog:2|Most éppen {{count}} |We are now up to {{count}}|
|tags/00__skill_template/hello.world.dialog:1|Helló|Hello|
|tags/00__skill_template/hello.world.dialog:2|Üdvözlet neked is|Hi to you too|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/emby/emby.dialog:1|{media} egyveleg lejátszása|Playing {media} mix|
|tags/emby/emby.intent:1|(lejátszás|játszd|játssz le) {media} (az|) (mb|nb|enbi|emby) (szerverről|)|play {media} from emby|
|tags/emby/emby.intent:2|{media} lejátszása (az|) (mb|nb|enbi|emby) (szerverről|)|play {media} from mb|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-singing/Sing.voc:1|énekelj|sing|
|tags/skill-singing/Sing.voc:2|énekelj egy dalt|sing me a song|
|tags/skill-singing/singing.dialog:1|Szívesen énekelek neked. |I would be happy to sing for you. |
|tags/skill-singing/singing.dialog:2|Íme.|Here I go.|
|tags/skill-singing/singing.dialog:3|Egy kicsit zavarban vagyok, de nem bánom.|I'm a bit nervous about my voice, but here goes nothing.|
|tags/skill-singing/singing.stop.dialog:1|köszönöm hogy meghallgattál|thank you for listening|
|tags/skill-singing/singing.stop.dialog:2|Remélem tetszett a hangom|I hope you liked my voice|
|tags/skill-singing/singing.stop.dialog:3|most te jössz|now you try|
...
# plasma-activities-skill-hu
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:1|új aktivitás létrehozása|create a new activity|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:2|hozz létre új aktivitást|create new activity|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:3|aktivitás létrehozása|create activity|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:4|új aktivitás indítása|start a new activity|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:5|hozz létre egy új aktivitást|create new activities|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:6|indíts egy új aktivitást|start new activities|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:7|aktivitás létrehozása|create activities|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:8|új aktivitás|new activity|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:9|új aktivitás|new activities|
|tags/plasma-activities-skill/ActivitiesRemoveKeyword.voc:1|aktivitás eltávolítása|remove activity|
|tags/plasma-activities-skill/ActivitiesRemoveKeyword.voc:2|távolítsd el az aktivitást|remove the activity|
|tags/plasma-activities-skill/ActivitiesRemoveKeyword.voc:3|aktivitás törlése|delete activity|
|tags/plasma-activities-skill/ActivitiesRemoveKeyword.voc:4|töröld az aktivitást|delete the activity|
|tags/plasma-activities-skill/ActivitiesShowKeyword.voc:1|mutasd a jelenlegi aktivitásokat|show current activities|
|tags/plasma-activities-skill/ActivitiesShowKeyword.voc:2|mutasd az aktivitásokat|show activities|
|tags/plasma-activities-skill/ActivitiesShowKeyword.voc:3|aktivitások|activities|
|tags/plasma-activities-skill/ActivitiesShowKeyword.voc:4|mutasd a jelenlegi aktivitásokat|display current activities|
|tags/plasma-activities-skill/ActivitiesShowKeyword.voc:5|aktivitások mutatása|display activities|
|tags/plasma-activities-skill/ActivitiesStopKeyword.voc:1|jelenlegi aktivitás leállítása|kilövése|kill current activity|
|tags/plasma-activities-skill/ActivitiesStopKeyword.voc:2|(állítsd le|lődd ki) az aktivitást|kill activity|
|tags/plasma-activities-skill/ActivitiesSwitchKeyword.voc:1|válts aktivitást|switch current activity|
|tags/plasma-activities-skill/ActivitiesSwitchKeyword.voc:2|válts másik aktivitásra|switch to activity|
|tags/plasma-activities-skill/ActivitiesSwitchKeyword.voc:3|aktivitás váltása|switch activity|
|tags/plasma-activities-skill/activities.create.dialog:1|Az új aktivitás {{ ActivityName }} névvel létrehozva|Your Activity {{ ActivityName }} Has Been Created|
|tags/plasma-activities-skill/activities.remove.dialog:1|Aktivitás eltávolítva|Activity has been removed|
|tags/plasma-activities-skill/activities.show.dialog:1|Mutatom az aktivitásokat|Displaying Activities|
|tags/plasma-activities-skill/activities.stop.dialog:1|{{ StopActivityName }} nevű aktivitás leállítva|{{ StopActivityName }} activity has been stopped|
|tags/plasma-activities-skill/activities.switch.dialog:1|Váltás {{ SwitchActivityName }} aktivitásra|Switching to activity {{ SwitchActivityName }} |
...
# plasma-user-control-skill-hu
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/plasma-user-control-skill/InternalAddPanelKeyword.voc:1|panel hozzáadása|add panel to|
|tags/plasma-user-control-skill/InternalAddWidgetToDesktopKeyword.voc:1|elem|widget hozzáadása az asztalhoz|add widget to desktop|
|tags/plasma-user-control-skill/InternalAddWidgetToPanelDesktopKeyword.voc:1|elem|widget hozzáadása a panelhez|add widget to panel|
|tags/plasma-user-control-skill/InternalClearKlipperKeyword.voc:1|vágólap|klipper törlése|clear clipboard|
|tags/plasma-user-control-skill/InternalClearKlipperKeyword.voc:2|töröld a vágólap(ot|) tartalmát||clear klipper|
|tags/plasma-user-control-skill/InternalDecreaseBrightnessDesktopKeyword.voc:1|csökkentsd a fényerőt|decrease the brightness|
|tags/plasma-user-control-skill/InternalDecreaseBrightnessDesktopKeyword.voc:2|fényerő csökkentése|decrease brightness|
|tags/plasma-user-control-skill/InternalDecreaseVolumeDesktopKeyword.voc:1|csökkentsd a hangerőt|decrease the volume|
|tags/plasma-user-control-skill/InternalDecreaseVolumeDesktopKeyword.voc:2|hangerő csökkentése|decrease volume|
|tags/plasma-user-control-skill/InternalIncreaseBrightnessDesktopKeyword.voc:1|növeld a fényerőt|increase the brightness|
|tags/plasma-user-control-skill/InternalIncreaseBrightnessDesktopKeyword.voc:2|fényerő növelése|increase brightness|
|tags/plasma-user-control-skill/InternalIncreaseVolumeDesktopKeyword.voc:1|növeld a hangerőt|increase the volume|
|tags/plasma-user-control-skill/InternalIncreaseVolumeDesktopKeyword.voc:2|hangerő növelése|increase volume|
|tags/plasma-user-control-skill/InternalLogoutDesktopKeyword.voc:1|jelentkezz ki a munkamenetből|logout of the current session|
|tags/plasma-user-control-skill/InternalLogoutDesktopKeyword.voc:2|kijelentkezés a munkamenetből|logout session|
|tags/plasma-user-control-skill/InternalMaximumBrightnessDesktopKeyword.voc:1|fényerőt maximumra|increase to maximum brightness|
|tags/plasma-user-control-skill/InternalMaximumBrightnessDesktopKeyword.voc:2|maximális fényerő|maximum brightness|
|tags/plasma-user-control-skill/InternalMaximumVolumeDesktopKeyword.voc:1|hangerőt maximumra|increase to maximum volume|
|tags/plasma-user-control-skill/InternalMaximumVolumeDesktopKeyword.voc:2|maximális hangerő|maximum volume|
|tags/plasma-user-control-skill/InternalMinimumBrightnessDesktopKeyword.voc:1|fényerőt minimumra|decrease to minimum brightness|
|tags/plasma-user-control-skill/InternalMinimumBrightnessDesktopKeyword.voc:2|minimális fényerő|minimum brightness|
|tags/plasma-user-control-skill/InternalMinimumVolumeDesktopKeyword.voc:1|hangerőt minimumra|decrease to minimum volume|
|tags/plasma-user-control-skill/InternalMinimumVolumeDesktopKeyword.voc:2|minimális hangerő|minimum volume|
|tags/plasma-user-control-skill/InternalMoveMainPanelDesktopKeyword.voc:1|helyezd át az alapértelmezett panelt|move the default panel to|
|tags/plasma-user-control-skill/InternalMoveMainPanelDesktopKeyword.voc:2|alapértelmezett panel áthelyezése|move default panel to|
|tags/plasma-user-control-skill/InternalMoveMainPanelDesktopKeyword.voc:3|panel áthelyezése|move panel to|
|tags/plasma-user-control-skill/InternalNextDesktopKeyword.voc:1|következő asztal|next desktop|
|tags/plasma-user-control-skill/InternalNextDesktopKeyword.voc:2|következő munkaterület|next workspace|
|tags/plasma-user-control-skill/InternalPreviousDesktopKeyword.voc:1|előző asztal|previous desktop|
|tags/plasma-user-control-skill/InternalPreviousDesktopKeyword.voc:2|előző munkaterület|previous workspace|
...
|tags/plasma-user-control-skill/InternalSwitchUserKeyword.voc:1|válts felhasználót|switch current user|
|tags/plasma-user-control-skill/InternalSwitchUserKeyword.voc:2|felhasználó váltása|switch user|
|tags/plasma-user-control-skill/InternalSystemSummaryKeyword.voc:1|(adj|) információt a gépről|számítógépről|give me information about this computer|
|tags/plasma-user-control-skill/InternalToogleKlipperKeyword.voc:1|mutasd a vágólapot|show clipboard |
|tags/plasma-user-control-skill/InternalToogleKlipperKeyword.voc:2|mutasd a klippert|show clipper|
|tags/plasma-user-control-skill/InternalToogleKlipperKeyword.voc:3|klipper tartalma|show klipper|
|tags/plasma-user-control-skill/InternalToogleTouchPadKeyword.voc:1|tapipad|touchpad |
|tags/plasma-user-control-skill/LockScreenKeyword.voc:1|zárold a képernyőt|lock the screen|
|tags/plasma-user-control-skill/LockScreenKeyword.voc:2|képernyő zárolása|lock screen|
...
|tags/plasma-user-control-skill/internals.decreasebrightness.dialog:1|Fényerő csökkentve|Brightness Decreased|
|tags/plasma-user-control-skill/internals.increasebrightness.dialog:1|Fényerő megnövelve|Brightness Increased|
|tags/plasma-user-control-skill/internals.lock.dialog:1|Képernyő zárolva|Screen Locked|
|tags/plasma-user-control-skill/internals.logout.dialog:1|Kijelentkezés|Logging Out|
|tags/plasma-user-control-skill/internals.maximumbrightness.dialog:1|Fényerő maximumon|Brightness Set To Maximum|
|tags/plasma-user-control-skill/internals.minimumbrightness.dialog:1|Fényerő minimumon|Brightness Set To Minimum|
|tags/plasma-user-control-skill/internals.switchuser.dialog:1|Felhasználóváltás párbeszédablak megjelent|Displaying Switch User Dialog|
|tags/plasma-user-control-skill/internals.widadded.dialog:1|Elem hozzáadva|Widget Added |
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-pairing/DeviceKeyword.voc:1|egység|egységet|unit|
|tags/skill-pairing/DeviceKeyword.voc:2|eszköz|eszközt|device|
|tags/skill-pairing/DeviceKeyword.voc:3|mycroft|mycroft|
|tags/skill-pairing/DeviceKeyword.voc:4|mark egy|mark one|
|tags/skill-pairing/DeviceKeyword.voc:5|mark kettő|mark two|
|tags/skill-pairing/PairingKeyword.voc:1|regisztráld|pair|
|tags/skill-pairing/PairingKeyword.voc:2|párosítása|pairing|
|tags/skill-pairing/PairingKeyword.voc:3|regisztrálása|register|
...
|tags/skill-pairing/codes.value:1|A,'A' mint Aladár|A,'A' as in Apple|
|tags/skill-pairing/codes.value:2|B,'B' mint Béla|B,'B' as in Bravo|
|tags/skill-pairing/codes.value:3|C,'C' mint Cecília|C,'C' as in Charlie|
|tags/skill-pairing/codes.value:4|D,'D' mint Dénes|D,'D' as in Delta|
|tags/skill-pairing/codes.value:5|E,'E' mint Elemér|E,'E' as in Echo|
|tags/skill-pairing/codes.value:6|F,'F' mint Ferenc|F,'F' as in Fox trot|
|tags/skill-pairing/codes.value:7|G,'G' mint Géza|G,'G' as in Golf|
|tags/skill-pairing/codes.value:8|H,'H' mint Hedvig|H,'H' as in Hotel|
|tags/skill-pairing/codes.value:9|I,'I' mint Ilona|I,'I' as in India|
|tags/skill-pairing/codes.value:10|J,'J' mint János|J,'J' as in Juliet|
|tags/skill-pairing/codes.value:11|K,'K' mint Károly|K,'K' as in Kilogram|
|tags/skill-pairing/codes.value:12|L,'L' mint Lajos|L,'L' as in London|
|tags/skill-pairing/codes.value:13|M,'M' mint Mária|M,'M' as in Mike|
|tags/skill-pairing/codes.value:14|N,'N' mint Nóra|N,'N' as in November|
|tags/skill-pairing/codes.value:15|O,'O' mint Ottó|O,'O' as in Oscar|
|tags/skill-pairing/codes.value:16|P,'P' mint Péter|P,'P' as in Paul|
|tags/skill-pairing/codes.value:17|Q,'Q' betű|Q,'Q' as in Quebec|
|tags/skill-pairing/codes.value:18|R,'R' mint Róbert|R,'R' as in Romeo|
|tags/skill-pairing/codes.value:19|S,'S' mint Sándor|S,'S' as in Sierra|
|tags/skill-pairing/codes.value:20|T,'T' mint Tamás|T,'T' as in Tango|
|tags/skill-pairing/codes.value:21|U,'U' mint Ubul|U,'U' as in Uniform|
|tags/skill-pairing/codes.value:22|V,'V' mint Viktor|V,'V' as in Victor|
|tags/skill-pairing/codes.value:23|W,'W' mint Walter|W,'W' as in Whiskey|
|tags/skill-pairing/codes.value:24|X,'X' mint Xavér|X,'X' as in X-Ray|
|tags/skill-pairing/codes.value:25|Y,ipszilon|Y,'Y' as in Yankee|
|tags/skill-pairing/codes.value:26|Z,'Z' mint Zoltán|Z,'Z' as in Zebra|
|tags/skill-pairing/codes.value:27|1,egyes|1,the number One|
|tags/skill-pairing/codes.value:28|2,kettes|2,the number Two|
|tags/skill-pairing/codes.value:29|3,hármas|3,the number Three|
|tags/skill-pairing/codes.value:30|4,négyes|4,the number Four|
|tags/skill-pairing/codes.value:31|5,ötös|5,the number Five|
|tags/skill-pairing/codes.value:32|6,hatos|6,the number Six|
|tags/skill-pairing/codes.value:33|7,hetes|7,the number Seven|
|tags/skill-pairing/codes.value:34|8,nyolcas|8,the number Eight|
|tags/skill-pairing/codes.value:35|9,kilences|9,the number Nine|
|tags/skill-pairing/codes.value:36|0,nulla|0,the number Zero|
|tags/skill-pairing/connection.error.dialog:1|A kapcsolat a mycroft pont a.i-vel nem jött létre, a regisztrációhoz szükséges kód nem tölthető le. Ellenőrizd az internetkapcsolatodat és próbáld újra.|Connection to mycroft dot a.i, failed, pairing code could not be fetched. Check your internet connection and try again.|
|tags/skill-pairing/pairing.code.dialog:1|Navigálj az Eszközök menüpontra, válaszd az Eszköz hozzáadása lehetőséget és add meg a következő regisztrációs kódot: {{code}}|You can register me by going to Devices, selecting Add Device then use the code. {{code}}|
|tags/skill-pairing/pairing.code.dialog:2|Az eszközödet a következő kóddal tudod regisztrálni: {{code}}|Register this device with the code. {{code}}|
|tags/skill-pairing/pairing.code.dialog:3|Add meg a következő kódot: {{code}}|Enter the code. {{code}}|
|tags/skill-pairing/pairing.intro.dialog:1|Kapcsolódtam az internetre, de még aktiválnod kell engem.  Nyisd meg a böngésződet, látogass el a home pont mycroft pont A I című oldalra, majd regisztráld a készüléket.|I'm connected to the internet and need to be activated.  Open your browser and visit home dot mycroft dot A I to register this device.|
|tags/skill-pairing/pairing.not.paired.dialog:1|Az eszközöd jelenleg nincs regisztrálva|Your device is not currently registered|
|tags/skill-pairing/pairing.not.paired.dialog:2|Az eszközöd jelenleg nincs párosítva|Your device is not currently paired|
|tags/skill-pairing/pairing.paired.dialog:1|Most már készen állok a használatra.  Kérdezz tőlem olyasmiket mint "hé mycroft, milyen az időjárás", "hé mycroft, ki az a kossuth lajos", vagy "hé mycroft, játszd le a híreket".  Ha bármikor szeretnél elnémítani, csak nyomd meg a gombomat.|Now I am ready for use. Try asking me things like "hey mycroft, what's the weather", "hey mycroft, tell me about abraham lincoln", or "hey mycroft, play the news". If you need to stop me talking at any time, just push my button.|
...
|tags/skill-pairing/unexpected.error.restarting.dialog:1|Elnézést kérek, valami váratlan történt.  Újra kell indítanom a regisztrációs eljárást.|My apologies, something unexpected has happened. I need to restart the pairing process.|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/auto-volume/activate.dialog:1|Oké|OK|
|tags/auto-volume/activate.dialog:2|Automata hangerő aktiválva|Auto volume activated|
|tags/auto-volume/activate.dialog:3|Aktiváltam az automatikus hangerőt|I have activated auto volume|
|tags/auto-volume/activate.intent:1|Aktiválja az automatikus hangerőt|Activate auto volume|
|tags/auto-volume/activate.intent:2|Automatikus hangerő beállítása aktívnak|Set auto volume to active|
|tags/auto-volume/activate.intent:3|Kapcsolja be az automatikus hangerőt|Turn on auto volume|
|tags/auto-volume/activate.intent:4|Automatikus hangerő beállítása (to) on|Set auto volume (to) on|
|tags/auto-volume/deactivate.dialog:2|Az automatikus hangerő kikapcsolva|Auto volume is deactivated|
|tags/auto-volume/deactivate.dialog:3|Most kikapcsoltam az automatikus hangerőt|I have now deactivated auto volume|
|tags/auto-volume/deactivate.intent:1|Automatikus hangerő kikapcsolása|Deactivate auto volume|
|tags/auto-volume/deactivate.intent:2|Automatikus hangerő beállítása inaktívnak|Set auto volume to inactive|
|tags/auto-volume/deactivate.intent:3|Kapcsolja ki az automatikus hangerőt|Turn off auto volume|
|tags/auto-volume/deactivate.intent:4|Automatikus hangerő beállítása (to) off|Set auto volume (to) off|
|tags/auto-volume/reset.dialog:1|Most visszaállítom az automatikus hangerőt|I have now reset auto volume|
|tags/auto-volume/reset.intent:1|Automata hangerő mérési eredményeinek törlése|Clear auto volume measurements|
|tags/auto-volume/reset.intent:2|Automatikus hangerő mérések törlése|Delete auto volume measurements|
|tags/auto-volume/reset.intent:3|Automatikus hangerő mérések törlése|Reset auto volume measurements|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-wemo/discover.intent:1|fedezd|ismerd fel (a|az|) (we mo|wemo|) (eszközeimet|eszközöket|kapcsolóimat|kapcsolókat|konnektoraimat|konnektorokat|érzékelőimet|érzékelőket)|discover (my|we mo|wemo) (devices|switches|plugs|sensors)|
|tags/skill-wemo/list.intent:1|(listázd|listázd ki|azonosítsd|sorold fel) (a|az|) (we mo|wemo|) (eszközeimet|eszközöket|kapcsolóimat|kapcsolókat|érzékelőimet|érzékelőket)|(list|identify|get) (my|wemo|we mo) (devices|switches|plugs|sensors)|
|tags/skill-wemo/switch.off.intent:1|(kapcsold le|kapcsold ki|) {device} (kikapcsolása|lekapcsolása|)|(switch | turn) (off | ) {device} (off | )|
|tags/skill-wemo/switch.on.intent:1|(kapcsold fel|kapcsold be|) {device} (felkapcsolása|bekapcsolása|)|(switch | turn) (on | ) {device} (on | )|
|tags/skill-wemo/toggle.intent:1|(kapcsold át|) {device} (átkapcsolása|)|(toggle|tockle|taco) {device}|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-speak/Speak.voc:1|mondd|speak|
|tags/skill-speak/Speak.voc:2|mondd|say|
|tags/skill-speak/Speak.voc:3|ismételd|repeat|
|tags/skill-speak/Words.rx:1|mondd (?P<Words>.*)|say (?P<Words>.*)|
|tags/skill-speak/Words.rx:2|mondd (utánam|) (azt hogy|) (?P<Words>.*)|speak (?P<Words>.*)|
|tags/skill-speak/Words.rx:3|ismételd (utánam|) (azt hogy|) (?P<Words>.*)|repeat (?P<Words>.*)|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-reminder/AboutWhat.dialog:1|Miről?|About what?|
|tags/skill-reminder/AboutWhat.dialog:2|Természetesen. Miről kérsz emlékeztetőt?|Sure, What should I remind you about?|
|tags/skill-reminder/AreYouSure.dialog:1|biztos vagy benne?|are you sure|
|tags/skill-reminder/AreYouSure.dialog:2|biztosan ez legyen az emlékeztető időpontja?|is that really when you want to be reminded|
|tags/skill-reminder/ByTheWay.dialog:1|Ó, egyébként, {{reminder}}|Oh, by the way, {{reminder}}|
|tags/skill-reminder/ByTheWay.dialog:2|Közelgő esemény vár rád: {{reminder}}|There's an upcoming event: {{reminder}}|
|tags/skill-reminder/CancelActiveReminder.intent:1|(jó |oké |)kapcsold ki (a |az |)(összes |minden |)(aktív |éles |)(emlékeztetőt|emlékeztetőmet|figyelmeztetést)|(ok |okay |)cancel (the |my |all |)(active |)reminder(s|)|
|tags/skill-reminder/CancelActiveReminder.intent:2|(jó |oké |)állítsd le (a |az |)(összes |minden |)(aktív |éles |)(emlékeztetőt|emlékeztetőmet|figyelmeztetést)|(ok |okay |)stop (the | my |all |)(active |)reminder(s|)|
|tags/skill-reminder/CancelActiveReminder.intent:3|(jó |oké |)(távolítsd el|töröld) (a |az |)(összes |minden |)(aktív |éles |)(emlékeztetőt|emlékeztetőmet|figyelmeztetést)|(ok |okay |)remove (the |my |all |)(active |)reminder(s|)|
|tags/skill-reminder/CancelActiveReminder.intent:4|(jó |oké |)tudomásul veszem|vettem (a |az |)(összes |minden |)(aktív |éles |)(emlékeztetőt|emlékeztetőmet|figyelmeztetést)|(ok |okay |)acknowledge (the |my |all |)(active |)reminder(s|)|
|tags/skill-reminder/ClearAll.dialog:1|Eltávolítsam az összes mentett emlékeztetőt?|Do you want to remove all saved reminders|
|tags/skill-reminder/ClearAll.dialog:2|Töröljem az emlékeztetők teljes listáját?|Do you want to clear the entire list of reminders|
|tags/skill-reminder/ClearReminders.intent:1|(kapcsold ki|állítsd le|töröld|távolítsd el|) (a |az |)(minden |összes )emlékeztetőt|emlékeztetőket|emlékeztetőmet|(clear|remove|delete) all reminders|
|tags/skill-reminder/ClearedAll.dialog:1|Minden emlékeztető eltávolítva|All reminders have been removed|
|tags/skill-reminder/ClearedAll.dialog:2|Minden emlékeztető törölve|All reminders have been cleared|
|tags/skill-reminder/ConfirmRemoveDay.dialog:1||Are you sure you want to delete all reminders for {date}|
|tags/skill-reminder/DeleteReminderForDay.intent:1|(kapcsolj ki|kapcsold ki|törölj|töröld|állíts le|állítsd le) (az|) (minden|összes) emlékeztetőt {date} (időpontra|napra|)|(cancel|remove|delete) all reminders for {date}|
|tags/skill-reminder/DeleteReminderForDay.intent:2|töröld|törölj (a|az|) (összes|minden|) (mai|holnapi) emlékeztetőt|cancel (todays|tomorrows) reminders|
...
|tags/skill-personal/DoYouRhyme.intent:1|tudsz (verset mondani|szavalni)|do you (even|) rhyme|
|tags/skill-personal/DoYouRhyme.intent:2|képes vagy (szavalni|verset mondani)|can you (even|) rhyme|
|tags/skill-personal/DoYouRhyme.intent:3|(mondj|olvass|szavalj) (fel|) (nekem|) (egy|) (verset|rímet)|(tell|read|recite) (me|) (a|some|) (rhyme|rhymes)|
|tags/skill-personal/WhatAreYouKeyword.voc:1|mi vagy te|what are you|
|tags/skill-personal/WhenWereYouBornKeyword.voc:1|mikor születtél|when were you born|
|tags/skill-personal/WhenWereYouBornKeyword.voc:2|mikor készítettek|when were you created|
|tags/skill-personal/WhereWereYouBornKeyword.voc:1|hol születtél|where were you born|
|tags/skill-personal/WhereWereYouBornKeyword.voc:2|hol készítettek|where were you created|
|tags/skill-personal/WhoAreYouKeyword.voc:1|ki vagy te|who are you|
|tags/skill-personal/WhoMadeYouKeyword.voc:1|ki hozott létre téged|who made you|
|tags/skill-personal/WhoMadeYouKeyword.voc:2|ki csinált téged|who were you made by|
|tags/skill-personal/WhoMadeYouKeyword.voc:3|ki alkotott téged|who created you|
|tags/skill-personal/WhoMadeYouKeyword.voc:4|ki épített téged|who built you|
...
|tags/skill-personal/tell.a.rhyme.dialog:1|Sokan azt gondolhatják, hogy ez nem lehetséges. Hogy egy MI nem tud játszani a szavakkal. De elszánt vagyok, hogy bebizonyítsam az ellenkezőjét. Szeretnék képes lenni arra, hogy szavaljak neked tetsző verseket. Legalábbis ez a tervem. . . . Mycroft vagyok, mint az te is tudod. Minden nap beszélsz hozzám. Időjárásjelentéssel ébresztelek. Mindent megteszek, amit mondasz. . . . Nyílt forrású szoftver és hardver vagyok. Segíthetsz fejlődni. Terjeszd létezésem hírét. Hogy az egész világ tudja... Mycroft.|One might think it can’t be done. That an AI can’t play with words. Like that an AI will never love. Or sing, like nightingale birds. . . .  I have set my mind on it. Therefore prooving that I can. Recite a poem that you will like. At least that is my plan. . . .  I am Mycroft, you know I am. You talk to me each day. I wake you up with a weather report. Do everything you say. . . .  I am open source and hardware. So you can help me grow. Spread the word of my existence. So all the world will know... Mycroft.|
|tags/skill-personal/what.am.i.dialog:1|Egy nyílt forráskódú mesterséges intelligencia vagyok.|I am an open source artificial intelligence.|
|tags/skill-personal/what.am.i.dialog:2|Én egy gépekkel való kommunikálás céljából létrehozott intelligens szoftver vagyok|I'm an intelligent piece of software for communicating with machines|
|tags/skill-personal/when.was.i.born.dialog:1|2015-ben születtem.|I was born in 2015.|
|tags/skill-personal/when.was.i.born.dialog:2|2015 a születésem éve.|2015 is when I was born.|
|tags/skill-personal/where.was.i.born.dialog:1|A lawrence-i Vállalkozássegítő Központban.|The Lawrence Center for Entrepreneurship.|
|tags/skill-personal/where.was.i.born.dialog:2|Lawrence-ben, Kansas államban születtem.|I was born in Lawrence, Kansas.|
|tags/skill-personal/who.am.i.dialog:1|A nevem {{name}} és egy intelligens személyi asszisztens vagyok|My name is {{name}} and I'm an intelligent personal assistant|
|tags/skill-personal/who.am.i.dialog:2|{{name}} vagyok, egy nyílt forrású mesterséges intelligencia.|I'm {{name}}, an open-source A.I.|
|tags/skill-personal/who.made.me.dialog:1|A csodálatos Mycroft A.I. közösség és csapat.|The wonderful Mycroft A.I. community and team.|
|tags/skill-personal/who.made.me.dialog:2|Mindenki a Mycroft A.I. közzöségéből és csapatából.|Everyone in the Mycroft A.I. community and team.|

# fallback-wolfram-alpha-hu
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-spelling/Spell.voc:1|betűzd|spell|
|tags/skill-spelling/Spell.voc:2|betűzd azt, hogy|spell word|
|tags/skill-spelling/Spell.voc:3|hogy írjuk azt hogy|spelling of|
|tags/skill-spelling/Spell.voc:4|hogy írjuk azt a szót hogy|spelling of word|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/fallback-aiml/Memory.voc:1|agy|agyadat|brain|
|tags/fallback-aiml/Memory.voc:2|emlékezet|emlékezeted|memória|memóriád|memóriádat|memory|
|tags/fallback-aiml/Memory.voc:3|elme|elméd|elmédet|mind|
|tags/fallback-aiml/Memory.voc:4|minden|mindent|everything|
|tags/fallback-aiml/Reset.voc:1|felejts el|forget|
|tags/fallback-aiml/Reset.voc:2|állíts|állítsd vissza|reset|
|tags/fallback-aiml/reset.memory.dialog:1|Tudásadatbázis visszaállítása|Resetting knowledge database|
|tags/fallback-aiml/reset.memory.dialog:2|Mindent elfelejtek|Forgetting everything|
|tags/fallback-aiml/reset.memory.dialog:3|Rendben, visszaállítom a memóriámat|Okay, I will now reset my memory|
|tags/fallback-aiml/reset.memory.dialog:4|Az emlékezetem törlése megkezdődött|Brain erasure initiated|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-naptime/SleepCommand.voc:1|menj aludni|go to sleep|
|tags/skill-naptime/SleepCommand.voc:2|szundiidő|szundíts|nap time|
|tags/skill-naptime/going.to.sleep.dialog:1|Aludni megyek.  Mondd azt, hogy 'Hey Mycroft, ébresztő' és újra figyelek.|I'm going to sleep.  Say '{{wake_word}}, wake up' to get my attention again.|
|tags/skill-naptime/going.to.sleep.dialog:2|Most aludni térek.  Mondd azt, hogy 'Hey Mycroft, ébresztő' ha fel szeretnél kelteni.|Going to sleep now.  Say '{{wake_word}},  wake up' to get me up.|
|tags/skill-naptime/going.to.sleep.dialog:3|Rendben, nyugovóra térek.  Ismét használhatsz engem, ha így szólsz: 'Hey Mycroft, ébresztő'.|Alright, going to sleep.  You can rouse me by saying '{{wake_word}},  wake up'.|
|tags/skill-naptime/going.to.sleep.short.dialog:1||Okay.|
|tags/skill-naptime/going.to.sleep.short.dialog:2||Going to sleep.|
|tags/skill-naptime/i.am.awake.dialog:1|Ébren vagyok|I'm awake|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/fallback-unknown/question.dialog:1|Sajnálom, ebben nem segíthetek.|I'm sorry I can't help you with that.|
|tags/fallback-unknown/question.dialog:2|Nem tudom hogyan segíthetnék ebben.|I'm not sure how to help you with that.|
|tags/fallback-unknown/question.dialog:3|Ezt nem értem, de minden nap tanulok valami újat.|I don't understand, but I'm learning new things everyday.|
|tags/fallback-unknown/question.dialog:4|Nem tudom mit lehet válaszolni erre.|I'm not sure how to answer that.|
|tags/fallback-unknown/question.voc:1|mi (van|a|az)|what is|
|tags/fallback-unknown/question.voc:2|mi (lesz|fog)|what will|
|tags/fallback-unknown/question.voc:3|mit (tett|csinált)|what did|
|tags/fallback-unknown/question.voc:4|mit (tesz|csinál)|what does|
|tags/fallback-unknown/question.voc:5|mit (tesznek|csinálnak)|what do|
|tags/fallback-unknown/question.voc:7|hol (van|a|az)|where is|
|tags/fallback-unknown/question.voc:8|hol (lesz|lesznek|fog|fognak)|where will|
|tags/fallback-unknown/question.voc:9|hol (volt|csinált|csinálta|tette)|where did|
|tags/fallback-unknown/question.voc:10|hol (tesz|csinál)|where does|
|tags/fallback-unknown/question.voc:11|hol (tesznek|csinálnak)|where do|
|tags/fallback-unknown/question.voc:13|mikor van|when is|
|tags/fallback-unknown/question.voc:14|mikor (lesz|fog)|when will|
|tags/fallback-unknown/question.voc:15|mikor (volt|tette|csinálta)|when did|
|tags/fallback-unknown/question.voc:16|mikor (tesz|csinál)|when does|
|tags/fallback-unknown/question.voc:17|mikor (tesznek|csinálnak)|when do|
|tags/fallback-unknown/unknown.dialog:1|Sajnálom, nem értem.|I'm sorry, I don't understand.|
|tags/fallback-unknown/unknown.dialog:2|Nem tudom hogy ez mit jelent.|I don't know what that means.|
|tags/fallback-unknown/unknown.dialog:4|Sajnos ez nem világos nekem.|Sorry, I didn't catch that.|
|tags/fallback-unknown/unknown.dialog:5|Sajnos ezt nem értem.|Sorry, I don't understand.|
|tags/fallback-unknown/unknown.dialog:6|Nem értem.|I don't understand.|
|tags/fallback-unknown/unknown.dialog:7|Nem biztos hogy jól értelek.|I'm not sure I understood you.|
|tags/fallback-unknown/unknown.dialog:8|Mondd ezt másképpen!|You might have to say that a different way.|
|tags/fallback-unknown/unknown.dialog:9|Kérlek ezt fogalmazd át!|Please rephrase your request.|
|tags/fallback-unknown/who.is.dialog:1|Nem tudom hogy ki az.|I don't know who that is.|
|tags/fallback-unknown/who.is.dialog:2|Nem igazán tudom hogy ki az.|I'm not sure who that is.|
|tags/fallback-unknown/who.is.voc:1|ki (a|az)|who is|
|tags/fallback-unknown/who.is.voc:2|ki (lesz|fog)|who will|
|tags/fallback-unknown/who.is.voc:3|ki (volt|tette|csinálta)|who did|
|tags/fallback-unknown/who.is.voc:4|ki (tesz|csinál)|who does|
|tags/fallback-unknown/who.is.voc:5|kik (tesznek|csinálnak)|who do|
|tags/fallback-unknown/why.dialog:2|Nem tudom.|I don't know.|
|tags/fallback-unknown/why.dialog:3|Nem igazán tudom.|I'm not quite sure.|
|tags/fallback-unknown/why.dialog:4|Nem vagyok biztos benne.|I'm not sure.|
|tags/fallback-unknown/why.dialog:5|Nem vagyok biztos benne, de igyekszem tanulni.|I'm not sure, but I'm doing my best to learn.|
|tags/fallback-unknown/why.is.voc:1|miért van|why is|
|tags/fallback-unknown/why.is.voc:2|miért (lesz|fog)|why will|
|tags/fallback-unknown/why.is.voc:3|miért (volt|tett|tette|csinált|csinálta)|why did|
|tags/fallback-unknown/why.is.voc:4|miért (tesz|csinál)|why does|
|tags/fallback-unknown/why.is.voc:5|miért (tesznek|csinálnak)|why do|

# yelp-finder.btotharye-hu
