...
|tags/skill-playback-control/converse_resume.voc:3|oynatmaya devam et|resume playing|
...
# fallback-wolfram-alpha-tr
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/fallback-wolfram-alpha/Give.voc:1|söyle|tell|
|tags/fallback-wolfram-alpha/Give.voc:2|ver|give|
|tags/fallback-wolfram-alpha/Give.voc:3|ne|what|
|tags/fallback-wolfram-alpha/Give.voc:4|eposta|email|
|tags/fallback-wolfram-alpha/Give.voc:5|gönder|send|
|tags/fallback-wolfram-alpha/Source.voc:1|kaynak|source|
|tags/fallback-wolfram-alpha/Source.voc:2|kaynaklar|sources|
|tags/fallback-wolfram-alpha/Source.voc:3|detay|detail|
|tags/fallback-wolfram-alpha/Source.voc:4|dataylar|details|
...
|tags/fallback-wolfram-alpha/email.subject.dialog:1|Kaynaklar: '{{query}}'|Sources for: '{{query}}'|
|tags/fallback-wolfram-alpha/list.rx:1|(1,|1\.) (?P<Definition>.*) (2,|2\.) (.*)|(1,|1\.) (?P<Definition>.*) (2,|2\.) (.*)|
|tags/fallback-wolfram-alpha/no.info.to.send.dialog:1|Gönderilecek Wolfram Alpha sorusu bulamadım.|I couldn't find any Wolfram Alpha queries to send.|
|tags/fallback-wolfram-alpha/not.understood.dialog:1|Üzgünüm, ben {{phrase}} bilmiyorum|Sorry, I don't {{phrase}}|
|tags/fallback-wolfram-alpha/sent.email.dialog:1|Daha fazla bilgi ve kaynaklar için kayıtlı hesabınıza Wolfram Alpha bağlantısını içeren bir e-posta gönderdim.|I've sent an email to your registered account with a link to Wolfram Alpha for further details and sources.|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-pairing/DeviceKeyword.voc:1|birim|unit|
|tags/skill-pairing/DeviceKeyword.voc:2|cihaz|device|
|tags/skill-pairing/DeviceKeyword.voc:3|mycroft|mycroft|
|tags/skill-pairing/DeviceKeyword.voc:4|birini işaretle|mark one|
|tags/skill-pairing/DeviceKeyword.voc:5|ikisini işaretle|mark two|
|tags/skill-pairing/PairingKeyword.voc:1|eşleştir|pair|
|tags/skill-pairing/PairingKeyword.voc:2|eşleştirme|pairing|
|tags/skill-pairing/PairingKeyword.voc:3|kayıt ol|register|
...
|tags/skill-pairing/codes.value:36|0, Sıfır sayısı|0,the number Zero|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-support/ask.description.dialog:1|Lütfen yaşadığınız sorunu kısaca açıklayın|Please briefly describe the problem you are experiencing|
|tags/skill-support/ask.description.dialog:2|Karşılaştığınız sorunun kısa bir açıklaması nedir?|What's a brief description of the problem you are having?|
|tags/skill-support/cancelled.dialog:1|Peki|Alright|
|tags/skill-support/complete.dialog:1|Kayıtlı hesabınıza hata ayıklama bilgilerini ve destekle bağlantı kurma talimatlarını içeren bir e-posta gönderdim.|I've sent an email to your registered account with debugging information and instructions for contacting support.|
|tags/skill-support/confirm.support.dialog:1|Bir sorun giderme paketi oluşturmak ister misiniz? Bu, termbin.com servisine günlükleri yükler ve daha fazla bilgi içeren bir linki size e-posta olarak gönderir.|Would you like to create a troubleshooting package? This will upload logs to the zero ex zero dot S T service and email a link to you with more information.|
|tags/skill-support/contact.support.intent:1|sorun giderme isteği oluştur|create a troubleshoot request|
|tags/skill-support/contact.support.intent:2|cihazımda sorun giderme|troubleshoot my device|
|tags/skill-support/contact.support.intent:3|iletişim desteği|contact support|
|tags/skill-support/contact.support.intent:4|destek talebi oluştur|create a support ticket|
|tags/skill-support/one.moment.dialog:1|Bir dakika.|One moment.|
|tags/skill-support/support.dialog:1|destek|support|
|tags/skill-support/support.email.template:1|<p>Aşağıda, Mycroft tarafından oluşturulan sorun giderme paketine ait bir link verilmiştir:</p>|<p>Below is a link to the troubleshooting package generated by Mycroft:</p>|
|tags/skill-support/support.email.template:3|<ul><tt>|<ul><tt>|
|tags/skill-support/support.email.template:4|<p><b>Cihaz Adı:</b> {{device_name}}</p>|<p><b>Device Name:</b> {{device_name}}</p>|
|tags/skill-support/support.email.template:5|<p><b>Açıklama:</b> {{description}}</p>|<p><b>Description:</b> {{description}}</p>|
...
|tags/skill-support/support.title.dialog:1|Mycroft Sorun Giderme Asistanı|Mycroft Troubleshooting Assistant|
...
|tags/skill-support/yes.list:1|evet|yes|
|tags/skill-support/yes.list:2|evet|yeah|
|tags/skill-support/yes.list:3|evet|yep|
|tags/skill-support/yes.list:4|tabiki|sure|
|tags/skill-support/yes.list:5|lütfen|please|

# skill-configuration-tr
...
|tags/skill-configuration/ConfigurationSkillUpdateVerb.voc:1|güncelle|update|
...
# skill-version-checker-tr
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-version-checker/Check.voc:1|kontrol et|check|
|tags/skill-version-checker/Check.voc:2|bul|find|
|tags/skill-version-checker/Check.voc:3|çalışır durumda|running|
|tags/skill-version-checker/Check.voc:4|nedir|what is|
|tags/skill-version-checker/PlatformBuild.voc:1|platform oluşturma|platform build|
|tags/skill-version-checker/PlatformBuild.voc:2|platform versiyonu|platform version|
|tags/skill-version-checker/PlatformBuild.voc:3|yazılım sürümü|firmware version|
|tags/skill-version-checker/Version.voc:1|sürüm|version|
|tags/skill-version-checker/Version.voc:2|kod|code|
|tags/skill-version-checker/Version.voc:3|yayın|release|
|tags/skill-version-checker/Version.voc:4|sistem yazılımı|system software|
|tags/skill-version-checker/ask.upgrade.dialog:1|Sürümünüz eski. En son sürüm {{major}} {{minor}}, {{build}} sürümünü kullanmayı bırakın. Yükseltmeye başlamamı ister misiniz?|Your version is outdated. The latest version is {{major}} oh {{minor}}, release {{build}}.  Would you like me to start the upgrade?|
|tags/skill-version-checker/ask.upgrade.dialog:2|Sürümünüz eski. En son sürüm {{major}} {{minor}}, {{build}} sürümünü bırakın.   En son sürüme güncellememi ister misiniz?|Your version is outdated. The latest version is {{major}} oh {{minor}}, release {{build}}.  Would you like to update to the latest version?|
...
|tags/skill-version-checker/major.upgrade.declined.dialog:1|Sorun değil, şu an için şu anki yazılımımda kalacağım.|No problem, I'll stay with my current software for now.|
|tags/skill-version-checker/major.upgrade.dialog:1|Büyük bir Mycroft yazılımı güncellemesi var. Bu sizi yeni {{major}} oh {{minor}} bölümüne yönlendirecektir. Yazılım güncellemesini değiştirmek genellikle sorunsuzdur. Bununla birlikte, bazı beceriler yeni versiyonda mevcut olmayabilir. Bu yükseltmeye başlamak ister misiniz?|A major Mycroft software update is available.  This will move you to the new {{major}} oh {{minor}} branch.  Changing branches is usually painless.  However, some skills might not be available under the new branch.  Would you like to start this upgrade?|
|tags/skill-version-checker/platform.build.dialog:1|Platform derlemem {{build}}.|My platform build is {{build}}.|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/chatbot/Memory.voc:1|beyin|brain|
|tags/chatbot/Memory.voc:2|hafıza|memory|
|tags/chatbot/Memory.voc:3|akıl|mind|
|tags/chatbot/Memory.voc:4|her şey|everything|
|tags/chatbot/Reset.voc:1|unut|forget|
|tags/chatbot/Reset.voc:2|sıfırla|reset|
|tags/chatbot/reset.memory.dialog:1|Bilgi veritabanını sıfırlama|Resetting knowledge database|
|tags/chatbot/reset.memory.dialog:2|Her şeyi unut|Forgetting everything|
|tags/chatbot/reset.memory.dialog:3|Tamam, şimdi hafızamı sıfırlayacağım|Okay, I will now reset my memory|
|tags/chatbot/reset.memory.dialog:4|Beyin silme başlatıldı|Brain erasure initiated|

# mycroft-release-test-tr
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/mycroft-release-test/Release.dialog:1|18.2.4 testi geçti.|Test passed for 18.2.4.|
|tags/mycroft-release-test/ReleaseKeyword.voc:1|deneme testi|invoking test|
|tags/mycroft-release-test/ReleaseKeyword.voc:2|testi çağır|invoke test|
|tags/mycroft-release-test/ReleaseKeyword.voc:3|sürüm testini çağır|invoke release test|
|tags/mycroft-release-test/ReleaseKeyword.voc:4|sürüm testi|release test|
|tags/mycroft-release-test/ReleaseKeyword.voc:5|yayınlanan test|released test|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/desktop-control/CopyKeyword.voc:1|panoya kopyala|copy to clipboard|
|tags/desktop-control/CopyKeyword.voc:2|kopyala|copy|
|tags/desktop-control/CutKeyword.voc:1|panoya kes|cut to clipboard|
|tags/desktop-control/CutKeyword.voc:2|kes|cut|
|tags/desktop-control/DeleteKeyword.voc:1|sil|delete|
|tags/desktop-control/PasteKeyword.voc:1|panodan yapıştır|paste from clipboard|
|tags/desktop-control/PasteKeyword.voc:2|yapıştır|paste|
|tags/desktop-control/ScreenResKeyword.voc:1|ekran çözünürlüğü|screen resolution|
|tags/desktop-control/SelectAllKeyword.voc:1|hepsini seç|select all|
|tags/desktop-control/Text.rx:1|(tür) (?P<Text>.*)|(type) (?P<Text>.*)|
|tags/desktop-control/TypeKeyword.voc:1|tür|type|
|tags/desktop-control/absolutemousemove.dialog:1|Fareyi {{x}} ve {{y}} konumuna getir|Moving the mouse to {{x}} and {{y}}|
|tags/desktop-control/absolutemousemove.intent:1|fareyi {x} ve {y} konumuna getirin|move mouse to {x} and {y} |
|tags/desktop-control/down.entity:1|aşağı|down |
|tags/desktop-control/holdkey.intent:1|{key} tuşunu basılı tutun|hold the {key} key|
|tags/desktop-control/holdkey.intent:2|{key} tuşunu basılı tutun|hold down the {key} key|
...
|tags/desktop-control/key.entity:16|q|p|
|tags/desktop-control/key.entity:17|r|q|
|tags/desktop-control/key.entity:18|s|r|
...
|tags/desktop-control/key.entity:27|aşağı|down|
|tags/desktop-control/key.entity:28|yukarı|up|
|tags/desktop-control/key.entity:29|sola|left|
|tags/desktop-control/key.entity:30|sağa|right|
|tags/desktop-control/keyhold.dialog:1|Basılı tutun {{key}}|Holding {{key}}|
|tags/desktop-control/keyhold.dialog:2|{{Key}} tuşunu basılı tutun|Holding down the {{key}} key|
|tags/desktop-control/keypress.dialog:1|{{Key}} tuşuna basın|Pressing {{key}}|
|tags/desktop-control/keypress.dialog:2|Şimdi {{key}} tuşuna basmanız yeterli.|Pressing {{key}} for you now.|
|tags/desktop-control/keyrelease.dialog:1|{{Key}} tuşuna basmayı bırakın|Releasing {{key}}|
|tags/desktop-control/keyrelease.dialog:2|{{key}} tuşuna basmayı bırakın|Releasing the {{key}} key|
|tags/desktop-control/largescroll.entity:1|çok|lot|
|tags/desktop-control/medscroll.entity:1|biraz|some|
|tags/desktop-control/presskey.intent:1|{key} tuşuna basın|press the {key} key |
|tags/desktop-control/releasekey.intent:1|{key} tuşuna basmayı bırakın|release the {key} key|
|tags/desktop-control/releasekey.intent:2|{key} tuşuna git|let go of the {key} key|
|tags/desktop-control/screenresolution.dialog:1|Ekran çözünürlüğünüz {{x}} ile {{y}}|Your screen resolution is {{x}} by {{y}}|
|tags/desktop-control/screenresolution.dialog:2|Aktif ekranınızın çözünürlüğü {{x}} ile {{y}} 'dir.|The resolution of your active display is {{x}} by {{y}}|
...
|tags/desktop-control/smallscroll.entity:1|az|little|
|tags/desktop-control/typing.dialog:1|Bunu senin için şimdi yazıyorum|Typing that for you now|
|tags/desktop-control/typing.dialog:2|İsteğiniz yazılıyor|Typing your request|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-stock/StockPriceKeyword.voc:1|hisse senedi fiyatı|stock price|
|tags/skill-stock/StockPriceKeyword.voc:2|ticareti|trading at|
|tags/skill-stock/company.rx:1|(?P<Company>.*) hisse senedi fiyatı|price of (?P<Company>.*)|
|tags/skill-stock/company.rx:2|(?P<Company>.*) borsada kaçtan işlem yapıyor|is (?P<Company>.*) trading at|
|tags/skill-stock/not.found.dialog:1|Üzgünüz, {{company}} için bir hisse senedi fiyatı bulamadım.|Sorry, I couldn't find a stock price for {{company}}.|
|tags/skill-stock/not.found.dialog:2|{{company}} mevcut değil veya stok fiyatı yok.|{{company}} doesn't exist or has no stock price.|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/wikiquote/notfound.dialog:1|{{subject}} ile ilgili alıntı bulamadım|I didn't find any {{subject}} quotes|
|tags/wikiquote/random.intent:1||tell me (some|a) (quote|wisdom)|
|tags/wikiquote/random.intent:2||give me (some|a) (quote|wisdom)|
|tags/wikiquote/random.intent:3|Biraz bilgeliğe ihtiyacım var|I need some wisdom|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/emby/emby.dialog:1|Karışımı {media} oynat|Playing {media} mix|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/count/count.intent:1|{number} a kadar say|Count to {number}|
|tags/count/count_error.dialog:1|Anlamadım.|I do not understand. |
|tags/count/count_error.dialog:2|Bir şeyler kaçırıyorum.|I am missing something.|
|tags/count/count_error.dialog:3|Tekrar Söyle?|Say again?|
|tags/count/count_error.dialog:4|Üzgünüm. Bunu duymamış olayım.|Sorry. I did not hear that.|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/mycroft-timer/All.voc:1|tümü|all|
|tags/mycroft-timer/All.voc:2|çalışıyor|running|
|tags/mycroft-timer/All.voc:3||each|
|tags/mycroft-timer/Cancel.voc:1|iptal et|cancel|
|tags/mycroft-timer/Cancel.voc:2|kapat|turn off|
|tags/mycroft-timer/Cancel.voc:3|öldür|kill|
|tags/mycroft-timer/Cancel.voc:4|sil|delete|
|tags/mycroft-timer/Cancel.voc:5|dur|stop|
|tags/mycroft-timer/Cancel.voc:6|temizle|clear|
...
|tags/mycroft-timer/Mute.voc:1|sessiz|mute|
|tags/mycroft-timer/Mute.voc:2|sessizlik|silence|
|tags/mycroft-timer/Mute.voc:3|sessiz|quiet|
...
|tags/mycroft-timer/Time.voc:1|zamanlayıcı|time|
|tags/mycroft-timer/Timer.voc:1|zamanlayıcı|timer|
|tags/mycroft-timer/Timer.voc:2|zamanlayıcılar|timers|
|tags/mycroft-timer/all.list:2|her ikisi de|both|
|tags/mycroft-timer/and.dialog:1||and|
|tags/mycroft-timer/ask.cancel.running.dialog:1|Aktif zamanlayıcıyı iptal etmek istiyor musunuz?|Do you want to cancel the active timer?|
|tags/mycroft-timer/ask.cancel.running.dialog:2|Çalışan zamanlayıcıyı durdurmak ister misiniz?|Would you like to stop the running timer?|
|tags/mycroft-timer/ask.cancel.running.plural.dialog:1|Etkin zamanlayıcıları iptal etmek istiyor musunuz?|Do you want to cancel the active timers?|
|tags/mycroft-timer/ask.cancel.running.plural.dialog:2|Çalışan zamanlayıcıları durdurmak ister misiniz?|Would you like to stop the running timers?|
|tags/mycroft-timer/ask.how.long.dialog:1|Bir zamanlayıcının süresi ne kadar?|How long of a timer?|
|tags/mycroft-timer/ask.which.timer.cancel.dialog:1|{{names}} çalışan {{count}} zamanlayıcı var.  Hangisini soruyorsun?|There are {{count}} timers {{additional}} running, {{names}}, Which would you like to cancel?|
|tags/mycroft-timer/ask.which.timer.dialog:1|{{names}} çalışan {{count}} zamanlayıcı var.  Hangisini soruyorsun?|There are {{count}} timers {{additional}} running, {{names}}, Which are you asking about?|
|tags/mycroft-timer/cancel.all.dialog:1|{{count}} zamanlayıcı iptal edildi|{{count}} timers have been cancelled|
|tags/mycroft-timer/cancel.all.dialog:2|İptal edilen {{count}} zamanlayıcı|Cancelled {{count}} timers|
...
|tags/mycroft-timer/no.active.timer.dialog:1|Çalışan zamanlayıcı yok|There are no running timers|
|tags/mycroft-timer/no.active.timer.dialog:2|Çalışan zamanlayıcı yok|There are no active timers|
|tags/mycroft-timer/no.active.timer.dialog:2|Zamanlayıcı ayarlanmadı|No timer has been set|
...
|tags/mycroft-timer/start.timer.intent:3|{duration} için bir zamanlayıcı oluşturun.|(start|create) (a|) timer for {duration}|
...
|tags/mycroft-timer/started.ordinal.timer.dialog:2|Tamam, {{duration}} için başka bir zamanlayıcı ayarladım|Alright, I've set a {ordinal} timer for {duration}|
|tags/mycroft-timer/started.ordinal.timer.dialog:3|{{duration}} için başka bir zamanlayıcı başlatıyorum|I'm starting a {ordinal} timer for {duration}|
|tags/mycroft-timer/started.ordinal.timer.with.name.dialog:1|{{duration}} için bir zamanlayıcı başlatıyorum|A {ordinal} timer started for {duration} for {name}|
|tags/mycroft-timer/started.ordinal.timer.with.name.dialog:2|Tamam, {{duration}} için bir zamanlayıcı ayarladım|Alright, I've set a {ordinal} timer for {duration} for {name}|
|tags/mycroft-timer/started.ordinal.timer.with.name.dialog:3|{{duration}} için bir zamanlayıcı başlatıyorum|I'm starting a {ordinal} timer for {duration} for {name}|
|tags/mycroft-timer/started.timer.dialog:1|{{duration}} için zamanlayıcı başladı|Timer started for {duration}|
|tags/mycroft-timer/started.timer.dialog:2|Tamam, {{duration}} için bir zamanlayıcı ayarladım|Alright, I've set a timer for {duration}|
|tags/mycroft-timer/started.timer.dialog:3|{{duration}} için bir zamanlayıcı başlatıyorum|I'm starting a timer for {duration}|
|tags/mycroft-timer/started.timer.with.name.dialog:1|{{duration}} için bir zamanlayıcı başlatıyorum|A timer started for {duration} for {name}|
|tags/mycroft-timer/started.timer.with.name.dialog:2|Tamam, {{duration}} için bir zamanlayıcı ayarladım|Alright, I've set a timer for {duration} for {name}|
|tags/mycroft-timer/started.timer.with.name.dialog:3|{{duration}} için bir zamanlayıcı başlatıyorum|I'm starting a timer for {duration} for {name}|
|tags/mycroft-timer/stop.timer.intent:1||(stop|end|cancel|abort|delete|kill|turn off) (all|the|) (timer|timers)|
|tags/mycroft-timer/stop.timer.intent:2|kapat|turn it off|
...
|tags/mycroft-timer/tell.me.how.long.dialog:1|Ne kadar istediğini anlayamadım. ”" 3 dakika "veya" 30 saniye "gibi şeyler söyleyebilirsin.|I couldn't understand how long you wanted.  You can say things like "3 minutes" or "30 seconds".|
...
|tags/mycroft-timer/timer.details.named.with.ordinal.dialog:1|{{duration}} için bir zamanlayıcı başlatıyorum|a {ordinal} timer for {duration} for {name}|
...
|tags/mycroft-timer/timer.not.found.dialog:1|Zamanlayıcı ayarlanmadı|No such timer has been set|
...
# krunner-search-skill-tr
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/krunner-search-skill/CalculateKeyword.voc:1|hesapla|calculate |
|tags/krunner-search-skill/KrunnerPlasmaDesktopSkillKeyword.voc:1|bu bilgisayarda ara|search this computer for|
|tags/krunner-search-skill/KrunnerPlasmaDesktopSkillKeyword.voc:2|bunu ara|search this |
|tags/krunner-search-skill/KrunnerPlasmaDesktopSkillKeyword.voc:3|arama bilgisayarı|search computer for|
|tags/krunner-search-skill/KrunnerPlasmaDesktopSkillKeyword.voc:4|dosya ara|search file|
|tags/krunner-search-skill/KrunnerPlasmaDesktopSkillKeyword.voc:5|dosya adını ara|search filename|
|tags/krunner-search-skill/KrunnerPlasmaDesktopSkillKeyword.voc:6|bilgisayarda ara|search the computer for|
|tags/krunner-search-skill/KrunnerPlasmaDesktopSkillKeyword.voc:7|sistemi ara|search system|
|tags/krunner-search-skill/KrunnerPlasmaDesktopSkillKeyword.voc:8|sistem|system|
|tags/krunner-search-skill/KrunnerPlasmaDesktopSkillKeyword.voc:9|sistem araması|system search|
|tags/krunner-search-skill/KrunnerPlasmaDesktopSkillKeyword.voc:10|sistem arama dosyası|system search file|
|tags/krunner-search-skill/KrunnerPlasmaDesktopSkillKeyword.voc:11|dosyayı bul|find file|
|tags/krunner-search-skill/RecentFileKeyword.voc:1|son görüntüleme|display recent |
|tags/krunner-search-skill/RecentFileKeyword.voc:2|son dosyaları göster|display recent files|
|tags/krunner-search-skill/RecentFileKeyword.voc:3|son belgeleri göster|display recent documents|
|tags/krunner-search-skill/RecentFileKeyword.voc:4|son belgeler|recent documents|
|tags/krunner-search-skill/RecentFileKeyword.voc:5|son dosyalar|recent files|
|tags/krunner-search-skill/krunner.recent.dialog:1|Son dosyalarınızı görüntüleme|Displaying your recent files|
|tags/krunner-search-skill/krunner.search.dialog:1|Yerel olarak {{Query}} için arama yapıyorum|I am searching locally for {{ Query }}|

# yelp-finder.btotharye-tr
...
# skill-crystal-ball-tr
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-crystal-ball/CrystalBall.voc:1|Kristal top|Crystal Ball|
|tags/skill-crystal-ball/CrystalBall.voc:2|Ayna ayna|Mirror mirror|
|tags/skill-crystal-ball/Future.voc:1|gelecek|future|
|tags/skill-crystal-ball/Future.voc:2|yarın|tomorrow|
|tags/skill-crystal-ball/Query.voc:1|Bana söyle|Tell me|
|tags/skill-crystal-ball/Query.voc:2|Ne|What|
|tags/skill-crystal-ball/random.answer.dialog:1|Evet|Yes|
|tags/skill-crystal-ball/random.answer.dialog:2|Hayır|No|
|tags/skill-crystal-ball/random.answer.dialog:3|Tekrar sormayı dene|Try asking again later|
|tags/skill-crystal-ball/random.answer.dialog:4|Kesinlikle|Definitely|
|tags/skill-crystal-ball/random.answer.dialog:5|Tabii ki değil|Of course not|
|tags/skill-crystal-ball/random.answer.dialog:6|Tabiki|Sure|
|tags/skill-crystal-ball/random.answer.dialog:7|Hayır|Nope|
|tags/skill-crystal-ball/random.answer.dialog:8|Neden olmasın?|Why not?|
|tags/skill-crystal-ball/random.answer.dialog:9|Ben bahse girmem|I wouldn't bet on it|
|tags/skill-crystal-ball/random.answer.dialog:10|Kesinlikle!|You bet!|
|tags/skill-crystal-ball/random.answer.dialog:11|Nefesini tutma|Don't hold your breath|

# skill-finished-booting-tr
...
# btotharye-home-assistant-tr
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:1|etkinleştir|activate|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:2|ateş|fire|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:3|çağır|call up|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:4|tetikleyici|trigger|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:5|sahne|scene|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:6|otomasyon|automation|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:7|komut|script|
|tags/btotharye-home-assistant/DecreaseVerb.voc:1|azaltmak|decrease|
|tags/btotharye-home-assistant/DecreaseVerb.voc:2||down|
|tags/btotharye-home-assistant/DeviceTrackerKeyword.voc:1|nerede|where|
|tags/btotharye-home-assistant/DeviceTrackerKeyword.voc:2|yerini saptamak|konum|locate|location|
|tags/btotharye-home-assistant/IncreaseVerb.voc:1|artırmak|increase|
|tags/btotharye-home-assistant/IncreaseVerb.voc:2|yukarı|up|
|tags/btotharye-home-assistant/LightBrightenVerb.voc:1|aydınlat|daha parlak|parlak|parlaklığı artır|brighten|brighter|bright|up|
|tags/btotharye-home-assistant/LightDimVerb.voc:1|karart|söndür|karanlık|karartmak|azalt|kapat|dim|dimmer|dark|darken|lower|down|
|tags/btotharye-home-assistant/LightsKeyword.voc:1|ışık|light|
|tags/btotharye-home-assistant/LightsKeyword.voc:2|ışıklar|lights|
|tags/btotharye-home-assistant/LightsKeyword.voc:3|lamba|lamp|
|tags/btotharye-home-assistant/LightsKeyword.voc:4|lambalar|lamps|
|tags/btotharye-home-assistant/LightsKeyword.voc:5|ampul|bulb|
|tags/btotharye-home-assistant/LightsKeyword.voc:6|ampuller|bulbs|
|tags/btotharye-home-assistant/LightsKeyword.voc:7|led|l.e.d.|
|tags/btotharye-home-assistant/LightsKeyword.voc:8|aç|turn on|
|tags/btotharye-home-assistant/LightsKeyword.voc:9|kapat|turn off|
|tags/btotharye-home-assistant/LightsKeyword.voc:10|değiştir|toggle|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:1|durum|state|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:2|durum|status|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:3|sensör|sensor|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:4|detektör|detector|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:5|değer|value|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:6|okuma|read out|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:7|akım nedir|what is the current|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:8|akım nedir|what is current|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:9|bana akımı söyle|tell me the current|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:10|bana akımı söyle|tell me current|
|tags/btotharye-home-assistant/SetVerb.voc:1|ayar|set|
|tags/btotharye-home-assistant/SwitchActionKeyword.voc:1|kapat|turn|
|tags/btotharye-home-assistant/SwitchActionKeyword.voc:2|anahtar|switch|
...
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:2|{{dev_name}} değiştirildi.|triggered {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:3|{{dev_name}} tetiklendi.|{{dev_name}} was triggered.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:4|{{dev_name}} etkinleştirildi.|{{dev_name}} was activated.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:5|{{dev_name}} aktif.|activated {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.brightness.badreq.dialog:1|Lütfen 0 ile 100 arasında bir parlaklık seviyesi isteyin.|please request a brightness level between 0 and 100.|
|tags/btotharye-home-assistant/homeassistant.brightness.badreq.dialog:2|ne kadar parlak? 0 ile 100 arasında bir seviye seçebilirsiniz.|how bright? you can choose a level from 0 to 100.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.dimmable.dialog:1|{{dev_name}} karartılamıyor. Kısılabilir değil.|Can not dim {{dev_name}}. It is not dimmable.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.off.dialog:1|{{dev_name}} karartılamıyor. Kapalı.|Can not dim {{dev_name}}. It is off.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.off.dialog:2|{{dev_name}} karartılamıyor. Lütfen önce cihazı açınız.|Can not dim {{dev_name}}. Please turn it on before.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.off.dialog:3|{{dev_name}} karartılamıyor. Sadece açık olan cihazlarda mümkün olabilir.|{{dev_name}} can not be dimmed. Only devices that are turned on can be.|
|tags/btotharye-home-assistant/homeassistant.brightness.decreased.dialog:1|{{dev_name}}, {{brightness}} yüzdesine karartıldı.|Dimmed {{dev_name}} to {{brightness}} percent.|
|tags/btotharye-home-assistant/homeassistant.brightness.decreased.dialog:2|{{dev_name}} karartılmış .|Dimmed {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.brightness.dimmed.dialog:1|{{dev_name}} parlaklığını yüzde {{brightness}} olarak ayarla.|Set the brightness of {{dev_name}} to {{brightness}} percent.|
|tags/btotharye-home-assistant/homeassistant.brightness.increased.dialog:1|{{dev_name}} parlaklığı, {{brightness}}' a yükseldi.|Increased brightness of {{dev_name}} to {{brightness}} percent.|
|tags/btotharye-home-assistant/homeassistant.brightness.increased.dialog:2|{{dev_name}} cihazının parlaklığı artırıldı.|Increased brightness of {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.already.dialog:1|{{dev_name}} zaten {{action}}.|{{dev_name}} already {{action}}.|
|tags/btotharye-home-assistant/homeassistant.device.already.dialog:2|{{dev_name}} üzerinde değişiklik yapılmadı.|No changes made to {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.off.dialog:1|{{dev_name}} kapatıldı.|turned off {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.off.dialog:2|{{dev_name}} kapalı.|turned {{dev_name}} off.|
|tags/btotharye-home-assistant/homeassistant.device.off.dialog:3|{{dev_name}} şimdi kapalı.|{{dev_name}} is now off.|
|tags/btotharye-home-assistant/homeassistant.device.on.dialog:1|{{dev_name}} cihazı açık.|turned on {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.on.dialog:2|{{dev_name}} açıldı.|{{dev_name}} was turned on.|
|tags/btotharye-home-assistant/homeassistant.device.on.dialog:3|{{dev_name}} cihazı açık.|turned {{dev_name}} on.|
|tags/btotharye-home-assistant/homeassistant.device.toggle.dialog:1|{{dev_name}} değiştirildi.|toggled {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.toggle.dialog:2|{{dev_name}} değiştirildi.|{{dev_name}} was toggled.|
|tags/btotharye-home-assistant/homeassistant.device.unknown.dialog:1|Maalesef, Home Assistant'ı bulamıyorum |Sorry, I can't find the Home Assistant entity |
|tags/btotharye-home-assistant/homeassistant.device.unknown.dialog:2|Entity|Entity |
|tags/btotharye-home-assistant/homeassistant.device.unknown.dialog:3|Üzgünüm, entity.|Sorry, entity |
|tags/btotharye-home-assistant/homeassistant.device.unknown.dialog:4|Affedersiniz, bulamadım.|Excuse me, I wasn't able to find |
|tags/btotharye-home-assistant/homeassistant.error.offline.dialog:1|Ev asistanı sunucusu çevrimdışı görünüyor.|The Home assistant server appears to be offline.|
|tags/btotharye-home-assistant/homeassistant.error.offline.dialog:2|Ev asistanı sunucusuna erişilemedi.|Couldn't reach the home assistant server.|
|tags/btotharye-home-assistant/homeassistant.error.offline.dialog:3|Ev asistanı sunucusu yanıt vermedi.|The home assistant server did not respond.|
|tags/btotharye-home-assistant/homeassistant.error.setup.dialog:1|Lütfen ev yardımcısı beceri ayarlarını mycroft.ai üzerinden yapın.|Please configure the home assistant skill settings at home dot mycroft dot ai.|
|tags/btotharye-home-assistant/homeassistant.error.sorry.dialog:1|ne yapmamı istediğini bilmiyorum.|I don't know what you want me to do.|
|tags/btotharye-home-assistant/homeassistant.error.sorry.dialog:2|Ev asistanı ile nasıl konuşulacağını çözemedik|Couldn't figure out how to talk to Home Assistant.|
|tags/btotharye-home-assistant/homeassistant.error.sorry.dialog:3|Ne sorduğunu anlamıyorum.|I don't understand what you are asking.|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-singing/Sing.voc:1|şarkı söyle|sing|
|tags/skill-singing/Sing.voc:2|Bana bir şarkı söyle|sing me a song|
|tags/skill-singing/singing.dialog:1|Senin için şarkı söylemekten mutlu olurum.|I would be happy to sing for you. |
|tags/skill-singing/singing.dialog:2|İşte gidiyorum|Here I go.|
|tags/skill-singing/singing.dialog:3|Sesim için biraz gerginim, haydi hayırlısı|I'm a bit nervous about my voice, but here goes nothing.|
|tags/skill-singing/singing.stop.dialog:1|dinlediğiniz için teşekkürler|thank you for listening|
|tags/skill-singing/singing.stop.dialog:2|Umarım sesimi beğenmişsindir|I hope you liked my voice|
|tags/skill-singing/singing.stop.dialog:3|şimdi sen dene|now you try|

# picroft-google-aiy-voicekit-tr
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/picroft-google-aiy-voicekit/error.initialize.dialog:1|Google AIY ses seti yeteneğini başlatırken sorun yaşıyorum. Beceri yüklenmeyecek|I am having problems initializing the Google A I Y voice kit Skill. The Skill will not load. |
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-installer/action.list:1|yükleniyor|installing|
|tags/skill-installer/action.list:2|kaldırılıyor|removing|
|tags/skill-installer/cancelled.dialog:1|İptal edildi|Cancelled.|
|tags/skill-installer/cancelled.dialog:2|İşlem iptal edildi.|Action cancelled.|
|tags/skill-installer/choose.skill.dialog:1|Birden çok beceri bulundu, hangisini istersiniz ... {{skills}}|Multiple skills found, which would you like... {{skills}}|
|tags/skill-installer/error.already.beta.dialog:1|{{Skill}} önizleme sürümü zaten kurulu.|The preview version of {{skill}} has already been installed.|
|tags/skill-installer/error.already.installed.dialog:1|{{skill}} zaten kurulmuş|{{skill}} has already been installed|
|tags/skill-installer/error.already.removed.dialog:1|{{skill}} kurulu değil|{{skill}} is not installed|
|tags/skill-installer/error.already.removed.dialog:2|{{skill}} bu cihazda bulunamadı|{{skill}} was not found on this device|
|tags/skill-installer/error.filesystem.dialog:1|{{Action}} {{skill}} iken bir dosya sistemi hatası oluştu.|A filesystem error occurred while {{action}} {{skill}}.|
|tags/skill-installer/error.multiple.skills.dialog:1|İsteğinizde birden fazla eşleşme oldu, lütfen daha belirgin olun.|Your request had multiple matches, please be more specific.|
|tags/skill-installer/error.not.found.dialog:1|{{Skill}} adlı bir yetenek bulamadım.|I didn't find any skill named {{skill}}.|
|tags/skill-installer/error.other.dialog:1|{{Skill}} yüklenirken bilinmeyen bir hata oluştu.|An unknown error occurred while installing {{skill}}.|
|tags/skill-installer/error.pip.requirements.dialog:1|{{Skill}} için {{action}} Python bağımlılıkları yapılırken bir hata oluştu.|An error occurred while {{action}} the Python dependencies for {{skill}}.|
|tags/skill-installer/error.skill.requirements.dialog:1|{{Action}}, {{skill}} yetenek gereksinimleri için bir hata oluştu.|An error occurred while {{action}} the skill requirements for {{skill}}.|
|tags/skill-installer/error.system.requirements.dialog:1|{{Action}} sistem {{skill}} için paketlenirken bir hata oluştu.|An error occurred while {{action}} the system packages for {{skill}}.|
|tags/skill-installer/install.beta.complete.dialog:1|{{Skill}} geliştirme sürümü kuruldu. Bu sürüm, herhangi bir topluluk incelemesine veya kalite kontrol testine tabi tutulmamıştır, bu yüzden yazara sorunları bildirirken sorumluluğu üstlenin. : {{skill}} kur.|The development version of {{skill}} has been installed.  This version has not undergone any community review or quality control testing, so be responsible when reporting issues to the author.  To switch back to the officially released version, say: install {{skill}}.|
|tags/skill-installer/install.beta.confirm.dialog:1|Onaylama: {{skill}} 'in resmi olarak yayınlanan versiyonundan geliştirme versiyonuna geçeyim mi?|Confirming: Shall I switch from the officially released version of {{skill}} to the development version?|
|tags/skill-installer/install.beta.intent:1|{skill} (sürüm |) beta kur.|install {skill} (version|) beta.|
|tags/skill-installer/install.beta.intent:2|{skill} (beta|önizleme) sürümünü kur|install {skill} (beta|preview) version|
|tags/skill-installer/install.beta.intent:3||install (the|) (beta|preview) (version|)(of|) {skill}.|
|tags/skill-installer/install.beta.upgrade.confirm.dialog:1|Onaylama: {{skill}} en son geliştirme sürümüne yükselteyim mi?|Confirming: Shall I upgrade {{skill}} to the latest development version?|
|tags/skill-installer/install.complete.dialog:1|{{skill}} şimdi yüklendi ve kullanıma hazır|{{skill}} is now installed and ready for use|
|tags/skill-installer/install.confirm.dialog:1|Onaylama: {{author}} e ait olan {{skill}} 'i kuralım mı?|Confirming: Shall I install {{skill}} by {{author}}.|
|tags/skill-installer/install.custom.intent:1|Özel yetenek indirin|Download custom skill|
|tags/skill-installer/install.intent:1|kur {skill}.|install {skill}.|
|tags/skill-installer/install.intent:2|{skill} (sürüm |) (kararlı | resmi) kur.|install {skill} (version|) (stable|official).|
|tags/skill-installer/install.intent:3|{skill} becerisinin (resmi | kararlı) (sürümünü) kur.|install (the|) (official|stable) (version|of|) {skill}.|
|tags/skill-installer/install.intent:4||install official release (version|) of {skill}.|
|tags/skill-installer/install.reinstall.confirm.dialog:1|Onaylama: {{skill}} resmi yayın sürümünü tekrar yükleyeyim mi?|Confirming: Shall I reinstall the official release version of {{skill}}?|
|tags/skill-installer/installed.dialog:1|evet, {skill} yüklendi|yes, {skill} is installed|
|tags/skill-installer/is.installed.intent:1|{skill} kurulu|is {skill} installed|
|tags/skill-installer/list.skills.intent:1||(Show me|List) (available|installable) skills.|
|tags/skill-installer/list.skills.intent:2|Hangi (becerileri|) yükleyebilirim?|What (skills|) can I install?|
|tags/skill-installer/list.skills.intent:3|Yükleyebileceğim bazı beceriler nelerdir?|What are some skills I can install?|
|tags/skill-installer/not.installed.dialog:1|hayır, {skill} kurulu değil|no, {skill} isn't installed|
|tags/skill-installer/not.installed.dialog:2|hayır, {skill} yüklü değil|no, {skill} is not installed|
|tags/skill-installer/or.dialog:1|veya|or|
|tags/skill-installer/remove.complete.dialog:1|{{skill}} kaldırıldı|{{skill}} has been removed|
|tags/skill-installer/remove.confirm.dialog:1|Onaylama: {{author}} 'a ait {{skill}} kaldıralım mı?|Confirming:  Shall I remove {{skill}} by {{author}}.|
|tags/skill-installer/remove.intent:1|{skill} adlı (beceriyi|) kaldır|uninstall (skill|) {skill}|
|tags/skill-installer/remove.intent:3|{skill} adlı (beceriyi|) kaldır|uninstall {skill} (skill|)|
|tags/skill-installer/some.available.skills.dialog:1|İşte yükleyebileceğiniz yeteneklerden birkaçı ... {{skills}}|Here are a few of the skills you can install... {{skills}}|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-reminder/AboutWhat.dialog:1|Ne hakkında?|About what?|
|tags/skill-reminder/AboutWhat.dialog:2|Tabii, Size neyi hatırlatmalıyım?|Sure, What should I remind you about?|
|tags/skill-reminder/AreYouSure.dialog:1|emin misiniz|are you sure|
|tags/skill-reminder/AreYouSure.dialog:2|gerçekten hatırlatılmak istediğin zaman mı|is that really when you want to be reminded|
...
|tags/skill-reminder/ClearAll.dialog:1|Tüm kayıtlı hatırlatıcıları kaldırmak istiyor musunuz?|Do you want to remove all saved reminders|
|tags/skill-reminder/ClearAll.dialog:2|Tüm hatırlatıcı listesini silmek istiyor musunuz?|Do you want to clear the entire list of reminders|
|tags/skill-reminder/ClearReminders.intent:1|tüm hatırlatıcıları (temizle|kaldır|sil)|(clear|remove|delete) all reminders|
|tags/skill-reminder/ClearedAll.dialog:1|Tüm hatırlatıcılar kaldırıldı|All reminders have been removed|
|tags/skill-reminder/ClearedAll.dialog:2|Tüm hatırlatıcılar temizlendi|All reminders have been cleared|
|tags/skill-reminder/ConfirmRemoveDay.dialog:1||Are you sure you want to delete all reminders for {date}|
|tags/skill-reminder/DeleteReminderForDay.intent:1|{date} tarihindeki tüm hatırlatıcıları (iptal et|kaldır|sil)|(cancel|remove|delete) all reminders for {date}|
|tags/skill-reminder/DeleteReminderForDay.intent:2|(bugünün|yarının) hatırlatıcılarını iptal et|cancel (todays|tomorrows) reminders|
|tags/skill-reminder/DeleteReminderForDay.intent:3|(bugün|yarın) hatırlatıcılarının hepsini iptal et|cancel all reminders for (today|tomorrow)|
|tags/skill-reminder/GetNextReminders.intent:1|sonraki hatırlatma nedir?|what is (the|my) next reminder|
|tags/skill-reminder/GetNextReminders.intent:2|sırada ne var (hatırlatma | hatırlatmalar | hatırlatma listesi | hatırlatmalar listesi)|what is next on my (reminder|reminders|reminder list|list of reminders)|
|tags/skill-reminder/GetRemindersForDay.intent:1||get (the|all) reminders for {date}|
|tags/skill-reminder/GetRemindersForDay.intent:2|{date} için hatırlatıcılarım neler|what are (the|my) reminders for {date}|
|tags/skill-reminder/GetRemindersForDay.intent:3|{date} hatırlatıcı var mı|do i have any reminders( on|) {date}|
|tags/skill-reminder/ItIsNight.dialog:1|Bu gecenin ortasında|That's in the middle of the night|
|tags/skill-reminder/ItIsNight.dialog:2|Çok geç|That's very late|
|tags/skill-reminder/NextOtherDate.dialog:1||{reminder} at {time} {date}|
|tags/skill-reminder/NextToday.dialog:1|Bir sonraki hatırlatıcınız, {time} daki {reminder}|Your next reminder is {reminder} at {time}|
|tags/skill-reminder/NextTomorrow.dialog:1|Yarın ki {reminder}, {time} da |You have {reminder} tomorrow at {time}|
|tags/skill-reminder/NoActive.dialog:1|Etkin hatırlatıcı yok|There are no active reminders|
|tags/skill-reminder/NoDateTime.dialog:1|Üzgünüm, zamanı anlayamadım.|Sorry, I didn't catch the time.|
|tags/skill-reminder/NoDateTime.dialog:2|Zamanı başka bir şekilde söyleyebilir misin?|Can you say the time in an other way.|
...
|tags/skill-reminder/NoUpcoming.dialog:1|Yaklaşan hatırlatıcı yok|There are no upcoming reminders|
|tags/skill-reminder/NoUpcoming.dialog:2|Yaklaşan bir hatırlatıcı yok|You have no upcoming reminders|
|tags/skill-reminder/ParticularTime.dialog:1|Tamam, sana herhangi bir zamanda hatırlatmamı ister misin?|Right-o, do you want me to remind you at any particular time?|
|tags/skill-reminder/ParticularTime.dialog:2|Tamam, belirli bir zamanda hatırlatılmak ister misiniz?|Okay, do you want to be reminded at a specific time?|
...
|tags/skill-wiki/More.voc:2|devam et|continue|
|tags/skill-wiki/Random.intent:1|bana rastgele birşey söyle|tell me something random|
...
|tags/skill-wiki/Random.intent:5|bana rastgele birşey söyle|teach me something random|
...
# carstena-the-cows-lists-tr
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/carstena-the-cows-lists/AddTask.rx:1|ekle (? P <taskName>. +)|add (?P<taskName>.+)|
|tags/carstena-the-cows-lists/AddTaskToList.dialog:1|{{taskName}}, {{listName}} listesine eklendi|{{taskName}} was added to list {{listName}}|
|tags/carstena-the-cows-lists/AddTaskToList.rx:1|ekle (?P<taskName>.+) (benim )?(?P<listName>.+) listeme$|add (?P<taskName>.+) to (my )?(?P<listName>.+) list$|
|tags/carstena-the-cows-lists/AddTaskToList.rx:2|(?P<taskName>.+)'yi listesine (?P<listName>.+)$ ekle|add (?P<taskName>.+) to list (?P<listName>.+)$|
|tags/carstena-the-cows-lists/AddTaskToListKeyword.voc:1|ekle|add|
|tags/carstena-the-cows-lists/AddTaskToListMismatch.dialog:1|{{ListName}} adlı bir liste bulamıyorum, bunun yerine {{bestMatch}} 'e eklemek ister misiniz?|I cant find a list called {{listName}}, do you want to add the task to {{bestMatch}} instead?|
|tags/carstena-the-cows-lists/AddTaskToListUndo.dialog:1|{{TaskName}}'i, {{listName}} listesinden tekrar kaldırdım|I have removed {{taskName}} from list {{listName}} again|
|tags/carstena-the-cows-lists/AnythingElse.dialog:1|{taskName}, başka bir şey var mı?|{taskName}, anything else?|
|tags/carstena-the-cows-lists/AnythingElseEnd.dialog:1|tamam, görevler {{listName}} listesine eklendi|okay, the tasks are added to list {{listName}}|
|tags/carstena-the-cows-lists/AskSendException.dialog:1|Sorunu bildirmenize yardımcı olması için son anormal durumu bir posta ile göndermemi ister misiniz?|Do you want me to send a mail with the last exception, to help you report the issue?|
|tags/carstena-the-cows-lists/Authenticate.rx:1|kimlik doğrulaması (?P<authenticateWord>.+) sütü hatırla $|authenticate (?P<authenticateWord>.+) remember the milk$|
|tags/carstena-the-cows-lists/AuthenticateBeforeToken.dialog:1|Bir jeton almadan önce kendimi doğrulamam gerekiyor, lütfen "sütü hatırla" ile doğrulamama izin verin.|I must authenticate before getting a token, ask me to authenticate with remember the milk|
|tags/carstena-the-cows-lists/AuthenticateKeyword.voc:1|ile doğrula|authenticate with|
|tags/carstena-the-cows-lists/CompleteList.dialog:1|{{listName}} listesindeki {{nofTask}} görevler tamamlandı olarak işaretlendi|{{nofTask}} tasks on list {{listName}} was marked complete|
|tags/carstena-the-cows-lists/CompleteListOneTask.dialog:1|{{listName}} listesindeki {{nofTask}} görev tamamlandı olarak işaretlendi|{{nofTask}} task on list {{listName}} was marked complete|
|tags/carstena-the-cows-lists/CompleteListOneTaskUndo.dialog:1|{{ListName}} listesindeki {{nofTask}} görevini tekrar geri yükledim|I have restored {{nofTask}} task on list {{listName}} again|
|tags/carstena-the-cows-lists/CompleteListStart.dialog:1|{{ListName}} listesindeki {{nofTask}} görevleri tamamlandı olarak işaretleyeceğim, bu biraz zaman alabilir. Bitirdikten sonra geri yükleme, geri al diyerek bu işlemi geri alabilirsiniz.|I will mark {{nofTask}} tasks on list {{listName}} complete, this may take a while. You can undo this operation by saying either restore, undo or revert after I finish|
|tags/carstena-the-cows-lists/CompleteListUndo.dialog:1|{{ListName}} listesindeki {{nofTask}} görevleri tekrar geri yükledim|I have restored {{nofTask}} tasks on list {{listName}} again|
|tags/carstena-the-cows-lists/CompleteManyTasksOnList.dialog:1|{{listName}} listesindeki {{noFTask}} görevlerin {{taskName}} adlı görevleri tamamlandı olarak işaretlendi|{{nofTask}} tasks named {{taskName}} on list {{listName}} was marked complete|
|tags/carstena-the-cows-lists/CompletePartOfListStart.dialog:1|{{NofTask}} görevlerini buldum, işlem süresini kısaltabilmek için sadece bir kısmını tamamlayacağım.|I found {{nofTask}} tasks, I will only complete a part of them, to keep the processing time down.|
|tags/carstena-the-cows-lists/CompleteTask.rx:1|tamamlandı (?P<taskName>.+)$|complete (?P<taskName>.+)$|
|tags/carstena-the-cows-lists/CompleteTaskOnList.dialog:1|{{taskName}} listesindeki {{listName}} tamamlandı olarak işaretlendi|{{taskName}} on list {{listName}} was marked complete|
|tags/carstena-the-cows-lists/CompleteTaskOnList.rx:1|ekle (?P<taskName>.+) (benim )?(?P<listName>.+) listeme$|complete (?P<taskName>.+) on (my )?(?P<listName>.+) list$|
|tags/carstena-the-cows-lists/CompleteTaskOnList.rx:2|(?P<taskName>.+)'yi listesine (?P<listName>.+)$ ekle|complete (?P<taskName>.+) on list (?P<listName>.+)$|
|tags/carstena-the-cows-lists/CompleteTaskOnListKeyword.voc:1|tamamla|complete|
|tags/carstena-the-cows-lists/CompleteTaskOnListUndo.dialog:1|{{ListName}} listesindeki {{taskName}} 'i tekrar geri yükledim|I have restored {{taskName}} on list {{listName}} again|
|tags/carstena-the-cows-lists/ConfigNotFound.dialog:1|Konfigürasyonu okuyamadım. Lütfen mycroft.config dosyasını düzenleyin veya home.mycroft.ai üzerindeki yapılandırmayı güncelleyin|I could not read the configuration. Please edit mycroft dot config or update the configuration on home dot mycroft dot a, i|
|tags/carstena-the-cows-lists/DoYouWantToCompleteIt.dialog:1|tamamlamak ister misin|do you want to complete it|
|tags/carstena-the-cows-lists/Due.rx:1|ne olacak (?P<dueDate>(Şimdi|Dün|Bugün|Yarın|Pazartesi|Salı|Çarşamba|Perşembe|Cuma|Cumartesi|Pazar))$|what is due (?P<dueDate>(now|yesterday|today|tomorrow|monday|tuesday|wedensday|thursday|friday|saturday|sunday))$|
|tags/carstena-the-cows-lists/DueKeyword.voc:1|ne olduğunu|what is on|
|tags/carstena-the-cows-lists/DueKeyword.voc:2||what is due|
|tags/carstena-the-cows-lists/DueOnList.rx:1|ne olacak (?P<dueDate>(Şimdi|Dün|Bugün|Yarın|Pazartesi|Salı|Çarşamba|Perşembe|Cuma|Cumartesi|Pazar))$|what is on (my )?(?P<listName>.+) list (?P<dueDate>(now|yesterday|today|tomorrow|monday|tuesday|wedensday|thursday|friday|saturday|sunday))$|
|tags/carstena-the-cows-lists/EmailSent.dialog:1|Size kimlik doğrulama bağlantısı olan bir e-posta gönderdim, Mycroft'tan bir posta olup olmadığını kontrol edin|I have sent you an e-mail with an authentication link, check for a mail from Mycroft|
|tags/carstena-the-cows-lists/FindTask.rx:1|bul (?P<taskName>.+)|find (?P<taskName>.+)|
|tags/carstena-the-cows-lists/FindTaskOnList.dialog:1|{{ListName}} listesinde {{taskName}} buldum|I found {{taskName}} on list {{listName}}|
|tags/carstena-the-cows-lists/FindTaskOnList.rx:1|ara (?P<taskName>.+) (benim)?(?P<listName>.+) listemde$|find (?P<taskName>.+) on (my )?(?P<listName>.+) list$|
|tags/carstena-the-cows-lists/FindTaskOnList.rx:2|ara (?P<taskName>.+) listemde (?P<listName>.+)$|find (?P<taskName>.+) on list (?P<listName>.+)$|
|tags/carstena-the-cows-lists/FindTaskOnListKeyword.voc:1|ara|find|
|tags/carstena-the-cows-lists/FindTaskOnListMismatch.dialog:1|{{TaskName}} bulamadım, ancak {{listName}} listesinde {{bestMatch}} buldum.|I did not find {{taskName}}, but I did find {{bestMatch}} on list {{listName}}|
|tags/carstena-the-cows-lists/GeneralError.dialog:1|{{functionName}}, {{lineNumber}} satırında hata|Error in {{functionName}} at line {{lineNumber}}|
|tags/carstena-the-cows-lists/GetToken.rx:1|(?P<appName>.+)$ için bir jeton alın|get a token for (?P<appName>.+)$|
|tags/carstena-the-cows-lists/GetTokenKeyword.voc:1|jeton al|get token|
|tags/carstena-the-cows-lists/GotToken.dialog:1|Bir jetonum var. Şimdi listelerinize öğeler eklemeye hazırım. Gelen Kutusu listeme bir şey eklememi isteyin|I got a token. I am now ready to put items on your lists. Ask me to add something to my Inbox list|
|tags/carstena-the-cows-lists/IDontUnderstand.dialog:1|Sanırım görevler veya listeler hakkında bir şeyler söyledin ama anlamadım|I think you said something about tasks or lists, but I don't understand it|
|tags/carstena-the-cows-lists/InAuthentication.dialog:1|"Sütü hatırla" ile doğrulama sürecinde olduğunuz anlaşılıyor. Postadaki Mycroft'tan gelen kimlik doğrulama bağlantısını kullandıktan sonra, sütü hatırlamak için bir jeton almamı isteyin|It seems that you are in the process of authentication with remember the milk. After using the authentication link in the mail from Mycroft, ask me to get a token for remember the milk|
|tags/carstena-the-cows-lists/ListNotFound.dialog:1|Maalesef, {{listName}} adlı bir liste bulamadım.|Sorry, I could not find a list called {{listName}}|
|tags/carstena-the-cows-lists/LocalRegex.json:1|{|{|
|tags/carstena-the-cows-lists/LocalRegex.json:2|  "GörevEkle": ["ekle (?P<taskName>.+)"],|  "AddTask": ["add (?P<taskName>.+)"],|
|tags/carstena-the-cows-lists/LocalRegex.json:3|  "ListeyeGörevEkleyin": [|  "AddTaskToList": [|
|tags/carstena-the-cows-lists/LocalRegex.json:4|ekle (?P<taskName>.+) (benim )?(?P<listName>.+) listeme$|    "add (?P<taskName>.+) to (my|the) (?P<listName>.+) list$",|
|tags/carstena-the-cows-lists/LocalRegex.json:5|(?P<taskName>.+)'yi listesine (?P<listName>.+)$ ekle|    "add (?P<taskName>.+) to list (?P<listName>.+)$"],|
|tags/carstena-the-cows-lists/LocalRegex.json:6|  "GörevEkle": ["ekle (?P<taskName>.+)"],|  "FindTask": ["find (?P<taskName>.+)"],|
|tags/carstena-the-cows-lists/LocalRegex.json:7|  "ListeyeGörevEkleyin": [|  "FindTaskOnList": [|
|tags/carstena-the-cows-lists/LocalRegex.json:8|ekle (?P<taskName>.+) (benim )?(?P<listName>.+) listeme$|    "find (?P<taskName>.+) on (my|the) (?P<listName>.+) list$",|
|tags/carstena-the-cows-lists/LocalRegex.json:9|(?P<taskName>.+)'yi listesine (?P<listName>.+)$ ekle|    "find (?P<taskName>.+) on list (?P<listName>.+)$"],|
...
|tags/carstena-the-cows-lists/LocalRegex.json:12|ekle (?P<taskName>.+) (benim )?(?P<listName>.+) listeme$|    "complete (?P<taskName>.+) on (my|the) (?P<listName>.+) list$",|
|tags/carstena-the-cows-lists/LocalRegex.json:13|(?P<taskName>.+)'yi listesine (?P<listName>.+)$ ekle|    "complete (?P<taskName>.+) on list (?P<listName>.+)$"],|
|tags/carstena-the-cows-lists/LocalRegex.json:14||  "CompleteList" : [|
|tags/carstena-the-cows-lists/LocalRegex.json:15|(?P<listName>.+) (listemdeki|listesindeki) bütün (görevleri|maddeleri) tamamla$|    "complete all (task(s)?|item(s)?) on (my|the) (?P<listName>.+) list$",|
|tags/carstena-the-cows-lists/LocalRegex.json:16|ekle (?P<taskName>.+) (benim )?(?P<listName>.+) listeme$|    "complete all (task(s)?|item(s)?) on list (?P<listName>.+)$"],|
...
|tags/carstena-the-cows-lists/UsingAnotherList.dialog:1|{{ListName}} adlı bir liste bulamıyorum, bunun yerine {{bestMatch}} 'e eklemek ister misiniz?|I cant find a list called {{listName}}, do you want to use the list {{bestMatch}} instead?|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/fallback-aiml/Memory.voc:1|akıl|brain|
|tags/fallback-aiml/Memory.voc:2|hafıza|memory|
|tags/fallback-aiml/Memory.voc:3|akıl|mind|
|tags/fallback-aiml/Memory.voc:4|her şey|everything|
|tags/fallback-aiml/Reset.voc:1|unut|forget|
|tags/fallback-aiml/Reset.voc:2|sıfırla|reset|
|tags/fallback-aiml/reset.memory.dialog:1|Bilgi veritabanını sıfırlama|Resetting knowledge database|
|tags/fallback-aiml/reset.memory.dialog:2|Her şeyi unut|Forgetting everything|
|tags/fallback-aiml/reset.memory.dialog:3|Tamam, şimdi hafızamı sıfırlayacağım|Okay, I will now reset my memory|
|tags/fallback-aiml/reset.memory.dialog:4|Beyin silme başlatıldı|Brain erasure initiated|

# reginaneon-av-music-tr
...
# today-history.btotharye-tr
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/today-history.btotharye/RandomEventKeyword.voc:1|tarihte bu gün ne olay oldu|what event happened this day in history|
|tags/today-history.btotharye/RandomEventKeyword.voc:2|tarihte bu gün|this day in history|
|tags/today-history.btotharye/RandomEventKeyword.voc:3|tarihte bugün|today in history|
...
|tags/skill-alarm/Alarm.voc:2|alarmlar|alarms|
...
|tags/skill-alarm/All.voc:1|hepsi|all|
|tags/skill-alarm/All.voc:2|her ikisi de|both|
|tags/skill-alarm/StopBeeping.voc:7|sil|delete|
|tags/skill-alarm/Delete.voc:2||remove|
|tags/skill-alarm/StopBeeping.voc:4|iptal|cancel|
|tags/skill-alarm/Delete.voc:4||clear|
|tags/skill-alarm/Delete.voc:5||erase|
|tags/skill-alarm/StopBeeping.voc:10|devre dışı|disable|
|tags/skill-alarm/StopBeeping.voc:2|dur|stop|
|tags/skill-alarm/Delete.voc:8||turn off|
|tags/skill-alarm/Delete.voc:9||abort|
|tags/skill-alarm/StopBeeping.voc:8|durdur|kill|
|tags/skill-alarm/Except.voc:1|dışında|except|
|tags/skill-alarm/Except.voc:2|hariç|excluding|
...
|tags/skill-alarm/Recurrence.voc:1|pazartesi|monday|
|tags/skill-alarm/Recurrence.voc:2|salı|tuesday|
|tags/skill-alarm/Recurrence.voc:3|çarşamba|wednesday|
|tags/skill-alarm/Recurrence.voc:4|perşembe|thursday|
|tags/skill-alarm/Recurrence.voc:5|cuma|friday|
|tags/skill-alarm/Recurrence.voc:6|cumartesi|saturday|
|tags/skill-alarm/Recurrence.voc:7|pazar|sunday|
|tags/skill-alarm/Recurring.voc:1||# These values must also be supported in the recurring.value file|
|tags/skill-alarm/Recurring.voc:1|tekrarlayan|recurring|
|tags/skill-alarm/Recurring.voc:2|tekrarlanan|repeating|
|tags/skill-alarm/Recurring.voc:4||each|
|tags/skill-alarm/Recurring.voc:3|her|every|
|tags/skill-alarm/Recurring.voc:4|günlük|daily|
|tags/skill-alarm/Recurring.voc:5|hafta içi|weekdays|
|tags/skill-alarm/Recurring.voc:6|hafta sonları|weekends|
|tags/skill-alarm/Recurring.voc:7|pazartesileri|mondays|
|tags/skill-alarm/Recurring.voc:8|salıları|tuesdays|
|tags/skill-alarm/Recurring.voc:9|çarşambaları|wednesdays|
|tags/skill-alarm/Recurring.voc:10|perşembeleri|thursdays|
|tags/skill-alarm/Recurring.voc:11|cumaları|fridays|
|tags/skill-alarm/Recurring.voc:12|cumartesileri|saturdays|
|tags/skill-alarm/Recurring.voc:13|pazarları|sundays|
|tags/skill-alarm/Recurring.voc:15|hafta içi|work days|
|tags/skill-alarm/Recurring.voc:16|hafta içi|workdays|
|tags/skill-alarm/Recurring.voc:18||# Yes, it should already catch 'each' and 'every', but Adapt is missing these|
|tags/skill-alarm/Recurring.voc:19|her gün|every day|
|tags/skill-alarm/Recurring.voc:20||every weekday|
|tags/skill-alarm/Recurring.voc:21|her sabah|every morning|
|tags/skill-alarm/Recurring.voc:22|her öğleden sonra|every afternoon|
|tags/skill-alarm/Recurring.voc:23|her akşam|every evening|
|tags/skill-alarm/Recurring.voc:24|her gece|every night|
|tags/skill-alarm/Recurring.voc:25|her gün|each day|
|tags/skill-alarm/Recurring.voc:26|her hafta içi|each weekday|
|tags/skill-alarm/Recurring.voc:27|her sabah|each morning|
|tags/skill-alarm/Recurring.voc:28|her öğleden sonra|each afternoon|
|tags/skill-alarm/Recurring.voc:29|her akşam|each evening|
|tags/skill-alarm/Recurring.voc:30|her gece|each night|
|tags/skill-alarm/Set.voc:1|ekle|add|
|tags/skill-alarm/Set.voc:2|ayarla|set|
|tags/skill-alarm/Set.voc:3|başlat|start|
|tags/skill-alarm/Set.voc:4|oluştur|create|
|tags/skill-alarm/StopBeeping.voc:1|# Alarmı durduracak tek kelime|# Single words that will kill the alarm|
|tags/skill-alarm/StopBeeping.voc:3|kapat|shut|
|tags/skill-alarm/StopBeeping.voc:4|çık|quit|
|tags/skill-alarm/StopBeeping.voc:5|çık|exit|
|tags/skill-alarm/StopBeeping.voc:6|son|end|
|tags/skill-alarm/StopBeeping.voc:10|kapat|off|
|tags/skill-alarm/StopBeeping.voc:12|tamam|ok|
|tags/skill-alarm/StopBeeping.voc:13|ok|okay|
|tags/skill-alarm/StopBeeping.voc:14|peki|alright|
|tags/skill-alarm/WakeMe.voc:1|uyandır beni|wake me|
|tags/skill-alarm/WakeMe.voc:2|beni uyandır|wake me up|
|tags/skill-alarm/WakeMe.voc:3||let me know|
|tags/skill-alarm/alarm.already.exists.dialog:1|Bu alarm zaten mevcut|That alarm already exists.|
|tags/skill-alarm/alarm.already.exists.dialog:2||You already (have|set|created) an alarm for that time.|
|tags/skill-alarm/alarm.already.exists.dialog:3|Bu saate kuru bir alarm zaten var|An alarm is already (set|created) for that time.|
|tags/skill-alarm/alarm.cancelled.desc.dialog:1|{{desc}} için alarmı iptal ettim|I've cancelled the alarm for {{desc}}|
|tags/skill-alarm/alarm.cancelled.desc.recurring.dialog:1|{{desc}} için tekrar eden alarmı iptal ettim|I've cancelled the recurring alarm for {{desc}}|
...
|tags/skill-alarm/alarm.scheduled.dialog:1|Alarm kuruldu|Alarm set|
...
|tags/skill-alarm/alarms.list.empty.dialog:1|Alarm ayarlanmadı|No alarms have been set|
|tags/skill-alarm/alarms.list.empty.dialog:2|Aktif alarm yok|There are no active alarms|
...
|tags/skill-alarm/ask.cancel.desc.alarm.dialog:1|Onaylama: {{{desc}} için alarmı iptal etmek istiyor musunuz?|((Just|) Confirming:|)  Do you (wish|want) to cancel the alarm for {{desc}}?|
|tags/skill-alarm/ask.cancel.desc.alarm.recurring.dialog:1|Onaylama: {{{desc}} için alarmı iptal etmek istiyor musunuz?|((Just|) Confirming:|)  Do you (wish|want) to cancel the recurring alarm for {{desc}}?|
...
|tags/skill-alarm/confirm.alarm.dialog:1|{{time}} için bir alarm ayarlıyorum, bu doğru mu?|I'm (setting|creating) an alarm for {{time}}, does that sound right?|
|tags/skill-alarm/confirm.alarm.dialog:2|{{time}} için yeni bir alarm oluşturuyorum, doğru mu?|I'm (setting|creating) a new alarm for {{time}}, correct?|
|tags/skill-alarm/confirm.recurring.alarm.dialog:1|{{recurrence}} tarihinde {{time}} için yinelenen bir alarm ayarlıyorum, bu doğru mu?|I'm (setting|creating) a recurring alarm for {{time}} on {{recurrence}}, does that sound right?|
|tags/skill-alarm/confirm.recurring.alarm.dialog:2|{{recurrence}} tarihinde {{time}} için tekrar eden yeni bir alarm oluşturuyorum, doğru mu?|I'm (setting|creating) a new recurring alarm for {{time}} on {{recurrence}}, correct?|
|tags/skill-alarm/daytype.entity:1|(gün | hafta içi | hafta içi | hafta sonu | hafta sonları | yarın | bugün)|(day | weekday | weekdays | weekend | weekends | tomorrow | today)|
|tags/skill-alarm/daytype.entity:2|(pazartesi   | salı   | çarşamba   | perşembe   | cuma   | cumartesi   | pazar)|(monday  | tuesday  | wednesday  | thursday  | friday  | saturday  | sunday )|
|tags/skill-alarm/daytype.entity:3|(pazartesileri   | salıları   | çarşambaları   | perşembeleri   | cumaları   | cumartesileri   | pazarları)|(mondays  | tuesdays  | wednesdays  | thursdays  | fridays | saturdays  | sundays )|
...
|tags/skill-alarm/query.recurrence.dialog:1|Hangi günlerde?|On what days?|
|tags/skill-alarm/query.recurrence.dialog:2|Hangi günler için|For which days?|
...
|tags/skill-alarm/recurring.value:2|# önce çoğul versiyonlar listelenir, sonuçlar "cuma günleri saat 7'de" veya "her gün saat 7'de" olur.|# list plural version first, resulting in "7pm on fridays" or "7pm every day"|
|tags/skill-alarm/recurring.value:3|pazartesileri,1|mondays,1|
|tags/skill-alarm/recurring.value:4|pazartesi,1|monday,1|
|tags/skill-alarm/recurring.value:5|salıları,2|tuesdays,2|
|tags/skill-alarm/recurring.value:6|salı,2|tuesday,2|
|tags/skill-alarm/recurring.value:7|çarşambaları,3|wednesdays,3|
|tags/skill-alarm/recurring.value:8|çarşamba,3|wednesday,3|
|tags/skill-alarm/recurring.value:9|perşembeleri,4|thursdays,4|
|tags/skill-alarm/recurring.value:10|perşembe,4|thursday,4|
|tags/skill-alarm/recurring.value:11|cumaları,5|fridays,5|
|tags/skill-alarm/recurring.value:12|cuma,5|friday,5|
|tags/skill-alarm/recurring.value:13|cumartesileri,6|saturdays,6|
|tags/skill-alarm/recurring.value:14|cumartesi,6|saturday,6|
|tags/skill-alarm/recurring.value:15|pazarları,0|sundays,0|
|tags/skill-alarm/recurring.value:16|pazar,0|sunday,0|
|tags/skill-alarm/recurring.value:17|hafta içi, 1 2 3 4 5|weekdays,1 2 3 4 5|
|tags/skill-alarm/recurring.value:18|hafta içi, 1 2 3 4 5|weekday,1 2 3 4 5|
|tags/skill-alarm/recurring.value:19||every weekday, 1 2 3 4 5|
|tags/skill-alarm/recurring.value:20||each weekday, 1 2 3 4 5|
|tags/skill-alarm/recurring.value:19|hafta sonları, 0 6|weekends,0 6|
|tags/skill-alarm/recurring.value:20|hafta sonu,0 6|weekend,0 6|
|tags/skill-alarm/recurring.value:21|her gün, 0 1 2 3 4 5 6|every day,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:24|her gün, 0 1 2 3 4 5 6|each day,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:22|her gün, 0 1 2 3 4 5 6|everyday,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:26|her gün, 0 1 2 3 4 5 6|every morning,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:27|her gün, 0 1 2 3 4 5 6|every afternoon,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:28|her gün, 0 1 2 3 4 5 6|every evening,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:29|her gün, 0 1 2 3 4 5 6|every night,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:30|her gün, 0 1 2 3 4 5 6|each morning,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:31|her gün, 0 1 2 3 4 5 6|each afternoon,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:32|her gün, 0 1 2 3 4 5 6|each evening,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:33|her gün, 0 1 2 3 4 5 6|each night,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:23|günlük, 0 1 2 3 4 5 6|daily,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:35|hafta içi, 1 2 3 4 5|work days,1 2 3 4 5|
|tags/skill-alarm/recurring.value:24||work,1 2 3 4 5|
|tags/skill-alarm/repeats.dialog:1||repeats|
|tags/skill-alarm/snooze.intent:1|şekerleme|snooze|
...
|tags/skill-alarm/snooze.intent:5|(the|) alarmını iptal et|pause (the|) alarm|
...
|tags/skill-number-guess/Play.voc:1|Çal|Play|
|tags/skill-number-guess/Play.voc:2|Oyunu Başlat|Start a game|
|tags/skill-number-guess/Suggest.voc:1|Haydi|Let's|
|tags/skill-number-guess/Suggest.voc:2|Bize bırak|Let us|
|tags/skill-number-guess/Suggest.voc:3|Neden yapmıyoruz|Why don't we|
|tags/skill-number-guess/Suggest.voc:4|Peki ya biz|How about we|
|tags/skill-number-guess/Suggest.voc:5|Yapmalıyız|We should|
|tags/skill-number-guess/correct.dialog:1|Doğru!|That's right!|
|tags/skill-number-guess/correct.dialog:2|Anladın!|You got it!|
|tags/skill-number-guess/correct.dialog:3|Doğru|Correct!|
|tags/skill-number-guess/correct.dialog:4|Bu sayı!|That's the number!|
|tags/skill-number-guess/correct.dialog:5|İyi iş!|Good job!|
|tags/skill-number-guess/correct.dialog:6|Kazandın!|You win!|
|tags/skill-number-guess/get.lower.dialog:1|Alt sınırın ne olmasını istiyorsun?|What do you want the lower bound to be?|
|tags/skill-number-guess/get.upper.dialog:1|Üst sınırın ne olmasını istiyorsun?|What do you want the upper bound to be?|
|tags/skill-number-guess/guess.dialog:1|Tahmini sayı|Guess the number|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-volume/Decrease.voc:1|düşük|lower|
|tags/skill-volume/Decrease.voc:2|azalt|reduce|
|tags/skill-volume/Decrease.voc:3|düşür|decrease|
|tags/skill-volume/Decrease.voc:5|daha sessiz|quieter|
...
|tags/skill-volume/Increase.voc:1|yükselt|rise|
|tags/skill-volume/Increase.voc:4|arttır|increase|
|tags/skill-volume/Increase.voc:2|yükselt|raise|
|tags/skill-volume/Increase.voc:3|arttır|boost|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/translate-skill/HowUseKeyword.voc:1|nasıl kullanılır|how use|
|tags/translate-skill/HowUseKeyword.voc:2|nasıl|how|
|tags/translate-skill/HowUseKeyword.voc:3|ile yardım|help with|
|tags/translate-skill/HowUseKeyword.voc:4|yardım|help|
|tags/translate-skill/HowUseKeyword.voc:5|Bana yardım et|help me with|
|tags/translate-skill/HowUseKeyword.voc:6|ne dedin|what say with|
|tags/translate-skill/LanguageKeyword.voc:1|dil|language|
|tags/translate-skill/LanguageKeyword.voc:2|diller|languages|
|tags/translate-skill/LanguageNameKeyword.voc:1|en|ingilizce|en|english|
|tags/translate-skill/LanguageNameKeyword.voc:2|es|ispanyolca|es|spanish|
|tags/translate-skill/LanguageNameKeyword.voc:3|it|italyanca|it|italian|
|tags/translate-skill/LanguageNameKeyword.voc:4|fr|fransızca|fr|french|
|tags/translate-skill/LanguageNameKeyword.voc:5|nl|hollandaca|nl|dutch|
|tags/translate-skill/LanguageNameKeyword.voc:6|de|almanca|de|german|
|tags/translate-skill/LanguageNameKeyword.voc:7|pl|lehçe|pl|polish|
|tags/translate-skill/LanguageNameKeyword.voc:8|pt|portekizce|pt|portuguese|
|tags/translate-skill/LanguageNameKeyword.voc:9|da|danimarkaca|da|danish|
|tags/translate-skill/LanguageNameKeyword.voc:10|hu|macarca|hu|hungarian|
|tags/translate-skill/LanguageNameKeyword.voc:11|sv|işveçce|sv|swedish|
|tags/translate-skill/LanguageNameKeyword.voc:12|no|norveçce|no|norwegian|
|tags/translate-skill/LanguageNameKeyword.voc:13|ca|katalanca|ca|catalan|
|tags/translate-skill/LanguageNameKeyword.voc:14|ro|romanca|ro|romanian|
|tags/translate-skill/LanguageNameKeyword.voc:15|sk|slovakça|sk|slovak|
|tags/translate-skill/LanguageNameKeyword.voc:16|zh-TW|çince|zh-TW|chinese|
|tags/translate-skill/LanguageNameKeyword.voc:17|ja|japonca|ja|japanese|
|tags/translate-skill/LanguageNameKeyword.voc:18|ko|korece|ko|korean|
|tags/translate-skill/LanguageNameKeyword.voc:19|el|yunanca|el|greek|
|tags/translate-skill/LanguageNameKeyword.voc:20|vi|vietnamca|vi|vietnamese|
|tags/translate-skill/LanguageNameKeyword.voc:21|tr|türkçe|tr|turkish|
|tags/translate-skill/LanguageNameKeyword.voc:22|fi|fince|fi|finnish|
|tags/translate-skill/LanguageNameKeyword.voc:23|ar|arapça|ar|arabic|
|tags/translate-skill/RepeatKeyword.voc:1|tekrar et|repeat|
|tags/translate-skill/SkillNameKeyword.voc:1|çeviri becerisi|translate skill|
|tags/translate-skill/SkillNameKeyword.voc:2|çeviri becerisi|translateskill|
|tags/translate-skill/SkillNameKeyword.voc:3|çeviri|translate|
|tags/translate-skill/SpeakKeyword.voc:1|konuşabilir misin|can you speak|
|tags/translate-skill/SpeakKeyword.voc:2|başka biliyor musun|do you know other|
|tags/translate-skill/SpeakKeyword.voc:3|başkalarını tanıyor musun|do you know others|
|tags/translate-skill/SpeakKeyword.voc:4|sen başkasını biliyor musun|you know other|
|tags/translate-skill/SpeakKeyword.voc:5|başkalarını tanıyor musun|you know others|
|tags/translate-skill/SpeakKeyword.voc:6|konuşabiliyor musun|do you can speak|
|tags/translate-skill/SpeakKeyword.voc:7|konuşur musun|do you speak|
|tags/translate-skill/SpeakKeyword.voc:8|başka konuşabiliyor musun|do you speak other|
|tags/translate-skill/SpeakKeyword.voc:9|başkalarından bahset|speak others|
|tags/translate-skill/SpeakKeyword.voc:10|başkasını konuş|speak other|
|tags/translate-skill/ToKeyword.voc:1|-e|to|
|tags/translate-skill/TranslateKeyword.voc:2|konuş|speak|
|tags/translate-skill/how.use.dialog:1|Çok iyi, açıklayacağım; Söyleyebilirsiniz: İsveççe merhaba sevgili dostlarım çevirmek, diyebilirsin: merhaba sevgili dostlarım romence çevirmek, başka bir kullanım yöntemi de bana sormak: Başka dilleri mi konuşuyorsun ?, İngilizce, İspanyolca, Fransızca konuşabiliyorum İtalyanca, Portekizce, Hollandaca, Almanca, İsveççe, Macarca, Lehçe, Norveççe, Danca, Romence, Slovakça, Katalanca, Çince ve Japonca|Very good, I'll explain; you can say: translate to swedish hello my dear friends, you can also say: translate hi my dear friends to romanian, another way of using is asking me: do you speak other languages?, I can speak in English, Spanish, French, Italian, Portuguese, Dutch, German, Swedish, Hungarian, Polish, Norwegian, Danish, Romanian, Slovak, Catalan, Chinese and Japanese|
|tags/translate-skill/in.dialog:1|{{language}}|in {{language}}|
|tags/translate-skill/phrase.rx:1|(çevir|söyle) (to|in|on) (spanish|italian|english|french|dutch|german|polish|portuguese|danish|hungarian|swedish|norwegian|catalan|romanian|slovak|chinese|japanese|korean|greek|vietnamese|turkish|finnish|arabic) (?P<Phrase>.*)|(translate|say) (to|in|on) (spanish|italian|english|french|dutch|german|polish|portuguese|danish|hungarian|swedish|norwegian|catalan|romanian|slovak|chinese|japanese|korean|greek|vietnamese|turkish|finnish|arabic) (?P<Phrase>.*)|
|tags/translate-skill/translate.rx:1|(çevir|konuş) (?P<Translate>.*) (to|in) (ispanyolca|italyanca|ingilizce|fransızca|flemenkçe|almanca|lehçe|portekizce|danimarkaca|macarca|isveçce|norveçce|katalan|romence|slovakca|çince|japonca|korece|yunanca|vietnamca|türkçe|fince|arapca)|(translate|say) (?P<Translate>.*) (to|in) (spanish|italian|english|french|dutch|german|polish|portuguese|danish|hungarian|swedish|norwegian|catalan|romanian|slovak|chinese|japanese|korean|greek|vietnamese|turkish|finnish|arabic)|
|tags/translate-skill/what.did.you.think.dialog:1|Dil konuşma yeteneğim hakkında ne düşünüyorsun!|What did you think of my ability to speak languages!|
|tags/translate-skill/what.did.you.think.dialog:2|Ne düşünüyorsun, denemek istersin misin!|What do you think, you would like to try!|
|tags/translate-skill/what.did.you.think.dialog:3|kolay, eğer pratik yaparsan, bunu başaracaksın!|easy, if you practice, you will also achieve it!|
|tags/translate-skill/what.did.you.think.dialog:4|Pratik ve pratik, bu gerçekleşecek!|Practice and practice, this will be achieved!|
|tags/translate-skill/yes.ask.dialog:1|Evet, başka dilleri konuşabiliyorum, ne söylememi istiyorsun?|Yes, i can speak other languages, what do you want me to say?|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-naptime/SleepCommand.voc:1|uyu|go to sleep|
|tags/skill-naptime/SleepCommand.voc:2|şekerleme zamanı|nap time|
|tags/skill-naptime/going.to.sleep.dialog:1|Uyuyacağım. Yine dikkatimi çekmek için 'Hey Mycroft, uyan' de.|I'm going to sleep.  Say '{{wake_word}}, wake up' to get my attention again.|
|tags/skill-naptime/going.to.sleep.dialog:2|Şimdi uyuyacağım. Bana 'ayağa kalk' Hey Mycroft, uyan ' de. |Going to sleep now.  Say '{{wake_word}},  wake up' to get me up.|
|tags/skill-naptime/going.to.sleep.dialog:3|Tamam, uyuyacağım. 'Hey Mycroft, uyan' diyerek beni uyandırabilirsiniz.|Alright, going to sleep.  You can rouse me by saying '{{wake_word}},  wake up'.|
|tags/skill-naptime/going.to.sleep.short.dialog:1||Okay.|
|tags/skill-naptime/going.to.sleep.short.dialog:2||Going to sleep.|
|tags/skill-naptime/i.am.awake.dialog:1|uyanığım|I'm awake|
...
# plasma-activities-skill-tr
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:1|yeni bir etkinlik oluştur|create a new activity|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:2|yeni etkinlik oluştur|create new activity|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:3|etkinlik oluştur|create activity|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:4|yeni bir faaliyet başlatmak|start a new activity|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:5|yeni etkinlikler oluştur|create new activities|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:6|yeni faaliyetlere başla|start new activities|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:7|etkinlik oluştur|create activities|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:8|yeni aktivite|new activity|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:9|yeni aktiviteler|new activities|
|tags/plasma-activities-skill/ActivitiesRemoveKeyword.voc:1|etkinliği kaldır|remove activity|
|tags/plasma-activities-skill/ActivitiesRemoveKeyword.voc:2|etkinliği kaldır|remove the activity|
|tags/plasma-activities-skill/ActivitiesRemoveKeyword.voc:3|etkinliği sil|delete activity|
|tags/plasma-activities-skill/ActivitiesRemoveKeyword.voc:4|etkinliği sil|delete the activity|
|tags/plasma-activities-skill/ActivitiesShowKeyword.voc:1|mevcut etkinlikleri göster|show current activities|
|tags/plasma-activities-skill/ActivitiesShowKeyword.voc:2|etkinlikleri göster|show activities|
|tags/plasma-activities-skill/ActivitiesShowKeyword.voc:3|etkinlikler|activities|
|tags/plasma-activities-skill/ActivitiesShowKeyword.voc:4|mevcut etkinlikleri göster|display current activities|
|tags/plasma-activities-skill/ActivitiesShowKeyword.voc:5|etkinlikleri görüntüleme|display activities|
|tags/plasma-activities-skill/ActivitiesStopKeyword.voc:1|mevcut etkinliği iptal et|kill current activity|
|tags/plasma-activities-skill/ActivitiesStopKeyword.voc:2|etkinliği öldür|kill activity|
|tags/plasma-activities-skill/ActivitiesSwitchKeyword.voc:1|mevcut etkinliği değiştir|switch current activity|
|tags/plasma-activities-skill/ActivitiesSwitchKeyword.voc:2|faaliyete geç|switch to activity|
|tags/plasma-activities-skill/ActivitiesSwitchKeyword.voc:3|faaliyete geç|switch activity|
|tags/plasma-activities-skill/activities.create.dialog:1|Faaliyetiniz {{ActivityName}} Oluşturuldu|Your Activity {{ ActivityName }} Has Been Created|
|tags/plasma-activities-skill/activities.remove.dialog:1|Etkinlik kaldırıldı|Activity has been removed|
|tags/plasma-activities-skill/activities.show.dialog:1|Faaliyetleri Görüntüleme|Displaying Activities|
|tags/plasma-activities-skill/activities.stop.dialog:1|{StopActivityName}} etkinliği durduruldu|{{ StopActivityName }} activity has been stopped|
|tags/plasma-activities-skill/activities.switch.dialog:1|{{SwitchActivityName}} etkinliği aktif et|Switching to activity {{ SwitchActivityName }} |
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-speak/Speak.voc:1|konuş|speak|
|tags/skill-speak/Speak.voc:2|söyle|say|
|tags/skill-speak/Speak.voc:3|tekrarla|repeat|
|tags/skill-speak/Words.rx:1|söyle (?P<Words>.*)|say (?P<Words>.*)|
|tags/skill-speak/Words.rx:2|konuş (?P<Words>.*)|speak (?P<Words>.*)|
|tags/skill-speak/Words.rx:3|tekrar et (?P<Words>.*)|repeat (?P<Words>.*)|

# kathy-msk-test-skill-tr
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/kathy-msk-test-skill/test.msk.kathy.dialog:1|İşte lezzetli bir ziyafet var|Here have a delicious treat|
|tags/kathy-msk-test-skill/test.msk.kathy.dialog:2|Kim iyi bir boi|Who's a good boi|
|tags/kathy-msk-test-skill/test.msk.kathy.intent:1|Corgi'ye bir ziyafet verin|Give the corgi a treat|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/mycroft-mark-1/auto.noon.dialog:1|Gün ortası gibi görünüyor, parlaklığı ayarlayacağım.|It seems to be midday, I will adjust the brightness.|
|tags/mycroft-mark-1/auto.sunrise.dialog:1|Tamam, güneş doğuyor, parlaklığı ayarlayacağım|Okay, The sun is coming out, I will adjust the brightness|
|tags/mycroft-mark-1/auto.sunrise.dialog:2|Tamam, güneş doğdu, parlaklık seviyesini ayarla|Okay, the sun is out, setting the brightness level|
|tags/mycroft-mark-1/auto.sunset.dialog:1|Tamam, hava kararıyor, parlaklığı buna göre ayarlayacağım.|Okay, It's getting dark, I will adjust the brightness accordingly.|
|tags/mycroft-mark-1/brightness.auto.intent:1|parlaklığı otomatik olarak ayarla|set brightness to auto|
|tags/mycroft-mark-1/brightness.auto.intent:2|otomatik parlaklık|auto brightness|
...
|tags/mycroft-mark-1/brightness.entity:7|tam|full|
|tags/mycroft-mark-1/brightness.entity:8|parlak|bright|
|tags/mycroft-mark-1/brightness.entity:9|yarım|half|
|tags/mycroft-mark-1/brightness.entity:10|kısık|dim|
|tags/mycroft-mark-1/brightness.entity:11|düşük|low|
|tags/mycroft-mark-1/brightness.entity:12|otomatik|auto|
|tags/mycroft-mark-1/brightness.entity:13|otomatik|automatic|
|tags/mycroft-mark-1/brightness.error.dialog:1|Bu parlaklık değerini anlamıyorum, bana yüzde 0 ile 100 arasında bir parlaklık değeri ver.|I do not understand that brightness value, give me a brightness value from 0 to 100 percent.|
...
|tags/mycroft-mark-1/brightness.levels.value:10|otomatik|automatic,-1|
...
# 00__skill_template-tr
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/00__skill_template/Count.voc:1|say|count|
|tags/00__skill_template/Dir.voc:1|yukarı|up|
|tags/00__skill_template/Dir.voc:2|aşağı|down|
|tags/00__skill_template/Hello.voc:1|merhaba|hello|
|tags/00__skill_template/Hello.voc:2|selamlar|greetings|
|tags/00__skill_template/Hello.voc:3|merhaba|howdy|
|tags/00__skill_template/World.voc:1|dünya|world|
|tags/00__skill_template/World.voc:2|yeryüzü|earth|
|tags/00__skill_template/count.is.now.dialog:1|şimdi say{{count}}|The count is now {{count}}|
|tags/00__skill_template/count.is.now.dialog:2|Şimdi {{count}}. sıradayız.|We are now up to {{count}}|
|tags/00__skill_template/hello.world.dialog:1|Merhaba|Hello|
|tags/00__skill_template/hello.world.dialog:2|Sana da merhaba|Hi to you too|
...
|tags/skill-weather/ConfirmQuery.voc:6|-ecek/-acak|going to|
...
|tags/skill-weather/E.dialog:1|doğu|east|
|tags/skill-weather/fahrenheit.dialog:1|fahrenhayt|fahrenheit|
...
|tags/skill-weather/Forecast.voc:1|hava tahmini|forecast|
...
|tags/skill-weather/Query.voc:1|nasıl|how|
|tags/skill-weather/Humidity.voc:1|nem|humid|
|tags/skill-weather/Humidity.voc:2|nemlilik|humidity|
|tags/skill-weather/Humidity.voc:3|sisli|steamy|
|tags/skill-weather/Later.voc:1|sonraki saat|next hour|
|tags/skill-weather/Later.voc:2|gelecek saatler|next hours|
|tags/skill-weather/Later.voc:3|birkaç saat|few hours|
|tags/skill-weather/Later.voc:4|önümüzdeki birkaç saat|next few hours|
|tags/skill-weather/Later.voc:5|birkaç saat|couple of hours|
|tags/skill-weather/Later.voc:6|sonraki birkaç saat|next couple of hours|
|tags/skill-weather/Later.voc:7|sonra|later|
...
|tags/skill-weather/N.dialog:1|kuzey|north|
|tags/skill-weather/NE.dialog:1|kuzey doğu|north east|
|tags/skill-weather/NW.dialog:1|kuzey batı|north west|
|tags/skill-weather/Next.voc:1|sonraki|next|
|tags/skill-weather/Next.voc:2|tekrar|again|
|tags/skill-weather/Now.voc:1||current|
|tags/skill-weather/Now.voc:2|kar|now|
|tags/skill-weather/Precipitation.voc:1|yağmur|rain|
|tags/skill-weather/Precipitation.voc:2|kar|snow|
|tags/skill-weather/Precipitation.voc:3|yağış|precipitation|
|tags/skill-weather/Precipitation.voc:4|yağışlı|rainy|
|tags/skill-weather/Precipitation.voc:5|karlı|snowy|
|tags/skill-weather/Precipitation.voc:6|yağmurlu|raining|
|tags/skill-weather/Precipitation.voc:7|kar yağışı|snowing|
|tags/skill-weather/Precipitation.voc:8||drizzle|
|tags/skill-weather/Query.voc:2|nedir|what is|
...
|tags/skill-weather/RelativeTime.voc:4|şimşek|night|
|tags/skill-weather/RelativeTime.voc:5||tonight|
|tags/skill-weather/RelativeTime.voc:6||overnight|
|tags/skill-weather/S.dialog:1|güney|south|
|tags/skill-weather/SE.dialog:1|güney doğu|south east|
|tags/skill-weather/SW.dialog:1|güney batı|south west|
...
|tags/skill-weather/Sunrise.voc:1|gündoğumu|sunrise|
|tags/skill-weather/Sunrise.voc:2|gündoğumu|sun rise|
|tags/skill-weather/Sunrise.voc:3|şafak|dawn|
|tags/skill-weather/Sunrise.voc:4|tan|daybreak|
|tags/skill-weather/Sunrise.voc:5|tan|day break|
|tags/skill-weather/Sunset.voc:1|gün batımı|sunset|
|tags/skill-weather/Sunset.voc:2|gün batımı|sun set|
|tags/skill-weather/Sunset.voc:3|alaca karanlık|dusk|
|tags/skill-weather/Weather.voc:2|sıcaklık|temperature|
...
|tags/skill-weather/celsius.dialog:1|santigrat|celsius|
|tags/skill-weather/W.dialog:1|batı|west|
|tags/skill-weather/Weather.voc:1|hava durumu|weather|
|tags/skill-weather/WeatherType.voc:1|yağmurlu|yağışlı|rain|raining|
|tags/skill-weather/WeatherType.voc:2|karlı|kar yağışlı|snow|snowing|
|tags/skill-weather/WeatherType.voc:3|karla karışık yağmur|sleet|
|tags/skill-weather/WeatherType.voc:4|dolu yağışı|dolu yağışlı|hail|hailing|
|tags/skill-weather/WeatherType.voc:5|güneşli|güneşli|sunny|sun|
|tags/skill-weather/WeatherType.voc:6|sıcak|ılık|hot|warm|
|tags/skill-weather/WeatherType.voc:7|soğuk|serin|cold|cool|
|tags/skill-weather/Week.voc:1||week|
|tags/skill-weather/Week.voc:2||weekly|
|tags/skill-weather/Weekend.voc:1||weekend|
|tags/skill-weather/Next.voc:3|ne zaman|when|
...
|tags/skill-weather/Windy.voc:1|rüzgar|wind|
|tags/skill-weather/Windy.voc:2|rüzgarlı|windy|
|tags/skill-weather/Windy.voc:3|rüzgar|winds|
|tags/skill-weather/Windy.voc:4||wind speed|
|tags/skill-weather/Windy.voc:3|esintili|breezy|
|tags/skill-weather/Windy.voc:4|esiyor|gusting|
|tags/skill-weather/Windy.voc:5|esiyor|blowing|
...
|tags/skill-weather/at.time.local.weather.dialog:1|{{condition}}, azami {{temp_max}} sıcaklıklara yakın olacak|It will be {condition}, with temperatures near {temp} in the {time}|
|tags/skill-weather/at.time.local.weather.dialog:2|Daha sonra {{condition}} ve {{temp_max}} derece civarında olacak|{time}, it will be {condition} and around {temp} degrees|
|tags/skill-weather/at.time.local.weather.dialog:3|Daha sonra {{condition}} ve {{temp_max}} derece olacak|{time}, it will be {condition} and {temp} degrees|
...
|tags/skill-weather/condition.category.value:5|yağmurlu|yağışlı|Rain,raining|
|tags/skill-weather/condition.category.value:6|karlı|kar yağışlı|Snow,snowing|
...
|tags/skill-weather/current.weather.dialog:1|Şu anda {{condition}} ve {{temp}} derece {{scale}}. Bugünün tahmini en yüksek {{temp_max}} ve en düşük {{temp_min}} derecedir.|It's currently {condition} and {temp} degrees {scale} in {location}. Today's forecast is for a high of {temp_max} and a low of {temp_min}.|
...
|tags/skill-weather/do:|Korkarım bunu bilmiyorum|I'm afraid I don't know that|
|tags/skill-weather/do:|Bu bilgiye sahip değilim|I don't have that information|
...
|tags/skill-weather/heavy.dialog:1|şiddet|heavy|
|tags/skill-weather/hour.local.weather.dialog:1|{{condition}}, azami {{temp_max}} sıcaklıklara yakın olacak|It will be {condition}, with temperatures near {temp}|
|tags/skill-weather/hour.local.weather.dialog:2|Daha sonra {{condition}} ve {{temp_max}} derece civarında olacak|Later it will be {condition} and around {temp} degrees|
|tags/skill-weather/hour.local.weather.dialog:3|Daha sonra {{condition}} ve {{temp_max}} derece olacak|Later it will be {condition} and {temp} degrees|
...
|tags/skill-weather/light.dialog:1|şimşek|light|
...
|tags/skill-weather/location.not.found.dialog:1|Nerede olduğundan emin değilim|I not sure where that is|
|tags/skill-weather/location.not.found.dialog:2|O yeri bilmiyorum|I don't know that location|
|tags/skill-weather/location.not.found.dialog:3|O yeri bilmiyorum|I don't know that place|
...
|tags/skill-weather/meters:|metre/saniye|meters per second|
|tags/skill-weather/miles:|mil/saatte|miles per hour|
|tags/skill-weather/min.max.dialog:1||Today's forecast is for a high of {temp_max} and a low of {temp_min}.|
|tags/skill-weather/no:|Tahminlerde yağış yok|No precipitation is in the forecast|
|tags/skill-weather/no:|Hiçbiri tahmin edilmedi|None is forecasted|
...
|tags/skill-weather/no.forecast.dialog:1|Üzgünüz, {{day}} için hava tahminini bilmiyorum|Sorry, I don't know the forecast {day}|
|tags/skill-weather/no.forecast.dialog:2|{{Day}} için bir hava tahminim yok|I don't have a forecast {day}|
...
|tags/skill-weather/tonight.local.weather.dialog:1|{{condition}}, azami {{temp_max}} sıcaklıklara yakın olacak|Tonight it will be {condition}, with temperatures near {temp}|
|tags/skill-weather/tonight.local.weather.dialog:2|Daha sonra {{condition}} ve {{temp_max}} derece civarında olacak|Tonight it will be {condition} and around {temp} degrees|
|tags/skill-weather/tonight.local.weather.dialog:3|Daha sonra {{condition}} ve {{temp_max}} derece olacak|Tonight it will be {condition} and {temp} degrees|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/rss-reader/check.feeds.intent:1|yeni yayınları kontrol et|check for new feeds|
|tags/rss-reader/choice.error.dialog:1|Üzgünüm, seçiminizi bulamadım.|Sorry, I couldn't catch your choice.|
|tags/rss-reader/choice.options.value:1|#anahtar,değer|#key,value|
|tags/rss-reader/choice.options.value:2|dur,durdur|stop,stop|
|tags/rss-reader/choice.options.value:3|Bir sonraki, sonraki|next,next|
|tags/rss-reader/choice.options.value:4|yazar,yetki|author,author|
|tags/rss-reader/choice.options.value:5|e-mail, e-posta|email,email|
|tags/rss-reader/choice.options.value:6|tekrar,tekrar|repeat,repeat|
|tags/rss-reader/choice.options.value:7|özet,özeti|summary,summary|
|tags/rss-reader/choice.options.value:8|senkronizasyon, senkronize|sync,synchronize|
|tags/rss-reader/choice.prompt.dialog:1|Ben şimdi ne yapmalıyım?|What should I do now?|
|tags/rss-reader/feed.count.dialog:1|{{name}} kaynağında okumak için {{number}} {{article}} var|The feed {{name}} has {{number}} {{article}} to read.|
|tags/rss-reader/feed.email.dialog:1|E-posta bildirildiği şekilde gönderildi.|The email has been sent as instructed.|
|tags/rss-reader/feed.email.dialog:2|E-posta gönderildi.|The email has just been sent.|
|tags/rss-reader/feed.error.dialog:1|{{name}} yayınını ayrıştırırken bir sorun oluştu. Ana bilgisayar kapalı olabilir veya beceri ayarları yanlış olabilir.|There was a problem parsing the {{name}} feed. The host might be down or the skill settings inaccurate.|
|tags/rss-reader/feed.read.dialog:1|Şimdi {{name}} yayınınızı okuyorum.|I'm now reading your {{name}} feed.|
|tags/rss-reader/new.article.value:1|kişisel,yeni makale|singular,new article|
|tags/rss-reader/new.article.value:2|çoğul, yeni makaleler|plural,new articles|
|tags/rss-reader/read.feeds.intent:1|haber bültenimi oku|read my new feeds|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/lifx-mycroft/Brightness.voc:1|parlaklık|brightness|
|tags/lifx-mycroft/Brightness.voc:2|parlaklık|luminosity|
|tags/lifx-mycroft/Color.dialog:1|{{name}} ayarını {{color}} olarak ayarlayınız.|Setting {{name}} to {{color}}.|
|tags/lifx-mycroft/Decrease.voc:1|karart|darken|
|tags/lifx-mycroft/Decrease.voc:2|mat|dull|
|tags/lifx-mycroft/Decrease.voc:3|soldur|fade|
|tags/lifx-mycroft/Decrease.voc:4|dim|dim|
|tags/lifx-mycroft/Decrease.voc:5|karartmak|blacken|
|tags/lifx-mycroft/Decrease.voc:6|azaltmak|decrease|
|tags/lifx-mycroft/Decrease.voc:7|azalt|down|
...
|tags/lifx-mycroft/Increase.voc:1|aydınlatma|brighten|
|tags/lifx-mycroft/Increase.voc:2|aydınlatma|lighten|
|tags/lifx-mycroft/Increase.voc:3|aydınlatma|illuminate|
|tags/lifx-mycroft/Increase.voc:4|koyulaştır|intensify|
|tags/lifx-mycroft/Increase.voc:5|artır|increase|
|tags/lifx-mycroft/Increase.voc:6|yükselt|up|
|tags/lifx-mycroft/Off.voc:1|kapalı|off|
|tags/lifx-mycroft/Off.voc:2|devre dışı|disable|
|tags/lifx-mycroft/On.voc:1|açık|on|
|tags/lifx-mycroft/On.voc:2|etkinleştir|enable|
|tags/lifx-mycroft/Percent.rx:1|.*?(?P<Percent>\d+%)|.*?(?P<Percent>\d+%)|
|tags/lifx-mycroft/Saturation.voc:1|koyuluk|saturation|
|tags/lifx-mycroft/Saturation.voc:2|yoğunluk|intensity|
|tags/lifx-mycroft/SetPercent.dialog:1|{{param}} ayarını {{value}} olarak ayarlayın.|Setting {{param}} to {{value}}.|
|tags/lifx-mycroft/SetPercent.dialog:2|{{param}} 'ı {{value}} olarak değiştir.|Changing {{param}} to {{value}}.|
|tags/lifx-mycroft/SetPercent.dialog:3|{{name}} {{param}} ayarını {{value}} olarak ayarlayınız.|Setting {{name}} {{param}} to {{value}}.|
...
|tags/lifx-mycroft/Temperature.voc:1|sıcaklık|temp|
|tags/lifx-mycroft/Temperature.voc:2|ısı|warmth|
|tags/lifx-mycroft/Temperature.voc:3|renk sıcaklığı|colortemp|
|tags/lifx-mycroft/Temperature.voc:4|kelvin|kelvin|
|tags/lifx-mycroft/Temperature.voc:5|renk sıcaklığı|color temperature|
|tags/lifx-mycroft/Turn.voc:1||turn|
|tags/lifx-mycroft/Turn.voc:2|ayarla|set|
|tags/lifx-mycroft/Turn.voc:3|değiştir|change|
|tags/lifx-mycroft/Turn.voc:4|değiştir|toggle|
|tags/lifx-mycroft/Turn.voc:5|anahtar/değiştir|switch|
|tags/lifx-mycroft/Turn.voc:6|yap|make|

# fallback-recommendations-skill-tr
...
|tags/decide-skill/DecideKeyword.voc:1|Belirle|Decide|
|tags/decide-skill/DecideKeyword.voc:2|Ne giymeliyim|What should I wear|
|tags/decide-skill/DecideKeyword.voc:3|Ne yemeliyim|What should I eat|
|tags/decide-skill/DecideKeyword.voc:4|oyun|game|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/spotify-skill/And.dialog:1|ve|and|
|tags/spotify-skill/AvailableDevices.dialog:1|{{devices}} adlı Spotify aygıtlarını görüyorum.|I see the Spotify devices named: {{devices}}|
|tags/spotify-skill/AvailableDevices.dialog:2|{{devices}} adlı Spotify aygıtlarını buldum.|I've found the Spotify devices named: {{devices}}|
...
|tags/spotify-skill/Device.voc:1|aygıt|device|
|tags/spotify-skill/Device.voc:2|birim|unit|
|tags/spotify-skill/Device.voc:3|aygıtlar|devices|
|tags/spotify-skill/Device.voc:4|birimler|units|
...
|tags/spotify-skill/FailedToStart.dialog:1|Spotify oynatıcısını başlatamadım. Lütfen ağ bağlantınızı ve kullanıcı adınızın ve şifrenizin doğru olduğunu kontrol edin.|I wasn't able to launch the Spotify player.  Please check your network connectivity and that your username and password are correct.|
|tags/spotify-skill/For.dialog:1|için|for|
|tags/spotify-skill/For.voc:2|albüm için|for album|
|tags/spotify-skill/For.voc:3|albüm için|for the album|
|tags/spotify-skill/For.voc:4|sanatçı için|for artist|
|tags/spotify-skill/For.voc:5|sanatçı için|for the artist|
|tags/spotify-skill/ForArtist.dialog:1|sanatçı için| for the artist |
|tags/spotify-skill/ListeningToAlbumBy.dialog:1|{{artist}} e ait {{album}} dinleniyor.|Listening to {{album}} by {{artist}}.|
|tags/spotify-skill/ListeningToAlbumBy.dialog:2|Şimdi {{artist}} in {{album}} ü çalıyor.|Now playing {{album}} by {{artist}}.|
|tags/spotify-skill/ListeningToArtist.dialog:1|Şimdi {{artist}} dinliyorum|Now listening to {{artist}}|
|tags/spotify-skill/ListeningToArtist.dialog:2|{{artist}} dinleniyor|Listening to {{artist}}|
|tags/spotify-skill/ListeningToArtist.dialog:3|Şarkıları {{artist}} göre çalma|Playing songs by {{artist}}|
|tags/spotify-skill/ListeningToGenre.dialog:1|Tamam, bazı {{genre}} seslerini duyalım. {{artist}} nın {{track}} ile başla|Okay, let's hear some {{genre}}. Starting with {{track}} by {{artist}}|
|tags/spotify-skill/ListeningToGenre.dialog:2|Biraz {{genre}} duyalım. {{artist}} nın {{track}} parçası ile başla.|Let's hear some {{genre}}. Starting with {{track}} by {{artist}}|
|tags/spotify-skill/ListeningToGenre.dialog:3|Biraz {{genre}} duyalım. {{artist}} nın {{track}} parçası ile başla.|Let's hear some {{genre}} music. This is {{track}} by {{artist}}|
|tags/spotify-skill/ListeningToGenre.dialog:4||Playing {{genre}} music. Starting off with {{track}} by {{artist}}|
|tags/spotify-skill/ListeningToPlaylist.dialog:1|{{playlist}} çalma listesini dinle|Listening to the playlist {{playlist}}|
|tags/spotify-skill/ListeningToPlaylist.dialog:2|Şimdi {{playlist}} çalıyor|Now playing the playlist {{playlist}}|
|tags/spotify-skill/ListeningToPlaylist.dialog:3|Tamam, hadi {{playlist}} dinleyelim|Okay, let's hear your playlist {{playlist}}|
|tags/spotify-skill/ListeningToPlaylist.dialog:4|Anladım. Sıradaki, çalma listeniz {{playlist}}|Got it. Next up, your playlist {{playlist}}|
...
|tags/spotify-skill/NoArtistResults.dialog:1|Hmm, o sanatçıyı bulamıyorum.|Hmm, I can't find that artist.|
|tags/spotify-skill/NoArtistResults.dialog:2|Üzgünüm, o sanatçıyı bulamıyorum.|Sorry, I can't find that artist.|
|tags/spotify-skill/NoArtistResults.dialog:3|O sanatçıyı bulamıyorum.|I can't seem to find that artist.|
|tags/spotify-skill/NoArtistResults.dialog:4|O sanatçı için sonuç alamadım.|I didn't get any results for that artist.|
|tags/spotify-skill/NoArtistResults.dialog:5|Üzgünüm, o sanatçı için sonuç alamadım.|Sorry, I didn't get any results for that artist.|
|tags/spotify-skill/NoArtistResults.dialog:6|tüh, aradığın sanatçıyı bulamadım.|Uh-oh, I didn't find the artist you were looking for.|
|tags/spotify-skill/NoDefaultDeviceAvailable.dialog:1|Herhangi bir varsayılan Spot-ify cihazı bulamadım. Spot-ify'nin çalıştığından veya yeteneğin varsayılan kütüphaneleri kullanacak şekilde yapılandırıldığından emin olun.|I couldn't find any default Spot-ify device.  Make sure Spot-ify is running, or that the skill has been configured to use the default libraries|
|tags/spotify-skill/NoDefaultDeviceAvailable.dialog:2|Varsayılan Spot-ify cihazı mevcut değil. Spot-ify'nin çalıştığından veya yeteneğin varsayılan kitaplıkları kullanacak şekilde yapılandırıldığından emin olun.|There's no default Spot-ify device available. Make sure Spot-ify is running, or that the skill has been configured to use the default libraries|
|tags/spotify-skill/NoDevicesAvailable.dialog:1|Spotify cihazı bulamadım.|I couldn't find any Spotify devices.|
|tags/spotify-skill/NoDevicesAvailable.dialog:2|Spotify cihazı yok.|There are no Spotify devices available.|
|tags/spotify-skill/NoResults.dialog:1|Hmm, onu bulamıyorum.|Hmm, I can't find that.|
|tags/spotify-skill/NoResults.dialog:2|Üzgünüm, bulamıyorum.|Sorry, I can't find that.|
|tags/spotify-skill/NoResults.dialog:3|Bunu bulamıyorum.|I can't seem to find that.|
|tags/spotify-skill/NoResults.dialog:4|Bunun için sonuç alamadım.|I didn't get any results for that.|
|tags/spotify-skill/NoResults.dialog:5|Üzgünüm, bunun için sonuç alamadım.|Sorry, I didn't get any results for that.|
|tags/spotify-skill/NoResults.dialog:6|tüh, aradığınızı bulamadım.|Uh-oh, I didn't find what you were looking for.|
...
|tags/spotify-skill/NotConfigured.dialog:1|Bir Spotify hesabına bağlı değilim, bu beceriyi yetkilendirmek için mycroft.ai sayfasına gidin.|I'm not connected to your Spotify account yet.  Go to home dot mycroft dot ai to setup your Spotify skill.|
...
|tags/spotify-skill/Search.voc:1|ara|search|
|tags/spotify-skill/Search.voc:2|ara|look for|
...
|tags/spotify-skill/Spotify.voc:2|spotify kullan|using spotify|
|tags/spotify-skill/Spotify.voc:3|spotify ile|with spotify|
|tags/spotify-skill/Spotify.voc:4|Spotify'da|on Spotify|
|tags/spotify-skill/StopMusic.intent:1||(stop|end|turn off) (the|) (music|spotify|)|
|tags/spotify-skill/ToDevice.rx:1|(?P<ToDevice>.+) adlı aygıta|to (?P<ToDevice>.+)|
|tags/spotify-skill/Transfer.voc:1|aktar|transfer|
|tags/spotify-skill/Transfer.voc:2|taşı|move|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/homeassistant/AutomationActionKeyword.voc:1|etkinleştir|activate|
|tags/homeassistant/AutomationActionKeyword.voc:2|yangın|fire|
|tags/homeassistant/AutomationActionKeyword.voc:3|çağrı|call up|
|tags/homeassistant/AutomationActionKeyword.voc:4|tetikleyici|trigger|
|tags/homeassistant/AutomationActionKeyword.voc:5|sahne|scene|
|tags/homeassistant/AutomationActionKeyword.voc:6|otomasyon|automation|
|tags/homeassistant/AutomationActionKeyword.voc:7|senaryo|script|
|tags/homeassistant/ClimateKeyword.voc:1|{entity} sıcaklığını {temperature} olarak ayarlayın|set the {entity} temperature to {temperature}|
|tags/homeassistant/DecreaseVerb.voc:1|azalt|decrease|
|tags/homeassistant/DecreaseVerb.voc:2|azalt|down|
|tags/homeassistant/DeviceTrackerKeyword.voc:1|nerede|where is|
|tags/homeassistant/DeviceTrackerKeyword.voc:2|yer|konum|locate|location|
|tags/homeassistant/DeviceTrackerKeyword.voc:3|nerede|where|
|tags/homeassistant/IncreaseVerb.voc:1|artır|increase|
|tags/homeassistant/IncreaseVerb.voc:2|yükselt|up|
...
|tags/homeassistant/LightsKeyword.voc:1|ışık|light|
|tags/homeassistant/LightsKeyword.voc:2|ışıklar|lights|
|tags/homeassistant/LightsKeyword.voc:3|lamba|lamp|
|tags/homeassistant/LightsKeyword.voc:4|lambalar|lamps|
|tags/homeassistant/LightsKeyword.voc:5|ampul|bulb|
|tags/homeassistant/LightsKeyword.voc:6|ampuller|bulbs|
|tags/homeassistant/LightsKeyword.voc:7|led|l.e.d.|
|tags/homeassistant/LightsKeyword.voc:8|aç|turn on|
|tags/homeassistant/LightsKeyword.voc:9|kapat|turn off|
|tags/homeassistant/LightsKeyword.voc:10|değiştir|toggle|
|tags/homeassistant/SensorStatusKeyword.voc:1|durum|state|
|tags/homeassistant/SensorStatusKeyword.voc:2|durum|status|
|tags/homeassistant/SensorStatusKeyword.voc:3|sensör|sensor|
|tags/homeassistant/SensorStatusKeyword.voc:4|detektör|detector|
|tags/homeassistant/SensorStatusKeyword.voc:5|değer|value|
...
|tags/homeassistant/SensorStatusKeyword.voc:12|termostatın değeri nedir|what is the value of thermostat|
|tags/homeassistant/SetVerb.voc:1||set|
|tags/homeassistant/SwitchActionKeyword.voc:1||turn|
|tags/homeassistant/SwitchActionKeyword.voc:2|anahtar|switch|
...
|tags/homeassistant/set.climate.intent:2|{entity} sıcaklığını {temp} olarak ayarlayın|set the {entity} temperature to {temp} degrees|
|tags/homeassistant/set.climate.intent:3|{entity} sıcaklığını {temperature} olarak değiştir|change the {entity} temperature to {temp} degrees|
...
|tags/skill-personal/WhatAreYou.intent:1|Sen nesin|what are you|
|tags/skill-personal/WhenWereYouBorn.intent:1|sen ne zaman doğdun|when were you born|
|tags/skill-personal/WhenWereYouBorn.intent:2|ne zaman yaratıldın|when were you created|
|tags/skill-personal/WhereWereYouBorn.intent:1|Nerede doğdun|where were you born|
|tags/skill-personal/WhereWereYouBorn.intent:2|nerede yaratıldın|where were you created|
|tags/skill-personal/WhoAreYou.intent:1|kimsin|who are you|
|tags/skill-personal/WhoMadeYou.intent:1|seni kim yaptı|who made you|
|tags/skill-personal/WhoMadeYou.intent:2|kim tarafından yapıldı|who were you made by|
|tags/skill-personal/WhoMadeYou.intent:3|seni kim yarattı|who created you|
|tags/skill-personal/WhoMadeYou.intent:4|seni kim inşa etti|who built you|
...
|tags/skill-personal/what.am.i.dialog:1|Ben açık kaynaklı bir yapay zekayım.|I am an open source artificial intelligence.|
|tags/skill-personal/what.am.i.dialog:2|Makinelerle iletişim kurmak için akıllı bir yazılım parçasıyım|I'm an intelligent piece of software for communicating with machines|
|tags/skill-personal/when.was.i.born.dialog:1|2015 yılında doğdum.|I was born in 2015.|
|tags/skill-personal/when.was.i.born.dialog:2|2015 benim doğduğum zamandı.|2015 is when I was born.|
|tags/skill-personal/where.was.i.born.dialog:1|Lawrence Girişimcilik Merkezi.|The Lawrence Center for Entrepreneurship.|
|tags/skill-personal/where.was.i.born.dialog:2|Lawrence, Kansas'ta doğdum.|I was born in Lawrence, Kansas.|
|tags/skill-personal/who.am.i.dialog:1|Benim adım {{name}} ve akıllı bir kişisel asistanım|My name is {{name}} and I'm an intelligent personal assistant|
|tags/skill-personal/who.am.i.dialog:2|Ben {{name}}, açık kaynaklı bir A.I. yim|I'm {{name}}, an open-source A.I.|
|tags/skill-personal/who.made.me.dialog:1|Mycroft A.I. Harika bir topluluk ve ekip.|The wonderful Mycroft A.I. community and team.|
|tags/skill-personal/who.made.me.dialog:2|Mycroft A.I.’deki herkes topluluk ve ekip.|Everyone in the Mycroft A.I. community and team.|
...
|tags/email-skill/check.email.intent:1|e-postamı kontrol et.|check my email|
|tags/email-skill/check.email.intent:2|postalarımı kontrol et.|check my mail|
|tags/email-skill/check.email.intent:3|yeni posta var mı?|do i have any new mail|
|tags/email-skill/check.email.intent:4|e-postam var mı?|do I have any email|
|tags/email-skill/check.email.intent:5|yeni e-postam var mı?|do i have any new emails|
...
|tags/email-skill/error.getting.mail.dialog:1|E-postanız alınırken bir hata oluştu. Kimlik bilgilerinizi ve sunucu bilgilerinizi kontrol etmeyi deneyin.|There was an error getting your email Try checking your credentials and server information|
|tags/email-skill/error.getting.mail.dialog:2|Postalarınızı alırken bir sorun oluştuğu için kimlik bilgilerinizi ve sunucu bilgilerinizi kontrol edin.|Check your credentials and server information because there was a problem getting your mail|
|tags/email-skill/error.getting.mail.dialog:3|E-posta sunucunuza bağlanamıyorum. Parolanızı ve sunucu bilgilerinizi kontrol edin.|I can not connect to your email server Check your password and server information|
|tags/email-skill/list.subjects.dialog:1|{message_num} numarası {sender} aitdir. Konusu {subject} 'dir.|Your {message_num} email is from {sender} Its subject is {subject}|
|tags/email-skill/list.subjects.dialog:2|{message_num} sayılı mesajın konusu {subject}'dir. Göndericisi {sender}'dir.|The {message_num} email's subject is {subject} Its from {sender}|
|tags/email-skill/more.emails.dialog:1|daha fazlasını duymak ister misin?|would you like to hear more|
|tags/email-skill/more.emails.dialog:2|e-postalarından daha fazlasını duymak ister misin?|want to hear more of your emails|
|tags/email-skill/more.emails.dialog:3|daha fazla duymak ister misin?|do you want to hear more|
...
|tags/email-skill/no.more.emails.dialog:1|tamam.|okay|
|tags/email-skill/no.new.email.dialog:1|Yeni bir e-posta yok.|There is no new email|
|tags/email-skill/no.new.email.dialog:2|Yeni bir e-posta yok.|There's no new email|
|tags/email-skill/no.new.email.dialog:3|Yeni posta yok.|There's no new mail|
|tags/email-skill/no.new.email.dialog:4|Yeni posta yok.|There is no new mail|
|tags/email-skill/no.new.email.dialog:5|Senin için yeni bir e-posta yok.|There's no new email for you|
|tags/email-skill/no.new.email.dialog:6|Senin için yeni posta yok.|There's no new mail for you|
|tags/email-skill/no.new.email.dialog:7|Yeni postanız yok.|You have no new mail|
|tags/email-skill/no.new.email.dialog:8|Yeni bir e-postan yok.|You have no new email|
...
|tags/email-skill/setup.dialog:1|E-posta becerisi için e-posta bilgileri gerekli, bu ayarları girmek için lütfen ana sayfaya gidin http://www.mycroft.ai|To set the email skill up, please go to home dot mycroft dot a i to enter your email information|
|tags/email-skill/setup.dialog:2|E-posta becerisini ayarlaman gerekiyor. E-posta bilgilerinizi girmek için lütfen ana sayfaya gidin http://www.mycroft.ai|You need to set the email skill up To do so, please go to home dot mycroft dot a i to enter your email information|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/fallback-unknown/question.dialog:1|Üzgünüm bunun için yardım edemiyorum.|I'm sorry I can't help you with that.|
|tags/fallback-unknown/question.dialog:2|Sana nasıl yardım edeceğimi bilmiyorum.|I'm not sure how to help you with that.|
|tags/fallback-unknown/question.dialog:3|Anlayamadım ama her gün yeni şeyler öğreniyorum.|I don't understand, but I'm learning new things everyday.|
|tags/fallback-unknown/question.dialog:4|Buna nasıl cevap veririm emin değilim.|I'm not sure how to answer that.|
|tags/fallback-unknown/question.voc:1|nedir|what is|
|tags/fallback-unknown/question.voc:2|ne olacak|what will|
|tags/fallback-unknown/question.voc:3|ne yaptı|what did|
|tags/fallback-unknown/question.voc:4|ne yapar|what does|
|tags/fallback-unknown/question.voc:5|ne yapar|what do|
|tags/fallback-unknown/question.voc:7|nerede|where is|
|tags/fallback-unknown/question.voc:8|nerede olacak|where will|
|tags/fallback-unknown/question.voc:9|nerede oldu|where did|
|tags/fallback-unknown/question.voc:10|nerede|where does|
|tags/fallback-unknown/question.voc:11|nerede|where do|
|tags/fallback-unknown/question.voc:13|ne zaman|when is|
|tags/fallback-unknown/question.voc:14|ne zaman olacak|when will|
|tags/fallback-unknown/question.voc:15|ne zaman oldu|when did|
|tags/fallback-unknown/question.voc:16|ne zaman|when does|
|tags/fallback-unknown/question.voc:17|ne zaman|when do|
|tags/fallback-unknown/unknown.dialog:1|Üzgünüm, anlayamadım.|I'm sorry, I don't understand.|
|tags/fallback-unknown/unknown.dialog:2|Bunun ne demek olduğunu bilmiyorum.|I don't know what that means.|
|tags/fallback-unknown/unknown.dialog:4||Sorry, I didn't catch that.|
|tags/fallback-unknown/unknown.dialog:5|Üzgünüm, anlayamadım.|Sorry, I don't understand.|
...
|tags/fallback-unknown/who.is.dialog:1|Bunun ne demek olduğunu bilmiyorum.|I don't know who that is.|
|tags/fallback-unknown/who.is.dialog:2||I'm not sure who that is.|
|tags/fallback-unknown/who.is.voc:1||who is|
|tags/fallback-unknown/who.is.voc:2|ne olacak|who will|
|tags/fallback-unknown/who.is.voc:3|ne yaptı|who did|
|tags/fallback-unknown/who.is.voc:4|ne yapar|who does|
|tags/fallback-unknown/who.is.voc:5|ne yapar|who do|
...
|tags/fallback-unknown/why.is.voc:2|ne olacak|why will|
|tags/fallback-unknown/why.is.voc:3|ne yaptı|why did|
|tags/fallback-unknown/why.is.voc:4|ne yapar|why does|
|tags/fallback-unknown/why.is.voc:5|ne yapar|why do|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-aircrack/Clients.voc:1|istemci|client|
|tags/skill-aircrack/Clients.voc:2|istemciler|clients|
|tags/skill-aircrack/Clients.voc:3|bağlantı|connection|
|tags/skill-aircrack/Clients.voc:4|bağlantılar|connections|
...
|tags/skill-aircrack/Deauth.voc:3|bağlantıyı kes|disconnect|
|tags/skill-aircrack/Deauth.voc:4|deauth|dee auth|
|tags/skill-aircrack/Deauth.voc:5|deauthenticate|dee authenticate|
|tags/skill-aircrack/Interface.voc:1|aygıtlar|devices|
|tags/skill-aircrack/Interface.voc:2|ara yüzler|interfaces|
|tags/skill-aircrack/Interface.voc:3|aygıt|device|
|tags/skill-aircrack/Interface.voc:4|ara yüz|interface|
|tags/skill-aircrack/List.voc:1|liste|list|
|tags/skill-aircrack/List.voc:2|tara|scan|
|tags/skill-aircrack/Monitor.voc:1|ekran|monitor|
|tags/skill-aircrack/Monitor.voc:2|izleme|monitoring|
|tags/skill-aircrack/Monitor.voc:3|döküm|dump|
|tags/skill-aircrack/Monitor.voc:4|dökümleme|dumping|
|tags/skill-aircrack/Network.voc:1|kablosuz ağlar|wireless networks|
|tags/skill-aircrack/Network.voc:2|ağlar|networks|
|tags/skill-aircrack/Network.voc:3|kablosuz ağ|wireless network|
|tags/skill-aircrack/Network.voc:4|ağ|network|
|tags/skill-aircrack/Network.voc:5|wifi ağı|wifi network|
|tags/skill-aircrack/Network.voc:6|wifi ağları|wifi networks|
|tags/skill-aircrack/Password.voc:1|şifre|password|
|tags/skill-aircrack/Password.voc:2|şifre|pass word|
|tags/skill-aircrack/Select.voc:1|seç|select|
|tags/skill-aircrack/Select.voc:2|kullan|use|
|tags/skill-aircrack/Start.voc:1|başlat|start|
|tags/skill-aircrack/Start.voc:2|başla|begin|
|tags/skill-aircrack/Stop.voc:1|dur|stop|
|tags/skill-aircrack/Stop.voc:2|son|end|
|tags/skill-aircrack/cannot.sudo.dialog:1|Hata, aircrack komutlarını parola olmadan sudo yapamıyorum. Lütfen sudo erişimi hakkındaki notlar için github.com/JonStratton/skill-aircrack adresini ziyaret edin.|Error, I cannot seem to sudo the aircrack commands without a password. Please see github.com/JonStratton/skill-aircrack for notes on sudo access.|
|tags/skill-aircrack/captured.handshake.dialog:1||Captured Handshake|
|tags/skill-aircrack/confirm.permission.dialog:1|Kullanmaya yetkili olmadığınız bir wifi ağına erişim yasadışı olabilir. Lütfen Evet diyerek bu ağa bağlanma izniniz olduğunu onaylayın, aksi halde iptal etmek için Hayır deyin.|Accessing a wifi network you are not authorized to use can be illegal. Please confirm that you have permission to connect to this network by saying Yes, otherwise say No to cancel.|
|tags/skill-aircrack/deauthing.clients.dialog:1||Deauthing clients connected to the {{selected_network}} network.|
|tags/skill-aircrack/interfaces.are.dialog:1|Aşağıdaki Arayüzler mevcuttur: {{available_interfaces}}|The following Interfaces are available: {{available_interfaces}}|
|tags/skill-aircrack/interfaces.are.dialog:2|Kullanılabilir Arayüzler: {{available_interfaces}}|Here are the available Interfaces: {{available_interfaces}}|
|tags/skill-aircrack/interfaces.are.dialog:3|{{available_interfaces}} kullanılabilir.|{{available_interfaces}} are available.|
...
|tags/skill-aircrack/networks.are.dialog:1|Aşağıdaki ağlar kullanılabilir: {{available_networks}}|The following networks are available: {{available_networks}}|
|tags/skill-aircrack/no.interfaces.dialog:1|Kullanılabilir arayüz yok.|There are no available interfaces.|
|tags/skill-aircrack/no.networks.dialog:1|Kullanılabilir ağ yok.|There are no available networks.|
|tags/skill-aircrack/no.password.dialog:1|Şifre bulunamadı.|No password found.|
|tags/skill-aircrack/no.such.interface.dialog:1|Böyle bir Arabirim bulunamadı.|No such Interface found.|
|tags/skill-aircrack/no.such.network.dialog:1|Böyle bir ağ bulunamadı.|No such network found.|
|tags/skill-aircrack/number.rx:1||(number) (?P<Number>.*)|
|tags/skill-aircrack/recovered.password.dialog:1|Şu şifre kurtarıldı: {{password}}|Recovered the following password: {{password}}|
|tags/skill-aircrack/select.interface.first.dialog:1|Lütfen önce Arabirimi seçin.|Please select Interface first.|
|tags/skill-aircrack/selected.interface.dialog:1|{{selected_interface}} arayüzü seçildi.|Selected the {{selected_interface}} interface.|
|tags/skill-aircrack/selected.network.dialog:1|{{selected_network}} ağı seçildi.|Selected the {{selected_network}} network.|
|tags/skill-aircrack/start.monitor.dialog:1||Starting Monitor|
|tags/skill-aircrack/stop.monitor.dialog:1||Stopping Monitor|
|tags/skill-aircrack/yes.list:1|evet|yes|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-date-time/Date.voc:1|tarih|date|
|tags/skill-date-time/Date.voc:2|gün|day|
|tags/skill-date-time/Display.voc:1|görüntüle|display|
|tags/skill-date-time/Display.voc:2|göster|show|
...
|tags/skill-date-time/Query.voc:1|ne|what|
|tags/skill-date-time/Query.voc:2|söyle|tell|
...
|tags/skill-date-time/Date.voc:3|bugün|today|
|tags/skill-date-time/RelativeDay.voc:2|bugün|todays|
|tags/skill-date-time/RelativeDay.voc:3|bugün|today's|
...
|tags/skill-date-time/Time.voc:1|zaman|time|
|tags/skill-date-time/Time.voc:2||clock|
|tags/skill-date-time/date.dialog:1|{{date}}|{{date}}|
|tags/skill-date-time/date.dialog:2|{{date}}'dır|It is {{date}}|
|tags/skill-date-time/date.dialog:3|{{date}}'dir|It's {{date}}|
...
|tags/skill-date-time/did.you.mean.timezone.dialog:1|{zone_name} saat dilimini mi kastediyorsun?|Did you mean the {zone_name} time zone?|
|tags/skill-date-time/location.rx:1|Konum (?P<Location>.*)|\b(at|in|for) (?P<Location>.*)|
...
|tags/skill-date-time/time.current.dialog:2|saat {{time}}|It is {{time}}|
|tags/skill-date-time/time.current.dialog:4|saat {{time}}|It's {{time}}|
|tags/skill-date-time/time.current.dialog:5|Şu anda {{time}}|Currently {{time}}|
|tags/skill-date-time/time.future.dialog:1|{{time}}|{time}|
|tags/skill-date-time/time.future.dialog:2||It will be {time}|
|tags/skill-date-time/time.tz.not.found.dialog:1|{{location}} için saat dilimini bulamadım|I could not find the time zone for {{location}}|
...
# skill-audio-record-tr
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-audio-record/Delete.voc:1|sil|delete|
|tags/skill-audio-record/Delete.voc:2|sil|erase|
|tags/skill-audio-record/Delete.voc:3|kaldır|remove|
|tags/skill-audio-record/Delete.voc:4|temizle|clear|
|tags/skill-audio-record/Play.voc:1|oynat|play|
|tags/skill-audio-record/Play.voc:2|yeniden oynat|replay|
|tags/skill-audio-record/Play.voc:3|playback|playback|
|tags/skill-audio-record/Play.voc:4|geri oynat|play back|
|tags/skill-audio-record/Play.voc:5|oynuyor|playing|
|tags/skill-audio-record/Play.voc:6|yeniden oynuyor|replaying|
...
|tags/skill-audio-record/Recording.voc:1|kayıt|record|
|tags/skill-audio-record/Recording.voc:2|kayıtlı|recorded|
|tags/skill-audio-record/Recording.voc:3|kaydediyor|recording|
|tags/skill-audio-record/Recording.voc:4|ses|audio|
|tags/skill-audio-record/StartRecording.intent:1|kayda başla|start recording|
...
|tags/skill-audio-record/audio.record.disk.full.dialog:1|Daha fazla ses kaydetmek için yeterli boş disk alanı yok.|There is not enough free disk space to record any more audio.|
|tags/skill-audio-record/audio.record.no.recording.dialog:1|Kaydedilmiş bir kayıt yok. Bir tane oluşturmak için 'kaydı başlat' işlevini kullanın.|There is no saved recording.  Say 'start recording' to create one.|
|tags/skill-audio-record/audio.record.removed.dialog:1|Kayıt silindi|Recording deleted|
|tags/skill-audio-record/audio.record.removed.dialog:2|Kayıt atıldı|Recording discarded|
|tags/skill-audio-record/audio.record.start.duration.dialog:1|{{duration}} süreli ses kaydı|Recording audio for {{duration}}|
|tags/skill-audio-record/audio.record.start.duration.dialog:2|{{duration}} için kayda başla|Starting recording for {{duration}}|
|tags/skill-audio-record/audio.record.start.duration.dialog:3|{{duration}} kayıt yapılıyor|Recording for {{duration}}|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-joke/Adult.voc:1|yetişkin|adult|
|tags/skill-joke/Adult.voc:2|seksi|sexy|
|tags/skill-joke/Adult.voc:3|sex|sex|
|tags/skill-joke/Adult.voc:4|edepsiz|dirty|
|tags/skill-joke/Adult.voc:5|dobra|raunchy|
|tags/skill-joke/Adult.voc:6|yaramaz|naughty|
|tags/skill-joke/Chuck.voc:1||chuck|
|tags/skill-joke/Chuck.voc:2||chuck norris|
|tags/skill-joke/Joke.voc:1|şaka|joke|
|tags/skill-joke/Joke.voc:2|beni güldür|make me laugh|
|tags/skill-joke/Joke.voc:3|günümü aydınlat|brighten my day|
|tags/skill-joke/Joke.voc:4|bana şaka yap|tell me joke|
|tags/skill-joke/Neutral.voc:1|tarafsız|neutral|
|tags/skill-joke/Neutral.voc:2|Saldırgan olmayan|non-offensive|
|tags/skill-joke/Neutral.voc:3|geeksever|geeky|
...
# skill-hello-world-tr
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-hello-world/HelloWorldKeyword.voc:1|selam dünya|hello world|
|tags/skill-hello-world/HelloWorldKeyword.voc:2|selamlar|greetings|
|tags/skill-hello-world/HowAreYouKeyword.voc:1|nasılsın|how are you|
|tags/skill-hello-world/HowAreYouKeyword.voc:2|nasıl oldun|how have you been|
|tags/skill-hello-world/HowAreYouKeyword.voc:3|Senin günün nasıldı|how has your day been|
|tags/skill-hello-world/ThankYouKeyword.voc:1|teşkkür ederim|thank you|
|tags/skill-hello-world/ThankYouKeyword.voc:2|teşekkürler|thanks|
|tags/skill-hello-world/hello.world.dialog:1|Merhaba dünya|Hello world|
|tags/skill-hello-world/hello.world.dialog:2|Merhaba|Hello|
|tags/skill-hello-world/hello.world.dialog:3|sana da selam|Hi to you too|
|tags/skill-hello-world/how.are.you.dialog:1|iyiyim|I'm doing well|
|tags/skill-hello-world/how.are.you.dialog:2|Çok iyi|Pretty well|
|tags/skill-hello-world/how.are.you.dialog:3|Fena değil|Not bad|
|tags/skill-hello-world/how.are.you.dialog:4|Ben mükemmelim|I'm doing excellent|
|tags/skill-hello-world/how.are.you.dialog:5|Daha iyi olabilir|Could be better|
|tags/skill-hello-world/how.are.you.dialog:6|Ben çok iyiyim|I'm doing very well|
|tags/skill-hello-world/welcome.dialog:1|İstediğin zaman.|Any time.|
|tags/skill-hello-world/welcome.dialog:2|Hizmet verdiğim için mutluyum.|Glad to be of service.|
|tags/skill-hello-world/welcome.dialog:3|Yardım etmekten memnun oldum.|Glad to help.|
|tags/skill-hello-world/welcome.dialog:4|Zevkle.|My Pleasure.|
|tags/skill-hello-world/welcome.dialog:5|Sorun değil.|No problem.|
|tags/skill-hello-world/welcome.dialog:6|Rica ederim.|You're welcome.|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/speedtest/Run.voc:1|çalıştır|run|
|tags/speedtest/Speedtest.voc:1|hız testi|speedtest|
|tags/speedtest/Speedtest.voc:2|hız testi|speed test|
|tags/speedtest/error.dialog:1|Bir hata oluştu, hız testini çalıştıramadım... üzgünüm.|There was an error, i could not run a speedtest... sorry.|
|tags/speedtest/result.dialog:1|İndirme hızın saniyede {{DOWN}} Megabit ve yükleme hızın saniyede {{UP}} Megabit.|Your download speed is {{DOWN}} Megabit per second and your upload speed is {{UP}} Megabit per second.|
|tags/speedtest/running.dialog:1|Hız testi şimdi başlıyor, sonuçlar gelince bildireceğim.|Starting speedtest now, i will be back with the results in a moment.|
...
|tags/auto-volume/activate.dialog:2|Otomatik ses seviyesi aktifleştirildi.|Auto volume activated|
|tags/auto-volume/activate.dialog:3|Otomatik ses seviyesini aktifleştirdim.|I have activated auto volume|
|tags/auto-volume/activate.intent:1|Otomatik ses seviyesini etkinleştir|Activate auto volume|
|tags/auto-volume/activate.intent:2|otomatik ses seviyesi aktif|Set auto volume to active|
|tags/auto-volume/activate.intent:3|otomatik ses seviyesini aç|Turn on auto volume|
|tags/auto-volume/activate.intent:4|otomatik ses seviyesini aç|Set auto volume (to) on|
|tags/auto-volume/deactivate.dialog:2|Otomatik ses seviyesi kapalı|Auto volume is deactivated|
|tags/auto-volume/deactivate.dialog:3|Otomatik ses seviyesini kapadım|I have now deactivated auto volume|
|tags/auto-volume/deactivate.intent:1|Otomatik ses seviyesi yenilendi|Deactivate auto volume|
|tags/auto-volume/deactivate.intent:2|otomatik ses seviyesini kapat|Set auto volume to inactive|
|tags/auto-volume/deactivate.intent:3|otomatik ses seviyesini kapat|Turn off auto volume|
|tags/auto-volume/deactivate.intent:4|otomatik ses seviyesini kapat|Set auto volume (to) off|
|tags/auto-volume/reset.dialog:1|otomatik sesi sıfırladım|I have now reset auto volume|
|tags/auto-volume/reset.intent:1|otomatik sesi temizle|Clear auto volume measurements|
|tags/auto-volume/reset.intent:2|otomatik ses ayarlarını sil|Delete auto volume measurements|
|tags/auto-volume/reset.intent:3|otomatik sesi sıfırla|Reset auto volume measurements|
