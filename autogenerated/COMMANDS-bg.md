...
# plasma-mycroft-applet-control-bg
...
# fallback-recommendations-skill-bg
...
# bedtime-stories-skill-bg
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/bedtime-stories-skill/list.stories.dialog:1|Ето (приказките | разказите) за лека нощ които имам на разположение. {{stories}}|Here are the bedtime stories I have available. {{stories}}|
|tags/bedtime-stories-skill/list.stories.dialog:2|Ето (приказките | разказите) за лека нощ в моята библиотека. {{stories}}|Here are the bedtime stories in my library. {{stories}}|
|tags/bedtime-stories-skill/list.stories.intent:1|Списък на (приказките | разказите) за лека нощ|List bedtime stories|
|tags/bedtime-stories-skill/list.stories.intent:2|Какви истории имаш|What stories do you have|
|tags/bedtime-stories-skill/list.stories.intent:3|Какви (приказките | истории) за лека нощ имаш|What bed time stories do you have|
|tags/bedtime-stories-skill/pick.story.dialog:1|Добре, нека видя дали я имам тази история.|Okay, let me see if I have that story.|
|tags/bedtime-stories-skill/pick.story.intent:1|разкажи ми {title}|tell me {title}|
|tags/bedtime-stories-skill/pick.story.intent:2|прочети ми {title}|read me {title}|
|tags/bedtime-stories-skill/pick.story.intent:3|прочети ми {title}|readme {title}|
|tags/bedtime-stories-skill/pick.story.intent:4|Кажи ми {title}|Tell me {title}|
|tags/bedtime-stories-skill/stories.bedtime.dialog:1|Добре. Това е отличен избор от моята библиотека.|Okay, sure. Here is a great selection from my library.|
|tags/bedtime-stories-skill/stories.bedtime.dialog:2|Няма проблем, настанете се удобно докато избера история.|No problem, get comfy while I pick a story.|
|tags/bedtime-stories-skill/stories.bedtime.intent:1|Разкажи ми история|Tell me a story|
|tags/bedtime-stories-skill/stories.bedtime.intent:2|Разкажи ми (приказка | разказ ) за лека нощ|Tell me a bed time story|
|tags/bedtime-stories-skill/stories.bedtime.intent:3|Разкажи ми приказка|Tell me a fairy tale|
|tags/bedtime-stories-skill/stories.bedtime.intent:4|Разкажи ни история|Tell us a story|
|tags/bedtime-stories-skill/stories.bedtime.intent:5|Разкажи ми хубава история|Tell me a good story|
|tags/bedtime-stories-skill/title.entity:1|червената шапчица|little red riding hood|
|tags/bedtime-stories-skill/title.entity:2|трите мечета|the three bears|
|tags/bedtime-stories-skill/title.entity:3|Хензел и Гретел|hansel and gretel|
|tags/bedtime-stories-skill/title.entity:4||the velveteen rabbit|
|tags/bedtime-stories-skill/title.entity:5|Румпелщилцхен|rumplestiltskin|
|tags/bedtime-stories-skill/title.entity:6|Новите дрехи на царя|the emporers new clothes|
|tags/bedtime-stories-skill/title.entity:7|Принцесата и граховото зърно|the princess on the pea|
|tags/bedtime-stories-skill/title.entity:8|Обущарят и джуджетата|the elves and the shoemaker|
|tags/bedtime-stories-skill/title.entity:9||the three billy goats gruff|
|tags/bedtime-stories-skill/title.entity:10|Зайчето Питър|peter rabbit|
|tags/bedtime-stories-skill/title.entity:11|Нощта преди Коледа|twas the night before christmas|
...
# 00__skill_template-bg
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/00__skill_template/Count.voc:1|брой|count|
|tags/00__skill_template/Dir.voc:1|Нагоре|up|
|tags/00__skill_template/Dir.voc:2|надолу|down|
|tags/00__skill_template/Hello.voc:1|здравей|hello|
|tags/00__skill_template/Hello.voc:2|поздрави|greetings|
|tags/00__skill_template/Hello.voc:3|Здрасти|howdy|
|tags/00__skill_template/World.voc:1|свят|world|
|tags/00__skill_template/World.voc:2|земя|earth|
|tags/00__skill_template/count.is.now.dialog:1|Броячът сега е |The count is now {{count}}|
|tags/00__skill_template/count.is.now.dialog:2|Сега се до|We are now up to {{count}}|
|tags/00__skill_template/hello.world.dialog:1|Здравейте|Hello|
|tags/00__skill_template/hello.world.dialog:2|Здравей и на теб|Hi to you too|

# skill-playback-control-bg
...
# picroft-google-aiy-voicekit-bg
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/bark-skill/bark.dialog:1|Бау бау бау|Ruff ruff ruff|
|tags/bark-skill/bark.dialog:2|Бау|Ruff|
|tags/bark-skill/bark.dialog:3|Бау Бау|Ruff ruff|
|tags/bark-skill/bark.dialog:4|Бау бау бау бау|Ruff ruff ruff ruff|
|tags/bark-skill/bark.dialog:5|Бау бау бау бау бау|Ruff ruff ruff ruff ruff|
|tags/bark-skill/bark.intent:1|Лай|Bark|
|tags/bark-skill/bark.intent:2|Как прави кучето|What does a dog say|
|tags/bark-skill/bark.intent:3|Погледни тази котка|Look at that cat|
|tags/bark-skill/bark.intent:4|Пощальона е тук|Mailman is here|
...
# btotharye-home-assistant-bg
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:1|включване|activate|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:2|огън|fire|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:3|звънни|call up|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:4|превключвател|trigger|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:5|сцена|scene|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:6|автоматизация|automation|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:7|скрипт|script|
|tags/btotharye-home-assistant/DecreaseVerb.voc:1|Намаляване|decrease|
|tags/btotharye-home-assistant/DecreaseVerb.voc:2|долу|down|
|tags/btotharye-home-assistant/DeviceTrackerKeyword.voc:1|къде|where|
|tags/btotharye-home-assistant/DeviceTrackerKeyword.voc:2|откривам|местоположение|locate|location|
|tags/btotharye-home-assistant/IncreaseVerb.voc:1|увеличаване|increase|
|tags/btotharye-home-assistant/IncreaseVerb.voc:2|горе|up|
|tags/btotharye-home-assistant/LightBrightenVerb.voc:1|най-светло|по-светло|светло|увеличаване|brighten|brighter|bright|up|
|tags/btotharye-home-assistant/LightDimVerb.voc:1|затъмняване|затъмнител|тъмен|по-тъмен|най-тъмен|намаляване|dim|dimmer|dark|darken|lower|down|
|tags/btotharye-home-assistant/LightsKeyword.voc:1|светлина|light|
|tags/btotharye-home-assistant/LightsKeyword.voc:2|светлини|lights|
|tags/btotharye-home-assistant/LightsKeyword.voc:3|лампа|lamp|
|tags/btotharye-home-assistant/LightsKeyword.voc:4|лампи|lamps|
|tags/btotharye-home-assistant/LightsKeyword.voc:5|крушка|bulb|
|tags/btotharye-home-assistant/LightsKeyword.voc:6|крушки|bulbs|
|tags/btotharye-home-assistant/LightsKeyword.voc:7|ЛЕД|l.e.d.|
|tags/btotharye-home-assistant/LightsKeyword.voc:8|включване|turn on|
|tags/btotharye-home-assistant/LightsKeyword.voc:9|изключване|turn off|
|tags/btotharye-home-assistant/LightsKeyword.voc:10|превключване|toggle|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:1|положение|state|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:2|състояние|status|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:3|сензор|sensor|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:4|детектор|detector|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:5|стойност|value|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:6|измерена стойност|read out|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:7|какво е текущото|what is the current|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:8|какво е текущо|what is current|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:9|кажи ми текущото | какво е текущото|tell me the current|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:10|кажи ми текущ|tell me current|
|tags/btotharye-home-assistant/SetVerb.voc:1|задай|set|
|tags/btotharye-home-assistant/SwitchActionKeyword.voc:1|обърни|turn|
|tags/btotharye-home-assistant/SwitchActionKeyword.voc:2|превключване|switch|
|tags/btotharye-home-assistant/automation.rx:1|(активирай|запали|включи|звънни) (?P<Entity>.*)|(activate|fire|trigger|call up) (?P<Entity>.*)|
|tags/btotharye-home-assistant/dimming.rx:1|(задай) (?:осветеността от )?(?P<Entity>.*) (на) (?P<BrightnessValue>\d*)(?: процент)?|(set) (?:brightness of )?(?P<Entity>.*) (to) (?P<BrightnessValue>\d*)(?: percent)?|
|tags/btotharye-home-assistant/dimming.rx:2|(затъмни|освети|увеличи|намали) (?:осветеността от )?(?P<Entity>.*?) (?:със)? (?P<BrightnessValue>\d*)?(?: процент)?|(dim|brighten|increase|decrease) (?:brightness of )?(?P<Entity>.*?) (?:by)? (?P<BrightnessValue>\d*)?(?: percent)?|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:1|задействана автоматизация {{dev_name}}.|triggered automation {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:2|задействана {{dev_name}}.|triggered {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:3|{{dev_name}} беше задействан.|{{dev_name}} was triggered.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:4|{{dev_name}} беше активиран.|{{dev_name}} was activated.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:5|активиран {{dev_name}}.|activated {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.brightness.badreq.dialog:1|Моля, заявете яркост между 0 и 100.|please request a brightness level between 0 and 100.|
|tags/btotharye-home-assistant/homeassistant.brightness.badreq.dialog:2|колко светло? може да изберете ниво от 0 до 100.|how bright? you can choose a level from 0 to 100.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.dimmable.dialog:1|Не мога да затъмня {{dev_name}}. Не поддържа тази функция.|Can not dim {{dev_name}}. It is not dimmable.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.off.dialog:1|Не мога да затъмня {{dev_name}}. {{dev_name}} е изключен.|Can not dim {{dev_name}}. It is off.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.off.dialog:2|Не мога да затъмня {{dev_name}}. Моля включете {{dev_name}} преди това.|Can not dim {{dev_name}}. Please turn it on before.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.off.dialog:3|{{dev_name}} не може да бъде затъмнен. Само устройства които са включени могат да го направят.|{{dev_name}} can not be dimmed. Only devices that are turned on can be.|
|tags/btotharye-home-assistant/homeassistant.brightness.decreased.dialog:1|{{dev_name}} е затъмнен с {{brightness}} процент.|Dimmed {{dev_name}} to {{brightness}} percent.|
|tags/btotharye-home-assistant/homeassistant.brightness.decreased.dialog:2|{{dev_name}} е затъмнен.|Dimmed {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.brightness.dimmed.dialog:1|Задай осветеността на {{dev_name}} на {{brightness}} процента.|Set the brightness of {{dev_name}} to {{brightness}} percent.|
|tags/btotharye-home-assistant/homeassistant.brightness.increased.dialog:1|Увеличи осветеността на {{dev_name}} с {{brightness}} процента.|Increased brightness of {{dev_name}} to {{brightness}} percent.|
|tags/btotharye-home-assistant/homeassistant.brightness.increased.dialog:2|Увеличена е осветеността на {{dev_name}}.|Increased brightness of {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.already.dialog:1|{{dev_name}} вече {{action}}.|{{dev_name}} already {{action}}.|
|tags/btotharye-home-assistant/homeassistant.device.already.dialog:2|Няма направени промени на {{dev_name}}.|No changes made to {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.off.dialog:1|{{dev_name}} е изключен.|turned off {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.off.dialog:2|{{dev_name}} е изключен.|turned {{dev_name}} off.|
|tags/btotharye-home-assistant/homeassistant.device.off.dialog:3|{{dev_name}} сега е изключен.|{{dev_name}} is now off.|
|tags/btotharye-home-assistant/homeassistant.device.on.dialog:1| {{dev_name}} е включен.|turned on {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.on.dialog:2|{{dev_name}} беше включен.|{{dev_name}} was turned on.|
|tags/btotharye-home-assistant/homeassistant.device.on.dialog:3|{{dev_name}} е включено.|turned {{dev_name}} on.|
|tags/btotharye-home-assistant/homeassistant.device.toggle.dialog:1|задействана {{dev_name}}.|toggled {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.toggle.dialog:2|{{dev_name}} беше задействан.|{{dev_name}} was toggled.|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/auto-volume/activate.dialog:1|ОК|OK|
|tags/auto-volume/activate.dialog:2|Автоматичното увеличение на звука е активирано|Auto volume activated|
|tags/auto-volume/activate.dialog:3|Активирах автоматичното усилнане на звука|I have activated auto volume|
|tags/auto-volume/activate.intent:1|Активирай авто усилването на звука|Activate auto volume|
|tags/auto-volume/activate.intent:2|Настрой авто усилването на активно|Set auto volume to active|
|tags/auto-volume/activate.intent:3|Включи (авто усилването | автоматичното усилване ) (на звука)|Turn on auto volume|
|tags/auto-volume/activate.intent:4|Задай (авто усилването | автоматичното усилване ) (на звука) на включено|Set auto volume (to) on|
|tags/auto-volume/deactivate.dialog:2|(Aвто усилването | Aвтоматичното усилване ) (на звука) е деактивирано|Auto volume is deactivated|
|tags/auto-volume/deactivate.dialog:3|Деактивирах (авто усилването | автоматичното усилване ) на звука|I have now deactivated auto volume|
|tags/auto-volume/deactivate.intent:1|Деактивирай (авто усилването | автоматичното усилване ) на звука|Deactivate auto volume|
|tags/auto-volume/deactivate.intent:2|Задай (авто усилването | автоматичното усилване ) на активно|Set auto volume to inactive|
|tags/auto-volume/deactivate.intent:3|Изключи (авто усилването | автоматичното усилване ) (на звука)|Turn off auto volume|
|tags/auto-volume/deactivate.intent:4|Задай (авто усилването | автоматичното усилване ) (на звука) на изключено|Set auto volume (to) off|
|tags/auto-volume/reset.dialog:1|Рестартирах (авто усилването | автоматичното усилване ) (на звука)|I have now reset auto volume|
|tags/auto-volume/reset.intent:1|Изчисти измерванията на (авто усилването | автоматичното усилване ) (на звука)|Clear auto volume measurements|
|tags/auto-volume/reset.intent:2|Изтрий измерванията за (авто усилването | автоматичното усилване ) (на звука)|Delete auto volume measurements|
|tags/auto-volume/reset.intent:3|Рестартирай измерванията за (авто усилването | автоматичното усилване )(на звука)|Reset auto volume measurements|
...
# mozilla-webthings-gateway-skill-bg
