...
# skill-hello-world-nb
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-hello-world/HelloWorldKeyword.voc:1|hallo verden|hello world|
|tags/skill-hello-world/HelloWorldKeyword.voc:2|hilsener|greetings|
|tags/skill-hello-world/HowAreYouKeyword.voc:1|hvordan går det|how are you|
|tags/skill-hello-world/HowAreYouKeyword.voc:2|hvordan går det|how have you been|
|tags/skill-hello-world/HowAreYouKeyword.voc:3|hvordan har dagen din vært|how has your day been|
|tags/skill-hello-world/ThankYouKeyword.voc:1|tusen takk|thank you|
|tags/skill-hello-world/ThankYouKeyword.voc:2|takk|thanks|
|tags/skill-hello-world/hello.world.dialog:1|Hallo verden|Hello world|
|tags/skill-hello-world/hello.world.dialog:2|Hallo|Hello|
|tags/skill-hello-world/hello.world.dialog:3|Hei til deg også|Hi to you too|
|tags/skill-hello-world/how.are.you.dialog:1|Jeg har det bra|I'm doing well|
|tags/skill-hello-world/how.are.you.dialog:2|Ganske bra|Pretty well|
|tags/skill-hello-world/how.are.you.dialog:3|Jeg har det fantastisk|Not bad|
|tags/skill-hello-world/how.are.you.dialog:4|Jeg har det helt fantastisk|I'm doing excellent|
|tags/skill-hello-world/how.are.you.dialog:5|Kunne hatt det bedre|Could be better|
|tags/skill-hello-world/how.are.you.dialog:6|Jeg har det veldig bra|I'm doing very well|
|tags/skill-hello-world/welcome.dialog:1|Når som helst.|Any time.|
|tags/skill-hello-world/welcome.dialog:2|Glad for å kunne stå til tjeneste.|Glad to be of service.|
|tags/skill-hello-world/welcome.dialog:3|Glad for å kunne hjelpe.|Glad to help.|
|tags/skill-hello-world/welcome.dialog:4|Bare Hyggelig.|My Pleasure.|
|tags/skill-hello-world/welcome.dialog:5|Ingen problem.|No problem.|
|tags/skill-hello-world/welcome.dialog:6|Bare hyggelig.|You're welcome.|

# skill-finished-booting-nb
...
|tags/emby/emby.intent:1|spill {media} fra emby|play {media} from emby|
|tags/emby/emby.intent:2|spill {media} fra mb|play {media} from mb|

# plasma-user-control-skill-nb
...
|tags/homeseer-mycroft/DeviceStatus.dialog:1|Nåværende status til {{name}} er {{value}}.|The current status of {{name}} is {{value}}.|
|tags/homeseer-mycroft/DeviceStatus.dialog:2|For øyeblikket, statusen til {{name}} er {{value}}.|Currently, the status of {{name}} is {{value}}.|
|tags/homeseer-mycroft/DeviceStatus.dialog:3|{{name}} er {{value}} akkurat nå.|{{name}} is {{value}} right now.|
|tags/homeseer-mycroft/Error.dialog:1|Beklager, det var et problem med HomeSeer, {{exception}}.|Sorry, there was a problem with HomeSeer, {{exception}}.|
|tags/homeseer-mycroft/Error.dialog:2|Jeg beklager, men det var et problem med HomeSeer, {{exception}}.|I'm sorry, but there was a problem with HomeSeer, {{exception}}.|
|tags/homeseer-mycroft/GetStatusDetail.rx:1|få (status|status) (?:av)?(?P<StatusDetail>.+)|get (status|condition) (?:of)?(?P<StatusDetail>.+)|
|tags/homeseer-mycroft/Lock.dialog:1|{{setting}} til {{name}}.|{{setting}}ing the {{name}}.|
|tags/homeseer-mycroft/LockSettingDetails.rx:1|(?P<LockSetting>(lås opp|lås)) (?P<LockDetail>.+)|(?P<LockSetting>(unlock|lock)) (?P<LockDetail>.+)|
|tags/homeseer-mycroft/Percent.rx:1|(?P<Percentage>\d+)|(?P<Percentage>\d+)|
|tags/homeseer-mycroft/RunEvent.dialog:1|Kjører {{event}}.|Running event {{event}}.|
|tags/homeseer-mycroft/RunEvent.dialog:2|Starter {{event}} handlingen.|Starting {{event}} event.|
|tags/homeseer-mycroft/RunEvent.dialog:3|Ok, starter handling {{event}}.|Ok, starting event {{event}}.|
|tags/homeseer-mycroft/RunEventDetails.rx:1|kjør handling (?P<EventDetail>.+)|run event (?P<EventDetail>.+)|
|tags/homeseer-mycroft/RunEventDetails.rx:2|kjør (?P<EventDetail>.+) handling|run (?P<EventDetail>.+) event|
|tags/homeseer-mycroft/SetPercent.dialog:1|Setter {{name}} til {{percent}}%.|Setting {{name}} to {{percent}}%.|
|tags/homeseer-mycroft/SetPercent.dialog:2|Endrer {{name}} til {{percent}}%.|Changing {{name}} to {{percent}}%.|
|tags/homeseer-mycroft/SetPercentAll.dialog:1|Setter alle {{name}} til {{percent}}%.|Setting all {{name}} to {{percent}}%.|
|tags/homeseer-mycroft/SetPercentAll.dialog:2|Endrer alle {{name}} til {{percent}}%.|Changing all {{name}} to {{percent}}%.|
|tags/homeseer-mycroft/SetSettingDetails.rx:1|sett (?:av )?(?:alle )?(?P<SetDetail>.+) til|set (?:of )?(?:all )?(?P<SetDetail>.+) to|
|tags/homeseer-mycroft/ToggleAll.dialog:1|Skrur {{setting}} alle {{name}}.|Turning {{setting}} all {{name}}.|
|tags/homeseer-mycroft/ToggleAll.dialog:2|Setter alle {{name}} til {{setting}}.|Setting all {{name}} to {{setting}}.|
|tags/homeseer-mycroft/ToggleSingle.dialog:1|Endrer {{setting}} på {{name}}.|Turning {{setting}} the {{name}}.|
|tags/homeseer-mycroft/ToggleSingle.dialog:2|Ok, endrer {{setting}} på {{name}} nå.|Ok, turning {{setting}} the {{name}} now.|
|tags/homeseer-mycroft/TurnSettingDetails.rx:1|skru (?P<ToggleSetting>(av|på)) (?:alle )?(?P<ToggleSingleDetail>.+)|turn (?P<ToggleSetting>(off|on)) (?:all )?(?P<ToggleSingleDetail>.+)|
...
|tags/btotharye-home-assistant/DecreaseVerb.voc:1|øke|decrease|
|tags/btotharye-home-assistant/DecreaseVerb.voc:2||down|
|tags/btotharye-home-assistant/DeviceTrackerKeyword.voc:1||where|
|tags/btotharye-home-assistant/DeviceTrackerKeyword.voc:2|lokalisere|lokasjon|locate|location|
|tags/btotharye-home-assistant/IncreaseVerb.voc:1|øke|increase|
...
|tags/btotharye-home-assistant/LightsKeyword.voc:5|lyspære|bulb|
|tags/btotharye-home-assistant/LightsKeyword.voc:6|lyspære|bulbs|
...
# picroft-google-aiy-voicekit-nb
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/picroft-google-aiy-voicekit/error.initialize.dialog:1|Jeg har problemer med å starte Google AIY voicekit ferdigheten. Ferdigheten vil ikke bli lastet.|I am having problems initializing the Google A I Y voice kit Skill. The Skill will not load. |
...
|tags/skill-npr-news/Latest.voc:2|siste|latest|
...
|tags/skill-joke/Adult.voc:4|skitten|dirty|
|tags/skill-joke/Adult.voc:5|frekk|raunchy|
|tags/skill-joke/Adult.voc:6|uskikkelig|naughty|
|tags/skill-joke/Chuck.voc:1|chuck|chuck|
|tags/skill-joke/Chuck.voc:2|chuck norris|chuck norris|
|tags/skill-joke/Joke.voc:1|vits|joke|
|tags/skill-joke/Joke.voc:2|få meg til å le|make me laugh|
|tags/skill-joke/Joke.voc:3|lys opp dagen min|brighten my day|
|tags/skill-joke/Joke.voc:4|fortell meg en vits|tell me joke|
|tags/skill-joke/Neutral.voc:1|nøytral|neutral|
|tags/skill-joke/Neutral.voc:2|ikke-støtende|non-offensive|
|tags/skill-joke/Neutral.voc:3|nerdete|geeky|
...
# skill-release-test-nb
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-release-test/Release.dialog:1|Test bestått for 18.8.5|Test passed for 19.08.5|
|tags/skill-release-test/ReleaseKeyword.voc:1|starter test|invoking test|
|tags/skill-release-test/ReleaseKeyword.voc:2|start test|invoke test|
|tags/skill-release-test/ReleaseKeyword.voc:3|start utgivelses test|invoke release test|
|tags/skill-release-test/ReleaseKeyword.voc:4|utgivelse test|release test|
|tags/skill-release-test/ReleaseKeyword.voc:5|utgitt test|released test|

# tronald-dump-skill-nb
...
# plasma-mycroft-applet-control-nb
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-speak/Speak.voc:1|snakk|speak|
|tags/skill-speak/Speak.voc:2|si|say|
|tags/skill-speak/Speak.voc:3|gjenta|repeat|
|tags/skill-speak/Words.rx:1|si (?P<Words>.*)|say (?P<Words>.*)|
|tags/skill-speak/Words.rx:2|snakk (?P<Words>.*)|speak (?P<Words>.*)|
|tags/skill-speak/Words.rx:3|gjenta (?P<Words>.*)|repeat (?P<Words>.*)|
...
# mycroft-release-test-nb
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/mycroft-release-test/Release.dialog:1|Test bestått for 18.2.4|Test passed for 18.2.4.|
|tags/mycroft-release-test/ReleaseKeyword.voc:1|starter test|invoking test|
|tags/mycroft-release-test/ReleaseKeyword.voc:2|start test|invoke test|
|tags/mycroft-release-test/ReleaseKeyword.voc:3|start utgivelsestest|invoke release test|
|tags/mycroft-release-test/ReleaseKeyword.voc:4|utgivelsestest|release test|
|tags/mycroft-release-test/ReleaseKeyword.voc:5|utgitt test|released test|
...
# today-history.btotharye-nb
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/today-history.btotharye/RandomEventKeyword.voc:1|hvilken historisk hendelse skjedde på denne dagen|what event happened this day in history|
|tags/today-history.btotharye/RandomEventKeyword.voc:2|denne dagen i historien|this day in history|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/desktop-control/CopyKeyword.voc:1|kopier til utklippstavlen|copy to clipboard|
|tags/desktop-control/CopyKeyword.voc:2|kopi|copy|
|tags/desktop-control/CutKeyword.voc:1|klipp ut til utklippstavlen|cut to clipboard|
|tags/desktop-control/CutKeyword.voc:2|klipp ut|cut|
|tags/desktop-control/DeleteKeyword.voc:1|slett|delete|
|tags/desktop-control/PasteKeyword.voc:1|lim inn fra utklippstavlen|paste from clipboard|
|tags/desktop-control/PasteKeyword.voc:2|lim inn|paste|
|tags/desktop-control/ScreenResKeyword.voc:1|skjermoppløsning|screen resolution|
|tags/desktop-control/SelectAllKeyword.voc:1|velg alt|select all|
|tags/desktop-control/Text.rx:1|(skriv) (?P<Text>.*)|(type) (?P<Text>.*)|
|tags/desktop-control/TypeKeyword.voc:1|skriv|type|
|tags/desktop-control/absolutemousemove.dialog:1|Flytter musen til {{x}} og {{y}}|Moving the mouse to {{x}} and {{y}}|
|tags/desktop-control/absolutemousemove.intent:1|flytt musen til {x} og {y} |move mouse to {x} and {y} |
|tags/desktop-control/down.entity:1|ned |down |
|tags/desktop-control/holdkey.intent:1|hold {key} tasten|hold the {key} key|
|tags/desktop-control/holdkey.intent:2|trykk ned {key} tasten|hold down the {key} key|
...
|tags/desktop-control/key.entity:27|ned|down|
|tags/desktop-control/key.entity:28|opp|up|
|tags/desktop-control/key.entity:29|venstre|left|
|tags/desktop-control/key.entity:30|høyre|right|
|tags/desktop-control/keyhold.dialog:1|Holder {{key}}|Holding {{key}}|
|tags/desktop-control/keyhold.dialog:2|Holder nede {{key}} tasten|Holding down the {{key}} key|
|tags/desktop-control/keypress.dialog:1|Trykker {{key}}|Pressing {{key}}|
|tags/desktop-control/keypress.dialog:2|Trykker {{key}} for deg nå.|Pressing {{key}} for you now.|
|tags/desktop-control/keyrelease.dialog:1|Slipper {{key}}|Releasing {{key}}|
|tags/desktop-control/keyrelease.dialog:2|Slipper {{key}} tasten|Releasing the {{key}} key|
|tags/desktop-control/largescroll.entity:1|alt|lot|
|tags/desktop-control/medscroll.entity:1|noe|some|
|tags/desktop-control/presskey.intent:1|trykk {key} tasten |press the {key} key |
|tags/desktop-control/releasekey.intent:1|slipp {key} tasten|release the {key} key|
|tags/desktop-control/releasekey.intent:2|slipp {key} tasten|let go of the {key} key|
|tags/desktop-control/screenresolution.dialog:1|Din skjermoppløsning er {{x}} gange {{y}}|Your screen resolution is {{x}} by {{y}}|
|tags/desktop-control/screenresolution.dialog:2|Skjermoppløsningen på den aktive skjermen er {{x}} gange {{y}}|The resolution of your active display is {{x}} by {{y}}|
|tags/desktop-control/scroll.intent:1|bla {down} en {smallscroll}|scroll {down} a {smallscroll}|
|tags/desktop-control/scroll.intent:2|bla {down} en {largescroll}|scroll {down} a {largescroll}|
|tags/desktop-control/scroll.intent:3|bla {down} {medscroll}|scroll {down} {medscroll}|
|tags/desktop-control/scroll.intent:4|bla {up} en {smallscroll}|scroll {up} a {smallscroll}|
|tags/desktop-control/scroll.intent:5|bla {up} en {largescroll}|scroll {up} a {largescroll}|
|tags/desktop-control/scroll.intent:6|bla {up} {medscroll}|scroll {up} {medscroll}|
|tags/desktop-control/smallscroll.entity:1|litt|little|
|tags/desktop-control/typing.dialog:1|Noterer det for deg nå|Typing that for you now|
|tags/desktop-control/typing.dialog:2|Noterer din forespørsel|Typing your request|
...
|tags/skill-stop/StopKeyword.voc:3|ti stilt|shut up|
...
# fallback-recommendations-skill-nb
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/fallback-persona/FallbackPersona.voc:1|tilbakefalls personlighet|fallback persona|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-support/ask.description.dialog:1|Vær så snill å kort, beskriv problemet du opplever|Please briefly describe the problem you are experiencing|
|tags/skill-support/ask.description.dialog:2|Hva er en kort beskrivelse av problemet du får?|What's a brief description of the problem you are having?|
|tags/skill-support/cancelled.dialog:1|Ok|Alright|
|tags/skill-support/complete.dialog:1|Jeg har sendt en epost til den registrerte kontoen din med debugging informasjon, samt instruksjoner for hvordan kontakte support.|I've sent an email to your registered account with debugging information and instructions for contacting support.|
|tags/skill-support/confirm.support.dialog:1|Ønsker du å lage en feilsøkingspakke? Logger vil bli lastet opp til termbin dot com tjenesten og en epost med link og mer informasjon vil bli sendt deg.|Would you like to create a troubleshooting package? This will upload logs to the zero ex zero dot S T service and email a link to you with more information.|
|tags/skill-support/contact.support.intent:1|lag en feilsøkingsforespørsel|create a troubleshoot request|
|tags/skill-support/contact.support.intent:2|feilsøk min enhet|troubleshoot my device|
|tags/skill-support/contact.support.intent:3|kontakt brukerstøtte|contact support|
|tags/skill-support/contact.support.intent:4|lag en sak hos brukerstøtte|create a support ticket|
|tags/skill-support/one.moment.dialog:1|Et øyeblikk.|One moment.|
|tags/skill-support/support.dialog:1|brukerstøtte|support|
|tags/skill-support/support.email.template:1|<p>Under er en lenke til feilsøkingspakken laget av Mycroft:</p>|<p>Below is a link to the troubleshooting package generated by Mycroft:</p>|
|tags/skill-support/support.email.template:3|<ul><tt>|<ul><tt>|
|tags/skill-support/support.email.template:4|<p><b>Enhetens Navn:</b> {{device_name}}</p>|<p><b>Device Name:</b> {{device_name}}</p>|
|tags/skill-support/support.email.template:5|<p><b>Beskrivelse:</b> {{description}}</p>|<p><b>Description:</b> {{description}}</p>|
...
|tags/skill-support/support.email.template:10|<a href='mailto:support@mycroft.ai?Subject=Troubleshooting%20Package&amp;body=Troubleshooting%20Package:%20{{url}}' target='_top'>Send dette til support@mycroft.ai</a> for å sende denne informasjonen til Mycroft teamet for videre assistanse.|<a href='mailto:support@mycroft.ai?Subject=Troubleshooting%20Package&amp;body=Troubleshooting%20Package:%20{{url}}' target='_top'>Send this to support@mycroft.ai</a> to pass this information to the Mycroft team for further assistance.|
|tags/skill-support/support.title.dialog:1|Mycroft Feilsøkingsassistent|Mycroft Troubleshooting Assistant|
...
|tags/skill-support/yes.list:3|jepp|yep|
|tags/skill-support/yes.list:4|sikkert|sure|
|tags/skill-support/yes.list:5|vær så snill|please|

# carstena-the-cows-lists-nb
...
|tags/skill-spelling/Spell.voc:2|stav ordet|spell word|
|tags/skill-spelling/Spell.voc:3|staving av|spelling of|
|tags/skill-spelling/Spell.voc:4|staving av ordet|spelling of word|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/cocktails/Again.voc:1|igjen|again|
|tags/cocktails/Ingredients.voc:1|ingrediens|ingredient|
|tags/cocktails/Ingredients.voc:2|ingredienser|ingredients|
|tags/cocktails/Needed.intent:1|hva trengs for å lage en {drink}|what is needed to make (a|an) {drink}|
|tags/cocktails/Needed.intent:2|hva trenger (jeg|du) for å lage en {drink}|what do (i|you) need (for|to make) (a|an) {drink}|
|tags/cocktails/Needed.intent:3|hva er (ingrediensen|ingrediensene) til {drink}|what are the (ingredients|ingredient) (of|for) (a|an) {drink}|
|tags/cocktails/NotFound.dialog:1|Beklager, jeg kunne ikke finne ønsket drink|Sorry, I couldn't find the requested drink|
|tags/cocktails/NotFound.dialog:2|Beklager, jeg kunne ikke finne det|I'm a fraid I couldn't find that|
|tags/cocktails/Recipie.intent:1|hvordan lager (jeg|du) en {drink}|how (would|do) (i|you) (make|mix) (a|an) {drink}|
|tags/cocktails/Recipie.intent:2|fortell (meg|oss) hvordan man lager en {drink}|tell (me|us) how to (make|mix) (a|an) {drink}|
|tags/cocktails/Recipie.intent:3|gi (meg|oss) instruksjoner for å lage en {drink}|give (me|us) instructions for (a|an) {drink}|
|tags/cocktails/Recipie.intent:4|hvordan lage en {drink}|how to (make|mix) (a|an) {drink}|
|tags/cocktails/Recipie.intent:5|hva er oppskriften til {drink}|what is the recipie for (a|an) {drink}|
|tags/cocktails/TellMe.voc:1|hva er|what are|
|tags/cocktails/TellMe.voc:2|fortell meg|tell me|
|tags/cocktails/What.voc:1|hva var|what was|
|tags/cocktails/What.voc:2|hva var|what were|
|tags/cocktails/YouWillNeed.dialog:1|du vil trenge {ingredients} og {final_ingredient}|You'll need {ingredients} and {final_ingredient}|
|tags/cocktails/YouWillNeed.dialog:2|du vil trenge {ingredients} og {final_ingredient}|You will need {ingredients} and {final_ingredient}|
|tags/cocktails/YouWillNeed.dialog:3|ingrediensene du trenger er: {ingredients} og {final_ingredient}|The required ingredients are: {ingredients} and {final_ingredient}|
...
|tags/decide-skill/Choice1.rx:2|mellom ((?P<Choice1>.*) og (?P<dummy>.*))|between ((?P<Choice1>.*) and (?P<dummy>.*))|
|tags/decide-skill/Choice2.rx:1|(.* (?P<dummy2>.*) eller (?P<Choice2>.*))|(.* (?P<dummy2>.*) or (?P<Choice2>.*))|
|tags/decide-skill/Choice2.rx:2|mellom ((?P<dummy2>.*) og (?P<Choice2>.*))|between ((?P<dummy2>.*) and (?P<Choice2>.*))|
|tags/decide-skill/DecideKeyword.voc:1|Bestem|Decide|
|tags/decide-skill/DecideKeyword.voc:2|Hva skal jeg ha på meg|What should I wear|
|tags/decide-skill/DecideKeyword.voc:3|Hva skal jeg spise|What should I eat|
|tags/decide-skill/DecideKeyword.voc:4|spill|game|
...
# mozilla-webthings-gateway-skill-nb
...
# 00__skill_template-nb
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/00__skill_template/Count.voc:1|Tell|count|
|tags/00__skill_template/Dir.voc:1|opp|up|
|tags/00__skill_template/Dir.voc:2|ned|down|
|tags/00__skill_template/Hello.voc:1|hallo|hello|
|tags/00__skill_template/Hello.voc:2|hilsener|greetings|
|tags/00__skill_template/Hello.voc:3|hvordan går det|howdy|
|tags/00__skill_template/World.voc:1|verden|world|
|tags/00__skill_template/World.voc:2|jorden|earth|
|tags/00__skill_template/count.is.now.dialog:1|Antallet er nå {{count}}|The count is now {{count}}|
|tags/00__skill_template/count.is.now.dialog:2|Vi er nå kommet til {{count}}|We are now up to {{count}}|
|tags/00__skill_template/hello.world.dialog:1|Hallo|Hello|
|tags/00__skill_template/hello.world.dialog:2|Hei til deg også|Hi to you too|
...
# knock-knock-jokes-skill-nb
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/knock-knock-jokes-skill/joke.voc:1|bank-bank-vitser|joke|
|tags/knock-knock-jokes-skill/knock-knock.dialog:1|bank-bank|knock knock|
...
|tags/chatbot/Memory.voc:3|sinn|mind|
|tags/chatbot/Memory.voc:4|alt|everything|
|tags/chatbot/Reset.voc:1|glem|forget|
|tags/chatbot/Reset.voc:2|tilbakestill|reset|
|tags/chatbot/reset.memory.dialog:1|tilbakestiller kunnskapsdatabasen|Resetting knowledge database|
|tags/chatbot/reset.memory.dialog:2|glem alt|Forgetting everything|
|tags/chatbot/reset.memory.dialog:3|Okay, jeg vil nå tilbakestille minnet mitt|Okay, I will now reset my memory|
|tags/chatbot/reset.memory.dialog:4|initierer sletting av hjernen|Brain erasure initiated|
