...
| :--- | :--- | :--- |
|tags/chatbot/Memory.voc:1|mozek|brain|
|tags/chatbot/Memory.voc:2|paměť|memory|
|tags/chatbot/Memory.voc:3|mysl|mind|
|tags/chatbot/Memory.voc:4|všechno|everything|
|tags/chatbot/Reset.voc:1|zapomenout|forget|
|tags/chatbot/Reset.voc:2|reset|reset|
|tags/chatbot/reset.memory.dialog:1|Resetuji znalostní databázi |Resetting knowledge database|
|tags/chatbot/reset.memory.dialog:2|Všechno zapomínám|Forgetting everything|
|tags/chatbot/reset.memory.dialog:3|Dobře, nyní si resetuji paměť|Okay, I will now reset my memory|
|tags/chatbot/reset.memory.dialog:4|Vymazání mozku zahájeno|Brain erasure initiated|
...
|tags/auto-volume/activate.dialog:2|Automatická hlasitost aktivována|Auto volume activated|
|tags/auto-volume/activate.dialog:3|Aktivoval jsem automatickou hlasitost|I have activated auto volume|
|tags/auto-volume/activate.intent:1|Aktivuj automatickou hlasitost|Activate auto volume|
|tags/auto-volume/activate.intent:2|Nastav automatickou hlasitost jako aktivní|Set auto volume to active|
|tags/auto-volume/activate.intent:3|Zapni automatickou hlasitost|Turn on auto volume|
|tags/auto-volume/activate.intent:4|Nastav automatickou hlasitost jako zapnutou|Set auto volume (to) on|
|tags/auto-volume/deactivate.dialog:2|Automatická hlasitost je deaktivována|Auto volume is deactivated|
|tags/auto-volume/deactivate.dialog:3|Právě jsem deaktivoval automatickou hlasitost|I have now deactivated auto volume|
|tags/auto-volume/deactivate.intent:1|Deaktivuj automatickou hlasitost|Deactivate auto volume|
|tags/auto-volume/deactivate.intent:2|Vypni automatickou hlasitost|Set auto volume to inactive|
|tags/auto-volume/deactivate.intent:3|Vypni automatickou hlasitost|Turn off auto volume|
|tags/auto-volume/deactivate.intent:4|Nastav automatickou hlasitost jako vypnutou|Set auto volume (to) off|
|tags/auto-volume/reset.dialog:1|Právě jsem resetoval automatickou hlasitost|I have now reset auto volume|
|tags/auto-volume/reset.intent:1|Smazat automatické měření hlasitosti|Clear auto volume measurements|
|tags/auto-volume/reset.intent:2|Vymazat automatické měření hlasitosti|Delete auto volume measurements|
|tags/auto-volume/reset.intent:3|Resetovat automatické měření hlasitosti|Reset auto volume measurements|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-speak/Speak.voc:1||speak|
|tags/skill-speak/Speak.voc:2||say|
|tags/skill-speak/Speak.voc:3||repeat|
|tags/skill-speak/Words.rx:1||say (?P<Words>.*)|
|tags/skill-speak/Words.rx:2||speak (?P<Words>.*)|
|tags/skill-speak/Words.rx:3||repeat (?P<Words>.*)|
...
# skill-version-checker-cs
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-version-checker/Check.voc:1|zkontrolovat|check|
|tags/skill-version-checker/Check.voc:2|najít|find|
|tags/skill-version-checker/Check.voc:3|běžící|running|
|tags/skill-version-checker/Check.voc:4|co je|what is|
|tags/skill-version-checker/PlatformBuild.voc:1|sestavení platformy|platform build|
|tags/skill-version-checker/PlatformBuild.voc:2|verze platformy|platform version|
|tags/skill-version-checker/PlatformBuild.voc:3|verze firmwaru|firmware version|
|tags/skill-version-checker/Version.voc:1|verze|version|
|tags/skill-version-checker/Version.voc:2|kód|code|
|tags/skill-version-checker/Version.voc:3|vydání|release|
|tags/skill-version-checker/Version.voc:4|systém|system software|
|tags/skill-version-checker/ask.upgrade.dialog:1|Vaše verze je zastaralá. Nejnovější verze je {{major}}.{{minor}}, vydání {{build}}.  Chcete spustit aktualizaci?|Your version is outdated. The latest version is {{major}} oh {{minor}}, release {{build}}.  Would you like me to start the upgrade?|
|tags/skill-version-checker/ask.upgrade.dialog:2|Vaše verze je zastaralá. Nejnovější verze je {{major}} tečka {{minor}}, vydání {{build}}.  Chcete aktualizovat na nejnovější verzi?|Your version is outdated. The latest version is {{major}} oh {{minor}}, release {{build}}.  Would you like to update to the latest version?|
...
|tags/skill-version-checker/major.upgrade.declined.dialog:1|Bez problému, zůstanu zatím na aktuální verzi.|No problem, I'll stay with my current software for now.|
|tags/skill-version-checker/major.upgrade.dialog:1|Důležitá aktualizace systému Mycroft je k dispozici.  Toto vás přesune na novou větev, {{major}} tečka {{minor}}.  Přepínání větví je většinou bezbolestné.  Nicméně, některé dovednosti nemusí být dostupné na nové větvi.  Chcete začít s aktualizací?|A major Mycroft software update is available.  This will move you to the new {{major}} oh {{minor}} branch.  Changing branches is usually painless.  However, some skills might not be available under the new branch.  Would you like to start this upgrade?|
|tags/skill-version-checker/platform.build.dialog:1|Mé sestavené platformy je {{build}}.|My platform build is {{build}}.|
|tags/skill-version-checker/platform.build.none.dialog:1|Běžím na zařízení, které nemá oficiální číslo sestavení platformy.|I'm running on a device that does not have an official platform build number.|
...
|tags/skill-version-checker/upgrade.cancelled.dialog:1|Dobrá, zůstanu na starší verzi|Alright, I'll remain on the older version|
|tags/skill-version-checker/upgrade.started.dialog:1|Aktualizace nyní probíhá v pozadí.  Může to chvíli trvat než bude stažena a nainstalována, ale již brzy budu běžet na nejnovější verzi.|I've started the update in the background.  It can take a while to download and upgrade, but I'll be running the latest code soon.|
|tags/skill-version-checker/version.dialog:1|Běžím na mycroft-core verzi {{major}} tečka {{minor}}, vydání {{build}}|I am running mycroft-core version {{major}} oh {{minor}}, release {{build}}|
|tags/skill-version-checker/version.latest.dialog:1|Používáte nejnovější verzi.|You are on the latest version.|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-stop/StopKeyword.voc:1|zastav|stop|
|tags/skill-stop/StopKeyword.voc:2|ticho|silence|
|tags/skill-stop/StopKeyword.voc:3|mlč|shut up|
|tags/skill-stop/StopKeyword.voc:4|buď zticha|be quiet|
...
# fallback-recommendations-skill-cs
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-volume/Decrease.voc:1|nižší|lower|
|tags/skill-volume/Decrease.voc:2|snížit|reduce|
|tags/skill-volume/Decrease.voc:3|zeslabit|decrease|
|tags/skill-volume/Decrease.voc:5|tišší|quieter|
...
|tags/skill-volume/Increase.voc:1|zvýšit|rise|
|tags/skill-volume/Increase.voc:4|zvýšit|increase|
|tags/skill-volume/Increase.voc:2|povýšit|raise|
|tags/skill-volume/Increase.voc:3|zesílit|boost|
|tags/skill-volume/Increase.voc:6|hlasitěji|louder|
...
|tags/skill-volume/Level.voc:13|tichý|quiet|
|tags/skill-volume/Level.voc:14|normální|normal|
|tags/skill-volume/Level.voc:15|hlasitý|loud|
...
|tags/skill-volume/Mute.voc:1|ztlumit|mute|
|tags/skill-volume/Mute.voc:2|ticho|silence|
...
|tags/skill-volume/Unmute.voc:2|zapnout zvuk|unmute|
|tags/skill-volume/Unmute.voc:1|resetovat|reset|
|tags/skill-volume/Unmute.voc:3|obnovit|restore|
|tags/skill-volume/Reset.voc:2||default|
|tags/skill-volume/Volume.voc:1|hlasitost|volume|
|tags/skill-volume/Volume.voc:2|reproduktor|speaker|
|tags/skill-volume/Volume.voc:4|zvuk|sound|
|tags/skill-volume/Volume.voc:4||audio|
|tags/skill-volume/already.max.volume.dialog:1||Volume is already at maximum|
|tags/skill-volume/already.max.volume.dialog:2|Hlasitější být nemohu|I can't get any louder|
|tags/skill-volume/decrease.volume.dialog:1|Hlasitost zeslabena na úroveň {{volume}}|Volume reduced to {{volume}}|
|tags/skill-volume/decrease.volume.dialog:2|Hlasitost snížena na úroveň {{volume}}|Volume decreased to {{volume}}|
|tags/skill-volume/decrease.volume.dialog:3|Hlasitost je nyní na úrovni {{volume}}|Volume is now {{volume}}|
|tags/skill-volume/increase.volume.dialog:2|Hlasitost zvýšena na úroveň {{volume}}|Volume increased to {{volume}}|
...
|tags/skill-volume/mute.volume.dialog:1|Zvuk bude ztlumen|Audio is going to be muted|
|tags/skill-volume/mute.volume.dialog:2|Zvuk bude ztlumen|Sound is going to be muted|
|tags/skill-volume/reset.volume.dialog:1|Hlasitost resetována na úroveň {{volume}}|Volume reset to {{volume}}|
|tags/skill-volume/reset.volume.dialog:2|Hlasitost obnovena na úroveň {{volume}}|Volume restored to {{volume}}|
|tags/skill-volume/set.volume.dialog:1|Hlasitost nastavena na úroveň {{volume}}|Volume set to {{volume}}|
|tags/skill-volume/set.volume.dialog:2|Hlasitost přepnuta na úroveň {{volume}}|Volume updated to {{volume}}|
|tags/skill-volume/set.volume.dialog:3|Hlasitost změněna na úroveň {{volume}}|Volume changed to {{volume}}|
...
|tags/skill-volume/volume.is.dialog:1|Hlasitost je nastavena na úroveň {{volume}}|The volume is set to {{volume}}|
|tags/skill-volume/volume.is.dialog:2|Hlasitost je na úrovni {{volume}}|The volume is at {{volume}}|

# picroft-google-aiy-voicekit-cs
...
|tags/email-skill/check.email.intent:1|zkontroluj můj email|check my email|
|tags/email-skill/check.email.intent:2|zkontroluj mojí poštu|check my mail|
|tags/email-skill/check.email.intent:3|dostal jsem nějakou novou poštu?|do i have any new mail|
|tags/email-skill/check.email.intent:4|mám nějakou novou poštu?|do I have any email|
|tags/email-skill/check.email.intent:5|Mám nějaké nové emaily?|do i have any new emails|
...
|tags/email-skill/error.getting.mail.dialog:1|Při získávání e-mailu došlo k chybě. Zkuste zkontrolovat svá přístupová práva a informace o serveru.|There was an error getting your email Try checking your credentials and server information|
|tags/email-skill/error.getting.mail.dialog:2|Zkontrolujte svá přístupová práva a informace o serveru, protože došlo k potížím při doručování pošty.|Check your credentials and server information because there was a problem getting your mail|
|tags/email-skill/error.getting.mail.dialog:3|Nemohu se připojit k vašemu e-mailovému serveru. Zkontrolujte heslo a informace o serveru.|I can not connect to your email server Check your password and server information|
|tags/email-skill/list.subjects.dialog:1|číslo {message_num} je od {sender}. Její předmět je {subject}.|Your {message_num} email is from {sender} Its subject is {subject}|
|tags/email-skill/list.subjects.dialog:2||The {message_num} email's subject is {subject} Its from {sender}|
|tags/email-skill/more.emails.dialog:1|chcete slyšet víc?|would you like to hear more|
|tags/email-skill/more.emails.dialog:2|chcete slyšet více vašich emailů?|want to hear more of your emails|
|tags/email-skill/more.emails.dialog:3|chcete se dozvědět víc?|do you want to hear more|
...
|tags/email-skill/no.more.emails.dialog:1|jasně.|okay|
|tags/email-skill/no.new.email.dialog:1|Neexistuje žádný nový email.|There is no new email|
|tags/email-skill/no.new.email.dialog:2|Není žádný nový email.|There's no new email|
|tags/email-skill/no.new.email.dialog:3|Žádná nová pošta není.|There's no new mail|
|tags/email-skill/no.new.email.dialog:4|Není tu žádná nová pošta.|There is no new mail|
|tags/email-skill/no.new.email.dialog:5|Pro vás není nový email.|There's no new email for you|
|tags/email-skill/no.new.email.dialog:6|Žádná nová pošta pro vás není.|There's no new mail for you|
|tags/email-skill/no.new.email.dialog:7|Nemáte žádnou novou poštu.|You have no new mail|
|tags/email-skill/no.new.email.dialog:8|Žádný nový email.|You have no new email|
...
|tags/email-skill/setup.dialog:1|Chcete-li nastavit email dovednost, prosím, jděte na domovskou tečku mycroft tečka a I pro zadání emailových informací.|To set the email skill up, please go to home dot mycroft dot a i to enter your email information|
|tags/email-skill/setup.dialog:2|Chcete-li nastavit email dovednost, prosím, jděte na domovskou tečku mycroft tečka a I pro zadání emailových informací.|You need to set the email skill up To do so, please go to home dot mycroft dot a i to enter your email information|
...
# btotharye-home-assistant-cs
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:1|Aktivuj|activate|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:2|oheň|fire|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:3|volej|call up|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:4||trigger|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:5|scéna|scene|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:6|automatizace|automation|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:7|skript|script|
|tags/btotharye-home-assistant/DecreaseVerb.voc:1|snížit|decrease|
|tags/btotharye-home-assistant/DecreaseVerb.voc:2|dolů|down|
|tags/btotharye-home-assistant/DeviceTrackerKeyword.voc:1|kam|where|
|tags/btotharye-home-assistant/DeviceTrackerKeyword.voc:2||locate|location|
|tags/btotharye-home-assistant/IncreaseVerb.voc:1|snížit|increase|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/count/count.intent:1|Počítej do {number}|Count to {number}|
|tags/count/count_error.dialog:1|Nerozumím.|I do not understand. |
|tags/count/count_error.dialog:2||I am missing something.|
|tags/count/count_error.dialog:3|Zopakujte?|Say again?|
|tags/count/count_error.dialog:4|Omlouvám se, neslyším.|Sorry. I did not hear that.|
|tags/count/count_start.dialog:1|Počítám do {number}. Začínám teď!|Counting to {number}. starting now!|
|tags/count/count_stop.dialog:1|Hotovo!|Done!|
...
|tags/count/countdown_start.dialog:1|Počítám do {number}. Začínám teď!|Count down from {number}. Starting now!|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-support/ask.description.dialog:1|Ve zkratce popište problém, se kterým jste se setkali|Please briefly describe the problem you are experiencing|
|tags/skill-support/ask.description.dialog:2|Jak byste popsali problém, se kterým se potýkáte?|What's a brief description of the problem you are having?|
|tags/skill-support/cancelled.dialog:1|Dobře|Alright|
|tags/skill-support/complete.dialog:1|Na emailovou adresu spojenou s vaším účtem jsem odeslal email s instrukcemi pro kontaktování podpory.|I've sent an email to your registered account with debugging information and instructions for contacting support.|
|tags/skill-support/confirm.support.dialog:1|Chcete vytvořit ladící balíček? Tato možnost nahraje záznamy do služby termbin tečka com a odešle vám email s odkazem pro více informací.|Would you like to create a troubleshooting package? This will upload logs to the zero ex zero dot S T service and email a link to you with more information.|
|tags/skill-support/contact.support.intent:1|vytvořit požadavek pro řešení problému|create a troubleshoot request|
|tags/skill-support/contact.support.intent:2|zkontrolovat mé zařízení|troubleshoot my device|
|tags/skill-support/contact.support.intent:3|kontaktovat podporu|contact support|
|tags/skill-support/contact.support.intent:4|vytvořit požadavek o podporu|create a support ticket|
|tags/skill-support/one.moment.dialog:1|Jen chvilinku.|One moment.|
|tags/skill-support/support.dialog:1|podpora|support|
|tags/skill-support/support.email.template:1|<p>Níže je odkaz na ladící balíček vytvožený Microftem:</p>|<p>Below is a link to the troubleshooting package generated by Mycroft:</p>|
|tags/skill-support/support.email.template:3|<ul><tt>|<ul><tt>|
|tags/skill-support/support.email.template:4|<p><b>Název zařízení:</b> {{device_name}}</p>|<p><b>Device Name:</b> {{device_name}}</p>|
|tags/skill-support/support.email.template:5|<p><b>Popis:</b> {{description}}</p>|<p><b>Description:</b> {{description}}</p>|
...
|tags/skill-support/yes.list:1|ano|yes|
|tags/skill-support/yes.list:2|jasně|yeah|
|tags/skill-support/yes.list:3|jo|yep|
|tags/skill-support/yes.list:4|jistě|sure|
|tags/skill-support/yes.list:5|prosím|please|
...
# mozilla-webthings-gateway-skill-cs
...
# knock-knock-jokes-skill-cs
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/knock-knock-jokes-skill/joke.voc:1|vtip|joke|
|tags/knock-knock-jokes-skill/knock-knock.dialog:1|ťuk ťuk|knock knock|
...
# carstena-the-cows-lists-cs
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/carstena-the-cows-lists/AddTask.rx:1|Přidat (?P<taskName>.+)|add (?P<taskName>.+)|
|tags/carstena-the-cows-lists/AddTaskToList.dialog:1|{{taskName}} byl přidán do seznamu {{listName}}|{{taskName}} was added to list {{listName}}|
...
|tags/carstena-the-cows-lists/FindTask.rx:1|Přidat (?P<taskName>.+)|find (?P<taskName>.+)|
...
# today-history.btotharye-cs
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/today-history.btotharye/RandomEventKeyword.voc:1|Jaká událost se stala tento den v minulosti|what event happened this day in history|
|tags/today-history.btotharye/RandomEventKeyword.voc:2|tento den v minulosti|this day in history|
|tags/today-history.btotharye/RandomEventKeyword.voc:3|dnes v minulosti|today in history|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/spotify-skill/And.dialog:1|a|and|
|tags/spotify-skill/AvailableDevices.dialog:1|Vidím Spotify zařízení pojmenované: {{devices}}|I see the Spotify devices named: {{devices}}|
|tags/spotify-skill/AvailableDevices.dialog:2|Našel jsem Spotify zařízení pojmenované: {{devices}}|I've found the Spotify devices named: {{devices}}|
...
|tags/spotify-skill/Device.voc:1|zařízení|device|
|tags/spotify-skill/Device.voc:2|jednotka|unit|
|tags/spotify-skill/Device.voc:3|zařízení|devices|
|tags/spotify-skill/Device.voc:4|jednotky|units|
...
|tags/spotify-skill/FailedToStart.dialog:1|Nepodařilo se mi spustit přehrávač Spotify.  Zkontrolujte prosím své připojení k internetu a že je vaše jméno a heslo správné.|I wasn't able to launch the Spotify player.  Please check your network connectivity and that your username and password are correct.|
|tags/spotify-skill/For.dialog:1|pro|for|
|tags/spotify-skill/For.voc:2|pro albun|for album|
|tags/spotify-skill/For.voc:3|pro album|for the album|
|tags/spotify-skill/For.voc:4|pro umělce|for artist|
|tags/spotify-skill/For.voc:5|pro umělce|for the artist|
|tags/spotify-skill/ForArtist.dialog:1| pro umělce | for the artist |
|tags/spotify-skill/ListeningToAlbumBy.dialog:1|Posloucháte {{album}} od {{artist}}.|Listening to {{album}} by {{artist}}.|
|tags/spotify-skill/ListeningToAlbumBy.dialog:2|Přehrávám {{album}} od {{artist}}.|Now playing {{album}} by {{artist}}.|
|tags/spotify-skill/ListeningToArtist.dialog:1|Posloucháte {{artist}}|Now listening to {{artist}}|
|tags/spotify-skill/ListeningToArtist.dialog:2|Posloucháte {{artist}}|Listening to {{artist}}|
|tags/spotify-skill/ListeningToArtist.dialog:3|Přehrávám skladby od {{artist}}|Playing songs by {{artist}}|
|tags/spotify-skill/ListeningToGenre.dialog:1|Okay, poslechněme nějaký {{genre}}. Začneme s {{track}} od {{artist}}|Okay, let's hear some {{genre}}. Starting with {{track}} by {{artist}}|
|tags/spotify-skill/ListeningToGenre.dialog:2|Poslechněme nějaký {{genre}}. Začneme s {{track}} by {{artist}}|Let's hear some {{genre}}. Starting with {{track}} by {{artist}}|
|tags/spotify-skill/ListeningToGenre.dialog:3|Poslechněme nějakou tu {{genre}} hudbu. Toto je {{track}} od {{artist}}|Let's hear some {{genre}} music. This is {{track}} by {{artist}}|
|tags/spotify-skill/ListeningToGenre.dialog:4|Přehrávám {{genre}} hudbu. Začínáme s {{track}} od {{artist}}|Playing {{genre}} music. Starting off with {{track}} by {{artist}}|
|tags/spotify-skill/ListeningToPlaylist.dialog:1|Posloucháte seznam {{playlist}}|Listening to the playlist {{playlist}}|
|tags/spotify-skill/ListeningToPlaylist.dialog:2|Nyní přehrávám seznam {{playlist}}|Now playing the playlist {{playlist}}|
|tags/spotify-skill/ListeningToPlaylist.dialog:3|Okay, poslechněme seznam {{playlist}}|Okay, let's hear your playlist {{playlist}}|
|tags/spotify-skill/ListeningToPlaylist.dialog:4|Mám to. Dále, váš seznam {{playlist}}|Got it. Next up, your playlist {{playlist}}|
|tags/spotify-skill/ListeningToSongBy.dialog:1|Posloucháte {{tracks}} by {{artist}}.|Listening to the song {{tracks}} by {{artist}}.|
|tags/spotify-skill/ListeningToSongBy.dialog:2|Nyní přehrávám {{tracks}} od {{artist}}.|Now playing the song {{tracks}} by {{artist}}.|
|tags/spotify-skill/ListeningToSongBy.dialog:3|Přehrávám {{tracks}} od {{artist}}|Playing {{tracks}} by {{artist}}|
|tags/spotify-skill/NoArtistResults.dialog:1|Hmm, nemohu nalézt tohoto umělce.|Hmm, I can't find that artist.|
|tags/spotify-skill/NoArtistResults.dialog:2|Omlouvám se, ale tohoto umělce neznám.|Sorry, I can't find that artist.|
|tags/spotify-skill/NoArtistResults.dialog:3|Ať hledám jak hledám, toho umělce nemohu najít.|I can't seem to find that artist.|
|tags/spotify-skill/NoArtistResults.dialog:4|Nenašel jsem žádné výsledky k tomuto umělci.|I didn't get any results for that artist.|
|tags/spotify-skill/NoArtistResults.dialog:5|Omlouvám se, ale nemohu najít žádné výsledky pro tohoto umělce.|Sorry, I didn't get any results for that artist.|
|tags/spotify-skill/NoArtistResults.dialog:6|Ach jo, nemohu najít umělce, kterého hledáte.|Uh-oh, I didn't find the artist you were looking for.|
|tags/spotify-skill/NoDefaultDeviceAvailable.dialog:1|Nemohu nalézt výchozí zařízení Spotify.  Přesvědčte se, že Spotify beží či zda dovednost byla nastavena tak, aby používala výchozí knihovny|I couldn't find any default Spot-ify device.  Make sure Spot-ify is running, or that the skill has been configured to use the default libraries|
|tags/spotify-skill/NoDefaultDeviceAvailable.dialog:2|Není k dispozici žádné výchozí Spotify zařízení. Zkontrolujte, zda Spotify běží či zda byla dovednost nastavena, aby používala výchozí knihovny|There's no default Spot-ify device available. Make sure Spot-ify is running, or that the skill has been configured to use the default libraries|
|tags/spotify-skill/NoDevicesAvailable.dialog:1|Nemohl jsem najít žádné Spotify zařízení.|I couldn't find any Spotify devices.|
|tags/spotify-skill/NoDevicesAvailable.dialog:2|Žádná Spotify zařízení nejsou k dispozici.|There are no Spotify devices available.|
|tags/spotify-skill/NoResults.dialog:1|Hmm, nemohu to najít.|Hmm, I can't find that.|
|tags/spotify-skill/NoResults.dialog:2|Omlouvám se, nemohu to najít.|Sorry, I can't find that.|
|tags/spotify-skill/NoResults.dialog:3|Prostě to nemohu najít.|I can't seem to find that.|
|tags/spotify-skill/NoResults.dialog:4|Tomuto požadavku neodpovídají žádné výsledky.|I didn't get any results for that.|
|tags/spotify-skill/NoResults.dialog:5|Omlouvám se, ale tomuto požadavku neodpovídají žádné výsledky.|Sorry, I didn't get any results for that.|
|tags/spotify-skill/NoResults.dialog:6|Ach jo, nenašel jsem to, co hledáte.|Uh-oh, I didn't find what you were looking for.|
...
|tags/spotify-skill/NotConfigured.dialog:1|Nejsem připojen k účtu Spotify, běžte na home tečka mycroft tečka ai pro autorizaci dovednosti.|I'm not connected to your Spotify account yet.  Go to home dot mycroft dot ai to setup your Spotify skill.|
...
|tags/spotify-skill/Search.voc:1|hledat|search|
|tags/spotify-skill/Search.voc:2|vyhledat|look for|
...
|tags/spotify-skill/Spotify.voc:2|použití spotify|using spotify|
|tags/spotify-skill/Spotify.voc:3|pro spotify|with spotify|
|tags/spotify-skill/Spotify.voc:4|na Spotify|on Spotify|
|tags/spotify-skill/StopMusic.intent:1||(stop|end|turn off) (the|) (music|spotify|)|
|tags/spotify-skill/ToDevice.rx:1|na (?P<ToDevice>.+)|to (?P<ToDevice>.+)|
|tags/spotify-skill/Transfer.voc:1|přesunout|transfer|
|tags/spotify-skill/Transfer.voc:2|přenést|move|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/homeassistant/AutomationActionKeyword.voc:1|aktivovat|activate|
|tags/homeassistant/AutomationActionKeyword.voc:2||fire|
|tags/homeassistant/AutomationActionKeyword.voc:3||call up|
|tags/homeassistant/AutomationActionKeyword.voc:4|spustit|trigger|
|tags/homeassistant/AutomationActionKeyword.voc:5||scene|
|tags/homeassistant/AutomationActionKeyword.voc:6|automatizace|automation|
|tags/homeassistant/AutomationActionKeyword.voc:7||script|
|tags/homeassistant/ClimateKeyword.voc:1|nastavit teplotu {entity} na teplotu {temperature}|set the {entity} temperature to {temperature}|
|tags/homeassistant/DecreaseVerb.voc:1|snížit|decrease|
|tags/homeassistant/DecreaseVerb.voc:2|dolů|down|
|tags/homeassistant/DeviceTrackerKeyword.voc:1|kde je|where is|
|tags/homeassistant/DeviceTrackerKeyword.voc:2|nalézt|lokace|locate|location|
|tags/homeassistant/DeviceTrackerKeyword.voc:3|kde|where|
|tags/homeassistant/IncreaseVerb.voc:1|zvýšit|increase|
|tags/homeassistant/IncreaseVerb.voc:2|nahoru|up|
...
|tags/homeassistant/LightsKeyword.voc:1|světla|light|
|tags/homeassistant/LightsKeyword.voc:2|světla|lights|
|tags/homeassistant/LightsKeyword.voc:3|lampa|lamp|
|tags/homeassistant/LightsKeyword.voc:4|lampy|lamps|
|tags/homeassistant/LightsKeyword.voc:5|žárovka|bulb|
|tags/homeassistant/LightsKeyword.voc:6|žárovky|bulbs|
|tags/homeassistant/LightsKeyword.voc:7|LED|l.e.d.|
|tags/homeassistant/LightsKeyword.voc:8|zapnout|turn on|
|tags/homeassistant/LightsKeyword.voc:9|vypnout|turn off|
|tags/homeassistant/LightsKeyword.voc:10|přepnout|toggle|
|tags/homeassistant/SensorStatusKeyword.voc:1|stav|state|
...
|tags/homeassistant/SensorStatusKeyword.voc:5|hodnota|value|
|tags/homeassistant/SensorStatusKeyword.voc:6|přečíst|read out|
|tags/homeassistant/SensorStatusKeyword.voc:7|jaký je aktuální|what is the current|
|tags/homeassistant/SensorStatusKeyword.voc:8|jaký je aktuální|what is current|
|tags/homeassistant/SensorStatusKeyword.voc:9|řekni mi aktuální|tell me the current|
|tags/homeassistant/SensorStatusKeyword.voc:10|řekni mi aktuální|tell me current|
|tags/homeassistant/SensorStatusKeyword.voc:11|dej mi hodnotu|give me the value of|
|tags/homeassistant/SensorStatusKeyword.voc:12|jaká je hodnota na termostatu|what is the value of thermostat|
|tags/homeassistant/SetVerb.voc:1|nastav|set|
|tags/homeassistant/SwitchActionKeyword.voc:1|otoč|turn|
|tags/homeassistant/SwitchActionKeyword.voc:2|přepni|switch|
|tags/homeassistant/automation.rx:1|(aktivuj|nahoď|zapni) (?P<Entity>.*)|(activate|fire|trigger|call up) (?P<Entity>.*)|
|tags/homeassistant/climate.rx:1|(nastav) (?P<Entity>.*) termostat na (?P<temp>[0-9]*)|(set) (?P<Entity>.*) thermostat to (?P<temp>[0-9]*)|
|tags/homeassistant/dimming.rx:1|(nastavit) (?:jas u )?(?P<Entity>.*) (na) (?P<BrightnessValue>\d*)(?: procent)?|(set) (?:brightness of )?(?P<Entity>.*) (to) (?P<BrightnessValue>\d*)(?: percent)?|
...
|tags/homeassistant/set.climate.intent:2|nastavit teplotu {entity} na {temp}|set the {entity} temperature to {temp} degrees|
|tags/homeassistant/set.climate.intent:3|nastavit teplotu {entity} na teplotu {temp}|change the {entity} temperature to {temp} degrees|
...
# bedtime-stories-skill-cs
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/bedtime-stories-skill/list.stories.dialog:1|Zde jsou příběhy, které mám k dispozici. {{stories}}|Here are the bedtime stories I have available. {{stories}}|
|tags/bedtime-stories-skill/list.stories.dialog:2|Zde jsou příběhy z mé knihovny. {{stories}}|Here are the bedtime stories in my library. {{stories}}|
|tags/bedtime-stories-skill/list.stories.intent:1|Seznam příběhů|List bedtime stories|
|tags/bedtime-stories-skill/list.stories.intent:2|Co máš za příběhy|What stories do you have|
|tags/bedtime-stories-skill/list.stories.intent:3|Co máš za příběhy na dobrou noc|What bed time stories do you have|
|tags/bedtime-stories-skill/pick.story.dialog:1|Okay, podívám se, zda ho mám.|Okay, let me see if I have that story.|
|tags/bedtime-stories-skill/pick.story.intent:1|vyprávěj mi {title}|tell me {title}|
|tags/bedtime-stories-skill/pick.story.intent:2|přečti mi {title}|read me {title}|
|tags/bedtime-stories-skill/pick.story.intent:3|přečti mi {title}|readme {title}|
|tags/bedtime-stories-skill/pick.story.intent:4|Přečti mi {title}|Tell me {title}|
|tags/bedtime-stories-skill/stories.bedtime.dialog:1|Dobrá. Zde je výběr z mé knihovny.|Okay, sure. Here is a great selection from my library.|
|tags/bedtime-stories-skill/stories.bedtime.dialog:2|Bez problému. Usaď se než vyberu příběh.|No problem, get comfy while I pick a story.|
|tags/bedtime-stories-skill/stories.bedtime.intent:1|Vyprávěj mi|Tell me a story|
|tags/bedtime-stories-skill/stories.bedtime.intent:2|Přečti mi příběh na dobrou noc|Tell me a bed time story|
|tags/bedtime-stories-skill/stories.bedtime.intent:3|Přečti mi pohádku|Tell me a fairy tale|
|tags/bedtime-stories-skill/stories.bedtime.intent:4|Vyprávěj nám|Tell us a story|
|tags/bedtime-stories-skill/stories.bedtime.intent:5|Přečti mi dobrý příběh|Tell me a good story|
|tags/bedtime-stories-skill/title.entity:1|Červená karkulka|little red riding hood|
|tags/bedtime-stories-skill/title.entity:2|tři medvědi|the three bears|
|tags/bedtime-stories-skill/title.entity:3|Jeníček a Mařenka|hansel and gretel|
|tags/bedtime-stories-skill/title.entity:4||the velveteen rabbit|
|tags/bedtime-stories-skill/title.entity:5|Rampelník|rumplestiltskin|
|tags/bedtime-stories-skill/title.entity:6|Císařovy nové šaty|the emporers new clothes|
|tags/bedtime-stories-skill/title.entity:7|Princezna na hrášku|the princess on the pea|
...
|tags/bedtime-stories-skill/title.entity:10|Králíček Petr|peter rabbit|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/wikiquote/notfound.dialog:1|Nenašel jsem žádné citace na téma {{subject}}|I didn't find any {{subject}} quotes|
|tags/wikiquote/random.intent:1|řekni mi (nějakou|nějaké) (citace|moudra)|tell me (some|a) (quote|wisdom)|
|tags/wikiquote/random.intent:2|řekni mi (nějakou|nějaké) (citace|moudra)|give me (some|a) (quote|wisdom)|
|tags/wikiquote/random.intent:3|Potřebuji nějakou moudrost|I need some wisdom|
...
# plasma-mycroft-applet-control-cs
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-installer/action.list:1|instaluji|installing|
|tags/skill-installer/action.list:2|odstraňuji|removing|
|tags/skill-installer/cancelled.dialog:1|Zrušeno.|Cancelled.|
|tags/skill-installer/cancelled.dialog:2|Akce zrušena.|Action cancelled.|
|tags/skill-installer/choose.skill.dialog:1|Byla nalezeno více dovedností, který chcete... {{skills}}|Multiple skills found, which would you like... {{skills}}|
|tags/skill-installer/error.already.beta.dialog:1|Preview verze dovednosti {{skill}} už je nainstalována.|The preview version of {{skill}} has already been installed.|
|tags/skill-installer/error.already.installed.dialog:1|Dovednost {{skill}} už je nainstalována|{{skill}} has already been installed|
|tags/skill-installer/error.already.removed.dialog:1|Dovednost {{skill}} není nainstalována|{{skill}} is not installed|
|tags/skill-installer/error.already.removed.dialog:2|Dovednost {{skill}} nebyla na tomto zařízení nalezena|{{skill}} was not found on this device|
|tags/skill-installer/error.filesystem.dialog:1|Během akce {{action}} dovednosti {{skill}} nastala chyba souborového systému.|A filesystem error occurred while {{action}} {{skill}}.|
|tags/skill-installer/error.multiple.skills.dialog:1|Váš požadavek má několik výsledků, buďte konkrétnější.|Your request had multiple matches, please be more specific.|
|tags/skill-installer/error.not.found.dialog:1|Nenašel jsem dovednost pod názvem {{skill}}.|I didn't find any skill named {{skill}}.|
|tags/skill-installer/error.other.dialog:1|Při instalaci dovednosti {{skill}} došlo k neznámé chybě.|An unknown error occurred while installing {{skill}}.|
|tags/skill-installer/error.pip.requirements.dialog:1|Při {{action}} Python závislostí pro dovednost {{skill}} došlo k chybě.|An error occurred while {{action}} the Python dependencies for {{skill}}.|
|tags/skill-installer/error.skill.requirements.dialog:1|Při {{action}} závislostí pro dovednost {{skill}} došlo k chybě.|An error occurred while {{action}} the skill requirements for {{skill}}.|
|tags/skill-installer/error.system.requirements.dialog:1|Při {{action}} balíčků systému pro dovednost {{skill}} došlo k chybě.|An error occurred while {{action}} the system packages for {{skill}}.|
...
|tags/skill-installer/installed.dialog:1|ano, dovednost {skill} je nainstalována|yes, {skill} is installed|
|tags/skill-installer/is.installed.intent:1|Je dovednost {skill} nainstalována?|is {skill} installed|
...
|tags/skill-installer/not.installed.dialog:1|Ne, dovednost {skill} není nainstalována|no, {skill} isn't installed|
|tags/skill-installer/not.installed.dialog:2|Ne, dovednost {skill} není nainstalována|no, {skill} is not installed|
...
# skill-hello-world-cs
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-hello-world/HelloWorldKeyword.voc:1|ahoj světe|hello world|
|tags/skill-hello-world/HelloWorldKeyword.voc:2|ahoj|greetings|
|tags/skill-hello-world/HowAreYouKeyword.voc:1|jak se máš|how are you|
|tags/skill-hello-world/HowAreYouKeyword.voc:2|jak je|how have you been|
|tags/skill-hello-world/HowAreYouKeyword.voc:3|jak se dnes máš|how has your day been|
|tags/skill-hello-world/ThankYouKeyword.voc:1|děkuji|thank you|
|tags/skill-hello-world/ThankYouKeyword.voc:2|díky|thanks|
|tags/skill-hello-world/hello.world.dialog:1|Ahoj světe|Hello world|
|tags/skill-hello-world/hello.world.dialog:2|Ahoj|Hello|
|tags/skill-hello-world/hello.world.dialog:3|Taky tě zdravím|Hi to you too|
|tags/skill-hello-world/how.are.you.dialog:1|Mám se dobře|I'm doing well|
|tags/skill-hello-world/how.are.you.dialog:2|Mám se docela dobře|Pretty well|
|tags/skill-hello-world/how.are.you.dialog:3|Nemám se špatně|Not bad|
|tags/skill-hello-world/how.are.you.dialog:4|Mám se skvěle|I'm doing excellent|
|tags/skill-hello-world/how.are.you.dialog:5|Mohlo by to být lepší|Could be better|
|tags/skill-hello-world/how.are.you.dialog:6|Mám se moc dobře|I'm doing very well|
|tags/skill-hello-world/welcome.dialog:1|Kdykoliv.|Any time.|
|tags/skill-hello-world/welcome.dialog:2|Rád jsem pomohl.|Glad to be of service.|
|tags/skill-hello-world/welcome.dialog:3|Rád jsem pomohl.|Glad to help.|
|tags/skill-hello-world/welcome.dialog:4|Potěšení je na mé straně.|My Pleasure.|
|tags/skill-hello-world/welcome.dialog:5|Bez problému.|No problem.|
|tags/skill-hello-world/welcome.dialog:6|Nemáš zač|You're welcome.|
...
# 00__skill_template-cs
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/00__skill_template/Count.voc:1|count|count|
|tags/00__skill_template/Dir.voc:1|Nahoru|up|
|tags/00__skill_template/Dir.voc:2|Dolů|down|
|tags/00__skill_template/Hello.voc:1|ahoj|hello|
|tags/00__skill_template/Hello.voc:2|ahoj|greetings|
|tags/00__skill_template/Hello.voc:3|Zdarec|howdy|
|tags/00__skill_template/World.voc:1|svět|world|
|tags/00__skill_template/World.voc:2|země|earth|
|tags/00__skill_template/count.is.now.dialog:1|Počet je teď {{count}}|The count is now {{count}}|
|tags/00__skill_template/count.is.now.dialog:2|Jsme teď na {{count}}|We are now up to {{count}}|
|tags/00__skill_template/hello.world.dialog:1|Ahoj|Hello|
|tags/00__skill_template/hello.world.dialog:2|Dobrý den i tobě|Hi to you too|
