...
|tags/skill-hello-world/HowAreYou.intent:1||how are you|
|tags/skill-hello-world/HowAreYou.intent:2||how have you been|
|tags/skill-hello-world/HowAreYou.intent:3||how has your day been|
...
# plasma-mycroft-applet-control-lt
...
|tags/plasma-mycroft-applet-control/MycroftPlasmoidShowKeyword.voc:1|pasirodyk|show yourself|
...
|tags/dice-skill/multiple.result.dialog:1||Your numbers are {result}|
...
|tags/dice-skill/single.result.dialog:1||The Result is {result}.|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/count/count.intent:1|Skaičiuok iki {number}|Count to {number}|
|tags/count/count_error.dialog:1|Aš nesuprantu.|I do not understand. |
...
# fallback-recommendations-skill-lt
...
# plasma-activities-skill-lt
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:1|sukurk naują veiklą|create a new activity|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:2|sukurk naują veiklą|create new activity|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:3|sukurk veiklą|create activity|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:4|sukurk naują veiklą|start a new activity|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:5|sukurk naujas veiklas|create new activities|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:6|sukurk naujas veiklas|start new activities|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:7|sukurk veiklas|create activities|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:8|nauja veikla|new activity|
|tags/plasma-activities-skill/ActivitiesCreateKeyword.voc:9|naujos veiklos|new activities|
|tags/plasma-activities-skill/ActivitiesRemoveKeyword.voc:1|pašalink veiklą|remove activity|
|tags/plasma-activities-skill/ActivitiesRemoveKeyword.voc:2|pašalink veiklą|remove the activity|
|tags/plasma-activities-skill/ActivitiesRemoveKeyword.voc:3|ištrink veiklą|delete activity|
|tags/plasma-activities-skill/ActivitiesRemoveKeyword.voc:4|ištrink veiklą|delete the activity|
|tags/plasma-activities-skill/ActivitiesShowKeyword.voc:1||show current activities|
|tags/plasma-activities-skill/ActivitiesShowKeyword.voc:2|naujos veiklos|show activities|
...
|tags/skill-date-time/RelativeDay.voc:1||today|
...
|tags/skill-date-time/what.time.is.it.intent:2||do you have the (current|) time|
|tags/skill-date-time/what.time.is.it.intent:3||current time|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/desktop-control/CopyKeyword.voc:1|nukopijuok į iškarpinę|copy to clipboard|
|tags/desktop-control/CopyKeyword.voc:2|nukopijuok|copy|
|tags/desktop-control/CutKeyword.voc:1|iškirpk į iškarpinę|cut to clipboard|
|tags/desktop-control/CutKeyword.voc:2|iškirpk|cut|
|tags/desktop-control/DeleteKeyword.voc:1|ištrink|delete|
|tags/desktop-control/PasteKeyword.voc:1|įdėk iš iškarpinės|paste from clipboard|
|tags/desktop-control/PasteKeyword.voc:2|įdėk|paste|
...
|tags/desktop-control/down.entity:1|žemyn|down |
...
|tags/desktop-control/key.entity:27|žemyn|down|
|tags/desktop-control/key.entity:28|aukštyn|up|
|tags/desktop-control/key.entity:29|kairėn|left|
|tags/desktop-control/key.entity:30|dešinėn|right|
...
# picroft-google-aiy-voicekit-lt
...
# mozilla-webthings-gateway-skill-lt
...
|tags/mycroft-timer/start.timer.intent:2||ping me in {duration}|
|tags/mycroft-timer/start.timer.intent:3||(start|create) (a|) timer|
|tags/mycroft-timer/start.timer.intent:4||(start|create) (a|) timer for {duration}|
|tags/mycroft-timer/start.timer.intent:5||(start|create) (a|) timer (for|called|named) {name}|
|tags/mycroft-timer/start.timer.intent:6||(start|create) (a|) {duration} timer|
|tags/mycroft-timer/start.timer.intent:7||(start|create) (a|) {duration} timer (for|called|named) {name}|
|tags/mycroft-timer/start.timer.intent:8||(start|create) (a|) timer (for|called|named) {name} for {duration}|
