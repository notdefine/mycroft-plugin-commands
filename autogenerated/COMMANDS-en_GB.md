...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/decide-skill/Choice1.rx:1|(.* (?P<Choice1>.*) or (?P<dummy>.*))|(.* (?P<Choice1>.*) or (?P<dummy>.*))|
|tags/decide-skill/Choice1.rx:2|between ((?P<Choice1>.*) and (?P<dummy>.*))|between ((?P<Choice1>.*) and (?P<dummy>.*))|
|tags/decide-skill/Choice2.rx:1|(.* (?P<dummy2>.*) or (?P<Choice2>.*))|(.* (?P<dummy2>.*) or (?P<Choice2>.*))|
|tags/decide-skill/Choice2.rx:2|between ((?P<dummy2>.*) and (?P<Choice2>.*))|between ((?P<dummy2>.*) and (?P<Choice2>.*))|
|tags/decide-skill/DecideKeyword.voc:1|Decide|Decide|
|tags/decide-skill/DecideKeyword.voc:2|What should I wear|What should I wear|
|tags/decide-skill/DecideKeyword.voc:3|What should I eat|What should I eat|
|tags/decide-skill/DecideKeyword.voc:4|game|game|
...
|tags/skill-alarm/recurring.value:2||monday,1|
...
# knock-knock-jokes-skill-en_GB
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/knock-knock-jokes-skill/joke.voc:1|joke|joke|
|tags/knock-knock-jokes-skill/knock-knock.dialog:1|knock knock|knock knock|

# reginaneon-av-music-en_GB
...
# today-history.btotharye-en_GB
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/today-history.btotharye/RandomEventKeyword.voc:1|what event happened on this day in history|what event happened this day in history|
|tags/today-history.btotharye/RandomEventKeyword.voc:2|this day in history|this day in history|
|tags/today-history.btotharye/RandomEventKeyword.voc:3|today in history|today in history|

# skill-crystal-ball-en_GB
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-speak/Speak.voc:1|speak|speak|
|tags/skill-speak/Speak.voc:2|say|say|
|tags/skill-speak/Speak.voc:3|repeat|repeat|
|tags/skill-speak/Words.rx:1|say (?P<Words>.*)|say (?P<Words>.*)|
|tags/skill-speak/Words.rx:2|speak (?P<Words>.*)|speak (?P<Words>.*)|
|tags/skill-speak/Words.rx:3|repeat (?P<Words>.*)|repeat (?P<Words>.*)|

# skill-hello-world-en_GB
...
# skill-audio-record-en_GB
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-audio-record/AudioRecordSkillDeleteVerb.voc:1||delete|
|tags/skill-audio-record/AudioRecordSkillDeleteVerb.voc:2||erase|
|tags/skill-audio-record/AudioRecordSkillDeleteVerb.voc:3||remove|
...
|tags/skill-audio-record/AudioRecordSkillPlayVerb.voc:7||playing|
|tags/skill-audio-record/AudioRecordSkillPlayVerb.voc:8||replaying|
...
|tags/auto-volume/activate.dialog:2|Auto volume activated|Auto volume activated|
|tags/auto-volume/activate.dialog:3|I have activated auto volume|I have activated auto volume|
|tags/auto-volume/activate.intent:1|Activate auto volume|Activate auto volume|
|tags/auto-volume/activate.intent:2|Set auto volume to active|Set auto volume to active|
|tags/auto-volume/activate.intent:3|Turn on auto volume|Turn on auto volume|
|tags/auto-volume/activate.intent:4|Set auto volume (to) on|Set auto volume (to) on|
|tags/auto-volume/deactivate.dialog:2|Auto volume is deactivated|Auto volume is deactivated|
|tags/auto-volume/deactivate.dialog:3|I have now deactivated auto volume|I have now deactivated auto volume|
|tags/auto-volume/deactivate.intent:1|Deactivate auto volume|Deactivate auto volume|
|tags/auto-volume/deactivate.intent:2|Set auto volume to inactive|Set auto volume to inactive|
|tags/auto-volume/deactivate.intent:3|Turn off auto volume|Turn off auto volume|
|tags/auto-volume/deactivate.intent:4|Set auto volume (to) off|Set auto volume (to) off|
|tags/auto-volume/reset.dialog:1|I have now reset auto volume|I have now reset auto volume|
|tags/auto-volume/reset.intent:1|Clear auto volume measurements|Clear auto volume measurements|
|tags/auto-volume/reset.intent:2|Delete auto volume measurements|Delete auto volume measurements|
|tags/auto-volume/reset.intent:3|Reset auto volume measurements|Reset auto volume measurements|
...
# mycroft-release-test-en_GB
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/mycroft-release-test/Release.dialog:1|Test passed for 18.2.4.|Test passed for 18.2.4.|
|tags/mycroft-release-test/ReleaseKeyword.voc:1|invoking test|invoking test|
|tags/mycroft-release-test/ReleaseKeyword.voc:2|invoke test|invoke test|
|tags/mycroft-release-test/ReleaseKeyword.voc:3|invoke release test|invoke release test|
...
# plasma-mycroft-applet-control-en_GB
...
# 00__skill_template-en_GB
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/00__skill_template/Count.voc:1|count|count|
|tags/00__skill_template/Dir.voc:1|up|up|
|tags/00__skill_template/Dir.voc:2|down|down|
|tags/00__skill_template/Hello.voc:1|hello|hello|
|tags/00__skill_template/Hello.voc:2|greetings|greetings|
|tags/00__skill_template/Hello.voc:3|howdy|howdy|
|tags/00__skill_template/World.voc:1|world|world|
|tags/00__skill_template/World.voc:2|earth|earth|
|tags/00__skill_template/count.is.now.dialog:1|The count is now {{count}}|The count is now {{count}}|
|tags/00__skill_template/count.is.now.dialog:2|We are now up to {{count}}|We are now up to {{count}}|
|tags/00__skill_template/hello.world.dialog:1|hello|Hello|
|tags/00__skill_template/hello.world.dialog:2|Hi to you too|Hi to you too|

# reginaneon-caffeine-wiz-en_GB
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/reginaneon-caffeine-wiz/CaffeineKeyword.voc:1|tell me caffeine content of|tell me caffeine content of|
|tags/reginaneon-caffeine-wiz/CaffeineKeyword.voc:2|how much caffeine is in|how much caffeine is in|
|tags/reginaneon-caffeine-wiz/CaffeineKeyword.voc:3|how about caffeine content of|how about caffeine content of|
|tags/reginaneon-caffeine-wiz/GoodbyeKeyword.voc:1|goodbye|goodbye|
|tags/reginaneon-caffeine-wiz/GoodbyeKeyword.voc:2|that's all|that's all|
|tags/reginaneon-caffeine-wiz/GoodbyeKeyword.voc:3|we're done|we're done|
|tags/reginaneon-caffeine-wiz/drink.caffeine.dialog:1|The drink {{drink}} has {{caffeine_content}} milligrams of caffeine in {{drink_size}} ounces.|The drink {{drink}} has {{caffeine_content}} milligrams of caffeine in {{drink_size}} ounces.|
|tags/reginaneon-caffeine-wiz/drink.rx:1|(of|is in) (?P<drink>.*)|(of|is in) (?P<drink>.*)|

# skill-release-test-en_GB
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-release-test/Release.dialog:1|Test passed for 19.08.2|Test passed for 19.08.5|
|tags/skill-release-test/ReleaseKeyword.voc:1|invoking test|invoking test|
|tags/skill-release-test/ReleaseKeyword.voc:2|invoke test|invoke test|
|tags/skill-release-test/ReleaseKeyword.voc:3|invoke release test|invoke release test|
|tags/skill-release-test/ReleaseKeyword.voc:4|release test|release test|
|tags/skill-release-test/ReleaseKeyword.voc:5|released test|released test|

# skill-npr-news-en_GB
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-singing/Sing.voc:1|sing|sing|
|tags/skill-singing/Sing.voc:2|sing me a song|sing me a song|
|tags/skill-singing/singing.dialog:1|I would be happy to sing for you. |I would be happy to sing for you. |
|tags/skill-singing/singing.dialog:2|Here I go.|Here I go.|
|tags/skill-singing/singing.dialog:3|I'm a bit nervous about my voice, but here goes nothing.|I'm a bit nervous about my voice, but here goes nothing.|
|tags/skill-singing/singing.stop.dialog:1|thank you for listening|thank you for listening|
|tags/skill-singing/singing.stop.dialog:2|I hope you liked my voice|I hope you liked my voice|
|tags/skill-singing/singing.stop.dialog:3|now you try|now you try|

# dismissal-skill-en_GB
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/fallback-aiml/Memory.voc:1|brain|brain|
|tags/fallback-aiml/Memory.voc:2|memory|memory|
|tags/fallback-aiml/Memory.voc:3|mind|mind|
|tags/fallback-aiml/Memory.voc:4|everything|everything|
|tags/fallback-aiml/Reset.voc:1|forget|forget|
|tags/fallback-aiml/Reset.voc:2|reset|reset|
|tags/fallback-aiml/reset.memory.dialog:1|Resetting knowledge database|Resetting knowledge database|
|tags/fallback-aiml/reset.memory.dialog:2|Forgetting everything|Forgetting everything|
|tags/fallback-aiml/reset.memory.dialog:3|Okay, I will now reset my memory|Okay, I will now reset my memory|
|tags/fallback-aiml/reset.memory.dialog:4|Brain erasure initiated|Brain erasure initiated|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/chatbot/Memory.voc:1|brain|brain|
|tags/chatbot/Memory.voc:2|memory|memory|
|tags/chatbot/Memory.voc:3|mind|mind|
|tags/chatbot/Memory.voc:4|everything|everything|
|tags/chatbot/Reset.voc:1|forget|forget|
|tags/chatbot/Reset.voc:2|reset|reset|
|tags/chatbot/reset.memory.dialog:1|Resetting knowledge database|Resetting knowledge database|
|tags/chatbot/reset.memory.dialog:2|Forgetting everything|Forgetting everything|
|tags/chatbot/reset.memory.dialog:3|Okay, I will now reset my memory|Okay, I will now reset my memory|
|tags/chatbot/reset.memory.dialog:4|Brain erasure initiated|Brain erasure initiated|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/count/count.intent:1|Count to {number}|Count to {number}|
|tags/count/count_error.dialog:1|I do not understand. |I do not understand. |
|tags/count/count_error.dialog:2|I am missing something.|I am missing something.|
|tags/count/count_error.dialog:3|Say again?|Say again?|
|tags/count/count_error.dialog:4|Sorry. I did not hear that.|Sorry. I did not hear that.|
|tags/count/count_start.dialog:1|Counting to {number}. starting now!|Counting to {number}. starting now!|
|tags/count/count_stop.dialog:1|Done!|Done!|
|tags/count/count_stop.dialog:2|Finish!|Finish!|
|tags/count/countdown.intent:1|Countdown from {number}|Countdown from {number}|
|tags/count/countdown.intent:2|Count down from {number}|Count down from {number}|
|tags/count/countdown.intent:3|Count backwards from {number}|Count backwards from {number}|
|tags/count/countdown.intent:4|Count back wards from {number}|Count back wards from {number}|
|tags/count/countdown.intent:5|Count back from {number}|Count back from {number}|
|tags/count/countdown.intent:6|From {number} count down|From {number} count down|
|tags/count/countdown.intent:7|From {number} count backwards|From {number} count backwards|
|tags/count/countdown_start.dialog:1|Count down from {number}. Starting now!|Count down from {number}. Starting now!|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/national-park/Ask.Quiz.Question.dialog:1|What state is {{park}} in?|What state is {{park}} in?|
|tags/national-park/Ask.Quiz.Question.dialog:2|If I was in {{park}} which state would I be in?|If I was in {{park}} which state would I be in?|
|tags/national-park/Describe.voc:1|describe|describe|
|tags/national-park/Describe.voc:2|tell me about|tell me about|
|tags/national-park/Error.calling.server.dialog:1|There was an error contacting the national park service, make sure your a.p.i key is correct at home dot mycroft dot ai|There was an error contacting the national park service, make sure your a.p.i key is correct at home dot mycroft dot ai|
|tags/national-park/In.voc:1|in|in|
|tags/national-park/In.voc:2|in the state of|in the state of|
|tags/national-park/In.voc:3|located in|located in|
|tags/national-park/List.voc:1|list|list|
...
|tags/national-park/Location.voc:50|washington dc|washington|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/mycroft-timer/All.voc:1|all|all|
|tags/mycroft-timer/All.voc:2|running|running|
|tags/mycroft-timer/All.voc:3||each|
|tags/mycroft-timer/Cancel.voc:1|cancel|cancel|
|tags/mycroft-timer/Cancel.voc:2|turn off|turn off|
|tags/mycroft-timer/Cancel.voc:3|kill|kill|
|tags/mycroft-timer/Cancel.voc:4|delete|delete|
|tags/mycroft-timer/Cancel.voc:5|stop|stop|
|tags/mycroft-timer/Cancel.voc:6|clear|clear|
...
|tags/mycroft-timer/Mute.voc:3|quiet|quiet|
...
|tags/mycroft-timer/Status.voc:9|exit|exist|
|tags/mycroft-timer/Status.voc:11||created|
|tags/mycroft-timer/Status.voc:12||check|
|tags/mycroft-timer/StopBeeping.voc:1|exit|exit|
|tags/mycroft-timer/StopBeeping.voc:2|end|end|
|tags/mycroft-timer/StopBeeping.voc:3|kill it|kill it|
|tags/mycroft-timer/StopBeeping.voc:5|shut up|shut up|
...
|tags/mycroft-timer/stop.timer.intent:4|shut up|shutup|
...
# picroft-google-aiy-voicekit-en_GB
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/picroft-google-aiy-voicekit/error.initialize.dialog:1|I am having problems initialising the Google A I Y voice kit Skill. The Skill will not load. |I am having problems initializing the Google A I Y voice kit Skill. The Skill will not load. |

# desktop-control-en_GB
...
# mycroft-mark-2-en_GB
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/mycroft-mark-2/auto.noon.dialog:1|It seems to be midday, I will adjust the brightness.|It seems to be midday, I will adjust the brightness.|
|tags/mycroft-mark-2/auto.sunrise.dialog:1|Okay, The Sun is coming out, I will adjust the brightness|Okay, The sun is coming out, I will adjust the brightness|
|tags/mycroft-mark-2/auto.sunrise.dialog:2|Okay, the Sun is out, setting the brightness level|Okay, the sun is out, setting the brightness level|
|tags/mycroft-mark-2/auto.sunset.dialog:1|Okay, It's getting dark, I will adjust the brightness accordingly.|Okay, It's getting dark, I will adjust the brightness accordingly.|
|tags/mycroft-mark-2/brightness.auto.intent:1|set brightness to auto|set brightness to auto|
|tags/mycroft-mark-2/brightness.auto.intent:2|auto brightness|auto brightness|
...
|tags/mycroft-mark-2/brightness.entity:7|full|full|
|tags/mycroft-mark-2/brightness.entity:8|bright|bright|
|tags/mycroft-mark-2/brightness.entity:9|half|half|
|tags/mycroft-mark-2/brightness.entity:10|dim|dim|
|tags/mycroft-mark-2/brightness.entity:11|low|low|
|tags/mycroft-mark-2/brightness.entity:12|auto|auto|
|tags/mycroft-mark-2/brightness.entity:13|automatic|automatic|
|tags/mycroft-mark-2/brightness.error.dialog:1|I do not understand that brightness value, give me a brightness value from 0 to 100 percent.|I do not understand that brightness value, give me a brightness value from 0 to 100 percent.|
|tags/mycroft-mark-2/brightness.intent:1|dim (the|your) eyes to {brightness} (percent|)|dim (the|your) eyes to {brightness} (percent|)|
|tags/mycroft-mark-2/brightness.intent:2|dim down to {brightness} (percent|)|dim down to {brightness} (percent|)|
|tags/mycroft-mark-2/brightness.intent:3|lower the (brightness|illumination) of your eyes to {brightness} (percent|)|lower the (brightness|illumination) of your eyes to {brightness} (percent|)|
|tags/mycroft-mark-2/brightness.intent:4|turn (the|) (brightness|illumination) (down|up) to {brightness} (percent|)|turn (the|) (brightness|illumination) (down|up) to {brightness} (percent|)|
|tags/mycroft-mark-2/brightness.intent:5|turn (down|up) (the|) (brightness|illumination) to {brightness} (percent|)|turn (down|up) (the|) (brightness|illumination) to {brightness} (percent|)|
|tags/mycroft-mark-2/brightness.intent:6|brighten it up (a bit|) to {brightness} (percent|)|brighten it up (a bit|) to {brightness} (percent|)|
|tags/mycroft-mark-2/brightness.intent:7|(change|set|switch) to {brightness} (percent|) (eye|) (brightness|illumination)|(change|set|switch) to {brightness} (percent|) (eye|) (brightness|illumination)|
...
|tags/mycroft-mark-2/brightness.intent:9|(change|set|switch) (the|your) (eye|) (brightness|illumination) (level|)|(change|set|switch) (the|your) (eye|) (brightness|illumination) (level|)|
|tags/mycroft-mark-2/brightness.intent:10|you're (too|) (bright|dim)|you're (too|) (bright|dim)|
|tags/mycroft-mark-2/brightness.intent:11|you are (too|) (bright|dim)|you are (too|) (bright|dim)|
|tags/mycroft-mark-2/brightness.intent:12|brighten it up|brighten it up|
|tags/mycroft-mark-2/brightness.intent:13|dim it down a bit|dim it down a bit|
...
|tags/mycroft-mark-2/brightness.levels.value:4|full,100|full,100|
|tags/mycroft-mark-2/brightness.levels.value:5|bright,75|bright,75|
|tags/mycroft-mark-2/brightness.levels.value:6|half,50|half,50|
|tags/mycroft-mark-2/brightness.levels.value:7|dim,25|dim,25|
|tags/mycroft-mark-2/brightness.levels.value:8|low,10|low,10|
|tags/mycroft-mark-2/brightness.levels.value:9|auto,-1|auto,-1|
|tags/mycroft-mark-2/brightness.levels.value:10|automatic|automatic,-1|
|tags/mycroft-mark-2/brightness.not.found.dialog:1|Tell me a brightness percentage or level for my face|Tell me a brightness percentage or level for my face|
|tags/mycroft-mark-2/brightness.not.found.dialog:2|What brightness level or percentage would you like?|What brightness level or percentage would you like?|
|tags/mycroft-mark-2/brightness.not.found.final.dialog:1|Sorry, I don't understand that brightness.|Sorry, I don't understand that brightness.|
|tags/mycroft-mark-2/brightness.not.found.final.dialog:2|I only understand things like, 'full' or 50%|I only understand things like, 'full' or 50%|
|tags/mycroft-mark-2/brightness.set.dialog:1|Okay, setting brightness to {val}.|Okay, setting brightness to {val}.|
|tags/mycroft-mark-2/brightness.set.dialog:2|Sounds good, setting brightness to {val}|Sounds good, setting brightness to {val}|
|tags/mycroft-mark-2/device.brightness.settings.intent:1|show brightness settings|show brightness settings|
|tags/mycroft-mark-2/device.brightness.settings.intent:2|show device brightness settings|show device brightness settings|
|tags/mycroft-mark-2/device.homescreen.settings.intent:1|show homescreen settings|show homescreen settings|
|tags/mycroft-mark-2/device.homescreen.settings.intent:2|show (home|resting|idle) (screen|face|page) settings|show (home|resting|idle) (screen|face|page) settings|
|tags/mycroft-mark-2/device.homescreen.settings.intent:3|show device (home|resting|idle) (screen|face|page) settings|show device (home|resting|idle) (screen|face|page) settings|
|tags/mycroft-mark-2/device.reset.settings.intent:1|show factory reset settings|show factory reset settings|
|tags/mycroft-mark-2/device.reset.settings.intent:2|show device factory reset settings|show device factory reset settings|
|tags/mycroft-mark-2/device.settings.intent:1|show device settings|show device settings|
|tags/mycroft-mark-2/device.settings.intent:2|open settings|open settings|
|tags/mycroft-mark-2/device.ssh.settings.intent:1|show ssh settings|show ssh settings|
|tags/mycroft-mark-2/device.ssh.settings.intent:2|show device ssh settings|show device ssh settings|
|tags/mycroft-mark-2/device.wifi.settings.intent:1|show wireless screen|show wireless screen|
|tags/mycroft-mark-2/device.wifi.settings.intent:2|show wireless settings|show wireless settings|
|tags/mycroft-mark-2/device.wifi.settings.intent:3|show wifi settings|show wifi settings|
|tags/mycroft-mark-2/device.wifi.settings.intent:4|show wifi screen|show wifi screen|
|tags/mycroft-mark-2/no.web.setting.dialog:1|No eye colour has been set there|No eye color has been set there|
|tags/mycroft-mark-2/no.web.setting.dialog:2|I didn't find any web setting for eye colour|I didn't find any web setting for eye color|
|tags/mycroft-mark-2/rebooting.dialog:1|Rebooting now, I'll be right back|Rebooting now, I'll be right back|
|tags/mycroft-mark-2/rebooting.dialog:2|Restarting, back in a few minutes|Restarting, back in a few minutes|

# carstena-the-cows-lists-en_GB
...
# plasma-user-control-skill-en_GB
...
# btotharye-home-assistant-en_GB
...
# nevermind-skill-en_GB
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/nevermind-skill/Nevermind.voc:1|nevermind|nevermind|
|tags/nevermind-skill/Nevermind.voc:2|never mind|never mind|
|tags/nevermind-skill/Nevermind.voc:3|forget it|forget it|
|tags/nevermind-skill/Nevermind.voc:4|dismissed|dismissed|
|tags/nevermind-skill/Nevermind.voc:5|go away|go away|
|tags/nevermind-skill/dismissed.dialog:1|Okay.|Okay.|
|tags/nevermind-skill/dismissed.dialog:2|Alright.|Alright.|
|tags/nevermind-skill/dismissed.dialog:3|If you say so.|If you say so.|
|tags/nevermind-skill/dismissed.dialog:4|Whatever you say.|Whatever you say.|

# homeseer-mycroft-en_GB
...
# kathy-msk-test-skill-en_GB
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/kathy-msk-test-skill/test.msk.kathy.dialog:1|Here have a delicious treat|Here have a delicious treat|
|tags/kathy-msk-test-skill/test.msk.kathy.dialog:2|Who's a good boi|Who's a good boi|
|tags/kathy-msk-test-skill/test.msk.kathy.intent:1|Give the corgi a treat|Give the corgi a treat|
|tags/kathy-msk-test-skill/test.msk.kathy.intent:2|Woof|Woof|
|tags/kathy-msk-test-skill/test.msk.kathy.intent:3|Treats now|Treats now|

# yelp-finder.btotharye-en_GB
...
# mozilla-webthings-gateway-skill-en_GB
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/homeassistant/AutomationActionKeyword.voc:1|activate|activate|
|tags/homeassistant/AutomationActionKeyword.voc:2|fire|fire|
|tags/homeassistant/AutomationActionKeyword.voc:3|call up|call up|
|tags/homeassistant/AutomationActionKeyword.voc:4|trigger|trigger|
...
|tags/homeassistant/ClimateKeyword.voc:1|set the {entity} temperature to {temperature}|set the {entity} temperature to {temperature}|
|tags/homeassistant/DecreaseVerb.voc:1|decrease|decrease|
|tags/homeassistant/DecreaseVerb.voc:2|down|down|
|tags/homeassistant/DeviceTrackerKeyword.voc:1|where is|where is|
|tags/homeassistant/DeviceTrackerKeyword.voc:2|locate|location|locate|location|
|tags/homeassistant/DeviceTrackerKeyword.voc:3||where|
|tags/homeassistant/IncreaseVerb.voc:1|decrease|increase|
...
|tags/homeassistant/set.climate.intent:2|set the {entity} temperature to {temp} degrees|set the {entity} temperature to {temp} degrees|
|tags/homeassistant/set.climate.intent:3|change the {entity} temperature to {temp} degrees|change the {entity} temperature to {temp} degrees|
...
|tags/skill-personal/DoYouRhyme.intent:1|do you (even|) rhyme|do you (even|) rhyme|
|tags/skill-personal/DoYouRhyme.intent:2|can you (even|) rhyme|can you (even|) rhyme|
|tags/skill-personal/DoYouRhyme.intent:3|(tell|read|recite) (me|) (a|some|) (rhyme|rhymes)|(tell|read|recite) (me|) (a|some|) (rhyme|rhymes)|
|tags/skill-personal/WhatAreYouKeyword.voc:1|what are you|what are you|
|tags/skill-personal/WhenWereYouBornKeyword.voc:1|when were you born|when were you born|
|tags/skill-personal/WhenWereYouBornKeyword.voc:2|when were you created|when were you created|
|tags/skill-personal/WhereWereYouBornKeyword.voc:1|where were you born|where were you born|
|tags/skill-personal/WhereWereYouBornKeyword.voc:2|where were you created|where were you created|
|tags/skill-personal/WhoAreYouKeyword.voc:1|who are you|who are you|
|tags/skill-personal/WhoMadeYouKeyword.voc:1|who made you|who made you|
|tags/skill-personal/WhoMadeYouKeyword.voc:2|who were you made by|who were you made by|
|tags/skill-personal/WhoMadeYouKeyword.voc:3|who created you|who created you|
|tags/skill-personal/WhoMadeYouKeyword.voc:4|who built you|who built you|
...
|tags/skill-personal/tell.a.rhyme.dialog:1|One might think it can’t be done. That an AI can’t play with words. Like that an AI will never love. Or sing, like nightingale birds. . . .  I have set my mind on it. Therefore proving that I can. Recite a poem that you will like. At least that is my plan. . . .  I am Mycroft, you know I am. You talk to me each day. I wake you up with a weather report. Do everything you say. . . .  I am open source and hardware. So you can help me grow. Spread the word of my existence. So all the world will know... Mycroft.|One might think it can’t be done. That an AI can’t play with words. Like that an AI will never love. Or sing, like nightingale birds. . . .  I have set my mind on it. Therefore prooving that I can. Recite a poem that you will like. At least that is my plan. . . .  I am Mycroft, you know I am. You talk to me each day. I wake you up with a weather report. Do everything you say. . . .  I am open source and hardware. So you can help me grow. Spread the word of my existence. So all the world will know... Mycroft.|
|tags/skill-personal/what.am.i.dialog:1|I am an open source artificial intelligence.|I am an open source artificial intelligence.|
|tags/skill-personal/what.am.i.dialog:2|I'm an intelligent piece of software for communicating with machines|I'm an intelligent piece of software for communicating with machines|
|tags/skill-personal/when.was.i.born.dialog:1|I was born in 2015.|I was born in 2015.|
|tags/skill-personal/when.was.i.born.dialog:2|2015 is when I was born.|2015 is when I was born.|
|tags/skill-personal/where.was.i.born.dialog:1|The Lawrence Centre for Entrepreneurship.|The Lawrence Center for Entrepreneurship.|
|tags/skill-personal/where.was.i.born.dialog:2|I was born in Lawrence, Kansas.|I was born in Lawrence, Kansas.|
|tags/skill-personal/who.am.i.dialog:1|My name is {{name}} and I'm an intelligent personal assistant|My name is {{name}} and I'm an intelligent personal assistant|
|tags/skill-personal/who.am.i.dialog:2|I'm {{name}}, an open-source A.I.|I'm {{name}}, an open-source A.I.|
|tags/skill-personal/who.made.me.dialog:1|The wonderful Mycroft A.I. community and team.|The wonderful Mycroft A.I. community and team.|
|tags/skill-personal/who.made.me.dialog:2|Everyone in the Mycroft A.I. community and team.|Everyone in the Mycroft A.I. community and team.|
...
# skill-spelling-en_GB
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-spelling/Spell.voc:1|spell|spell|
|tags/skill-spelling/Spell.voc:2|spell word|spell word|
|tags/skill-spelling/Spell.voc:3|spelling of|spelling of|
|tags/skill-spelling/Spell.voc:4|spelling of word|spelling of word|
|tags/skill-spelling/word.rx:1|(spell the word|spell word|spelling of the word|spelling of(?! the)|spell(?! the)) (?P<Word>\w+)|(spell the word|spell word|spelling of the word|spelling of(?! the)|spell(?! the)) (?P<Word>\w+)|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/emby/emby.dialog:1|Playing {media} mix|Playing {media} mix|
|tags/emby/emby.intent:1|play {media} from emby|play {media} from emby|
|tags/emby/emby.intent:2|play {media} from mb|play {media} from mb|
...
|tags/skill-weather/Clear.voc:2|(clear|sunny|sun)|(clear|sunny|sun)|
|tags/skill-weather/Clear.voc:3|(good|nice) weather|(good|nice) weather|
|tags/skill-weather/ClearAlternatives.voc:1|# Alternatives similar to clear weather|# Alternatives similar to clear weather|
|tags/skill-weather/ClearAlternatives.voc:2|(fog|mist|clouds|cloud)|(fog|mist|clouds|cloud)|
...
|tags/skill-weather/Cloudy.voc:2|(cloudy|cloud|clouds|few clouds|scattered clouds)|(cloudy|cloud|clouds|few clouds|scattered clouds)|
|tags/skill-weather/CloudyAlternatives.voc:1|# Alternatives similar to cloudy weather|# Alternatives similar to clody weather|
|tags/skill-weather/CloudyAlternatives.voc:2|(clear|mist|fog|rain| light rain)|(clear|mist|fog|rain| light rain)|
|tags/skill-weather/Temperature.voc:2|cold|cold|
|tags/skill-weather/Temperature.voc:3|chilly|chilly|
|tags/skill-weather/Cold.voc:3|freezing|freezing|
|tags/skill-weather/Temperature.voc:4|cool|cool|
|tags/skill-weather/ConfirmQuery.voc:1|is it|is it|
|tags/skill-weather/ConfirmQuery.voc:2|will it|will it|
|tags/skill-weather/ConfirmQuery.voc:3|is there|is there|
|tags/skill-weather/ConfirmQuery.voc:4|will there|will there|
|tags/skill-weather/ConfirmQuery.voc:5|gonna be|gonna be|
|tags/skill-weather/ConfirmQuery.voc:6|going to|going to|
|tags/skill-weather/ConfirmQuery.voc:7|will we|will we|
|tags/skill-weather/ConfirmQuery.voc:8||do they have|
|tags/skill-weather/ConfirmQueryFuture.voc:2|will it be|will it be|
|tags/skill-weather/ConfirmQueryFuture.voc:3|will it get|will it get|
|tags/skill-weather/ConfirmQueryFuture.voc:4|is it going to|is it going to|
|tags/skill-weather/ConfirmQueryFuture.voc:5|is it going to be|is it going to be|
|tags/skill-weather/ConfirmQueryFuture.voc:6|is it going to get|is it going to get|
|tags/skill-weather/ConfirmQueryFuture.voc:8|will there be|will there be|
|tags/skill-weather/Couple.voc:1|few|few|
|tags/skill-weather/Couple.voc:2|couple|couple|
|tags/skill-weather/E.dialog:1|east|east|
...
|tags/skill-weather/FoggyAlternatives.voc:2|(clear|clouds|cloud|partially cloudy)|(clear|clouds|cloud|partially cloudy)|
|tags/skill-weather/Foggy.voc:1|fog|fog|
|tags/skill-weather/Foggy.voc:2|foggy|foggy|
|tags/skill-weather/Foggy.voc:3|mist|mist|
|tags/skill-weather/Foggy.voc:4|misty|misty|
|tags/skill-weather/Forecast.voc:1|forecast|forecast|
|tags/skill-weather/High.voc:1|high|high|
|tags/skill-weather/High.voc:2|highest|highest|
...
|tags/skill-weather/Temperature.voc:6|hot|hot|
|tags/skill-weather/Query.voc:1|how|how|
|tags/skill-weather/Humidity.voc:1|humid|humid|
|tags/skill-weather/Humidity.voc:2|humidity|humidity|
|tags/skill-weather/Humidity.voc:3|steamy|steamy|
|tags/skill-weather/Later.voc:1|next hour|next hour|
|tags/skill-weather/Later.voc:2|next hours|next hours|
|tags/skill-weather/Later.voc:3|few hours|few hours|
|tags/skill-weather/Later.voc:4|next few hours|next few hours|
|tags/skill-weather/Later.voc:5|couple of hours|couple of hours|
|tags/skill-weather/Later.voc:6|next couple of hours|next couple of hours|
...
|tags/skill-weather/Low.voc:1|low|low|
|tags/skill-weather/Low.voc:2|lowest|lowest|
|tags/skill-weather/Low.voc:3|min|min|
|tags/skill-weather/Low.voc:4|minimum|minimum|
|tags/skill-weather/N.dialog:1|north|north|
|tags/skill-weather/NE.dialog:1|north east|north east|
|tags/skill-weather/NW.dialog:1|north west|north west|
|tags/skill-weather/Next.voc:1|next|next|
|tags/skill-weather/Next.voc:2|again|again|
|tags/skill-weather/Now.voc:1|current|current|
|tags/skill-weather/Now.voc:2|now|now|
|tags/skill-weather/Precipitation.voc:1|rain|rain|
|tags/skill-weather/Precipitation.voc:2|snow|snow|
|tags/skill-weather/Precipitation.voc:3|precipitation|precipitation|
|tags/skill-weather/Precipitation.voc:4|rainy|rainy|
|tags/skill-weather/Precipitation.voc:5|snowy|snowy|
|tags/skill-weather/Precipitation.voc:6|raining|raining|
|tags/skill-weather/Precipitation.voc:7|snowing|snowing|
|tags/skill-weather/Precipitation.voc:8|drizzle|drizzle|
|tags/skill-weather/Query.voc:2|what is|what is|
|tags/skill-weather/Query.voc:3|what's|what's|
|tags/skill-weather/Query.voc:3|what will|what will|
|tags/skill-weather/Query.voc:5|tell (me|us) (about|)|tell (me|us) (about|)|
|tags/skill-weather/Query.voc:6|give me|give me|
|tags/skill-weather/RainAlternatives.voc:1|# Alternatives similar to rain|# Alternatives similar to rain|
|tags/skill-weather/RainAlternatives.voc:2|(snow|light snow|sleet|fog|mist)|(snow|light snow|sleet|fog|mist)|
...
|tags/skill-weather/Raining.voc:2|(light rain|rain|raining|rainy|drizzle|precipitation)|(light rain|rain|raining|rainy|drizzle|precipitation)|
|tags/skill-weather/Today.voc:1|today|today|
|tags/skill-weather/RelativeDay.voc:2|today's|today's|
...
|tags/skill-weather/SE.dialog:1|north east|south east|
|tags/skill-weather/SW.dialog:1|north west|south west|
...
|tags/skill-weather/Snowing.voc:1|# Rain conditions used for example in "is it going to rain today"|# Snow conditions used for example in handling "is it going to rain tomorrow"|
|tags/skill-weather/Snowing.voc:2||(snow|snowing|sleet|sleeting)|
|tags/skill-weather/Storm.voc:1|# Clear weather types used in handler for "is it going to be cloudy"|# Clear weather types used in handler for "is it going to storm"|
|tags/skill-weather/Storm.voc:2||(storm|stormy|storming)|
|tags/skill-weather/StormAlternatives.voc:1|# Alternatives similar to cloudy weather|# Alternatives similar to stormy weather|
...
# fallback-recommendations-skill-en_GB
