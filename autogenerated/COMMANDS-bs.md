...
# yelp-finder.btotharye-bs
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/yelp-finder.btotharye/MoreInformation.voc:1|vise informacija|more info|
|tags/yelp-finder.btotharye/MoreInformation.voc:2|vise informacija|more information|
|tags/yelp-finder.btotharye/NextResult.voc:1|sledeci restoran|next restaurant|
|tags/yelp-finder.btotharye/NextResult.voc:2|sledeci rezultat|next result|
|tags/yelp-finder.btotharye/PrevResult.voc:1|prethodni restoran|previous restaurant|
|tags/yelp-finder.btotharye/PrevResult.voc:2|prethodni rezultat|previous result|
|tags/yelp-finder.btotharye/Sendinfo.voc:1|posalji informacije|send info|
|tags/yelp-finder.btotharye/Sendinfo.voc:2|vise informacija|send information|
...
|tags/btotharye-home-assistant/IncreaseVerb.voc:1|povećati|increase|
...
|tags/btotharye-home-assistant/LightsKeyword.voc:1|svijetla|light|
...
|tags/btotharye-home-assistant/LightsKeyword.voc:6|žarulja|bulbs|
|tags/btotharye-home-assistant/LightsKeyword.voc:7||l.e.d.|
|tags/btotharye-home-assistant/LightsKeyword.voc:8|upaliti|turn on|
|tags/btotharye-home-assistant/LightsKeyword.voc:9|upaliti|turn off|
...
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:7|koje je trenutno|what is the current|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:8|koje je trenutno|what is current|
...
|tags/btotharye-home-assistant/automation.rx:1|(aktivirati|vatra|okidac|pozvat) (?P<Entity>.*)|(activate|fire|trigger|call up) (?P<Entity>.*)|
|tags/btotharye-home-assistant/dimming.rx:1|(postavi) (?:osvjetljenje)?(?P<Entity>.*) (u) (?P<BrightnessValue>\d*)(?: procenat)?|(set) (?:brightness of )?(?P<Entity>.*) (to) (?P<BrightnessValue>\d*)(?: percent)?|
|tags/btotharye-home-assistant/dimming.rx:2|(tamnije|svjetlije|povecati|smanjiti) (?:osvjetljenje od )?(?P<Entity>.*?) (?:od)? (?P<BrightnessValue>\d*)?(?: postotak)?|(dim|brighten|increase|decrease) (?:brightness of )?(?P<Entity>.*?) (?:by)? (?P<BrightnessValue>\d*)?(?: percent)?|
...
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:3|{{dev_name}} je pokrenuto|{{dev_name}} was triggered.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:4|{{dev_name}} je aktiviran.|{{dev_name}} was activated.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:5|aktivno {{dev_name}}.|activated {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.brightness.badreq.dialog:1|molimo da zahtjevate jacinu osvjetljenja izmedju 0 i 100.|please request a brightness level between 0 and 100.|
|tags/btotharye-home-assistant/homeassistant.brightness.badreq.dialog:2|koliko svijetlo ? Mozete da birata izmedju 0 i 100.|how bright? you can choose a level from 0 to 100.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.dimmable.dialog:1|Ne moze {{dev_name}}. Ne podrzava.|Can not dim {{dev_name}}. It is not dimmable.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.off.dialog:1|Ne moze {{dev_name}}. Iskljuceno.|Can not dim {{dev_name}}. It is off.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.off.dialog:2|Ne mogu zamračiti {{dev_name}}. Molimo prvo upalite.|Can not dim {{dev_name}}. Please turn it on before.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.off.dialog:3|{{dev_name}} se ne može zamračiti. Samo se uključeni uređaji mogu zamračiti.|{{dev_name}} can not be dimmed. Only devices that are turned on can be.|
|tags/btotharye-home-assistant/homeassistant.brightness.decreased.dialog:1||Dimmed {{dev_name}} to {{brightness}} percent.|
|tags/btotharye-home-assistant/homeassistant.brightness.decreased.dialog:2|zamračeno {{dev_name}}.|Dimmed {{dev_name}}.|
...
|tags/btotharye-home-assistant/homeassistant.device.toggle.dialog:2|{{dev_name}} je pokrenuto|{{dev_name}} was toggled.|
...
# mozilla-webthings-gateway-skill-bs
...
# fallback-recommendations-skill-bs
...
# plasma-mycroft-applet-control-bs
...
# picroft-google-aiy-voicekit-bs
...
|tags/00__skill_template/Hello.voc:2|pozdravi|greetings|
...
|tags/00__skill_template/count.is.now.dialog:1|Sada je broj|The count is now {{count}}|
|tags/00__skill_template/count.is.now.dialog:2|Dosli smo do|We are now up to {{count}}|
|tags/00__skill_template/hello.world.dialog:1|Cao|Hello|
|tags/00__skill_template/hello.world.dialog:2|Cao i vama|Hi to you too|
