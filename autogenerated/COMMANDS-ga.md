...
|tags/fallback-unknown/question.voc:4|cad a|what does|
...
# picroft-google-aiy-voicekit-ga
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/fallback-aiml/Memory.voc:1|inchinn|brain|
|tags/fallback-aiml/Memory.voc:2|cuimhne|memory|
|tags/fallback-aiml/Memory.voc:3|aigne|mind|
|tags/fallback-aiml/Memory.voc:4|gach rud|everything|
|tags/fallback-aiml/Reset.voc:1|déan dearmad|forget|
|tags/fallback-aiml/Reset.voc:2|athshocraigh|reset|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/desktop-control/CopyKeyword.voc:1|cóipeáil go dtí an ghearrthaisce|copy to clipboard|
|tags/desktop-control/CopyKeyword.voc:2|cóipeáil|copy|
|tags/desktop-control/CutKeyword.voc:1|cóipeáil go dtí an ghearrthaisce|cut to clipboard|
...
|tags/desktop-control/PasteKeyword.voc:2|greamaigh|paste|
|tags/desktop-control/ScreenResKeyword.voc:1|taifeach an scáileáin|screen resolution|
|tags/desktop-control/SelectAllKeyword.voc:1|roghnaigh uile|select all|
|tags/desktop-control/Text.rx:1|(clóscríobh) (?P<Text>.*)|(type) (?P<Text>.*)|
|tags/desktop-control/TypeKeyword.voc:1|clóscríobh|type|
|tags/desktop-control/absolutemousemove.dialog:1|Ag bogadh na luchóige go {{x}} agus {{y}}|Moving the mouse to {{x}} and {{y}}|
|tags/desktop-control/absolutemousemove.intent:1|bog an luchóg go {x} agus {y} |move mouse to {x} and {y} |
|tags/desktop-control/down.entity:1|síos |down |
...
|tags/desktop-control/key.entity:27|síos |down|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-stop/StopKeyword.voc:1|stad|stop|
|tags/skill-stop/StopKeyword.voc:2|ciúnas|silence|
|tags/skill-stop/StopKeyword.voc:3|dún do chlab|shut up|
...
|tags/skill-stop/Reboot.voc:2|atosaigh|restart|
|tags/skill-stop/Shutdown.voc:1|múch|shutdown|
|tags/skill-stop/Shutdown.voc:2|múch|shut down|
...
# plasma-mycroft-applet-control-ga
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/decide-skill/Choice1.rx:1|(.* (?P<Choice1>.*) nó (?P<dummy>.*))|(.* (?P<Choice1>.*) or (?P<dummy>.*))|
|tags/decide-skill/Choice1.rx:2|idir ((?P<Choice1>.*) agus (?P<dummy>.*))|between ((?P<Choice1>.*) and (?P<dummy>.*))|
|tags/decide-skill/Choice2.rx:1|(.* (?P<dummy2>.*) nó (?P<Choice2>.*))|(.* (?P<dummy2>.*) or (?P<Choice2>.*))|
|tags/decide-skill/Choice2.rx:2|idir ((?P<dummy2>.*) agus (?P<Choice2>.*))|between ((?P<dummy2>.*) and (?P<Choice2>.*))|
|tags/decide-skill/DecideKeyword.voc:1|Cinn|Decide|
|tags/decide-skill/DecideKeyword.voc:2|Cad ba cheart dom a chaitheamh|What should I wear|
|tags/decide-skill/DecideKeyword.voc:3|Cad ba cheart dom a ithe|What should I eat|
|tags/decide-skill/DecideKeyword.voc:4|cluiche|game|
...
# mozilla-webthings-gateway-skill-ga
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/game-zork/Delete.voc:1|scrios|delete|
...
|tags/game-zork/Play.voc:1|seinn|play|
|tags/game-zork/Play.voc:2|Téigh go|goto|
|tags/game-zork/Play.voc:3|Téigh go|go to|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/homeassistant/AutomationActionKeyword.voc:1|gníomhachtaigh|activate|
...
|tags/homeassistant/AutomationActionKeyword.voc:5|radharc|scene|
...
|tags/homeassistant/DecreaseVerb.voc:2|síos|down|
|tags/homeassistant/DeviceTrackerKeyword.voc:1|cá bhfuil|where is|
|tags/homeassistant/DeviceTrackerKeyword.voc:2|aimsigh|suíomh|locate|location|
...
|tags/homeassistant/LightsKeyword.voc:1|soilse|light|
|tags/homeassistant/LightsKeyword.voc:2|soilse|lights|
...
|tags/homeassistant/LightsKeyword.voc:8|múch|turn on|
|tags/homeassistant/LightsKeyword.voc:9|múch|turn off|
|tags/homeassistant/LightsKeyword.voc:10|scoránaigh|toggle|
...
|tags/homeassistant/SensorStatusKeyword.voc:5|luach|value|
|tags/homeassistant/SensorStatusKeyword.voc:6|léigh os ard|read out|
...
|tags/homeassistant/SetVerb.voc:1|socraigh|set|
|tags/homeassistant/SwitchActionKeyword.voc:1|cas|turn|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/national-park/Ask.Quiz.Question.dialog:1|Cén stát a bhfuil {{park}} lonnaithe ann?|What state is {{park}} in?|
...
|tags/national-park/In.voc:3|lonnaithe i|located in|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/speedtest/Run.voc:1|rith|run|
|tags/speedtest/Speedtest.voc:1|tástáil luais|speedtest|
|tags/speedtest/Speedtest.voc:2|tástáil luais|speed test|
...
# yelp-finder.btotharye-ga
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/yelp-finder.btotharye/MoreInformation.voc:1|tuilleadh eolais|more info|
|tags/yelp-finder.btotharye/MoreInformation.voc:2|tuilleadh eolais|more information|
|tags/yelp-finder.btotharye/NextResult.voc:1|an chéad bhialann eile|next restaurant|
|tags/yelp-finder.btotharye/NextResult.voc:2|an chéad toradh eile|next result|
|tags/yelp-finder.btotharye/PrevResult.voc:1|an bhialann roimhe|previous restaurant|
|tags/yelp-finder.btotharye/PrevResult.voc:2||previous result|
|tags/yelp-finder.btotharye/Sendinfo.voc:1||send info|
|tags/yelp-finder.btotharye/Sendinfo.voc:2|tuilleadh eolais|send information|
|tags/yelp-finder.btotharye/Sendinfo.voc:3||send it to me|
|tags/yelp-finder.btotharye/Sendinfo.voc:4|seol na torthaí chugam|send me the results|
...
|tags/yelp-finder.btotharye/YelpPlace.voc:1|bialann|restaurant|
|tags/yelp-finder.btotharye/YelpPlace.voc:2|áit éigin le hithe|place to eat|
...
|tags/yelp-finder.btotharye/YelpPlace.voc:6|gar dom|near me|
|tags/yelp-finder.btotharye/YelpPlace.voc:7|in aice liom|by me|
|tags/yelp-finder.btotharye/YelpPlace.voc:8|in aice láithreach|nearby|
...
|tags/yelp-finder.btotharye/startover.dialog:1|Níl aon torthaí eile ann, ar mhaith leat iad a chloisteáil arís?|There are no more results, would you like to hear them again?|
...
# fallback-recommendations-skill-ga
...
|tags/fallback-recommendations-skill/skill.download.refused.dialog:1|Tá go maith.|Okay.|
|tags/fallback-recommendations-skill/skill.download.refused.dialog:2|Ceart go leor.|Alright.|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/laugh/Laugh.intent:1|déan gáire ar nós alexa|laugh like alexa|
|tags/laugh/Laugh.intent:2|an féidir leat gáire|can you laugh|
|tags/laugh/Laugh.intent:3|urchóideach (gáire|ag gáire|gáire)|evil (laugh|laughing|laughs|laughter)|
|tags/laugh/Laugh.voc:1||laugh|
|tags/laugh/Laugh.voc:2|ag gáire|laughing|
|tags/laugh/Laugh.voc:3||laughs|
|tags/laugh/Laugh.voc:4|gáire|laughter|
|tags/laugh/RandomLaugh.intent:1|gáir go fánach|laugh randomly|
|tags/laugh/RandomLaugh.intent:2|urchóideach (gáire|ag gáire|gáire)|trigger random (laugh|laughing|laughs|laughter)|
|tags/laugh/RandomLaugh.intent:3|urchóideach (gáire|ag gáire|gáire)|random (laugh|laughing|laughs|laughter)|
|tags/laugh/Stop.voc:1|tobscoir|abort|
|tags/laugh/Stop.voc:2|cealaigh|cancel|
|tags/laugh/Stop.voc:3|stad|stop|
|tags/laugh/cancel.dialog:1|cuireadh deireadh leis an ngáire|laughing stopped|
|tags/laugh/cancel.dialog:2|ní dhéanfaidh mé gáire a thuilleadh|i wont laugh anymore|
|tags/laugh/cancel_fail.dialog:1|nílim ag gáire|i am not laughing|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/email-skill/already.looking.for.all.dialog:1|Táim sa tóir ar ríomhphoist nua cheana féin|I'm already looking for new mail|
|tags/email-skill/already.looking.for.all.dialog:2|Táim sa tóir ar ríomhphoist nua cheana féin|I've already been looking for new mail|
|tags/email-skill/already.looking.for.all.dialog:3|Táim sa tóir ar ríomhphoist nua cheana féin|I am already looking for new e mail|
...
|tags/email-skill/notify.read.email.dialog:1|Tá {size} teachtaireacht ríomhphoist nua agat, ar mhaith leat iad a chloisteáil|You have {size} new email, do you want to hear them|
|tags/email-skill/notify.read.email.dialog:2|Tá {size} teachtaireacht ríomhphoist nua agat, ar mhaith leat iad a chloisteáil|There are {size} new email Do you want to hear them|
|tags/email-skill/notify.read.email.dialog:3||Do you want to hear your {size} emails|
|tags/email-skill/poll.emails.not.started.dialog:1|Táim sa tóir ar ríomhphoist nua cheana féin|I'm not looking for new mail|
...
|tags/email-skill/start.poll.email.dialog:1|Tabharfaidh mé fógra duit nuair a bheidh ríomhphoist nua ann|I will notify you of new mail|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/homeseer-mycroft/AllKeyword.voc:1|uile|all|
...
|tags/00__skill_template/Hello.voc:1|Dia duit|hello|
...
|tags/00__skill_template/hello.world.dialog:1|Dia duit|Hello|
|tags/00__skill_template/hello.world.dialog:2|Dia is mhuire duit|Hi to you too|
