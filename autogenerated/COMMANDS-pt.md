...
|tags/spotify-skill/AvailableDevices.dialog:1|Eu vejo o dispositivo Spotify com o nome: {{devices}}|I see the Spotify devices named: {{devices}}|
|tags/spotify-skill/AvailableDevices.dialog:2|Eu vejo o dispositivo Spotify com o nome: {{devices}}|I've found the Spotify devices named: {{devices}}|
...
|tags/email-skill/check.email.intent:1|Verifica o meu email.|check my email|
|tags/email-skill/check.email.intent:2|Verifica o meu email.|check my mail|
|tags/email-skill/check.email.intent:3|Tenho algum email novo?|do i have any new mail|
|tags/email-skill/check.email.intent:4|Tenho algum email?|do I have any email|
|tags/email-skill/check.email.intent:5|Tenho emails novos?|do i have any new emails|
...
|tags/email-skill/error.getting.mail.dialog:1|Ouve um erro ao tentar puchar o teu email. Tenta verificar as tuas credenciais e informação do servidor.|There was an error getting your email Try checking your credentials and server information|
...
|tags/email-skill/no.new.email.dialog:7|Tenho algum email novo?|You have no new mail|
|tags/email-skill/no.new.email.dialog:8|Tenho emails novos?|You have no new email|
...
# picroft-google-aiy-voicekit-pt
...
# btotharye-home-assistant-pt
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:1|Activar|activate|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:2|Fogo|fire|
...
|tags/btotharye-home-assistant/DeviceTrackerKeyword.voc:1|onde|where|
|tags/btotharye-home-assistant/DeviceTrackerKeyword.voc:2|Localização|locate|location|
|tags/btotharye-home-assistant/IncreaseVerb.voc:1|Aumentar|increase|
|tags/btotharye-home-assistant/IncreaseVerb.voc:2|cima|up|
...
|tags/btotharye-home-assistant/LightsKeyword.voc:2|Chuviscos|lights|
...
|tags/btotharye-home-assistant/LightsKeyword.voc:5|bolha|bulb|
|tags/btotharye-home-assistant/LightsKeyword.voc:6|bolhas|bulbs|
...
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:7|qual é o actual|what is the current|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:8|qual é actual|what is current|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:9|diz-me o actual|tell me the current|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:10|diz-me actual|tell me current|
|tags/btotharye-home-assistant/SetVerb.voc:1|pôr|set|
|tags/btotharye-home-assistant/SwitchActionKeyword.voc:1|rodar|turn|
|tags/btotharye-home-assistant/SwitchActionKeyword.voc:2|interruptor|switch|
|tags/btotharye-home-assistant/automation.rx:1|(Chamada|Entidade|Activo)<Entity>|(activate|fire|trigger|call up) (?P<Entity>.*)|
|tags/btotharye-home-assistant/dimming.rx:1|(coloca|colocar) o (?:brilho de )?(?P<Entity>.*) (a) (?P<BrightnessValue>\d*)(?:porcento)?|(set) (?:brightness of )?(?P<Entity>.*) (to) (?P<BrightnessValue>\d*)(?: percent)?|
|tags/btotharye-home-assistant/dimming.rx:2|(escurecer|clearear|aumentar|diminuir) (?:luminosidade de )?(?P<Entity>.*?) (?:por)? (?P<BrightnessValue>\d*)?(?: %)?|(dim|brighten|increase|decrease) (?:brightness of )?(?P<Entity>.*?) (?:by)? (?P<BrightnessValue>\d*)?(?: percent)?|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:1|automação {{dev_name}} acionada.|triggered automation {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:2|{{dev_name}} accionado|triggered {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:3|{{dev_name}} foi accionado.|{{dev_name}} was triggered.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:4|{{dev_name}} foi activado.|{{dev_name}} was activated.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:5|ativado|activated {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.brightness.badreq.dialog:1|por favor pede um nível de brilho entre zero e cem.|please request a brightness level between 0 and 100.|
|tags/btotharye-home-assistant/homeassistant.brightness.badreq.dialog:2|Quão brilhante? pode escolher um nível de 0 a 100.|how bright? you can choose a level from 0 to 100.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.dimmable.dialog:1|Não consigo atenuar  {{dev_name}}. Não é atenuável.|Can not dim {{dev_name}}. It is not dimmable.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.off.dialog:1|Não consigo atenuar {{dev_name}}. Está desligado.|Can not dim {{dev_name}}. It is off.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.off.dialog:2|Não é possível escurecer {{dev_name}}. Por favor, ligue-o primeiro.|Can not dim {{dev_name}}. Please turn it on before.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.off.dialog:3|Não é possível escurecer {{dev_name}}. Só equipamentos ligados podem ser escurecidos.|{{dev_name}} can not be dimmed. Only devices that are turned on can be.|
|tags/btotharye-home-assistant/homeassistant.brightness.decreased.dialog:1|{{dev_name}} escurecido para {{brightness}} por cento.|Dimmed {{dev_name}} to {{brightness}} percent.|
|tags/btotharye-home-assistant/homeassistant.brightness.decreased.dialog:2|Atenuado {{dev_name}}.|Dimmed {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.brightness.dimmed.dialog:1|Ajusta a luminosidade de {{dev_name}} para {{brightness}} por cento.|Set the brightness of {{dev_name}} to {{brightness}} percent.|
|tags/btotharye-home-assistant/homeassistant.brightness.increased.dialog:1|Luminosidade de {{dev_name}} aumentada para {{brightness}} por cento.|Increased brightness of {{dev_name}} to {{brightness}} percent.|
|tags/btotharye-home-assistant/homeassistant.brightness.increased.dialog:2|Brilho de {{dev_name}} aumentado|Increased brightness of {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.already.dialog:1|{{dev_name}} está {{action}}.|{{dev_name}} already {{action}}.|
|tags/btotharye-home-assistant/homeassistant.device.already.dialog:2|Nenhuma alteração foi feita ao {{dev_name}}.|No changes made to {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.off.dialog:1|{{dev_name}} desligado.|turned off {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.off.dialog:2|{{dev_name}} desligado.|turned {{dev_name}} off.|
|tags/btotharye-home-assistant/homeassistant.device.off.dialog:3|{{dev_name}} encontra-se agora desligado.|{{dev_name}} is now off.|
|tags/btotharye-home-assistant/homeassistant.device.on.dialog:1|{{dev_name}} foi ligado.|turned on {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.on.dialog:2|(o|a) {{dev_name}} foi ligado.|{{dev_name}} was turned on.|
|tags/btotharye-home-assistant/homeassistant.device.on.dialog:3|(o|a) {{dev_name}} foi ligado.|turned {{dev_name}} on.|
|tags/btotharye-home-assistant/homeassistant.device.toggle.dialog:1|{{dev_name}} accionado|toggled {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.toggle.dialog:2|{{dev_name}} foi accionado.|{{dev_name}} was toggled.|
|tags/btotharye-home-assistant/homeassistant.device.unknown.dialog:1|Peço desculpa, mas não consigo encontrar o Home Assistant|Sorry, I can't find the Home Assistant entity |
|tags/btotharye-home-assistant/homeassistant.device.unknown.dialog:2|Entidade|Entity |
|tags/btotharye-home-assistant/homeassistant.device.unknown.dialog:3|Desculpa, entidade|Sorry, entity |
|tags/btotharye-home-assistant/homeassistant.device.unknown.dialog:4|Desculpa, não consegui encontrar|Excuse me, I wasn't able to find |
|tags/btotharye-home-assistant/homeassistant.error.offline.dialog:1|O servidor do Home Assistant parece estar offline.|The Home assistant server appears to be offline.|
|tags/btotharye-home-assistant/homeassistant.error.offline.dialog:2|Não foi possível comunicar com o servidor do Home Assistant.|Couldn't reach the home assistant server.|
|tags/btotharye-home-assistant/homeassistant.error.offline.dialog:3|O servidor do Home Assistant não está a responder.|The home assistant server did not respond.|
|tags/btotharye-home-assistant/homeassistant.error.setup.dialog:1|Por favor, configura as definições das skills do Home Assistant em home ponto mycroft ponto ai.|Please configure the home assistant skill settings at home dot mycroft dot ai.|
|tags/btotharye-home-assistant/homeassistant.error.sorry.dialog:1|Não percebo o que queres que eu faça.|I don't know what you want me to do.|
|tags/btotharye-home-assistant/homeassistant.error.sorry.dialog:2|Não percebi como falar com o Home Assistant.|Couldn't figure out how to talk to Home Assistant.|
|tags/btotharye-home-assistant/homeassistant.error.sorry.dialog:3|Não percebo o que me estás a perguntar.|I don't understand what you are asking.|
|tags/btotharye-home-assistant/homeassistant.sensor.dialog:1|O {{dev_name}} está {{value}} {{unit}}.|Currently {{dev_name}} is {{value}} {{unit}}.|
...
|tags/btotharye-home-assistant/homeassistant.sensor.dialog:4|O {{dev_name}} está {{value}} {{unit}}.|{{dev_name}} is {{value}} {{unit}}.|
...
|tags/bark-skill/bark.intent:1|Ladra|Bark|
|tags/bark-skill/bark.intent:2|Como faz o cão|What does a dog say|
|tags/bark-skill/bark.intent:3|Olha aquele gato|Look at that cat|
|tags/bark-skill/bark.intent:4|O carteiro chegou|Mailman is here|

# tronald-dump-skill-pt
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/homeassistant/AutomationActionKeyword.voc:1|activar|activate|
|tags/homeassistant/AutomationActionKeyword.voc:2|dispara|fire|
|tags/homeassistant/AutomationActionKeyword.voc:3|chama|call up|
|tags/homeassistant/AutomationActionKeyword.voc:4|gatilho|trigger|
|tags/homeassistant/AutomationActionKeyword.voc:5|cenário|scene|
...
|tags/homeassistant/ClimateKeyword.voc:1|defina a temperatura da {entity} para {temperature}|set the {entity} temperature to {temperature}|
|tags/homeassistant/DecreaseVerb.voc:1|diminui|decrease|
|tags/homeassistant/DecreaseVerb.voc:2|descer|down|
...
|tags/homeassistant/IncreaseVerb.voc:1|aumenta|increase|
|tags/homeassistant/IncreaseVerb.voc:2|para cima|up|
|tags/homeassistant/LightBrightenVerb.voc:1|clarear|mais claro|claro|aumentar|brighten|brighter|bright|up|
|tags/homeassistant/LightDimVerb.voc:1|obscurecer|obscuro|escuro|escurecer|mais baixo|baixo|dim|dimmer|dark|darken|lower|down|
|tags/homeassistant/LightsKeyword.voc:1|leve|light|
|tags/homeassistant/LightsKeyword.voc:2|luzes|lights|
|tags/homeassistant/LightsKeyword.voc:3|lampada|lamp|
|tags/homeassistant/LightsKeyword.voc:4|lampadas|lamps|
|tags/homeassistant/LightsKeyword.voc:5|lampada|bulb|
|tags/homeassistant/LightsKeyword.voc:6|lampadas|bulbs|
|tags/homeassistant/LightsKeyword.voc:7|led.|l.e.d.|
|tags/homeassistant/LightsKeyword.voc:8|acende|turn on|
...
|tags/homeassistant/SensorStatusKeyword.voc:2|estados|status|
...
|tags/homeassistant/SensorStatusKeyword.voc:6|leia|read out|
|tags/homeassistant/SensorStatusKeyword.voc:7|actualmente qual é|what is the current|
|tags/homeassistant/SensorStatusKeyword.voc:8|o que é actual|what is current|
|tags/homeassistant/SensorStatusKeyword.voc:9|diga-me o actual|tell me the current|
|tags/homeassistant/SensorStatusKeyword.voc:10|diga-me actualmente|tell me current|
|tags/homeassistant/SensorStatusKeyword.voc:11|dá-me o valor de.|give me the value of|
|tags/homeassistant/SensorStatusKeyword.voc:12|qual é o valor do termostato|what is the value of thermostat|
|tags/homeassistant/SetVerb.voc:1|definir|set|
|tags/homeassistant/SwitchActionKeyword.voc:1|virar|turn|
|tags/homeassistant/SwitchActionKeyword.voc:2|trocar|switch|
|tags/homeassistant/automation.rx:1|(activar|dispara|desencadea|chama) (?P<Entity>.*)|(activate|fire|trigger|call up) (?P<Entity>.*)|
...
|tags/homeassistant/homeassistant.automation.trigger.dialog:1|desencadeando a automação {{dev_name}}.|triggered automation {{dev_name}}.|
|tags/homeassistant/homeassistant.automation.trigger.dialog:2|desencadeando {{dev_name}}.|triggered {{dev_name}}.|
|tags/homeassistant/homeassistant.automation.trigger.dialog:3|{{dev_name}} foi desencadeada.|{{dev_name}} was triggered.|
|tags/homeassistant/homeassistant.automation.trigger.dialog:4|{{dev_name}} está activo.|{{dev_name}} was activated.|
|tags/homeassistant/homeassistant.automation.trigger.dialog:5|activei {{dev_name}}.|activated {{dev_name}}.|
...
|tags/homeassistant/homeassistant.brightness.cantdim.dimmable.dialog:1|Impossível escurecer {{dev_name}}. Não é regulável.|Can not dim {{dev_name}}. It is not dimmable.|
|tags/homeassistant/homeassistant.brightness.cantdim.off.dialog:1|Impossível escurecer {{dev_name}}. Está desligada.|Can not dim {{dev_name}}. It is off.|
|tags/homeassistant/homeassistant.brightness.cantdim.off.dialog:2|Impossível escurecer {{dev_name}}. Acenda-a antes por favor.|Can not dim {{dev_name}}. Please turn it on before.|
|tags/homeassistant/homeassistant.brightness.cantdim.off.dialog:3|{{dev_name}} não dá para escurecer. Apenas dispositivos ligados podem.|{{dev_name}} can not be dimmed. Only devices that are turned on can be.|
...
|tags/homeassistant/homeassistant.brightness.dimmed.dialog:1|Define o brilho de {{dev_name}} para {{brightness}} por cento|Set the brightness of {{dev_name}} to {{brightness}} percent.|
|tags/homeassistant/homeassistant.brightness.increased.dialog:1|Aumentado o brilho do {{dev_name}} para {{brightness}} por cento.|Increased brightness of {{dev_name}} to {{brightness}} percent.|
...
|tags/homeassistant/homeassistant.device.already.dialog:2|Não alterei {{dev_name}}.|No changes made to {{dev_name}}.|
...
|tags/homeassistant/homeassistant.device.unknown.dialog:1|Desculpe, não encontro a entidade "{{dev_name}}" no Assistente Doméstico|Sorry, I can't find the Home Assistant entity "{{dev_name}}".|
|tags/homeassistant/homeassistant.device.unknown.dialog:2|Entidade "{{dev_name}}" não encontrada.|Entity "{{dev_name}}" could not be found.|
...
|tags/homeassistant/homeassistant.error.dialog:1|O acesso ao servidor do assistente doméstico em {{url}} falhou.|Access to home assistant server at {{url}} failed.|
|tags/homeassistant/homeassistant.error.http.dialog:1|O servidor do assistente doméstico não respondeu por causa de {{code}} {{reason}}|The home assistant server failed to respond because of {{code}} {{reason}}|
|tags/homeassistant/homeassistant.error.invalidurl.dialog:1|O endereço {{url}} não hospeda um servidor assistente doméstico válido|The url {{url}} does not host a valid home assistant server|
|tags/homeassistant/homeassistant.error.needurl.dialog:1|Precisas introduzir um URL no Microsoft home.|You need to in put a URL in Mycroft home.|
|tags/homeassistant/homeassistant.error.needurl.dialog:2|Precisas definir a skill metendo um URL no Mycroft home.|You need to setup the skill by putting a URL in Mycroft home.|
|tags/homeassistant/homeassistant.error.needurl.dialog:3|Para utilizar esta habilidade, mete um URL no Mycroft home.|To use this skill, put a URL in Mycroft home.|
|tags/homeassistant/homeassistant.error.offline.dialog:1|O servidor do assistente doméstico parece estar desactivado.|The Home assistant server appears to be offline.|
|tags/homeassistant/homeassistant.error.offline.dialog:2|Não foi possível aceder ao assistente doméstico.|Couldn't reach the home assistant server.|
|tags/homeassistant/homeassistant.error.offline.dialog:3|O assistente doméstico não respondeu.|The home assistant server did not respond.|
|tags/homeassistant/homeassistant.error.setup.dialog:1|Por favor, configure a habilidade do assistente domestico em home ponto mycroft pont ai.|Please configure the home assistant skill settings at home dot mycroft dot ai.|
...
|tags/homeassistant/homeassistant.error.ssl.dialog:1|A configuração para S S L no servidor assistente doméstico é invalida. |The configuration for S S L on the home assistant server is invalid. |
|tags/homeassistant/homeassistant.error.wrong_password.dialog:1|O servidor assistente doméstico não aceitou a senha configurada.|The home assistant server did not accept the configured password.|
|tags/homeassistant/homeassistant.sensor.dialog:1|Actualmente o {{dev_name}} é {{value}} {{unit}}.|Currently {{dev_name}} is {{value}} {{unit}}.|
|tags/homeassistant/homeassistant.sensor.dialog:2|{{dev_name}} está: {{value}} {{unit}}.|{{dev_name}} has the state: {{value}} {{unit}}.|
|tags/homeassistant/homeassistant.sensor.dialog:3|{{dev_name}} está a {{value}} {{unit}} neste momento.|{{dev_name}} is {{value}} {{unit}} at the moment.|
|tags/homeassistant/homeassistant.sensor.dialog:4|{{dev_name}} está a {{value}} {{unit}}.|{{dev_name}} is {{value}} {{unit}}.|
...
|tags/homeassistant/sensor.rx:6|(Como|Qual) é a (corrente )?(?P<Entity>.*) (status|state|value|sensor)|(how|what) is the (current )?(?P<Entity>.*) (status|state|value|sensor)|
|tags/homeassistant/sensor.rx:7|(Como|Qual) é a (corrente )?(?P<Entity>.*) (status|state|value|sensor)|tell me (the|our) (current )?(?P<Entity>.*) (status|state|value|sensor)|
...
|tags/homeassistant/set.climate.intent:2|defina a temperatura da {entity} para {temp} graus|set the {entity} temperature to {temp} degrees|
|tags/homeassistant/set.climate.intent:3|altere a temperatura de {entity} para {temp} graus.|change the {entity} temperature to {temp} degrees|
...
|tags/chatbot/Reset.voc:2|repor|reset|
|tags/chatbot/reset.memory.dialog:1|A limpar base de conhecimento|Resetting knowledge database|
|tags/chatbot/reset.memory.dialog:2|A esquecer tudo|Forgetting everything|
|tags/chatbot/reset.memory.dialog:3|Okay, vou reiniciar agora a minha memória|Okay, I will now reset my memory|
|tags/chatbot/reset.memory.dialog:4|Apagamento do cérebro iniciado|Brain erasure initiated|

# 00__skill_template-pt
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/00__skill_template/Count.voc:1|Contagem|count|
|tags/00__skill_template/Dir.voc:1|Para cima|up|
...
|tags/00__skill_template/count.is.now.dialog:1|A contagem é agora|The count is now {{count}}|
|tags/00__skill_template/count.is.now.dialog:2|A caminho dos |We are now up to {{count}}|
|tags/00__skill_template/hello.world.dialog:1|Olá|Hello|
|tags/00__skill_template/hello.world.dialog:2|Olá para ti também|Hi to you too|
...
# yelp-finder.btotharye-pt
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/yelp-finder.btotharye/MoreInformation.voc:1|mais informação|more info|
|tags/yelp-finder.btotharye/MoreInformation.voc:2|mais informação|more information|
...
|tags/yelp-finder.btotharye/Sendinfo.voc:1|envia informação|send info|
|tags/yelp-finder.btotharye/Sendinfo.voc:2|envia informação|send information|
|tags/yelp-finder.btotharye/Sendinfo.voc:3|envia-me isso|send it to me|
|tags/yelp-finder.btotharye/Sendinfo.voc:4|envia-me os resultados|send me the results|
...
# bedtime-stories-skill-pt
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/bedtime-stories-skill/list.stories.dialog:1|Estas são as histórias para dormir que tenho disponíveis. {{stories}}|Here are the bedtime stories I have available. {{stories}}|
|tags/bedtime-stories-skill/list.stories.dialog:2|Estas são as histórias para dormir na minha biblioteca. {{stories}}|Here are the bedtime stories in my library. {{stories}}|
|tags/bedtime-stories-skill/list.stories.intent:1|Lista de histórias para dormir|List bedtime stories|
|tags/bedtime-stories-skill/list.stories.intent:2|Quais as histórias que tens|What stories do you have|
|tags/bedtime-stories-skill/list.stories.intent:3|Que histórias para dormir é que tens|What bed time stories do you have|
|tags/bedtime-stories-skill/pick.story.dialog:1|Ok, deixa ver se tenho essa estória.|Okay, let me see if I have that story.|
|tags/bedtime-stories-skill/pick.story.intent:1|diz-me {title}|tell me {title}|
|tags/bedtime-stories-skill/pick.story.intent:2|lê-me {title}|read me {title}|
|tags/bedtime-stories-skill/pick.story.intent:3|diz-me {title}|readme {title}|
|tags/bedtime-stories-skill/pick.story.intent:4|diz-me {title}|Tell me {title}|
|tags/bedtime-stories-skill/stories.bedtime.dialog:1|Claro. Aqui está uma grandiosa seleção da minha biblioteca.|Okay, sure. Here is a great selection from my library.|
|tags/bedtime-stories-skill/stories.bedtime.dialog:2|Sem problema, pôe-te confortável enquanto eu escolho uma estória.|No problem, get comfy while I pick a story.|
|tags/bedtime-stories-skill/stories.bedtime.intent:1|Conta-me uma estória.|Tell me a story|
|tags/bedtime-stories-skill/stories.bedtime.intent:2|Conta-me uma estória para adormecer.|Tell me a bed time story|
|tags/bedtime-stories-skill/stories.bedtime.intent:3|Conta-me um conto de fadas|Tell me a fairy tale|
|tags/bedtime-stories-skill/stories.bedtime.intent:4|Conta-nos uma estória.|Tell us a story|
|tags/bedtime-stories-skill/stories.bedtime.intent:5|Conta-me uma boa estória.|Tell me a good story|
|tags/bedtime-stories-skill/title.entity:1|Capochinho vermelho|little red riding hood|
...
|tags/bedtime-stories-skill/title.entity:6|As novas roupas do emprerador|the emporers new clothes|
|tags/bedtime-stories-skill/title.entity:7|A princesa na ervilha|the princess on the pea|
|tags/bedtime-stories-skill/title.entity:8|Os gnomos e o sapateiro|the elves and the shoemaker|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-stop/StopKeyword.voc:1|pára|stop|
|tags/skill-stop/StopKeyword.voc:2|silêncio|silence|
|tags/skill-stop/StopKeyword.voc:3|cala-te|shut up|
|tags/skill-stop/StopKeyword.voc:4|pouco barulho|be quiet|
...
# mozilla-webthings-gateway-skill-pt
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/cocktails/Again.voc:1|outra vez|again|
|tags/cocktails/Ingredients.voc:1|ingrediente|ingredient|
|tags/cocktails/Ingredients.voc:2|ingredientes|ingredients|
|tags/cocktails/Needed.intent:1|o que é preciso para fazer (um|uma) {drink}|what is needed to make (a|an) {drink}|
|tags/cocktails/Needed.intent:2|Do que (eu|você) (preciso|precisa) para fazer (um|uma) {drink}|what do (i|you) need (for|to make) (a|an) {drink}|
|tags/cocktails/Needed.intent:3|(qual|quais) (é|são) (o|os) (ingrediente|ingredientes) para (um|uma) {drink}|what are the (ingredients|ingredient) (of|for) (a|an) {drink}|
|tags/cocktails/NotFound.dialog:1|Desculpe, não consegui encontrar a bebida pedida|Sorry, I couldn't find the requested drink|
|tags/cocktails/NotFound.dialog:2|Lamento, mas não consegui encontrar o que pediu|I'm a fraid I couldn't find that|
|tags/cocktails/Recipie.intent:1|como é que (eu faço|eu misturo|você faz|você mistura) (um|uma) {drink}|how (would|do) (i|you) (make|mix) (a|an) {drink}|
|tags/cocktails/Recipie.intent:2|diga-(me|nos) como (fazer|misturar) (um|uma) {drink}|tell (me|us) how to (make|mix) (a|an) {drink}|
|tags/cocktails/Recipie.intent:3|dá-(me|nos) instruções para fazer (um|uma) {drink}|give (me|us) instructions for (a|an) {drink}|
|tags/cocktails/Recipie.intent:4|como (fazer|preparar) (um|uma) {drink} |how to (make|mix) (a|an) {drink}|
|tags/cocktails/Recipie.intent:5|qual é a receita (do|da) {drink}|what is the recipie for (a|an) {drink}|
|tags/cocktails/TellMe.voc:1|quais são|what are|
|tags/cocktails/TellMe.voc:2|conta-me|tell me|
|tags/cocktails/What.voc:1|qual era|what was|
|tags/cocktails/What.voc:2|quais eram|what were|
|tags/cocktails/YouWillNeed.dialog:1|Vais precisar de {ingredients} e {final_ingredient}|You'll need {ingredients} and {final_ingredient}|
|tags/cocktails/YouWillNeed.dialog:2|Vais precisar de {ingredients} e {final_ingredient}|You will need {ingredients} and {final_ingredient}|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/count/count.intent:1|conta até {number}|Count to {number}|
|tags/count/count_error.dialog:1|Não compreendo|I do not understand. |
|tags/count/count_error.dialog:2|Não estou a entender|I am missing something.|
...
# fallback-recommendations-skill-pt
...
# plasma-mycroft-applet-control-pt
...
|tags/auto-volume/activate.dialog:2|Volume automático ativado|Auto volume activated|
|tags/auto-volume/activate.dialog:3|Ativei o volume automático|I have activated auto volume|
|tags/auto-volume/activate.intent:1|Ativar volume automático|Activate auto volume|
|tags/auto-volume/activate.intent:2|Coloca o volume automático ativo|Set auto volume to active|
|tags/auto-volume/activate.intent:3|Liga o volume automático|Turn on auto volume|
|tags/auto-volume/activate.intent:4|Coloca o volume em automático |Set auto volume (to) on|
|tags/auto-volume/deactivate.dialog:2|Volume automático desativado|Auto volume is deactivated|
|tags/auto-volume/deactivate.dialog:3|Desativei o volume automático|I have now deactivated auto volume|
|tags/auto-volume/deactivate.intent:1|Desativa o volume automático|Deactivate auto volume|
|tags/auto-volume/deactivate.intent:2|Coloca o volume automático como inativo|Set auto volume to inactive|
|tags/auto-volume/deactivate.intent:3|Desliga o volume automático|Turn off auto volume|
|tags/auto-volume/deactivate.intent:4|Coloca o volume automático desligado|Set auto volume (to) off|
|tags/auto-volume/reset.dialog:1|Restaurei o volume automático|I have now reset auto volume|
|tags/auto-volume/reset.intent:1|Apaga os valores do volume automático|Clear auto volume measurements|
|tags/auto-volume/reset.intent:2|Elimina os valores do volume automático|Delete auto volume measurements|
|tags/auto-volume/reset.intent:3|Cancela valores do volume automático|Reset auto volume measurements|
