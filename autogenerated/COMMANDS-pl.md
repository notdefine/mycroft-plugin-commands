...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-support/ask.description.dialog:1|Opisz krótko występujący problem|Please briefly describe the problem you are experiencing|
|tags/skill-support/ask.description.dialog:2||What's a brief description of the problem you are having?|
|tags/skill-support/cancelled.dialog:1|W porządku|Alright|
...
|tags/bedtime-stories-skill/title.entity:8|Bajki o krasnoludkach|the elves and the shoemaker|
...
|tags/skill-configuration/SetKeyword.voc:1|ustaw|set|
...
|tags/skill-configuration/precise.devmode.enabled.intent:1|Testowy model modułu Precise został włączony.|The test precise model has been enabled.|
...
|tags/dice-skill/range.needed.dialog:1|Musisz sprecyzować zakres.|You need a specify a range|
...
# plasma-mycroft-applet-control-pl
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/plasma-mycroft-applet-control/MycroftPlasmoidReadNewsKeyword.voc:1||getarticle newsurl|
|tags/plasma-mycroft-applet-control/MycroftPlasmoidShowInstallerKeyword.voc:1|pokaż listę umięjętności do zainstalowania|show list of installable skills|
|tags/plasma-mycroft-applet-control/MycroftPlasmoidShowKeyword.voc:1|Pokaż się|show yourself|
|tags/plasma-mycroft-applet-control/MycroftPlasmoidShowKeyword.voc:2|pokaż widżet|show widget|
|tags/plasma-mycroft-applet-control/MycroftPlasmoidShowSkillsKeyword.voc:1|pokaż najlepsze umiejętności|show the top skills|
|tags/plasma-mycroft-applet-control/MycroftPlasmoidShowSkillsKeyword.voc:2|pokaż umiejętności|show skills|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/spotify-skill/And.dialog:1|i|and|
|tags/spotify-skill/AvailableDevices.dialog:1|Widzę takie urządzenia Spotify: {{devices}}|I see the Spotify devices named: {{devices}}|
|tags/spotify-skill/AvailableDevices.dialog:2|Znalazłem takie urządzenia Spotify: {{devices}}|I've found the Spotify devices named: {{devices}}|
|tags/spotify-skill/CurrentAlbum.dialog:1|to jest {album}|this is {album}|
|tags/spotify-skill/CurrentAlbum.dialog:2|to {album}|it's {album}|
|tags/spotify-skill/CurrentAlbum.dialog:3|Słuchamy {album}|we're listening to {album}|
|tags/spotify-skill/CurrentAlbum.dialog:4|Odtwarzam {album}|I'm playing {album}|
|tags/spotify-skill/CurrentArtist.dialog:1|to jest {artist}|this is {artist}|
|tags/spotify-skill/CurrentArtist.dialog:2|Słuchamy {artist}|we're listening to {artist}|
|tags/spotify-skill/CurrentSong.dialog:1|Słuchamy utworu {song} w wykonaniu {artist}|We're listening to {song} by {artist}|
|tags/spotify-skill/CurrentSong.dialog:2|Odtwarzam {song} w wykonaniu {artist}|I'm playing {song} by {artist}|
|tags/spotify-skill/CurrentSong.dialog:3|{song} w wykonaniu {artist}|{song} by {artist}|
|tags/spotify-skill/Device.voc:1|urządzenie|device|
|tags/spotify-skill/Device.voc:2|jednostka|unit|
|tags/spotify-skill/Device.voc:3|Urządzenia|devices|
|tags/spotify-skill/Device.voc:4|jednostka|units|
|tags/spotify-skill/DeviceNotFound.dialog:1|Nie mogę znaleźć urządzenia {name}|I couldn't find the device {name}|
|tags/spotify-skill/DeviceNotFound.dialog:2|Nie ma urządzenia Spotify o nazwie {name}|There's no spotify device named {name}|
|tags/spotify-skill/FailedToStart.dialog:1|Nie mogłem uruchomić odtwarzacza Spotify. Proszę sprawdzić połączenie z siecią oraz czy nazwa użytkownika i hasło są poprawne.|I wasn't able to launch the Spotify player.  Please check your network connectivity and that your username and password are correct.|
|tags/spotify-skill/For.dialog:1|na|for|
|tags/spotify-skill/For.voc:2|na album|for album|
|tags/spotify-skill/For.voc:3|na album|for the album|
|tags/spotify-skill/For.voc:4|dla artysty|for artist|
|tags/spotify-skill/For.voc:5|dla artysty|for the artist|
|tags/spotify-skill/ForArtist.dialog:1| dla artysty | for the artist |
...
|tags/spotify-skill/OnAlbum.dialog:1|to jest z {album}|this is from {album}|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/list-manager/add.item.dialog:1|{{item_name}} dodany do listy {{list_name}}.|{{item_name}} added to your {{list_name}} list.|
|tags/list-manager/add.list.dialog:1|Twoja nowa lista {{list_name}} została dodana.|Your new list {{list_name}} has been added.|
|tags/list-manager/add.voc:1|dodaj|add|
|tags/list-manager/add.voc:2|utwórz|create|
|tags/list-manager/cancelled.dialog:1|Anulowano.|Cancelled.|
|tags/list-manager/confirm.deletion.dialog:1|Czy na pewno chcesz usunąć {{element}}?|Are you sure you want to delete {{element}}?|
|tags/list-manager/conj.value:1|conj,i|conj,and|
|tags/list-manager/del.item.dialog:1|{{item_name}} został usunięty z listy {{list_name}}.|{{item_name}} removed from your {{list_name}} list.|
|tags/list-manager/del.list.dialog:1|Twoja lista {{list_name}} została usunięta.|Your list {{list_name}} has been removed.|
|tags/list-manager/del.voc:1|usuń|remove|
|tags/list-manager/item.name.rx:1||(add|create|remove) (?P<item_name>.*) (to|from) (my|the)|
|tags/list-manager/item.not.found.dialog:1|{{item_name}} dodany do listy {{list_name}}.|{{item_name}} is not on your {{list_name}} list.|
|tags/list-manager/list.found.dialog:1|Już masz listę o nazwie {{list_name}}.|You alredy have a list called {{list_name}}.|
|tags/list-manager/list.name.rx:1||list (called|named) (?P<list_name>.*)|
|tags/list-manager/list.name.rx:2||(my|the) (?P<list_name>.*) list|
|tags/list-manager/list.not.found.dialog:1|Już masz listę o nazwie {{list_name}}.|You don't seem to have a list called {{list_name}}.|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/remember/All.voc:1|(Wszystko | Wszystkie)|All|
|tags/remember/Did.voc:1|zrobić|did|
|tags/remember/Forget.voc:1|wykasuj|forget|
|tags/remember/Phrase.voc:1|wyrażenie|phrase|
|tags/remember/Phrase.voc:2|wyrażenia|phrases|
|tags/remember/Remember.voc:1|zapamiętaj|remember|
|tags/remember/RememberPhrase.rx:1|(wyrażenie)(?P<RememberPhrase>.*)|(phrase) (?P<RememberPhrase>.*)|
|tags/remember/RememberPhrase.rx:2|(wyrażenia) (?P<RememberPhrase>.*)|(phrases) (?P<RememberPhrase>.*)|
|tags/remember/WhatToRemember.rx:1|(Zapamietaj | Zapamiętaj żeby | Zapamiętaj że | Pamiętaj | Pamiętaj że | Pamiętaj żeby)(?P<WhatToRemember>.*)|(remember) (?P<WhatToRemember>.*)|
|tags/remember/You.voc:1|ty|you|
|tags/remember/delete.dialog:1|Czy skasować wyrażenie: {{PHRASE}}?|Should i delete the phrase: {{PHRASE}}?|
|tags/remember/deleteall.dialog:1|Czy mam skasować wszystkie zapamiętane wyrażenia?|Should i delete everything i remembered for you?|
|tags/remember/forgotten.dialog:1|Skasowano|It is forgotten.|
|tags/remember/gotphrase.dialog:1|Zapamiętam {{REMEMBER}} dla ciebie|I will remember "{{REMEMBER}}" for you.|
|tags/remember/holdon.dialog:1|Będę pamiętał to wyrażenie.|I will hold on to this phrase.|
|tags/remember/iremembered.dialog:1|Zapamiętano wyrażenie:  {{REMEMBER}}.|I remember: {{REMEMBER}}.|
|tags/remember/short.dialog:1|Mogę zapamiętać tylko zdania składające się z więcej niż czterech liter. Spróbuj ponownie. |I can only remember sentences or words longer than four characters. Please rephrase.|
|tags/remember/sorry.dialog:1|Przepraszam, nie mogę zapamiętać tego wyrażenia. |I am sorry, i can not remember any phrase!|
|tags/remember/sorryforget.dialog:1|Błąd, nie mogę skasować wszystkich zapamiętanych wyrażeń. |I am sorry, there was an error, i could not forget anything!|
|tags/remember/sorrynophrase.dialog:1|Przepraszam, nie mogę znaleźć żadnych pasujących wyrażeń|I am sorry, i couldn't find a phrase matching your request.|
|tags/remember/yes.list:1|tak|yes|
|tags/remember/yes.list:2|zgadza się|yep|
|tags/remember/yes.list:3|spoko|yeah|
|tags/remember/yes.list:4|jasne|sure|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/translate-skill/HowUseKeyword.voc:1|jak użyć|how use|
|tags/translate-skill/HowUseKeyword.voc:2|jak|how|
|tags/translate-skill/HowUseKeyword.voc:3|pomóż z|help with|
|tags/translate-skill/HowUseKeyword.voc:4||help|
|tags/translate-skill/HowUseKeyword.voc:5|pomóż mi z|help me with|
|tags/translate-skill/HowUseKeyword.voc:6||what say with|
|tags/translate-skill/LanguageKeyword.voc:1|język|language|
|tags/translate-skill/LanguageKeyword.voc:2|języki|languages|
|tags/translate-skill/LanguageNameKeyword.voc:1|ang|angielski|en|english|
|tags/translate-skill/LanguageNameKeyword.voc:2|hiszp|hiszpański|es|spanish|
|tags/translate-skill/LanguageNameKeyword.voc:3|wł|włoski|it|italian|
|tags/translate-skill/LanguageNameKeyword.voc:4|fr|francuski|fr|french|
|tags/translate-skill/LanguageNameKeyword.voc:5||nl|dutch|
|tags/translate-skill/LanguageNameKeyword.voc:6|niem|niemiecki|de|german|
|tags/translate-skill/LanguageNameKeyword.voc:7|pol|polski|pl|polish|
...
|tags/translate-skill/RepeatKeyword.voc:1|powtórz|repeat|
...
|tags/translate-skill/SpeakKeyword.voc:2|czy znasz inny|do you know other|
|tags/translate-skill/SpeakKeyword.voc:3|czy znasz inne|do you know others|
|tags/translate-skill/SpeakKeyword.voc:4|czy znasz inny|you know other|
|tags/translate-skill/SpeakKeyword.voc:5|czy znasz inne|you know others|
...
|tags/translate-skill/how.use.dialog:1|Bardzo dobrze, Wytłumaczę: możesz powiedzieć: przetłumacz na szwedzki witajcie moi przyjaciele, możesz też powiedzieć: przetłumacz witajcie moi przyjaciele na rumuński, innym sposobem użycia jest spytanie mnie: czy mówisz w innych językach?, Mogę mówić po Angielsku, Hiszpańsku, Francusku, Włosku, Portugalsku, Holendersku, Niemiecku, Szwedzku, Węgiersku, Polsku, Norwesku, Duńsku, Rumuńsku, Słowacku, Katalońsku, Chińsku i Japońsku.|Very good, I'll explain; you can say: translate to swedish hello my dear friends, you can also say: translate hi my dear friends to romanian, another way of using is asking me: do you speak other languages?, I can speak in English, Spanish, French, Italian, Portuguese, Dutch, German, Swedish, Hungarian, Polish, Norwegian, Danish, Romanian, Slovak, Catalan, Chinese and Japanese|
|tags/translate-skill/in.dialog:1|po {{language}}|in {{language}}|
...
|tags/translate-skill/what.did.you.think.dialog:1|Co myślisz o mojej umiejętności mówienia w rożnych językach?|What did you think of my ability to speak languages!|
...
|tags/translate-skill/yes.ask.dialog:1|Tak, znam języki obce, co chcesz żebym powiedział?|Yes, i can speak other languages, what do you want me to say?|
...
|tags/skill-personal/DoYouRhyme.intent:1|(czy) umiesz rymować|do you (even|) rhyme|
|tags/skill-personal/DoYouRhyme.intent:2|(czy) potrafisz rymować|can you (even|) rhyme|
|tags/skill-personal/DoYouRhyme.intent:3|(opowiedz|przeczytaj|recytuj|wyrecytuj)(mi)(jakąś|jakieś)(rymowankę|rymowanki)|(tell|read|recite) (me|) (a|some|) (rhyme|rhymes)|
|tags/skill-personal/WhatAreYouKeyword.voc:1|czym jesteś|what are you|
|tags/skill-personal/WhenWereYouBornKeyword.voc:1|kiedy się (urodziłeś|urodziłaś)|when were you born|
|tags/skill-personal/WhenWereYouBornKeyword.voc:2|kiedy (cię stworzono|powstałaś)|when were you created|
|tags/skill-personal/WhereWereYouBornKeyword.voc:1|kiedy się (urodziłeś|urodziłaś)|where were you born|
|tags/skill-personal/WhereWereYouBorn.intent:2|kiedy (cię stworzono|powstałaś)|where were you created|
|tags/skill-personal/WhoAreYouKeyword.voc:1|kim (ty) jesteś|who are you|
|tags/skill-personal/WhoMadeYouKeyword.voc:1|kto cię stworzył|who made you|
|tags/skill-personal/WhoMadeYouKeyword.voc:2|przez kogo zostałaś stworzona|who were you made by|
|tags/skill-personal/WhoMadeYouKeyword.voc:3|kto cię stworzył|who created you|
|tags/skill-personal/WhoMadeYouKeyword.voc:4|kto cię zbudował|who built you|
...
|tags/skill-personal/what.am.i.dialog:1|Jestem otwartoźródłową sztuczną inteligencją|I am an open source artificial intelligence.|
|tags/skill-personal/what.am.i.dialog:2||I'm an intelligent piece of software for communicating with machines|
|tags/skill-personal/when.was.i.born.dialog:1|Urodziłem się w dwa tysiące piętnastym roku|I was born in 2015.|
|tags/skill-personal/when.was.i.born.dialog:2|2015, wtedy się urodziłem|2015 is when I was born.|
...
|tags/skill-personal/who.am.i.dialog:1|Nazywam się {{name}} i jestem twoim osobistym asystentem|My name is {{name}} and I'm an intelligent personal assistant|
...
# btotharye-home-assistant-pl
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:1|aktywuj|activate|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:2|ogień|fire|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:3|wywołaj|call up|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:4|uruchom|trigger|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:5|scena|scene|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:6|automatyzacja|automation|
|tags/btotharye-home-assistant/AutomationActionKeyword.voc:7|skrypt|script|
|tags/btotharye-home-assistant/DecreaseVerb.voc:1|zmniejszenie|decrease|
|tags/btotharye-home-assistant/DecreaseVerb.voc:2|dół|down|
|tags/btotharye-home-assistant/DeviceTrackerKeyword.voc:1|gdzie|where|
|tags/btotharye-home-assistant/DeviceTrackerKeyword.voc:2|znajdź|lokalizacja|locate|location|
|tags/btotharye-home-assistant/IncreaseVerb.voc:1|zwiększ|increase|
|tags/btotharye-home-assistant/IncreaseVerb.voc:2|góra|up|
|tags/btotharye-home-assistant/LightBrightenVerb.voc:1|jaśniej|jaśniejszy|rozjaśnij|brighten|brighter|bright|up|
|tags/btotharye-home-assistant/LightDimVerb.voc:1|Ciemny|Ciemniejszy|Ciemno|Przyciemniony|Zmniejsz|Dół|dim|dimmer|dark|darken|lower|down|
|tags/btotharye-home-assistant/LightsKeyword.voc:1|światło|light|
|tags/btotharye-home-assistant/LightsKeyword.voc:2|światła|lights|
|tags/btotharye-home-assistant/LightsKeyword.voc:3|lampa|lamp|
|tags/btotharye-home-assistant/LightsKeyword.voc:4|lampy|lamps|
|tags/btotharye-home-assistant/LightsKeyword.voc:5|żarówka|bulb|
|tags/btotharye-home-assistant/LightsKeyword.voc:6|żarówki|bulbs|
|tags/btotharye-home-assistant/LightsKeyword.voc:7|dioda LED.|l.e.d.|
|tags/btotharye-home-assistant/LightsKeyword.voc:8|włącz|turn on|
|tags/btotharye-home-assistant/LightsKeyword.voc:9|wyłącz|turn off|
|tags/btotharye-home-assistant/LightsKeyword.voc:10|przełącz|toggle|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:1|stan|state|
...
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:4|czujnik|detector|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:5|wartość|value|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:6|odczytać|read out|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:7|jaki jest kierunek|what is the current|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:8|jaki jest bieżący|what is current|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:9|powiedz mi kierunek|tell me the current|
|tags/btotharye-home-assistant/SensorStatusKeyword.voc:10|powiedz jaki jest bieżący|tell me current|
|tags/btotharye-home-assistant/SetVerb.voc:1|ustaw|set|
|tags/btotharye-home-assistant/SwitchActionKeyword.voc:1|skręt|turn|
|tags/btotharye-home-assistant/SwitchActionKeyword.voc:2|przełącznik|switch|
|tags/btotharye-home-assistant/automation.rx:1|(aktywuj| odpal| uruchom| wywołaj| włącz) (?P<Entity>.*)|(activate|fire|trigger|call up) (?P<Entity>.*)|
|tags/btotharye-home-assistant/dimming.rx:1|(ustaw) (?:jasność )?(?P<Entity>.*) (na) (?P<BrightnessValue>\d*)(?: procent)?|(set) (?:brightness of )?(?P<Entity>.*) (to) (?P<BrightnessValue>\d*)(?: percent)?|
|tags/btotharye-home-assistant/dimming.rx:2|(przyciemnij|rozjaśnij|zwiększ|zmniejsz) (?:jasność )?(?P<Entity>.*?) (?:o)? (?P<BrightnessValue>\d*)?(?: procent)?|(dim|brighten|increase|decrease) (?:brightness of )?(?P<Entity>.*?) (?:by)? (?P<BrightnessValue>\d*)?(?: percent)?|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:1|Automatyzacja {{dev_name}} uruchomiona. |triggered automation {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:2|Uruchomiono {{dev_name}}.|triggered {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:3|{{dev_name}} zostało uruchomione.|{{dev_name}} was triggered.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:4|{{dev_name}} zostało aktywowane.|{{dev_name}} was activated.|
|tags/btotharye-home-assistant/homeassistant.automation.trigger.dialog:5|aktywowano {{dev_name}}.|activated {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.brightness.badreq.dialog:1|Proszę podać wartość jasności pomiędzy 0 a 100.|please request a brightness level between 0 and 100.|
|tags/btotharye-home-assistant/homeassistant.brightness.badreq.dialog:2|jak jasno? możesz wybrać wartość od 0 do 100.|how bright? you can choose a level from 0 to 100.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.dimmable.dialog:1|Nie można ściemnić {{dev_name}}. Nie jest ściemnialne.|Can not dim {{dev_name}}. It is not dimmable.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.off.dialog:1|Nie można przyciemnić {{dev_name}}. Urządzenie jest wyłączone.|Can not dim {{dev_name}}. It is off.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.off.dialog:2|Nie można przyciemnić {{dev_name}}. Proszę najpierw włączyć.|Can not dim {{dev_name}}. Please turn it on before.|
|tags/btotharye-home-assistant/homeassistant.brightness.cantdim.off.dialog:3|{{dev_name}} nie może zostać przyciemnione. Mogą być jedynie urządzenia, które są włączone.|{{dev_name}} can not be dimmed. Only devices that are turned on can be.|
|tags/btotharye-home-assistant/homeassistant.brightness.decreased.dialog:1|Przyciemniono {{dev_name}} do {{brightness}} procent.|Dimmed {{dev_name}} to {{brightness}} percent.|
|tags/btotharye-home-assistant/homeassistant.brightness.decreased.dialog:2|Przyciemniono {{dev_name}}.|Dimmed {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.brightness.dimmed.dialog:1|Ustaw jasność urządzenia {{dev_name}} do {{brightness}} procent.|Set the brightness of {{dev_name}} to {{brightness}} percent.|
|tags/btotharye-home-assistant/homeassistant.brightness.increased.dialog:1|Zwiększ jasność {{dev_name}} do {{brightness}} procent.|Increased brightness of {{dev_name}} to {{brightness}} percent.|
|tags/btotharye-home-assistant/homeassistant.brightness.increased.dialog:2|Zwiększono jasność {{dev_name}}.|Increased brightness of {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.already.dialog:1|{{dev_name}} już {{action}}.|{{dev_name}} already {{action}}.|
|tags/btotharye-home-assistant/homeassistant.device.already.dialog:2|Zmiany nie zostały wprowadzone dla {{dev_name}}.|No changes made to {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.off.dialog:1|wyłączono {{dev_name}}.|turned off {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.off.dialog:2|{{dev_name}} zostało wyłączone.|turned {{dev_name}} off.|
|tags/btotharye-home-assistant/homeassistant.device.off.dialog:3|{{dev_name}} jest teraz wyłączone.|{{dev_name}} is now off.|
|tags/btotharye-home-assistant/homeassistant.device.on.dialog:1|włączono {{dev_name}}.|turned on {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.on.dialog:2|{{dev_name}} zostało włączone.|{{dev_name}} was turned on.|
|tags/btotharye-home-assistant/homeassistant.device.on.dialog:3|włączono {{dev_name}}.|turned {{dev_name}} on.|
|tags/btotharye-home-assistant/homeassistant.device.toggle.dialog:1|przełączono {{dev_name}}.|toggled {{dev_name}}.|
|tags/btotharye-home-assistant/homeassistant.device.toggle.dialog:2|{{dev_name}} zostało przełączone.|{{dev_name}} was toggled.|
|tags/btotharye-home-assistant/homeassistant.device.unknown.dialog:1|Przepraszam, nie mogę odnaleźć jednostki asystenta domu |Sorry, I can't find the Home Assistant entity |
|tags/btotharye-home-assistant/homeassistant.device.unknown.dialog:2|Jednostka |Entity |
|tags/btotharye-home-assistant/homeassistant.device.unknown.dialog:3|Przepraszam, jednostka |Sorry, entity |
|tags/btotharye-home-assistant/homeassistant.device.unknown.dialog:4|Przepraszam, nie byłem w stanie znaleźć |Excuse me, I wasn't able to find |
|tags/btotharye-home-assistant/homeassistant.error.offline.dialog:1|Wygląda na to, że serwer asystenta domu nie jest podłączony do sieci.|The Home assistant server appears to be offline.|
|tags/btotharye-home-assistant/homeassistant.error.offline.dialog:2|Nie mogę dotrzeć do serwera asystenta domu.|Couldn't reach the home assistant server.|
|tags/btotharye-home-assistant/homeassistant.error.offline.dialog:3|Serwer asystenta domu nie odpowiedział.|The home assistant server did not respond.|
|tags/btotharye-home-assistant/homeassistant.error.setup.dialog:1|Proszę skonfigurować ustawienia zdolności asystenta domu na stronie home kropka mycroft kropka ai.|Please configure the home assistant skill settings at home dot mycroft dot ai.|
|tags/btotharye-home-assistant/homeassistant.error.sorry.dialog:1|Nie wiem co chciałbyś, żebym zrobił.|I don't know what you want me to do.|
|tags/btotharye-home-assistant/homeassistant.error.sorry.dialog:2|Nie wiem w jaki sposób porozumieć się z asystentem domu.|Couldn't figure out how to talk to Home Assistant.|
|tags/btotharye-home-assistant/homeassistant.error.sorry.dialog:3|Nie rozumiem o co pytasz.|I don't understand what you are asking.|
|tags/btotharye-home-assistant/homeassistant.sensor.dialog:1|W tej chwili {{dev_name}} jest {{value}} {{unit}}.|Currently {{dev_name}} is {{value}} {{unit}}.|
|tags/btotharye-home-assistant/homeassistant.sensor.dialog:2|{{dev_name}} ma stan: {{value}} {{unit}}.|{{dev_name}} has the state: {{value}} {{unit}}.|
|tags/btotharye-home-assistant/homeassistant.sensor.dialog:3|{{dev_name}} jest {{value}} {{unit}} w tym momencie.|{{dev_name}} is {{value}} {{unit}} at the moment.|
|tags/btotharye-home-assistant/homeassistant.sensor.dialog:4|{{dev_name}} jest {{value}} {{unit}}.|{{dev_name}} is {{value}} {{unit}}.|
|tags/btotharye-home-assistant/homeassistant.tracker.found.dialog:1|Ostatnia znana lokazlizacja {{dev_name}} to {{location}}.|Last known location of {{dev_name}} is {{location}}.|
|tags/btotharye-home-assistant/homeassistant.tracker.found.dialog:2|{{dev_name}} jest w {{location}}.|{{dev_name}} is at {{location}}.|
|tags/btotharye-home-assistant/homeassistant.tracker.found.dialog:3|{{dev_name}} został wykryty w {{location}}.|{{dev_name}} has been detected at {{location}}.|
|tags/btotharye-home-assistant/numvalue.rx:1|(?P<Value>100?%|[1-9][0-9]?%?)(\D|$)|(?P<Value>100?%|[1-9][0-9]?%?)(\D|$)|
|tags/btotharye-home-assistant/sensor.rx:1|(jaki| jaką) (status| stan| wartość) (jest| ma) (?P<Entity>.*)|(in )?(what|which) (status|state|value) (is|has) (?P<Entity>.*)|
|tags/btotharye-home-assistant/sensor.rx:2|(jaki| jaka) jest (bieżący| bieżąca)?(status| stan| wartość| sensor) dla (?P<Entity>.*)|(how|what) is the (current )?(status|state|value|sensor) of (the )?(?P<Entity>.*)|
|tags/btotharye-home-assistant/sensor.rx:3|powiedz mi (status| stan| wartość| sensor) dla (?P<Entity>.*)|tell me (the|our) (current )?(status|state|value|sensor) of (the )?(?P<Entity>.*)|
|tags/btotharye-home-assistant/sensor.rx:4|(przeczytaj| odczytaj| powiedz| sprawdź) jaki jest (status| stan| wartość| sensor) (?P<Entity>.*)|read (out )?(the )?((status|state|value|sensor) (of )?)?(?P<Entity>.*)|
|tags/btotharye-home-assistant/sensor.rx:5|odczytaj (?P<Entity>.*) (status| stan| wartość| sensor)|read (out )?(the )?(?P<Entity>.*) (status|state|value|sensor)|
|tags/btotharye-home-assistant/sensor.rx:6|(jaki| jaka) jest (current )?(?P<Entity>.*) (status| stan| wartość| sensor)|(how|what) is the (current )?(?P<Entity>.*) (status|state|value|sensor)|
|tags/btotharye-home-assistant/sensor.rx:7|powiedz mi (nasz) (current )?(?P<Entity>.*) (status| stan| wartość| sensor)|tell me (the|our) (current )?(?P<Entity>.*) (status|state|value|sensor)|
|tags/btotharye-home-assistant/sensor.rx:8|(status| stan| wartość| sensor) (?P<Entity>.*)|(status|state|value|sensor) (?P<Entity>.*)|
|tags/btotharye-home-assistant/switch.rx:1|((włącz| wyłącz| przełącz) )?(?P<Action>włącz| wyłącz| przełącz) (?P<Entity>.*)|((turn|switch) )?(?P<Action>on|off|toggle) (?P<Entity>.*)|
...
|tags/btotharye-home-assistant/switch.rx:3|((włącz| wyłącz) )?(?P<Entity>.*) (?P<Action>)|((turn|switch) )?(?P<Entity>.*) (?P<Action>on|off)|
|tags/btotharye-home-assistant/tracker.rx:1|(jaka jest |(gdzie jest ?)?lokalizacja) (?P<Entity>.*)|(where is|(what is (the )?)?location of) (?P<Entity>.*)|
|tags/btotharye-home-assistant/tracker.rx:2|Lokalizacja (?P<Entity>.*)|(?P<Entity>.*) location|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-pairing/DeviceKeyword.voc:1|jednostka|unit|
|tags/skill-pairing/DeviceKeyword.voc:2|urządzenie|device|
|tags/skill-pairing/DeviceKeyword.voc:3|majkroft|mycroft|
|tags/skill-pairing/DeviceKeyword.voc:4|mark one|mark one|
|tags/skill-pairing/DeviceKeyword.voc:5|mark two|mark two|
|tags/skill-pairing/PairingKeyword.voc:1|paruj|pair|
|tags/skill-pairing/PairingKeyword.voc:2|parowanie|pairing|
|tags/skill-pairing/PairingKeyword.voc:3|rejestruj|register|
|tags/skill-pairing/already.paired.dialog:1|Zostałem już sparowany|I've already been paired|
|tags/skill-pairing/already.paired.dialog:2|Jestem już sparowany|I'm paired already|
|tags/skill-pairing/already.paired.dialog:3|Dziękuję, ale jestem już sparowany|Thanks but I'm already paired|
|tags/skill-pairing/codes.value:1|A, 'A' jak Adam|A,'A' as in Apple|
|tags/skill-pairing/codes.value:2|B,'B' jak Barbara|B,'B' as in Bravo|
|tags/skill-pairing/codes.value:3|C,'C' jak Celina|C,'C' as in Charlie|
|tags/skill-pairing/codes.value:4|D,'D' jak Daria|D,'D' as in Delta|
|tags/skill-pairing/codes.value:5|E,'E' jak Elżbieta|E,'E' as in Echo|
|tags/skill-pairing/codes.value:6|F,'F' jak Fabian|F,'F' as in Fox trot|
|tags/skill-pairing/codes.value:7|G,'G' jak Gabriela|G,'G' as in Golf|
|tags/skill-pairing/codes.value:8|H,'H' jak Henryk|H,'H' as in Hotel|
|tags/skill-pairing/codes.value:9|I,'I' jak Ignacy|I,'I' as in India|
|tags/skill-pairing/codes.value:10|J,'J' jak Julia|J,'J' as in Juliet|
|tags/skill-pairing/codes.value:11|K,'K' jak Krystian|K,'K' as in Kilogram|
|tags/skill-pairing/codes.value:12|L,'L' jak Laura|L,'L' as in London|
|tags/skill-pairing/codes.value:13|M,'M' jak Mikołaj|M,'M' as in Mike|
|tags/skill-pairing/codes.value:14|N,'N' jak Natalia|N,'N' as in November|
|tags/skill-pairing/codes.value:15|O,'O' jak Olaf|O,'O' as in Oscar|
|tags/skill-pairing/codes.value:16|P,'P' jak Patryk|P,'P' as in Paul|
|tags/skill-pairing/codes.value:17|Q,'Q' jak quiz|Q,'Q' as in Quebec|
|tags/skill-pairing/codes.value:18|R,'R' jak Robert|R,'R' as in Romeo|
|tags/skill-pairing/codes.value:19|S,'S' jak Sandra|S,'S' as in Sierra|
|tags/skill-pairing/codes.value:20|T,'T' jak Tomasz|T,'T' as in Tango|
|tags/skill-pairing/codes.value:21|U,'U' jak Ula|U,'U' as in Uniform|
|tags/skill-pairing/codes.value:22|V,'V' jak vip|V,'V' as in Victor|
|tags/skill-pairing/codes.value:23|W,'W' jak Wiktor|W,'W' as in Whiskey|
|tags/skill-pairing/codes.value:24|X,'X' jak X|X,'X' as in X-Ray|
|tags/skill-pairing/codes.value:25|Y,'Y' jak Yeti|Y,'Y' as in Yankee|
|tags/skill-pairing/codes.value:26|Z,'Z' jak Zbigniew|Z,'Z' as in Zebra|
|tags/skill-pairing/codes.value:27|1,numer Jeden|1,the number One|
|tags/skill-pairing/codes.value:28|2,numer Dwa|2,the number Two|
|tags/skill-pairing/codes.value:29|3,numer Trzy|3,the number Three|
|tags/skill-pairing/codes.value:30|4,numer Cztery|4,the number Four|
|tags/skill-pairing/codes.value:31|5,numer Pięć|5,the number Five|
|tags/skill-pairing/codes.value:32|6,numer Sześć|6,the number Six|
|tags/skill-pairing/codes.value:33|7,numer Siedem|7,the number Seven|
|tags/skill-pairing/codes.value:34|8,numer Osiem|8,the number Eight|
|tags/skill-pairing/codes.value:35|9,numer Dziewięć|9,the number Nine|
|tags/skill-pairing/codes.value:36|0,numer Zero|0,the number Zero|
|tags/skill-pairing/connection.error.dialog:1|Połączenie z mycroft kropka a.i nie powiodło się, kod parowania nie może zostać uzyskany. Sprawdź swoje połączenie z internetem i spróbuj jeszcze raz.|Connection to mycroft dot a.i, failed, pairing code could not be fetched. Check your internet connection and try again.|
|tags/skill-pairing/pairing.code.dialog:1|Możesz zarejestrować mnie przechodząc do Urządzeń, zaznaczając Dodaj Urządzenie i wpisując kod. {{code}}|You can register me by going to Devices, selecting Add Device then use the code. {{code}}|
|tags/skill-pairing/pairing.code.dialog:2|Zarejestruj to urządzenie kodem. {{code}}|Register this device with the code. {{code}}|
|tags/skill-pairing/pairing.code.dialog:3|Podaj kod. {{code}}|Enter the code. {{code}}|
|tags/skill-pairing/pairing.intro.dialog:1|Jestem podłączony do internetu i potrzebuję aby mnie aktywować.  Otwórz swoją przeglądarkę i odwiedź stronę home kropka mycroft kropka A I, żeby zarejestrować to urządzenie.|I'm connected to the internet and need to be activated.  Open your browser and visit home dot mycroft dot A I to register this device.|
|tags/skill-pairing/pairing.not.paired.dialog:1|Twoje urządzenie nie jest zarejestrowane|Your device is not currently registered|
|tags/skill-pairing/pairing.not.paired.dialog:2|Twoje urządzenie nie jest sparowane|Your device is not currently paired|
|tags/skill-pairing/pairing.paired.dialog:1|Teraz jestem gotowy do użycia. Spróbuj zapytać mnie o takie kwestia jak "hej mycroft, jaka jest pogoda", "hej mycroft, kim był abraham lincoln", lub "hey mycroft, odtwórz wiadomości". W dowolnym momencie, jeżeli chcesz żebym przestał mówić, po prostu wciśnij przycisk.|Now I am ready for use. Try asking me things like "hey mycroft, what's the weather", "hey mycroft, tell me about abraham lincoln", or "hey mycroft, play the news". If you need to stop me talking at any time, just push my button.|
|tags/skill-pairing/pairing.paired.no.button.dialog:1|Teraz jestem gotowy do użycia. Spróbuj zapytać mnie o takie kwestia jak "hej mycroft, jaka jest pogoda", "hej mycroft, kim był abraham lincoln", lub "hey mycroft, odtwórz wiadomości".|Now I am ready for use. Try asking me things like "hey mycroft, what's the weather", "hey mycroft, tell me about abraham lincoln", or "hey mycroft, play the news".|
|tags/skill-pairing/unexpected.error.restarting.dialog:1|Przepraszam, stało się coś nieoczekiwanego. Muszę zacząć proces parowania od nowa.|My apologies, something unexpected has happened. I need to restart the pairing process.|
|tags/skill-pairing/wait.for.startup.dialog:1|parowanie zakończone, proszę poczekać chwilę wczytuję umiejętności.|pairing is now complete, please wait a few moments while skills are loading.|
|tags/skill-pairing/wait.for.startup.dialog:2|urządzenie zostało sparowane, proszę poczekać chwilę aż skończę wczytywać umiejętności.|the device is now paired, please wait a few moments while I finish loading skills.|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/laugh/Laugh.intent:1|zaśmiej się jak alexa|laugh like alexa|
|tags/laugh/Laugh.intent:2|możesz się roześmiać|can you laugh|
|tags/laugh/Laugh.intent:3|złowrogi (śmiech|śmiech|śmiech|śmiech)|evil (laugh|laughing|laughs|laughter)|
|tags/laugh/Laugh.voc:1|śmiech|laugh|
|tags/laugh/Laugh.voc:2|śmiech|laughing|
|tags/laugh/Laugh.voc:3|śmiech|laughs|
|tags/laugh/Laugh.voc:4|śmiech|laughter|
|tags/laugh/RandomLaugh.intent:1|losowy śmiech|laugh randomly|
|tags/laugh/RandomLaugh.intent:2|uruchom losowy (śmiech|śmiech|śmiech|śmiech)|trigger random (laugh|laughing|laughs|laughter)|
|tags/laugh/RandomLaugh.intent:3|losowy (śmiech|śmiech|śmiech|śmiech)|random (laugh|laughing|laughs|laughter)|
|tags/laugh/Stop.voc:1|anuluj|abort|
|tags/laugh/Stop.voc:2|anuluj|cancel|
|tags/laugh/Stop.voc:3||stop|
|tags/laugh/cancel.dialog:1|śmiech zatrzymany|laughing stopped|
|tags/laugh/cancel.dialog:2|już więcej nie bedę|i wont laugh anymore|
|tags/laugh/cancel_fail.dialog:1|nie śmieje się|i am not laughing|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/rodent-facts/facts.rodent.dialog:1|Ok oto twój losowy fakt o szczurach {{ fact }}|Ok here is your random rat fact {{ fact }}|
|tags/rodent-facts/facts.rodent.intent:1|Powiedz mi fakt o gryzoniach|Give me a rodent fact|
|tags/rodent-facts/facts.rodent.intent:2|Opowiedz mi fakt o gryzoniach|Tell me a rodent fact|
|tags/rodent-facts/facts.rodent.intent:3|Daj mi fakt o szczurze|Give me a rat fact|

# skill-finished-booting-pl
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-finished-booting/finished.booting.dialog:1|Zakończono uruchamianie|I have now finished booting up.|
|tags/skill-finished-booting/finished.booting.dialog:2|Jestem teraz gotowy|I am now ready.|
|tags/skill-finished-booting/finished.booting.dialog:3|Cześc, tu mycroft i jestem gotowy do pracy|Hi, this is mycroft and I am ready to work.|
|tags/skill-finished-booting/finished.booting.dialog:4|Możesz zacząć od mycroft|You can get started with mycroft.|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/decide-skill/Choice1.rx:1|(.* (?P<Choice1>.*) lub (?P<dummy>.*))|(.* (?P<Choice1>.*) or (?P<dummy>.*))|
|tags/decide-skill/Choice1.rx:2|między ((?P<Choice1>.*) a (?P<dummy>.*))|between ((?P<Choice1>.*) and (?P<dummy>.*))|
|tags/decide-skill/Choice2.rx:1|(.* (?P<dummy2>.*) lub (?P<Choice2>.*))|(.* (?P<dummy2>.*) or (?P<Choice2>.*))|
|tags/decide-skill/Choice2.rx:2|między ((?P<dummy2>.*) a (?P<Choice2>.*))|between ((?P<dummy2>.*) and (?P<Choice2>.*))|
|tags/decide-skill/DecideKeyword.voc:1|Zdecyduj|Decide|
|tags/decide-skill/DecideKeyword.voc:2|Co mam założyć?|What should I wear|
|tags/decide-skill/DecideKeyword.voc:3|Co mam zjeść?|What should I eat|
|tags/decide-skill/DecideKeyword.voc:4|gra|game|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/count/count.intent:1|Policz do {number}|Count to {number}|
|tags/count/count_error.dialog:1|Nie rozumiem.|I do not understand. |
|tags/count/count_error.dialog:2|Czegoś nie rozumiem.|I am missing something.|
|tags/count/count_error.dialog:3|Powtórzysz?|Say again?|
|tags/count/count_error.dialog:4|Przykro mi. Nie usłyszałem tego.|Sorry. I did not hear that.|
|tags/count/count_start.dialog:1|Liczenie do {number}, start!|Counting to {number}. starting now!|
|tags/count/count_stop.dialog:1|Zrobione!|Done!|
|tags/count/count_stop.dialog:2|Skończone!|Finish!|
|tags/count/countdown.intent:1|Odliczanie od {number}|Countdown from {number}|
|tags/count/countdown.intent:2|Odliczaj od {number}|Count down from {number}|
|tags/count/countdown.intent:3|Liczenie od {number} w dół|Count backwards from {number}|
|tags/count/countdown.intent:4|Licz od {number} w dół|Count back wards from {number}|
|tags/count/countdown.intent:5|Odliczaj od {number}|Count back from {number}|
|tags/count/countdown.intent:6|Odlicz od liczby {number}|From {number} count down|
|tags/count/countdown.intent:7|Odliczaj od {number}|From {number} count backwards|
|tags/count/countdown_start.dialog:1|Odliczanie od liczby {number}. Zaczynam!|Count down from {number}. Starting now!|
...
# kathy-msk-test-skill-pl
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/kathy-msk-test-skill/test.msk.kathy.dialog:1|Zjedz te pyszną przekąskę|Here have a delicious treat|
|tags/kathy-msk-test-skill/test.msk.kathy.dialog:2|Kto jest dobrym pieskiem?|Who's a good boi|
|tags/kathy-msk-test-skill/test.msk.kathy.intent:1|Daj piesku przysmak|Give the corgi a treat|
|tags/kathy-msk-test-skill/test.msk.kathy.intent:2|Hau Hau!|Woof|
|tags/kathy-msk-test-skill/test.msk.kathy.intent:3|Teraz przysmak|Treats now|
...
# today-history.btotharye-pl
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/today-history.btotharye/RandomEventKeyword.voc:1|co zdarzyło się dziś w historii|what event happened this day in history|
|tags/today-history.btotharye/RandomEventKeyword.voc:2|ten dzień w historii|this day in history|
|tags/today-history.btotharye/RandomEventKeyword.voc:3|dziś w historii|today in history|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/fallback-unknown/question.dialog:1|Przepraszam, nie mogę Ci z tym pomóc.|I'm sorry I can't help you with that.|
|tags/fallback-unknown/question.dialog:2|Nie jestem pewien jak Ci z tym pomóc.|I'm not sure how to help you with that.|
|tags/fallback-unknown/question.dialog:3|Nie rozumiem, ale każdego dnia uczę się nowych rzeczy.|I don't understand, but I'm learning new things everyday.|
|tags/fallback-unknown/question.dialog:4|Nie jestem pewien jak na to odpowiedzieć.|I'm not sure how to answer that.|
|tags/fallback-unknown/question.voc:1|co jest|what is|
|tags/fallback-unknown/question.voc:2|co będzie|what will|
|tags/fallback-unknown/question.voc:3|co zrobiłem|what did|
|tags/fallback-unknown/question.voc:4|co robi|what does|
|tags/fallback-unknown/question.voc:5|co robić|what do|
|tags/fallback-unknown/question.voc:7|gdzie jest|where is|
|tags/fallback-unknown/question.voc:8|gdzie będzie|where will|
|tags/fallback-unknown/question.voc:9|gdzie zrobił|where did|
|tags/fallback-unknown/question.voc:10|gdzie robi|where does|
|tags/fallback-unknown/question.voc:11|gdzie robić|where do|
|tags/fallback-unknown/question.voc:13|kiedy jest|when is|
|tags/fallback-unknown/question.voc:14|kiedy będzie|when will|
|tags/fallback-unknown/question.voc:15|kiedy zrobił|when did|
|tags/fallback-unknown/question.voc:16|kiedy robi|when does|
|tags/fallback-unknown/question.voc:17|kiedy zrobić|when do|
|tags/fallback-unknown/unknown.dialog:1|Przepraszam, nie rozumiem.|I'm sorry, I don't understand.|
|tags/fallback-unknown/unknown.dialog:2|Nie wiem co to znaczy.|I don't know what that means.|
|tags/fallback-unknown/unknown.dialog:4|Przepraszam, nie załapałem tego.|Sorry, I didn't catch that.|
|tags/fallback-unknown/unknown.dialog:5|Przepraszam nie rozumiem.|Sorry, I don't understand.|
|tags/fallback-unknown/unknown.dialog:6|Nie rozumiem.|I don't understand.|
|tags/fallback-unknown/unknown.dialog:7|Nie jestem pewien czy Cię zrozumiałem.|I'm not sure I understood you.|
|tags/fallback-unknown/unknown.dialog:8|Spróbuj powiedzieć to w inny sposób.|You might have to say that a different way.|
|tags/fallback-unknown/unknown.dialog:9|Powtórz swoje polecenie używając innych słów.|Please rephrase your request.|
|tags/fallback-unknown/who.is.dialog:1|Nie wiem kto to jest.|I don't know who that is.|
|tags/fallback-unknown/who.is.dialog:2|Nie jestem pewien kto to jest.|I'm not sure who that is.|
|tags/fallback-unknown/who.is.voc:1|kim jest|who is|
|tags/fallback-unknown/who.is.voc:2|kim będzie|who will|
|tags/fallback-unknown/who.is.voc:3|kto zrobił|who did|
|tags/fallback-unknown/who.is.voc:4|kto robi|who does|
|tags/fallback-unknown/who.is.voc:5|kto to robi|who do|
|tags/fallback-unknown/why.dialog:2|Nie wiem|I don't know.|
|tags/fallback-unknown/why.dialog:3|Nie jestem do końca pewien.|I'm not quite sure.|
|tags/fallback-unknown/why.dialog:4|Nie jestem pewien.|I'm not sure.|
|tags/fallback-unknown/why.dialog:5|Nie jestem pewien, ale robię co mogę by się uczyć.|I'm not sure, but I'm doing my best to learn.|
|tags/fallback-unknown/why.is.voc:1|dlaczego jest|why is|
|tags/fallback-unknown/why.is.voc:2|dlaczego będzie|why will|
|tags/fallback-unknown/why.is.voc:3|dlaczego zrobił|why did|
|tags/fallback-unknown/why.is.voc:4|dlaczego|why does|
|tags/fallback-unknown/why.is.voc:5|dlaczego|why do|

# skill-release-test-pl
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-release-test/Release.dialog:1|Test zaliczony dla 19.2.5|Test passed for 19.08.5|
|tags/skill-release-test/ReleaseKeyword.voc:1|wywołuje test|invoking test|
|tags/skill-release-test/ReleaseKeyword.voc:2|wywołaj test|invoke test|
|tags/skill-release-test/ReleaseKeyword.voc:3|wywołaj test wydania|invoke release test|
|tags/skill-release-test/ReleaseKeyword.voc:4|test wydania|release test|
|tags/skill-release-test/ReleaseKeyword.voc:5|test wydany|released test|
...
|tags/skill-alarm/Alarm.voc:2|alarmy|alarms|
...
|tags/skill-alarm/All.voc:1|wszystkie|all|
|tags/skill-alarm/All.voc:2|oba|both|
|tags/skill-alarm/StopBeeping.voc:7|usuń|delete|
|tags/skill-alarm/Delete.voc:2||remove|
|tags/skill-alarm/StopBeeping.voc:4|anuluj|cancel|
|tags/skill-alarm/Delete.voc:4||clear|
|tags/skill-alarm/Delete.voc:5||erase|
|tags/skill-alarm/StopBeeping.voc:10|wyłącz|disable|
|tags/skill-alarm/StopBeeping.voc:2|zatrzymaj|stop|
|tags/skill-alarm/Delete.voc:8||turn off|
|tags/skill-alarm/Delete.voc:9||abort|
|tags/skill-alarm/StopBeeping.voc:8|zatrzymaj|kill|
|tags/skill-alarm/Except.voc:1|z wyjątkiem|except|
|tags/skill-alarm/Except.voc:2|z pominięciem|excluding|
|tags/skill-alarm/Except.voc:3|Wyklucz|exclude|
...
|tags/skill-alarm/Recurrence.voc:1|poniedziałek|monday|
|tags/skill-alarm/Recurrence.voc:2|wtorek|tuesday|
|tags/skill-alarm/Recurrence.voc:3|środa|wednesday|
|tags/skill-alarm/Recurrence.voc:4|czwartek|thursday|
|tags/skill-alarm/Recurrence.voc:5|piątek|friday|
|tags/skill-alarm/Recurrence.voc:6|sobota|saturday|
|tags/skill-alarm/Recurrence.voc:7|niedziela|sunday|
|tags/skill-alarm/Recurring.voc:1|# Te wartości również muszą być wspierane w pliku recurring.value|# These values must also be supported in the recurring.value file|
|tags/skill-alarm/Recurring.voc:1|powtarzające się|recurring|
|tags/skill-alarm/Recurring.voc:2|powtórzenie|repeating|
|tags/skill-alarm/Recurring.voc:4|każdy|each|
|tags/skill-alarm/Recurring.voc:3|każdy|every|
|tags/skill-alarm/Recurring.voc:4|codziennie|daily|
|tags/skill-alarm/Recurring.voc:5|dni powszednie|weekdays|
|tags/skill-alarm/Recurring.voc:6|weekendy|weekends|
|tags/skill-alarm/Recurring.voc:7|poniedziałki|mondays|
|tags/skill-alarm/Recurring.voc:8|wtorki|tuesdays|
|tags/skill-alarm/Recurring.voc:9|środy|wednesdays|
|tags/skill-alarm/Recurring.voc:10|czwartki|thursdays|
|tags/skill-alarm/Recurring.voc:11|piątki|fridays|
|tags/skill-alarm/Recurring.voc:12|soboty|saturdays|
|tags/skill-alarm/Recurring.voc:13|niedziele|sundays|
|tags/skill-alarm/Recurring.voc:15|dni robocze|work days|
|tags/skill-alarm/Recurring.voc:16|dni pracujące|workdays|
|tags/skill-alarm/Recurring.voc:18|# Tak, powinno już wyłapywać 'każdy' i 'poszczególny', ale Adapt je przegapia|# Yes, it should already catch 'each' and 'every', but Adapt is missing these|
|tags/skill-alarm/Recurring.voc:19|każdego dnia|every day|
|tags/skill-alarm/Recurring.voc:20|co tydzień|every weekday|
|tags/skill-alarm/Recurring.voc:21|każdego (ranka|poranka)|every morning|
|tags/skill-alarm/Recurring.voc:22|każdego popołudnia|every afternoon|
|tags/skill-alarm/Recurring.voc:23|każdego wieczoru|every evening|
|tags/skill-alarm/Recurring.voc:24|każdej nocy|every night|
|tags/skill-alarm/Recurring.voc:25|każdego dnia|each day|
|tags/skill-alarm/Recurring.voc:26|każdego dnia tygodnia|each weekday|
|tags/skill-alarm/Recurring.voc:27|każdego (ranka|poranka)|each morning|
|tags/skill-alarm/Recurring.voc:28|każdego popołudnia|each afternoon|
|tags/skill-alarm/Recurring.voc:29|każdego wieczoru|each evening|
|tags/skill-alarm/Recurring.voc:30|każdej nocy|each night|
|tags/skill-alarm/Set.voc:1|dodaj|add|
|tags/skill-alarm/Set.voc:1|ustaw|set|
|tags/skill-alarm/Set.voc:2|początek|start|
|tags/skill-alarm/Set.voc:3|utwórz|create|
|tags/skill-alarm/StopBeeping.voc:1|# Pojedyncze słowa, które wyłączą alarm|# Single words that will kill the alarm|
|tags/skill-alarm/StopBeeping.voc:3|zakończ|shut|
|tags/skill-alarm/StopBeeping.voc:4|zakończ|quit|
|tags/skill-alarm/StopBeeping.voc:5|wyjdź|exit|
|tags/skill-alarm/StopBeeping.voc:6|koniec|end|
|tags/skill-alarm/StopBeeping.voc:10|wyłącz|off|
|tags/skill-alarm/StopBeeping.voc:12|ok|ok|
|tags/skill-alarm/StopBeeping.voc:13|dobrze|okay|
|tags/skill-alarm/StopBeeping.voc:14|w porządku|alright|
|tags/skill-alarm/WakeMe.voc:1|obudź mnie|wake me|
|tags/skill-alarm/WakeMe.voc:2|obudź mnie|wake me up|
|tags/skill-alarm/WakeMe.voc:3||let me know|
|tags/skill-alarm/alarm.already.exists.dialog:1|Taki alarm już istnieje.|That alarm already exists.|
|tags/skill-alarm/alarm.already.exists.dialog:2||You already (have|set|created) an alarm for that time.|
|tags/skill-alarm/alarm.already.exists.dialog:3|Alarm o takim czasie jest już ustawiony|An alarm is already (set|created) for that time.|
|tags/skill-alarm/alarm.cancelled.desc.dialog:1|Anulowałem alarm dla {{desc}}|I've cancelled the alarm for {{desc}}|
|tags/skill-alarm/alarm.cancelled.desc.recurring.dialog:1|Anulowałem powtarzający się alarm dla {{desc}}|I've cancelled the recurring alarm for {{desc}}|
...
|tags/skill-alarm/alarm.cancelled.recurring.dialog:1|Seria powtarzających się alarmów została anulowana|The repeating alarm series has been cancelled|
...
|tags/skill-alarm/alarm.delete.cancelled.dialog:1|Żaden alarm nie został usunięty|No alarm is deleted|
...
|tags/skill-alarm/alarm.past.dialog:1|Nie mogę ustawić alarmu w przeszłości|I (cannot|can't) set an alarm in the past|
|tags/skill-alarm/alarm.past.dialog:2|Nie jestem w stanie ustawić alarmu dla czasu, który jest przeszłością|I can't set that time. It has already passed|
|tags/skill-alarm/alarm.schedule.cancelled.dialog:1||No alarm was (set|scheduled|created)|
|tags/skill-alarm/alarm.scheduled.dialog:1|Ustaw alarm|Alarm set|
...
|tags/skill-alarm/alarm.scheduled.for.time.dialog:1|Alarm ustawiony dla {{time}}, w {{rel}}|Alarm (created|set) for {{time}}, in {{rel}}|
|tags/skill-alarm/alarm.scheduled.for.time.dialog:2|Utworzyłem alarm dla {{time}}, {{rel}} od teraz|I've (created|set) an alarm for {{time}}, {{rel}} from now|
|tags/skill-alarm/alarms.list.empty.dialog:1|Żaden alarm nie został ustawiony|No alarms have been set|
|tags/skill-alarm/alarms.list.empty.dialog:2|Nie ma żadnego aktywnego alarmu|There are no active alarms|
...
|tags/skill-alarm/ask.cancel.desc.alarm.dialog:1|Potwierdzenie: Czy chcesz anulować alarm dla {{desc}}?|((Just|) Confirming:|)  Do you (wish|want) to cancel the alarm for {{desc}}?|
|tags/skill-alarm/ask.cancel.desc.alarm.recurring.dialog:1|Potwierdzenie: Czy chcesz anulować powtarzający się alarm dla {{desc}}?|((Just|) Confirming:|)  Do you (wish|want) to cancel the recurring alarm for {{desc}}?|
...
|tags/skill-alarm/confirm.alarm.dialog:1|Ustawiam alarm na {{time}}, czy to jest w porządku?|I'm (setting|creating) an alarm for {{time}}, does that sound right?|
|tags/skill-alarm/confirm.alarm.dialog:2|Tworzę nowy alarm na {{time}}, czy jest poprawny?|I'm (setting|creating) a new alarm for {{time}}, correct?|
|tags/skill-alarm/confirm.recurring.alarm.dialog:1|Ustawiam powtarzający się alarm na {{time}} dla {{recurrence}}, czy to w porządku?|I'm (setting|creating) a recurring alarm for {{time}} on {{recurrence}}, does that sound right?|
|tags/skill-alarm/confirm.recurring.alarm.dialog:2|Tworzę nowy powtarzający się alarm na {{time}} dla {{recurrence}}, czy jest poprawny?|I'm (setting|creating) a new recurring alarm for {{time}} on {{recurrence}}, correct?|
|tags/skill-alarm/daytype.entity:1|(dzień | dzień powszedni | dni powszednie | weekend | weekendy | jutro | dziś)|(day | weekday | weekdays | weekend | weekends | tomorrow | today)|
|tags/skill-alarm/daytype.entity:2|(poniedziałek  | wtorek  | środa  | czwartek  | piątek  | sobota  | niedziela |(monday  | tuesday  | wednesday  | thursday  | friday  | saturday  | sunday )|
|tags/skill-alarm/daytype.entity:3|(poniedziałki  | wtorki  | środy  | czwartki  | piątki | soboty  | niedziele )|(mondays  | tuesdays  | wednesdays  | thursdays  | fridays | saturdays  | sundays )|
...
|tags/skill-alarm/next.alarm.dialog:1|Twój następny alarm jest {when}, {duration} od teraz|(Your|The) next alarm is {when}, {duration} from now|
|tags/skill-alarm/next.alarm.dialog:2|Następny alarm jest o {when}, {duration} od teraz|(Your|The) next alarm is for {when}, {duration} from now|
|tags/skill-alarm/no.exceptions.yet.dialog:1|Jeszcze nie wspieram wyjątków. Musisz stworzyć osobny powtarzający się alarm.|I (can't|don't) support exceptions (yet|as of now).  You have to create individual repeating alarms.|
|tags/skill-alarm/query.for.when.dialog:1||(Alarm|) for (when|what time)?|
|tags/skill-alarm/query.recurrence.dialog:1|W jakie dni?|On what days?|
|tags/skill-alarm/query.recurrence.dialog:2|Dla jakich dni?|For which days?|
|tags/skill-alarm/recurring.alarm.dialog:1|{{time}} na {{recurrence}}|{{time}} on {{recurrence}}|
|tags/skill-alarm/recurring.alarm.named.dialog:1||{{time}} on {{recurrence}} (named|for|called) {{name}}|
|tags/skill-alarm/recurring.alarm.scheduled.for.time.dialog:1|Alarm ustawiony na {{time}}, zaczyna się o {{rel}}|Alarm (created|set) for {{time}}, beginning in {{rel}}|
|tags/skill-alarm/recurring.alarm.scheduled.for.time.dialog:2|Stworzyłem alarm na {{time}}, zaczynający się {{rel}} od teraz|I've (created|set) an alarm for {{time}}, starting {{rel}} from now |
|tags/skill-alarm/recurring.value:1|# przetłumaczone nazwy dni tygodnia|# translated name, day(s) of week|
|tags/skill-alarm/recurring.value:2|# pierwsza jest lista nazw w liczbnie mnogiej, efekt w postaci "7 w piątki" albo "7 każdego dnia"|# list plural version first, resulting in "7pm on fridays" or "7pm every day"|
|tags/skill-alarm/recurring.value:3|poniedziałki,1|mondays,1|
|tags/skill-alarm/recurring.value:2|poniedziałek,1|monday,1|
|tags/skill-alarm/recurring.value:5|wtorki,2|tuesdays,2|
|tags/skill-alarm/recurring.value:4|wtorek,2|tuesday,2|
|tags/skill-alarm/recurring.value:7|środy,3|wednesdays,3|
|tags/skill-alarm/recurring.value:6|środa,3|wednesday,3|
|tags/skill-alarm/recurring.value:9|czwartki,4|thursdays,4|
|tags/skill-alarm/recurring.value:8|czwartek,4|thursday,4|
|tags/skill-alarm/recurring.value:11|piątki,5|fridays,5|
|tags/skill-alarm/recurring.value:10|piątek,5|friday,5|
|tags/skill-alarm/recurring.value:13|soboty,6|saturdays,6|
|tags/skill-alarm/recurring.value:12|sobota,6|saturday,6|
|tags/skill-alarm/recurring.value:15|niedziele,0|sundays,0|
|tags/skill-alarm/recurring.value:14|niedziela,0|sunday,0|
|tags/skill-alarm/recurring.value:17|dni powszednie,1 2 3 4 5|weekdays,1 2 3 4 5|
|tags/skill-alarm/recurring.value:16|dzień powszedni,1 2 3 4 5|weekday,1 2 3 4 5|
|tags/skill-alarm/recurring.value:19|każdy dzień tygodnia, 1 2 3 4 5|every weekday, 1 2 3 4 5|
|tags/skill-alarm/recurring.value:20|każdego dnia tygodnia, 1 2 3 4 5|each weekday, 1 2 3 4 5|
|tags/skill-alarm/recurring.value:19|weekendy,0 6|weekends,0 6|
|tags/skill-alarm/recurring.value:18|weekend,0 6|weekend,0 6|
|tags/skill-alarm/recurring.value:21|codziennie,0 1 2 3 4 5 6|every day,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:24|każdego dnia,0 1 2 3 4 5 6|each day,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:22|codziennie,0 1 2 3 4 5 6|everyday,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:26|każdego poranka,0 1 2 3 4 5 6|every morning,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:27|każdego popołudnia,0 1 2 3 4 5 6|every afternoon,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:28|każdego wieczora,0 1 2 3 4 5 6|every evening,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:29|każdej nocy,0 1 2 3 4 5 6|every night,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:30|każdego ranka,0 1 2 3 4 5 6|each morning,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:31|każdego popołudnia,0 1 2 3 4 5 6|each afternoon,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:32|każdego wieczora,0 1 2 3 4 5 6|each evening,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:33|każda noc,0 1 2 3 4 5 6|each night,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:20|dziennie,0 1 2 3 4 5 6|daily,0 1 2 3 4 5 6|
|tags/skill-alarm/recurring.value:35|dni robocze,1 2 3 4 5|work days,1 2 3 4 5|
|tags/skill-alarm/recurring.value:24|praca,1 2 3 4 5|work,1 2 3 4 5|
|tags/skill-alarm/repeats.dialog:1||repeats|
|tags/skill-alarm/snooze.intent:1|drzemka|snooze|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/desktop-control/CopyKeyword.voc:1|kopiuj do schowka|copy to clipboard|
|tags/desktop-control/CopyKeyword.voc:2|kopiuj|copy|
|tags/desktop-control/CutKeyword.voc:1|wytnij do schowka|cut to clipboard|
|tags/desktop-control/CutKeyword.voc:2|wytnij|cut|
|tags/desktop-control/DeleteKeyword.voc:1|usuń|delete|
|tags/desktop-control/PasteKeyword.voc:1|wklej ze schowka|paste from clipboard|
|tags/desktop-control/PasteKeyword.voc:2|wklej|paste|
|tags/desktop-control/ScreenResKeyword.voc:1|rozdzielczość ekranu|screen resolution|
|tags/desktop-control/SelectAllKeyword.voc:1|zaznacz wszystko|select all|
|tags/desktop-control/Text.rx:1||(type) (?P<Text>.*)|
|tags/desktop-control/TypeKeyword.voc:1||type|
|tags/desktop-control/absolutemousemove.dialog:1|Przesuwanie myszy na {{x}} i {{y}}|Moving the mouse to {{x}} and {{y}}|
|tags/desktop-control/absolutemousemove.intent:1|przesuń kursor myszy na {x} i {y} |move mouse to {x} and {y} |
|tags/desktop-control/down.entity:1|w dół |down |
|tags/desktop-control/holdkey.intent:1|naciśnij klawisz {key}|hold the {key} key|
|tags/desktop-control/holdkey.intent:2|przytrzymaj klawisz {key}|hold down the {key} key|
...
|tags/desktop-control/key.entity:27|w dół|down|
|tags/desktop-control/key.entity:28|w górę|up|
|tags/desktop-control/key.entity:29|w lewo|left|
|tags/desktop-control/key.entity:30|w prawo|right|
|tags/desktop-control/keyhold.dialog:1||Holding {{key}}|
|tags/desktop-control/keyhold.dialog:2|Przytrzymaj klawisz {{key}}|Holding down the {{key}} key|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/homeassistant/AutomationActionKeyword.voc:1|aktywuj|activate|
|tags/homeassistant/AutomationActionKeyword.voc:2|wywołaj|fire|
|tags/homeassistant/AutomationActionKeyword.voc:3|wywołaj|call up|
|tags/homeassistant/AutomationActionKeyword.voc:4|wyzwól|trigger|
|tags/homeassistant/AutomationActionKeyword.voc:5|scena|scene|
|tags/homeassistant/AutomationActionKeyword.voc:6|automatyzacja|automation|
|tags/homeassistant/AutomationActionKeyword.voc:7|skrypt|script|
|tags/homeassistant/ClimateKeyword.voc:1|ustaw temperaturę {entity} na {temperature}|set the {entity} temperature to {temperature}|
|tags/homeassistant/DecreaseVerb.voc:1|obniż|decrease|
|tags/homeassistant/DecreaseVerb.voc:2|dół|down|
|tags/homeassistant/DeviceTrackerKeyword.voc:1|gdzie jest|where is|
|tags/homeassistant/DeviceTrackerKeyword.voc:2|lokalizuj|lokalizacja|locate|location|
|tags/homeassistant/DeviceTrackerKeyword.voc:3|gdzie|where|
|tags/homeassistant/IncreaseVerb.voc:1|zwiększ|increase|
|tags/homeassistant/IncreaseVerb.voc:2|góra|up|
|tags/homeassistant/LightBrightenVerb.voc:1|rozjaśnij|jaśniej|brighten|brighter|bright|up|
|tags/homeassistant/LightDimVerb.voc:1|przyciemnij|ciemniej|ciemno|ściemnij|dim|dimmer|dark|darken|lower|down|
|tags/homeassistant/LightsKeyword.voc:1|światło|light|
|tags/homeassistant/LightsKeyword.voc:2|światła|lights|
|tags/homeassistant/LightsKeyword.voc:3|lampa|lamp|
|tags/homeassistant/LightsKeyword.voc:4|lampy|lamps|
|tags/homeassistant/LightsKeyword.voc:5|żarówka|bulb|
|tags/homeassistant/LightsKeyword.voc:6|żarówki|bulbs|
|tags/homeassistant/LightsKeyword.voc:7|LED|l.e.d.|
|tags/homeassistant/LightsKeyword.voc:8|włącz|turn on|
|tags/homeassistant/LightsKeyword.voc:9|wyłącz|turn off|
|tags/homeassistant/LightsKeyword.voc:10|przełącz|toggle|
|tags/homeassistant/SensorStatusKeyword.voc:1|stan|state|
|tags/homeassistant/SensorStatusKeyword.voc:2|status|status|
|tags/homeassistant/SensorStatusKeyword.voc:3|czujnik|sensor|
|tags/homeassistant/SensorStatusKeyword.voc:4|wykrywacz|detector|
|tags/homeassistant/SensorStatusKeyword.voc:5|wartość|value|
|tags/homeassistant/SensorStatusKeyword.voc:6|odczyt|read out|
|tags/homeassistant/SensorStatusKeyword.voc:7|jaki jest aktualny|what is the current|
|tags/homeassistant/SensorStatusKeyword.voc:8|jaki jest aktualny|what is current|
|tags/homeassistant/SensorStatusKeyword.voc:9|podaj (mi) aktualny|tell me the current|
|tags/homeassistant/SensorStatusKeyword.voc:10|podaj (mi) aktualny|tell me current|
|tags/homeassistant/SensorStatusKeyword.voc:11|podaj (mi) wartość|give me the value of|
|tags/homeassistant/SensorStatusKeyword.voc:12|jaka jest (wartość|temperatura) na termostacie|what is the value of thermostat|
|tags/homeassistant/SetVerb.voc:1|ustaw|set|
|tags/homeassistant/SwitchActionKeyword.voc:1|ustaw|turn|
|tags/homeassistant/SwitchActionKeyword.voc:2|przełącz|switch|
|tags/homeassistant/automation.rx:1|(uruchom|odpal|włącz|wyzwól|przywołaj) (?P<Entity>.*)|(activate|fire|trigger|call up) (?P<Entity>.*)|
|tags/homeassistant/climate.rx:1|(ustaw) (?P<Entity>.*) termostat na (?P<temp>[0-9]*)|(set) (?P<Entity>.*) thermostat to (?P<temp>[0-9]*)|
|tags/homeassistant/dimming.rx:1|(ustaw) (?:jasność )?(?P<Entity>.*) (na) (?P<BrightnessValue>\d*)(?: procent)?|(set) (?:brightness of )?(?P<Entity>.*) (to) (?P<BrightnessValue>\d*)(?: percent)?|
|tags/homeassistant/dimming.rx:2|(przyciemnij|rozjaśnij|zwiększ|zmniejsz) (?:jasność )?(?P<Entity>.*?) (?:o)? (?P<BrightnessValue>\d*)?(?: procent)?|(dim|brighten|increase|decrease) (?:brightness of )?(?P<Entity>.*?) (?:by)? (?P<BrightnessValue>\d*)?(?: percent)?|
|tags/homeassistant/homeassistant.automation.trigger.dialog:1|wywołano automatyzację {{dev_name}}.|triggered automation {{dev_name}}.|
|tags/homeassistant/homeassistant.automation.trigger.dialog:2|wywołano {{dev_name}}.|triggered {{dev_name}}.|
|tags/homeassistant/homeassistant.automation.trigger.dialog:3|{{dev_name}} został wywołany.|{{dev_name}} was triggered.|
|tags/homeassistant/homeassistant.automation.trigger.dialog:4|{{dev_name}} został aktywowany.|{{dev_name}} was activated.|
|tags/homeassistant/homeassistant.automation.trigger.dialog:5|aktywowano {{dev_name}}.|activated {{dev_name}}.|
|tags/homeassistant/homeassistant.brightness.badreq.dialog:1|poziom jasności musi mieścić się między 0 a 100.|please request a brightness level between 0 and 100.|
|tags/homeassistant/homeassistant.brightness.badreq.dialog:2|Jak jasno? Możesz wybrać poziom z przedziału od 0 do 100.|how bright? you can choose a level from 0 to 100.|
|tags/homeassistant/homeassistant.brightness.cantdim.dimmable.dialog:1|Nie mogę przyciemnić {{dev_name}}. To urządzenie nie obsługuje tej funkcji.|Can not dim {{dev_name}}. It is not dimmable.|
|tags/homeassistant/homeassistant.brightness.cantdim.off.dialog:1|Nie mogę przyciemnić {{dev_name}}. Urządzenie jest wyłączone.|Can not dim {{dev_name}}. It is off.|
|tags/homeassistant/homeassistant.brightness.cantdim.off.dialog:2|Nie mogę przyciemnić {{dev_name}}. Najpierw musisz włączyć to urządzenie.|Can not dim {{dev_name}}. Please turn it on before.|
...
|tags/homeassistant/homeassistant.brightness.decreased.dialog:2|wywołano {{dev_name}}.|Dimmed {{dev_name}}.|
...
|tags/homeassistant/homeassistant.device.toggle.dialog:1|wywołano {{dev_name}}.|toggled {{dev_name}}.|
|tags/homeassistant/homeassistant.device.toggle.dialog:2|{{dev_name}} został wywołany.|{{dev_name}} was toggled.|
...
|tags/homeassistant/set.climate.intent:2|ustaw temperaturę {entity} na {temp} stopni|set the {entity} temperature to {temp} degrees|
|tags/homeassistant/set.climate.intent:3|ustaw temperaturę {entity} na {temp} stopni|change the {entity} temperature to {temp} degrees|
...
|tags/skill-weather/Cold.voc:3|mroźno|freezing|
...
|tags/skill-weather/ConfirmQuery.voc:6|będzie|going to|
...
|tags/skill-weather/E.dialog:1|wschód|east|
...
|tags/skill-weather/Foggy.voc:1|mgła|fog|
|tags/skill-weather/Foggy.voc:2|mgliście|foggy|
|tags/skill-weather/Foggy.voc:3|mgła|mist|
|tags/skill-weather/Foggy.voc:4|mgliście|misty|
|tags/skill-weather/Forecast.voc:1|prognoza|forecast|
|tags/skill-weather/High.voc:1|wysoki|high|
...
|tags/skill-weather/Query.voc:1|jak|how|
|tags/skill-weather/Humidity.voc:1|wilgotny|humid|
|tags/skill-weather/Humidity.voc:2|wilgotność|humidity|
|tags/skill-weather/Humidity.voc:3|parny|steamy|
|tags/skill-weather/Later.voc:1|następna godzina|next hour|
|tags/skill-weather/Later.voc:2|następne godziny|next hours|
|tags/skill-weather/Later.voc:3|kilka godzin|few hours|
|tags/skill-weather/Later.voc:4|następne kilka godzin|next few hours|
|tags/skill-weather/Later.voc:5|kilka godzin|couple of hours|
|tags/skill-weather/Later.voc:6|następne kilka godzin|next couple of hours|
|tags/skill-weather/Later.voc:7|później|later|
|tags/skill-weather/Location.voc:1|Seattle|Seattle|
|tags/skill-weather/Location.voc:2|Los Angeles Kalifornia|Los Angeles california|los angeles|la|
|tags/skill-weather/Location.voc:3|Lawrence Kansas|Lawrence kansas|
|tags/skill-weather/Location.voc:4|Portland Oregon|portland oregon|portland|
|tags/skill-weather/Location.voc:5|Spokane|spokane|
|tags/skill-weather/Location.voc:6|Nowy Jork|new york|
...
|tags/skill-weather/Location.voc:14|Waszyngton|washington d c|
...
|tags/skill-weather/N.dialog:1|północ|north|
|tags/skill-weather/NE.dialog:1|północny-wschód|north east|
|tags/skill-weather/NW.dialog:1|północny-zachód|north west|
|tags/skill-weather/Next.voc:1|następny|next|
|tags/skill-weather/Next.voc:2|ponownie|again|
|tags/skill-weather/Now.voc:1||current|
|tags/skill-weather/Now.voc:2|śnieg|now|
|tags/skill-weather/Precipitation.voc:1|deszcz|rain|
|tags/skill-weather/Precipitation.voc:2|śnieg|snow|
|tags/skill-weather/Precipitation.voc:3|opady atmosferyczne|precipitation|
|tags/skill-weather/Precipitation.voc:4|deszczowy|rainy|
|tags/skill-weather/Precipitation.voc:5|śnieżny|snowy|
|tags/skill-weather/Precipitation.voc:6|padać deszcz|raining|
|tags/skill-weather/Precipitation.voc:7|padać śnieg|snowing|
|tags/skill-weather/Precipitation.voc:8||drizzle|
|tags/skill-weather/Query.voc:2|co jest|what is|
...
|tags/skill-weather/S.dialog:1|południe|south|
|tags/skill-weather/SE.dialog:1|południowy-wschód|south east|
|tags/skill-weather/SW.dialog:1|południowy-zachód|south west|
...
|tags/skill-weather/Sunrise.voc:1|wschód słońca|sunrise|
|tags/skill-weather/Sunrise.voc:2|wschód słońca|sun rise|
|tags/skill-weather/Sunrise.voc:3|świt|dawn|
|tags/skill-weather/Sunrise.voc:4||daybreak|
|tags/skill-weather/Sunrise.voc:5||day break|
|tags/skill-weather/Sunset.voc:1|zachód słońca|sunset|
|tags/skill-weather/Sunset.voc:2|zachód słońca|sun set|
|tags/skill-weather/Sunset.voc:3|zmierzch|dusk|
...
|tags/skill-weather/W.dialog:1|zachód|west|
|tags/skill-weather/Weather.voc:1|pogoda|weather|
|tags/skill-weather/WeatherType.voc:1|deszcẓ|deszcz|rain|raining|
...
|tags/skill-weather/WeatherType.voc:6|gorąco|ciepło|hot|warm|
|tags/skill-weather/WeatherType.voc:7|zimno|chłodno|cold|cool|
|tags/skill-weather/Week.voc:1||week|
|tags/skill-weather/Week.voc:2||weekly|
|tags/skill-weather/Weekend.voc:1||weekend|
|tags/skill-weather/Next.voc:3|kiedy|when|
...
|tags/skill-weather/Windy.voc:1|wiatr|wind|
|tags/skill-weather/Windy.voc:2|wietrznie|windy|
|tags/skill-weather/Windy.voc:3|wiatr|winds|
|tags/skill-weather/Windy.voc:4||wind speed|
|tags/skill-weather/Windy.voc:3||breezy|
|tags/skill-weather/Windy.voc:4||gusting|
|tags/skill-weather/Windy.voc:5|wieje|blowing|
...
|tags/skill-weather/condition.category.value:5|deszcẓ|deszcz|Rain,raining|
...
|tags/skill-weather/current.weather.dialog:1|Aktualnie {{condition}} and {{temp}} degrees {{scale}}. Temperatura prognozowana na dziś to maksymalnie {{temp_max}} i minimalnie {{temp_min}}.|It's currently {condition} and {temp} degrees {scale} in {location}. Today's forecast is for a high of {temp_max} and a low of {temp_min}.|
...
# picroft-google-aiy-voicekit-pl
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/picroft-google-aiy-voicekit/error.initialize.dialog:1|Mam problem z inicjalizacją funkcji głosowych Google A I Y. Funkcja nie zostanie załadowana. |I am having problems initializing the Google A I Y voice kit Skill. The Skill will not load. |

# 00__skill_template-pl
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/00__skill_template/Count.voc:1|liczyć|count|
|tags/00__skill_template/Dir.voc:1|góra|up|
|tags/00__skill_template/Dir.voc:2|dół|down|
|tags/00__skill_template/Hello.voc:1|cześć|hello|
|tags/00__skill_template/Hello.voc:2|Witam!|greetings|
|tags/00__skill_template/Hello.voc:3|hej|howdy|
|tags/00__skill_template/World.voc:1|świat|world|
|tags/00__skill_template/World.voc:2|ziemia|earth|
|tags/00__skill_template/count.is.now.dialog:1|Liczbą jest teraz {{count}}|The count is now {{count}}|
|tags/00__skill_template/count.is.now.dialog:2|Teraz jesteśmy przy {{count}} |We are now up to {{count}}|
|tags/00__skill_template/hello.world.dialog:1|Cześć|Hello|
|tags/00__skill_template/hello.world.dialog:2|Cześć|Hi to you too|
...
|tags/skill-date-time/Date.voc:2|dzień|day|
|tags/skill-date-time/Display.voc:1||display|
|tags/skill-date-time/Display.voc:2|pokaż|show|
...
|tags/skill-date-time/Query.voc:1|co|what|
|tags/skill-date-time/Query.voc:2|powiedz|tell|
...
|tags/skill-date-time/Time.voc:1|czas|time|
...
# carstena-the-cows-lists-pl
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/carstena-the-cows-lists/AddTask.rx:1|Dodaj (?P<taskName>.+)|add (?P<taskName>.+)|
|tags/carstena-the-cows-lists/AddTaskToList.dialog:1|{{taskName}} został dodany do listy {{listName}}|{{taskName}} was added to list {{listName}}|
|tags/carstena-the-cows-lists/AddTaskToList.rx:1|Dodaj (?P<taskName>.+) do (my )?(?P<listName>.+) list$|add (?P<taskName>.+) to (my )?(?P<listName>.+) list$|
|tags/carstena-the-cows-lists/AddTaskToList.rx:2|Dodaj (?P<taskName>.+) do listy (?P<listName>.+)$|add (?P<taskName>.+) to list (?P<listName>.+)$|
|tags/carstena-the-cows-lists/AddTaskToListKeyword.voc:1|dodaj|add|
|tags/carstena-the-cows-lists/AddTaskToListMismatch.dialog:1|Nie znalazłem listy o nazwie {{listName}}. Czy zamiast tego mogę dodać zadanie do {{bestMatch}}?|I cant find a list called {{listName}}, do you want to add the task to {{bestMatch}} instead?|
|tags/carstena-the-cows-lists/AddTaskToListUndo.dialog:1|Jeszcze raz usunąłem {{taskName}} z listy {{listName}}|I have removed {{taskName}} from list {{listName}} again|
|tags/carstena-the-cows-lists/AnythingElse.dialog:1|{taskName}, coś jeszcze?|{taskName}, anything else?|
|tags/carstena-the-cows-lists/AnythingElseEnd.dialog:1|Ok, zadania zostały dodane do listy {{listName}}|okay, the tasks are added to list {{listName}}|
|tags/carstena-the-cows-lists/AskSendException.dialog:1|Czy chcesz abym wysłał wiadomość z ostatnim błędem aby pomóc zgłosić problem?|Do you want me to send a mail with the last exception, to help you report the issue?|
|tags/carstena-the-cows-lists/Authenticate.rx:1|Uwierzytelnij (?P<authenticateWord>.+) pamiętaj o milk$|authenticate (?P<authenticateWord>.+) remember the milk$|
|tags/carstena-the-cows-lists/AuthenticateBeforeToken.dialog:1|Przed pobraniem tokenu muszę się uwierzytelnić, poproś mnie o uwierzytelnienie z remember the milk.|I must authenticate before getting a token, ask me to authenticate with remember the milk|
|tags/carstena-the-cows-lists/AuthenticateKeyword.voc:1|Uwierzytelnij z|authenticate with|
|tags/carstena-the-cows-lists/CompleteList.dialog:1|{{nofTask}} zadania na liście {{listName}} zostały oznaczone jako wykonane|{{nofTask}} tasks on list {{listName}} was marked complete|
|tags/carstena-the-cows-lists/CompleteListOneTask.dialog:1|{{nofTask}} zadanie na liście {{listName}} zostało oznaczone jako wykonane|{{nofTask}} task on list {{listName}} was marked complete|
|tags/carstena-the-cows-lists/CompleteListOneTaskUndo.dialog:1|Zadanie {{nofTask}} z listy {{listName}} zostało ponownie przywrócone|I have restored {{nofTask}} task on list {{listName}} again|
|tags/carstena-the-cows-lists/CompleteListStart.dialog:1|Oznaczę zadania {{nofTask}} na liście {{listName}} jako wykonane, to może chwilę zająć. Możesz cofnąć tą operację mówiąc: przywróć, cofnij lub odwróć po moim zakończeniu zadania|I will mark {{nofTask}} tasks on list {{listName}} complete, this may take a while. You can undo this operation by saying either restore, undo or revert after I finish|
|tags/carstena-the-cows-lists/CompleteListUndo.dialog:1|Zadanie {{nofTask}} z listy {{listName}} zostało ponownie przywrócone|I have restored {{nofTask}} tasks on list {{listName}} again|
|tags/carstena-the-cows-lists/CompleteManyTasksOnList.dialog:1|{{nofTask}} zadania na liście {{listName}} zostały oznaczone jako wykonane|{{nofTask}} tasks named {{taskName}} on list {{listName}} was marked complete|
|tags/carstena-the-cows-lists/CompletePartOfListStart.dialog:1|Znalazłem {{nofTask}} zadań. Ukończę tylko część z nich aby skrócić czas wykonania procesu|I found {{nofTask}} tasks, I will only complete a part of them, to keep the processing time down.|
|tags/carstena-the-cows-lists/CompleteTask.rx:1|ukończ (?P<taskName>.+)$|complete (?P<taskName>.+)$|
|tags/carstena-the-cows-lists/CompleteTaskOnList.dialog:1|{{nofTask}} zadanie na liście {{listName}} zostało oznaczone jako wykonane|{{taskName}} on list {{listName}} was marked complete|
|tags/carstena-the-cows-lists/CompleteTaskOnList.rx:1|Dodaj (?P<taskName>.+) do (my )?(?P<listName>.+) list$|complete (?P<taskName>.+) on (my )?(?P<listName>.+) list$|
|tags/carstena-the-cows-lists/CompleteTaskOnList.rx:2|Dodaj (?P<taskName>.+) do listy (?P<listName>.+)$|complete (?P<taskName>.+) on list (?P<listName>.+)$|
|tags/carstena-the-cows-lists/CompleteTaskOnListKeyword.voc:1|zakończone|complete|
|tags/carstena-the-cows-lists/CompleteTaskOnListUndo.dialog:1|Usunąłem {{taskName}} z listy {{listName}} jeszcze raz.|I have restored {{taskName}} on list {{listName}} again|
|tags/carstena-the-cows-lists/ConfigNotFound.dialog:1|Nie mogę odczytać konfiguracji. Proszę edytuj plik mycroft kropka config albo zaktualizuj konfigurację na home kropka mycroft kropka a, i|I could not read the configuration. Please edit mycroft dot config or update the configuration on home dot mycroft dot a, i|
|tags/carstena-the-cows-lists/DoYouWantToCompleteIt.dialog:1|Czy chcesz to zastąpić?|do you want to complete it|
...
|tags/carstena-the-cows-lists/FindTask.rx:1|Znajdź (?P<taskName>.+)|find (?P<taskName>.+)|
|tags/carstena-the-cows-lists/FindTaskOnList.dialog:1|Znalazłem {{taskName}} na liście {{listName}}|I found {{taskName}} on list {{listName}}|
|tags/carstena-the-cows-lists/FindTaskOnList.rx:1|Dodaj (?P<taskName>.+) do (my )?(?P<listName>.+) list$|find (?P<taskName>.+) on (my )?(?P<listName>.+) list$|
|tags/carstena-the-cows-lists/FindTaskOnList.rx:2|Dodaj (?P<taskName>.+) do listy (?P<listName>.+)$|find (?P<taskName>.+) on list (?P<listName>.+)$|
|tags/carstena-the-cows-lists/FindTaskOnListKeyword.voc:1|znajdź|find|
...
|tags/carstena-the-cows-lists/LocalRegex.json:4|Dodaj (?P<taskName>.+) do (my )?(?P<listName>.+) list$|    "add (?P<taskName>.+) to (my|the) (?P<listName>.+) list$",|
|tags/carstena-the-cows-lists/LocalRegex.json:5|Dodaj (?P<taskName>.+) do listy (?P<listName>.+)$|    "add (?P<taskName>.+) to list (?P<listName>.+)$"],|
...
|tags/carstena-the-cows-lists/LocalRegex.json:8|Dodaj (?P<taskName>.+) do (my )?(?P<listName>.+) list$|    "find (?P<taskName>.+) on (my|the) (?P<listName>.+) list$",|
|tags/carstena-the-cows-lists/LocalRegex.json:9|Dodaj (?P<taskName>.+) do listy (?P<listName>.+)$|    "find (?P<taskName>.+) on list (?P<listName>.+)$"],|
...
|tags/carstena-the-cows-lists/LocalRegex.json:12|Dodaj (?P<taskName>.+) do (my )?(?P<listName>.+) list$|    "complete (?P<taskName>.+) on (my|the) (?P<listName>.+) list$",|
|tags/carstena-the-cows-lists/LocalRegex.json:13|Dodaj (?P<taskName>.+) do listy (?P<listName>.+)$|    "complete (?P<taskName>.+) on list (?P<listName>.+)$"],|
|tags/carstena-the-cows-lists/LocalRegex.json:14||  "CompleteList" : [|
|tags/carstena-the-cows-lists/LocalRegex.json:15|    "Ukończ wszystkie (zadania(e)?|Pozycje(a)?) na (mojej|istniejacej) (?P<listName>.+) list$",|    "complete all (task(s)?|item(s)?) on (my|the) (?P<listName>.+) list$",|
|tags/carstena-the-cows-lists/LocalRegex.json:16|    "Ukończ wszystkie (zadania(s)?|pozycje(s)?) na liscie (?P<listName>.+)$"],|    "complete all (task(s)?|item(s)?) on list (?P<listName>.+)$"],|
...
|tags/carstena-the-cows-lists/UsingAnotherList.dialog:1|Nie znalazłem {{listName}}, czy zamiast tego mogę dodać zadanie do {{bestMatch}}|I cant find a list called {{listName}}, do you want to use the list {{bestMatch}} instead?|
...
# knock-knock-jokes-skill-pl
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/knock-knock-jokes-skill/joke.voc:1|żart|joke|
|tags/knock-knock-jokes-skill/knock-knock.dialog:1|puk puk|knock knock|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-singing/Sing.voc:1|śpiewaj|sing|
|tags/skill-singing/Sing.voc:2|zaśpiewaj mi piosenkę|sing me a song|
|tags/skill-singing/singing.dialog:1|Z przyjemnością dla Ciebie zaśpiewam.|I would be happy to sing for you. |
|tags/skill-singing/singing.dialog:2|Uwaga, nadchodzę.|Here I go.|
|tags/skill-singing/singing.dialog:3|Mam lekką tremę przez mój głos, ale spróbuję.|I'm a bit nervous about my voice, but here goes nothing.|
|tags/skill-singing/singing.stop.dialog:1|Dziękuję za wysłuchanie|thank you for listening|
|tags/skill-singing/singing.stop.dialog:2|Mam nadzieję, że mój głos Ci się spodobał|I hope you liked my voice|
|tags/skill-singing/singing.stop.dialog:3|Teraz Ty spróbuj|now you try|
...
|tags/email-skill/check.email.intent:1|sprawdź pocztę.|check my email|
|tags/email-skill/check.email.intent:2|sprawdź maila.|check my mail|
|tags/email-skill/check.email.intent:3|mam nowe wiadomości?|do i have any new mail|
|tags/email-skill/check.email.intent:4|mam nowe wiadomości?|do I have any email|
|tags/email-skill/check.email.intent:5|mam nowe wiadomości?|do i have any new emails|
...
|tags/email-skill/error.getting.mail.dialog:1|Pojawił się błąd podczas próby połączenia się z twoja skrzynką pocztową. Spróbuj sprawdzić swoje dane logowania i informacje serwera.|There was an error getting your email Try checking your credentials and server information|
|tags/email-skill/error.getting.mail.dialog:2|Sprawdź swoje dane logowania i informacje serwera ponieważ pojawił się błąd podczas próby połączenia do twojej poczty.|Check your credentials and server information because there was a problem getting your mail|
|tags/email-skill/error.getting.mail.dialog:3|Nie mogę połączyć się z twoim serwerem poczty. Sprawdź swoje hasło i informacje serwera.|I can not connect to your email server Check your password and server information|
|tags/email-skill/list.subjects.dialog:1|numer {message_num} jest od {sender}. Tytuł wiadomości to {subject}.|Your {message_num} email is from {sender} Its subject is {subject}|
|tags/email-skill/list.subjects.dialog:2|Temat wiadomości numer {message_num} to {subject}. Została wysłana przez {sender}|The {message_num} email's subject is {subject} Its from {sender}|
|tags/email-skill/more.emails.dialog:1|chcesz usłyszeć więcej?|would you like to hear more|
|tags/email-skill/more.emails.dialog:2|Przeczytać więcej wiadomości?|want to hear more of your emails|
...
|tags/email-skill/no.new.email.dialog:1|Nie ma żadnych nowych wiadomości.|There is no new email|
|tags/email-skill/no.new.email.dialog:2|Brak nowych wiadomości.|There's no new email|
|tags/email-skill/no.new.email.dialog:3|Brak nowych wiadomości.|There's no new mail|
|tags/email-skill/no.new.email.dialog:4|Nie ma żadnych nowych wiadomości.|There is no new mail|
|tags/email-skill/no.new.email.dialog:5|Nie ma nowych wiadomości.|There's no new email for you|
|tags/email-skill/no.new.email.dialog:6|Nie ma nowych wiadomości.|There's no new mail for you|
|tags/email-skill/no.new.email.dialog:7|mam nowe wiadomości?|You have no new mail|
|tags/email-skill/no.new.email.dialog:8|mam nowe wiadomości?|You have no new email|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-volume/Decrease.voc:1|zmniejsz|lower|
|tags/skill-volume/Decrease.voc:2|zredukuj|reduce|
|tags/skill-volume/Decrease.voc:3|zmniejsz|decrease|
|tags/skill-volume/Decrease.voc:5|ciszej|quieter|
|tags/skill-volume/Decrease.voc:5|ciszej|softer|
|tags/skill-volume/Decrease.voc:6|mniej|less|
|tags/skill-volume/Decrease.voc:7|w dół|down|
|tags/skill-volume/Increase.voc:1|wyżej|higher|
|tags/skill-volume/Increase.voc:1|zwiększ|rise|
|tags/skill-volume/Increase.voc:4|zwiększ|increase|
|tags/skill-volume/Increase.voc:2|podgłośnij|raise|
|tags/skill-volume/Increase.voc:3|wzmocnij|boost|
|tags/skill-volume/Increase.voc:6|głośniej|louder|
|tags/skill-volume/Increase.voc:7|bardziej|more|
|tags/skill-volume/Increase.voc:8|powiększ|up|
...
|tags/skill-volume/Level.voc:13|cicho|quiet|
|tags/skill-volume/Level.voc:14|normalny|normal|
|tags/skill-volume/Level.voc:15|głośno|loud|
|tags/skill-volume/MaxVolume.voc:1|maks|max|
|tags/skill-volume/MaxVolume.voc:2|maksymalnie|maximum|
|tags/skill-volume/MaxVolume.voc:3|najgłośniej|loudest|
|tags/skill-volume/MaxVolume.voc:4|największa|highest|
|tags/skill-volume/MaxVolume.voc:5|do końca|all the way|
|tags/skill-volume/MaxVolume.voc:6|do oporu|crank|
|tags/skill-volume/MaxVolumePhrase.voc:2|podkręć|turn|
|tags/skill-volume/Mute.voc:1|wycisz|mute|
|tags/skill-volume/Mute.voc:2|cisza|silence|
|tags/skill-volume/Percent.voc:1|procent|percent|
|tags/skill-volume/Percent.voc:2|%|%|
|tags/skill-volume/Query.voc:1|co|what|
|tags/skill-volume/Query.voc:2|powiedz|tell|
|tags/skill-volume/QueryPhrase.voc:1|jak wysoko|how high|
|tags/skill-volume/QueryPhrase.voc:2|jak głośno|how loud|
|tags/skill-volume/Set.voc:2|zrób|make|
|tags/skill-volume/Set.voc:3|ustaw|set|
|tags/skill-volume/To.voc:1|na|to|
|tags/skill-volume/Unmute.voc:2|przywróć dźwięk|unmute|
|tags/skill-volume/Unmute.voc:1|zresetuj|reset|
|tags/skill-volume/Unmute.voc:3|przywróć|restore|
|tags/skill-volume/Reset.voc:2|domyślny|default|
|tags/skill-volume/Volume.voc:1|głośność|volume|
|tags/skill-volume/Volume.voc:2|głośnik|speaker|
|tags/skill-volume/Volume.voc:4|dźwięk|sound|
|tags/skill-volume/Volume.voc:4|audio|audio|
|tags/skill-volume/already.max.volume.dialog:1|Głośność jest już maksymalna|Volume is already at maximum|
|tags/skill-volume/already.max.volume.dialog:2|Nie mogę już głośniej|I can't get any louder|
|tags/skill-volume/decrease.volume.dialog:1|Głośność obniżona do {{volume}}|Volume reduced to {{volume}}|
|tags/skill-volume/decrease.volume.dialog:2|Głośność zniżona do {{volume}}|Volume decreased to {{volume}}|
|tags/skill-volume/decrease.volume.dialog:3|Głośność jest teraz na {{volume}}|Volume is now {{volume}}|
|tags/skill-volume/increase.volume.dialog:2|Głośność zwiększona do {{volume}}|Volume increased to {{volume}}|
|tags/skill-volume/max.volume.dialog:1|Głośność ustawiona na maksymalnym poziomie|Volume set to maximum level|
|tags/skill-volume/max.volume.dialog:2|Głośność zaktualizowana na maksymalny poziom|Volume updated to maximum level|
|tags/skill-volume/max.volume.dialog:3|Zmieniono poziom głośności na maksymalny poziom|Volume changed to maximum level|
|tags/skill-volume/mute.volume.dialog:1|Dźwięk zostanie wyciszony|Audio is going to be muted|
|tags/skill-volume/mute.volume.dialog:2|Dźwięk będzie wyciszony|Sound is going to be muted|
|tags/skill-volume/reset.volume.dialog:1|Poziom głośności zresetowany na {{volume}}|Volume reset to {{volume}}|
|tags/skill-volume/reset.volume.dialog:2|Głośność przywrócona do {{volume}}|Volume restored to {{volume}}|
|tags/skill-volume/set.volume.dialog:1|Głośność ustawiona na {{volume}}|Volume set to {{volume}}|
|tags/skill-volume/set.volume.dialog:2|Głośność zaktualizowana na {{volume}}|Volume updated to {{volume}}|
|tags/skill-volume/set.volume.dialog:3|Głośność zmieniona na {{volume}}|Volume changed to {{volume}}|
|tags/skill-volume/set.volume.percent.dialog:1|Głośność ustawiona na {{level}} procent|Volume set to {{level}} percent|
|tags/skill-volume/set.volume.percent.dialog:2|Głośność zaktualizowana na {{level}} procent|Volume updated to {{level}} percent|
|tags/skill-volume/set.volume.percent.dialog:3|Głośność zmieniona na {{level}} procent|Volume changed to {{level}} percent|
|tags/skill-volume/volume.is.dialog:1|Głośność jest ustawiona na {{volume}}|The volume is set to {{volume}}|
|tags/skill-volume/volume.is.dialog:2|Głośność jest na {{volume}}|The volume is at {{volume}}|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/emby/emby.dialog:1|Odtwórz mix {media}|Playing {media} mix|
|tags/emby/emby.intent:1|Odtwórz {media} z emby|play {media} from emby|
|tags/emby/emby.intent:2|odtwórz {media} z mb|play {media} from mb|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-wiki/More.voc:1|więcej|more|
|tags/skill-wiki/More.voc:2|kontynuuj |continue|
|tags/skill-wiki/Random.intent:1|powiedz mi coś losowego|tell me something random|
|tags/skill-wiki/Random.intent:2|powiedz mi losową ciekawostkę|tell me a random fact|
|tags/skill-wiki/Random.intent:3|naucz mnie losowej ciekawostki|teach me a random fact|
|tags/skill-wiki/Random.intent:4|naucz mnie czegoś|teach me something|
|tags/skill-wiki/Random.intent:5|naucz mnie czegoś losowego|teach me something random|
|tags/skill-wiki/Random.intent:6|powiedz mi losową rzecz|tell me a random thing|
|tags/skill-wiki/Wikipedia.voc:1|wiki|wiki|
|tags/skill-wiki/Wikipedia.voc:2|Wikipedia|wikipedia|
|tags/skill-wiki/Wikipedia.voc:3|powiedz mi o|tell me about|
|tags/skill-wiki/Wikipedia.voc:4|powiedz nam o|tell us about|
|tags/skill-wiki/Wikipedia.voc:5|co wikipedia mówi o|what does wikipedia say about|
|tags/skill-wiki/Wikipedia.voc:6|znajdź|search|
|tags/skill-wiki/article.title.rx:1||.*(wiki|for|about|wikipedia)(?! (for|about)) (?P<ArticleTitle>.+)|
|tags/skill-wiki/disambiguate.dialog:1|czy chodziło Ci o {{options}}|did you mean {{options}}|
|tags/skill-wiki/disambiguate.dialog:2|czy chciałbyś usłyszeć o {{options}}|would you like to hear about {{options}}|
|tags/skill-wiki/no:|Nie mogę znaleźć powiązanego artykułu na Wikipedii|I can't find a related Wikipedia article|
|tags/skill-wiki/no:|Boję się, że nie ma żadnego artykułu na ten temat|I'm afraid there isn't any article about that|
|tags/skill-wiki/or.dialog:1|albo|or|
|tags/skill-wiki/searching.dialog:1|Daj mi chwilę kiedy będę szukał {{query}}|Just a moment while I look up {{query}}|
|tags/skill-wiki/searching.dialog:2|Pozwól mi sprawdzić {{query}}|Let me look up {{query}}|
|tags/skill-wiki/searching.dialog:3|Szukam w Wikipedii o {{query}}|I'm checking Wikipedia for {{query}}|
|tags/skill-wiki/thats:|To wszystko co wiem|That's all I know|
|tags/skill-wiki/thats:|To wszystko co znalazłem|That's all I can find|
|tags/skill-wiki/wikipedia_lang.value:1|# Kod językowy, który Wikipedia stosuje do obsługi zapytań w wybranym języku|# Wikipedia language code used to service queries in the active language|
|tags/skill-wiki/wikipedia_lang.value:2|code,pl|code,en|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-speak/Speak.voc:1|mów|speak|
|tags/skill-speak/Speak.voc:2|powiedz|say|
|tags/skill-speak/Speak.voc:3|powtórz|repeat|
|tags/skill-speak/Words.rx:1|powiedz (?P<Words>.*)|say (?P<Words>.*)|
|tags/skill-speak/Words.rx:2|mów (?P<Words>.*)|speak (?P<Words>.*)|
|tags/skill-speak/Words.rx:3|powtórz (?P<Words>.*)|repeat (?P<Words>.*)|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/wikiquote/notfound.dialog:1|Nie mogę znaleźć żadnych cytatów związanych z {{subject}}|I didn't find any {{subject}} quotes|
|tags/wikiquote/random.intent:1|(zacytuj coś|powiedz coś mądrego)|tell me (some|a) (quote|wisdom)|
|tags/wikiquote/random.intent:2|(powiedz|daj mi) (cytat|coś mądrego)|give me (some|a) (quote|wisdom)|
|tags/wikiquote/random.intent:3|Potrzebuję mądrości|I need some wisdom|
|tags/wikiquote/specific.intent:1|powiedz (coś|cytat) ( |o) {subject}|tell me (some|a|an) {subject} (quote|wisdom)|
|tags/wikiquote/specific.intent:2|daj mi coś o {subject}|give me (some|a|an) {subject} (quote|wisdom)|
|tags/wikiquote/specific.intent:3|Potrzebuję czegoś związanego z {subject}|I need some {subject} (quote|wisdom)|
|tags/wikiquote/specific.intent:4|powiedz mi cytat ( |o) {subject}|tell me a quote (from|about) {subject}|
|tags/wikiquote/specific.intent:5|daj mi cytat (z|o) {subject}|give me a quote (from|about) {subject}|
|tags/wikiquote/specific.intent:6|Potrzebuję cytatu (z|o) {subject}|I need a quote (from|about) {subject}|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/fallback-aiml/Memory.voc:1|mózg|brain|
|tags/fallback-aiml/Memory.voc:2|pamięć|memory|
|tags/fallback-aiml/Memory.voc:3|umysł|mind|
|tags/fallback-aiml/Memory.voc:4|wszystko|everything|
|tags/fallback-aiml/Reset.voc:1|zapomnij|forget|
|tags/fallback-aiml/Reset.voc:2|zresetuj|reset|
|tags/fallback-aiml/reset.memory.dialog:1|Resetuje bazę danych|Resetting knowledge database|
|tags/fallback-aiml/reset.memory.dialog:2|Wszystko zapominam|Forgetting everything|
|tags/fallback-aiml/reset.memory.dialog:3|Ok, Zresetuje teraz moją pamięć|Okay, I will now reset my memory|
|tags/fallback-aiml/reset.memory.dialog:4|Reset mózgu zainicjowany|Brain erasure initiated|

# skill-version-checker-pl
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/fallback-query/Question.voc:1|co?|what|
|tags/fallback-query/Question.voc:2|kto|who|
|tags/fallback-query/Question.voc:3|kiedy|when|
|tags/fallback-query/Question.voc:4|jak|how|
|tags/fallback-query/Question.voc:5|gdzie|where|
|tags/fallback-query/Question.voc:6||why|
|tags/fallback-query/noAnswer.dialog:1|Przepraszam nie znam odpowiedzi |Sorry, I don't know the answer to that|
|tags/fallback-query/noAnswer.dialog:2|Nie mam na to odpowiedzi|I don't have the answer for that|
|tags/fallback-query/noAnswer.dialog:3|Nie wiem|I don't know|
|tags/fallback-query/noAnswer.dialog:4|Bije mnie|Beats me|

# mycroft-release-test-pl
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/mycroft-release-test/Release.dialog:1|Testy zaliczone 18.2.4.|Test passed for 18.2.4.|
|tags/mycroft-release-test/ReleaseKeyword.voc:1|wywołuje test|invoking test|
|tags/mycroft-release-test/ReleaseKeyword.voc:2|wywołaj test|invoke test|
|tags/mycroft-release-test/ReleaseKeyword.voc:3|wywołaj test wydania|invoke release test|
|tags/mycroft-release-test/ReleaseKeyword.voc:4|test wydania|release test|
|tags/mycroft-release-test/ReleaseKeyword.voc:5|wydano test|released test|

# krunner-search-skill-pl
...
# skill-audio-record-pl
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-audio-record/AudioRecordSkillDeleteVerb.voc:1|usuń|delete|
|tags/skill-audio-record/AudioRecordSkillDeleteVerb.voc:2|usuń|erase|
|tags/skill-audio-record/AudioRecordSkillDeleteVerb.voc:3|usuń|remove|
|tags/skill-audio-record/Delete.voc:4|wyczyść|clear|
|tags/skill-audio-record/AudioRecordSkillPlayVerb.voc:2|odtwórz|play|
|tags/skill-audio-record/AudioRecordSkillPlayVerb.voc:3||replay|
|tags/skill-audio-record/AudioRecordSkillPlayVerb.voc:4||playback|
|tags/skill-audio-record/Play.voc:4||play back|
|tags/skill-audio-record/AudioRecordSkillPlayVerb.voc:7|odtwarzanie|playing|
|tags/skill-audio-record/Play.voc:6|odtwarzanie|replaying|
...
|tags/skill-audio-record/AudioRecordSkillKeyword.voc:1|nagraj|record|
|tags/skill-audio-record/Recording.voc:2|nagrano|recorded|
|tags/skill-audio-record/AudioRecordSkillKeyword.voc:2||recording|
|tags/skill-audio-record/Recording.voc:4||audio|
|tags/skill-audio-record/StartRecording.intent:1|rozpocznij nagrywanie|start recording|
...
|tags/skill-audio-record/audio.record.removed.dialog:1|Nagranie usunięte|Recording deleted|
|tags/skill-audio-record/audio.record.removed.dialog:2|Nagranie odrzucone|Recording discarded|
|tags/skill-audio-record/audio.record.start.duration.dialog:1|Nagrywanie dźwięku przez {{duration}}|Recording audio for {{duration}}|
|tags/skill-audio-record/audio.record.start.duration.dialog:2|Rozpoczynanie nagrywania przez {{duration}}|Starting recording for {{duration}}|
|tags/skill-audio-record/audio.record.start.duration.dialog:3|Nagrywanie przez {{duration}}|Recording for {{duration}}|

# fallback-wolfram-alpha-pl
  

|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/fallback-wolfram-alpha/Give.voc:1|powiedz|tell|
|tags/fallback-wolfram-alpha/Give.voc:2|daj|give|
|tags/fallback-wolfram-alpha/Give.voc:3|co|what|
|tags/fallback-wolfram-alpha/Give.voc:4|e-mail|email|
|tags/fallback-wolfram-alpha/Give.voc:5|wyślij|send|
|tags/fallback-wolfram-alpha/Source.voc:1|źródło|source|
|tags/fallback-wolfram-alpha/Source.voc:2|źródła|sources|
|tags/fallback-wolfram-alpha/Source.voc:3|detal|detail|
|tags/fallback-wolfram-alpha/Source.voc:4|detale|details|
|tags/fallback-wolfram-alpha/email.body.dialog:1|Zapytałeś <br/><ul><tt>'{{query}}'</tt></ul><br/> i otrzymałeś odpowiedź <br/><ul><tt>'{{answer}}'</tt></ul><P> W celu poznania szczegółów i użytego źródła informacji odwiedź:<br/><a href="http://www.wolframalpha.com/input/?i={{url_query}}">www.wolframalpha.com</a>|You asked <br/><ul><tt>'{{query}}'</tt></ul><br/> and were told <br/><ul><tt>'{{answer}}'</tt></ul><P> For more details and the information sources used to generate the answer visit:<br/><a href="http://www.wolframalpha.com/input/?i={{url_query}}">www.wolframalpha.com</a>|
|tags/fallback-wolfram-alpha/email.subject.dialog:1|Źródła dla: '{{query}}'|Sources for: '{{query}}'|
|tags/fallback-wolfram-alpha/list.rx:1|(1,|1\.) (?P<Definition>.*) (2,|2\.) (.*)|(1,|1\.) (?P<Definition>.*) (2,|2\.) (.*)|
|tags/fallback-wolfram-alpha/no.info.to.send.dialog:1|Nie mogę odnaleźć żadnych zapytań Wolfram Alpha do wysłania.|I couldn't find any Wolfram Alpha queries to send.|
|tags/fallback-wolfram-alpha/not.understood.dialog:1|Przepraszam, Ja nie {{phrase}}|Sorry, I don't {{phrase}}|
|tags/fallback-wolfram-alpha/sent.email.dialog:1|Wysłałem link do Wolfram Alpha na twój zarejestrowany adres e-mail wraz ze źródłami i dalszymi szczegółami.|I've sent an email to your registered account with a link to Wolfram Alpha for further details and sources.|
...
# fallback-recommendations-skill-pl
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-installer/action.list:1|instalowanie|installing|
|tags/skill-installer/action.list:2|usuwanie|removing|
|tags/skill-installer/cancelled.dialog:1|Anulowano.|Cancelled.|
|tags/skill-installer/cancelled.dialog:2|Akcja anulowana.|Action cancelled.|
|tags/skill-installer/choose.skill.dialog:1|Znaleziona wiele zdolności, którą chciałbyś... {{skills}}|Multiple skills found, which would you like... {{skills}}|
|tags/skill-installer/error.already.beta.dialog:1|Wersja podglądowa zdolności {{skill}} została już zainstalowana.|The preview version of {{skill}} has already been installed.|
|tags/skill-installer/error.already.installed.dialog:1|zdolność {{skill}} została już wcześniej zainstalowana|{{skill}} has already been installed|
|tags/skill-installer/error.already.removed.dialog:1|zdolność {{skill}} nie jest zainstalowana|{{skill}} is not installed|
|tags/skill-installer/error.already.removed.dialog:2|{{skill}} nie został odnaleziony na tym urządzeniu|{{skill}} was not found on this device|
|tags/skill-installer/error.filesystem.dialog:1|Pojawił się błąd systemu plików podczas {{action}} {{skill}}.|A filesystem error occurred while {{action}} {{skill}}.|
|tags/skill-installer/error.multiple.skills.dialog:1|Twoje rządanie ma wiele rozwiązań, proszę bądź bardziej precyzyjny.|Your request had multiple matches, please be more specific.|
|tags/skill-installer/error.not.found.dialog:1|Nie znalazłem żadnej zdolności nazwanej {{skill}}.|I didn't find any skill named {{skill}}.|
|tags/skill-installer/error.other.dialog:1|Wystąpił nieznany błąd podczas instalacji {{skill}}.|An unknown error occurred while installing {{skill}}.|
|tags/skill-installer/error.pip.requirements.dialog:1|Wystąpił błąd podczas {{action}} zależności Python dla {{skill}}.|An error occurred while {{action}} the Python dependencies for {{skill}}.|
|tags/skill-installer/error.skill.requirements.dialog:1|Wystąpił błąd podczas {{action}} wymagań dla {{skill}}.|An error occurred while {{action}} the skill requirements for {{skill}}.|
|tags/skill-installer/error.system.requirements.dialog:1|Wystąpił błąd podczas {{action}} pakietów systemowych dla {{skill}}.|An error occurred while {{action}} the system packages for {{skill}}.|
|tags/skill-installer/install.beta.complete.dialog:1|Wersja deweloperska zdolności {{skill}} zostałą zainstalowana.  Ta wersja nie przeszła recenzji społeczności ani testów kontroli jakości, bądź odpowiedzialny zgłaszając problemy autorowi zdolności.  Aby wrócić do oficjalnej wersji, powiedz: zainstaluj {{skill}}.|The development version of {{skill}} has been installed.  This version has not undergone any community review or quality control testing, so be responsible when reporting issues to the author.  To switch back to the officially released version, say: install {{skill}}.|
|tags/skill-installer/install.beta.confirm.dialog:1|Potwierdzenie: Czy mam przełączyć oficjalną wersję {{skill}} na wersję deweloperską?|Confirming: Shall I switch from the officially released version of {{skill}} to the development version?|
|tags/skill-installer/install.beta.intent:1|zainstaluj {skill} (w wersji|) beta.|install {skill} (version|) beta.|
|tags/skill-installer/install.beta.intent:2|zainstaluj {skill} (beta|podglądową) wersję|install {skill} (beta|preview) version|
|tags/skill-installer/install.beta.intent:3|instaluj (beta|podglądową) (wersję|) {skill}.|install (the|) (beta|preview) (version|)(of|) {skill}.|
|tags/skill-installer/install.beta.upgrade.confirm.dialog:1|Potwierdzenie: Mam uaktualnić wersję {{skill}} do ostatniej wersji deweloperskiej?|Confirming: Shall I upgrade {{skill}} to the latest development version?|
|tags/skill-installer/install.complete.dialog:1|zdolność {{skill}} jest teraz zainstalowana i gotowa do użytku|{{skill}} is now installed and ready for use|
|tags/skill-installer/install.confirm.dialog:1|Potwierdzenie: Mam zainstalować zdolność {{skill}} stworzoną przez {{author}}.|Confirming: Shall I install {{skill}} by {{author}}.|
|tags/skill-installer/install.custom.intent:1|Pobierz własną zdolność|Download custom skill|
|tags/skill-installer/install.intent:1|zainstaluj {skill}.|install {skill}.|
|tags/skill-installer/install.intent:2|zainstaluj {skill} (w wersji|) (stabilnej| oficjalnej).|install {skill} (version|) (stable|official).|
|tags/skill-installer/install.intent:3|zainstaluj (oficjalną| stabilną) (wersję) {skill}.|install (the|) (official|stable) (version|of|) {skill}.|
|tags/skill-installer/install.intent:4|zainstaluj oficjalne wydanie {skill}.|install official release (version|) of {skill}.|
|tags/skill-installer/install.reinstall.confirm.dialog:1|Potwierdzenie: Mam reinstalować oficjalne wydanie {{skill}}?|Confirming: Shall I reinstall the official release version of {{skill}}?|
|tags/skill-installer/installed.dialog:1|zdolność {skill} jest zainstalowana|yes, {skill} is installed|
|tags/skill-installer/is.installed.intent:1|czy {skill} jest zainstalowana|is {skill} installed|
|tags/skill-installer/list.skills.intent:1|(Pokaż| Wykaż) (dostępne| możliwe do zainstalowania) zdolności.|(Show me|List) (available|installable) skills.|
|tags/skill-installer/list.skills.intent:2|Co mogę zainstalować?|What (skills|) can I install?|
|tags/skill-installer/list.skills.intent:3|Jakie zdolności mogę zainstalować?|What are some skills I can install?|
|tags/skill-installer/not.installed.dialog:1|nie, zdolność {skill} nie jest zainstalowana|no, {skill} isn't installed|
|tags/skill-installer/not.installed.dialog:2|nie, zdolność {skill} nie jest zainstalowana|no, {skill} is not installed|
|tags/skill-installer/or.dialog:1|czy|or|
|tags/skill-installer/remove.complete.dialog:1|zdolność {{skill}} została usunięta|{{skill}} has been removed|
|tags/skill-installer/remove.confirm.dialog:1|Potwierdzenie:  Mam usunąć zdolność {{skill}} stworzoną przez {{author}}.|Confirming:  Shall I remove {{skill}} by {{author}}.|
|tags/skill-installer/remove.intent:1|odinstaluj (zdolność|) {skill}|uninstall (skill|) {skill}|
|tags/skill-installer/remove.intent:3|odinstaluj {skill}|uninstall {skill} (skill|)|
|tags/skill-installer/some.available.skills.dialog:1|Tutaj jest kilka zdolności, które możesz zainstalować... {{skills}}|Here are a few of the skills you can install... {{skills}}|

# skill-number-guess-pl
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/skill-reminder/AboutWhat.dialog:1|O czym?|About what?|
|tags/skill-reminder/AboutWhat.dialog:2|Oczywiście, o czym mam Ci przypomnieć?|Sure, What should I remind you about?|
|tags/skill-reminder/AreYouSure.dialog:1|Czy jesteś pewien|are you sure|
|tags/skill-reminder/AreYouSure.dialog:2|czy na pewno to jest to, o czym mam Ci przypomnieć|is that really when you want to be reminded|
|tags/skill-reminder/ByTheWay.dialog:1|A tak przy okazji, {{reminder}}|Oh, by the way, {{reminder}}|
|tags/skill-reminder/ByTheWay.dialog:2|Twoje nadchodzące wydarzenie: {{reminder}}|There's an upcoming event: {{reminder}}|
|tags/skill-reminder/CancelActiveReminder.intent:1|(dobra |ok |wporządku |)anuluj (moje |wszystkie |)(aktywne |)(przypomnienie|przypomnienia)|(ok |okay |)cancel (the |my |all |)(active |)reminder(s|)|
|tags/skill-reminder/CancelActiveReminder.intent:2|(dobra |ok |wporządku |)zatrzymaj (moje |wszystkie |)(aktywne |)(przypomnienie|przypomnienia)|(ok |okay |)stop (the | my |all |)(active |)reminder(s|)|
|tags/skill-reminder/CancelActiveReminder.intent:3|(dobra |ok |)usuń (moje |wszystkie |)(aktywne |)przypomnieni(a|e)|(ok |okay |)remove (the |my |all |)(active |)reminder(s|)|
|tags/skill-reminder/CancelActiveReminder.intent:4|(dobra |ok |)potwierdź (moje |wszystkie |)(aktywne |)przypomnieni(e|a)|(ok |okay |)acknowledge (the |my |all |)(active |)reminder(s|)|
|tags/skill-reminder/ClearAll.dialog:1|Czy na pewno chcesz usunąć wszystkie zapisane przypomnienia|Do you want to remove all saved reminders|
|tags/skill-reminder/ClearAll.dialog:2|Czy chcesz wyczyścić wszystkie zapisane przypomnienia|Do you want to clear the entire list of reminders|
|tags/skill-reminder/ClearReminders.intent:1|(wyczyść|usuń|skasuj) wszystkie przypomnienia|(clear|remove|delete) all reminders|
|tags/skill-reminder/ClearedAll.dialog:1|Wszystkie przypomnienia zostały usunięte|All reminders have been removed|
|tags/skill-reminder/ClearedAll.dialog:2|Wyczyszczono wszystkie przypomnienia|All reminders have been cleared|
|tags/skill-reminder/ConfirmRemoveDay.dialog:1|Czy na pewno chcesz usunąć wszystkie przypomnienia dla {date}|Are you sure you want to delete all reminders for {date}|
|tags/skill-reminder/DeleteReminderForDay.intent:1|(usuń|anuluj|wyczyść) wszystkie przypomnienia dla {date}|(cancel|remove|delete) all reminders for {date}|
|tags/skill-reminder/DeleteReminderForDay.intent:2|anuluj (dzisiejsze|jutrzejsze) przypomninia|cancel (todays|tomorrows) reminders|
|tags/skill-reminder/DeleteReminderForDay.intent:3|anuluj wszystkie przypomnienia na (dziś|jutro)|cancel all reminders for (today|tomorrow)|
|tags/skill-reminder/GetNextReminders.intent:1|jakie jest (|moje) następne przypomnienie|what is (the|my) next reminder|
|tags/skill-reminder/GetNextReminders.intent:2|co jest (następne (na|w|dla))|następnym) (przypomnieniem|przypomnieniach|przypomnień|liście przypomnień)|what is next on my (reminder|reminders|reminder list|list of reminders)|
|tags/skill-reminder/GetRemindersForDay.intent:1|(podaj|daj|przypomnij) (wszystkie|) przypomnienia dla {date}|get (the|all) reminders for {date}|
|tags/skill-reminder/GetRemindersForDay.intent:2|jakie są (moje|) przypomnienia dla {date}|what are (the|my) reminders for {date}|
|tags/skill-reminder/GetRemindersForDay.intent:3|czy mam jakieś przypomnienia dla {date}|do i have any reminders( on|) {date}|
|tags/skill-reminder/ItIsNight.dialog:1|To będzie w środku nocy|That's in the middle of the night|
|tags/skill-reminder/ItIsNight.dialog:2|To będzie bardzo późno|That's very late|
|tags/skill-reminder/NextOtherDate.dialog:1|{reminder} o {time} {date}|{reminder} at {time} {date}|
|tags/skill-reminder/NextToday.dialog:1|Twoje następne przypomnienie to {reminder} o {time}|Your next reminder is {reminder} at {time}|
|tags/skill-reminder/NextTomorrow.dialog:1|Masz {reminder} jutro o {time}|You have {reminder} tomorrow at {time}|
|tags/skill-reminder/NoActive.dialog:1|Brak aktywnych przypomnień|There are no active reminders|
|tags/skill-reminder/NoDateTime.dialog:1|Przepraszam, nie zrozumiałem o której|Sorry, I didn't catch the time.|
|tags/skill-reminder/NoDateTime.dialog:2|Czy możesz powtórzyć w inny sposób o której |Can you say the time in an other way.|
|tags/skill-reminder/NoRemindersForDate.dialog:1|Brak przypomnień dla {date}|There are no reminders for {date}|
|tags/skill-reminder/NoRemindersForDate.dialog:2|Wygląda na to, że nie ma żadnych przypomnień dla {date}|There don't seem to be any reminders set for {date}|
|tags/skill-reminder/NoUpcoming.dialog:1|Brak nadchodzących przypomnień|There are no upcoming reminders|
|tags/skill-reminder/NoUpcoming.dialog:2|Nie masz nadchodzących przypomnień|You have no upcoming reminders|
|tags/skill-reminder/ParticularTime.dialog:1|Dobrze, czy chcesz żebym przypomniał Ci o jakiejś konkretnej godzinie?|Right-o, do you want me to remind you at any particular time?|
|tags/skill-reminder/ParticularTime.dialog:2|W porządku, kiedy mam Ci o tym przypomnieć o konkretnej godzinie?|Okay, do you want to be reminded at a specific time?|
|tags/skill-reminder/Reminder.intent:1|(mógłbyś |)(przypomnieć|przypomnij) mi (o|żeby(m|)|by(m|)) {reminder}|(could you |)remind me (about|of|to) {reminder}|
|tags/skill-reminder/ReminderAt.intent:1|(przypomnij|zgłoś) mi {reminder} ((na|){timedate}|jutro|dzień po {date})|(remind|notify) me to {reminder} ((at|on) {timedate}|tomorrow|the day after {date})|
|tags/skill-reminder/ReminderAt.intent:2|dodaj nowe przypomnienie {reminder} (na|) {timedate}|add new reminder {reminder} (at|on) {timedate}|
|tags/skill-reminder/ReminderAt.intent:3|dodaj przypomnienie {reminder} (na|) {timedate}|add a reminder to {reminder} (at|on) {timedate}|
|tags/skill-reminder/ReminderAt.intent:4|(przypomnij|powiadom) (mi|mnie) o {reminder} (o|na) {timedate}|(remind|notify) me about {reminder} (at|on) {timedate}|
|tags/skill-reminder/ReminderAt.intent:5|(przypomnij|powiadom) (mi|mnie) żeby(m|) {reminder} na {timedate}|(remind|notify) me to {reminder} in {timedate}|
|tags/skill-reminder/ReminderAt.intent:6|dodaj nowe przypomnienie {reminder} na {timedate}|add new reminder {reminder} in {timedate}|
|tags/skill-reminder/ReminderAt.intent:7|dodaj przypomnienie żeby {reminder} na {timedate}|add a reminder to {reminder} in {timedate}|
|tags/skill-reminder/ReminderCancelled.dialog:1|Przypomnienie zostało anulowane.|The reminder was cancelled.|
|tags/skill-reminder/ReminderCancelled.dialog:2|Anulowanie przypomnienia.|Cancelling reminder.|
|tags/skill-reminder/reminder.off.dialog:1|przypomnienie zostało wyłączone|the reminder has been turned off|
|tags/skill-reminder/reminder.off.dialog:2|wyłączono przypomnienie|the reminder has been shut off|
|tags/skill-reminder/reminder.off.dialog:3|zatrzymano przypomnienie|the reminder has been stopped|
|tags/skill-reminder/Reminding.dialog:1|Przypomnienie, {{reminder}} .|Reminder, {{reminder}} .|
|tags/skill-reminder/Reminding.dialog:2|Jest przypomnienie, {{reminder}} .|There's a reminder, {{reminder}} .|
|tags/skill-reminder/RemindingInFifteen.dialog:1|Dobrze, przypomnę Ci za 15 minut|Okay, I'll remind you in fifteen minutes|
|tags/skill-reminder/RemindingInFifteen.dialog:2|Oczywiście, przypomnę Ci za 15 minut|Sure, I'll remind you in fifteen minutes|
|tags/skill-reminder/RemindingInFifteen.dialog:3|W porządku, przypomnę Ci za chwilę|Very well, I'll remind you again in a bit|
|tags/skill-reminder/SavingReminder.dialog:1|Oczywiście, zapisuję przypomnienie na {{timedate}}|Sure, saving a reminder for {{timedate}}|
|tags/skill-reminder/SavingReminder.dialog:2|Ustawiłem przypomnienie na {{timedate}}|I've set a reminder for {{timedate}}|
|tags/skill-reminder/SavingReminder.dialog:3|Przypomnienie ustawione na {{timedate}}|Reminder set for {{timedate}}|
|tags/skill-reminder/SavingReminderDate.dialog:1|Oczywiście, zapisuję przypomnienie na {{date}} o {{time}}|Sure, saving a reminder for {{date}} at {{time}}|
|tags/skill-reminder/SavingReminderDate.dialog:2|Ustawiłem przypomnienie na {{date}} o {{time}}|I've set a reminder for {{date}} {{time}}|
|tags/skill-reminder/SavingReminderDate.dialog:3|Przypomnienie ustawione na {{time}} o {{date}}|Reminder set for {{time}} on {{date}}|
|tags/skill-reminder/SavingReminderTomorrow.dialog:1|Oczywiście, zapisuję przypomnienie na jutro o {{timedate}}|Sure, saving a reminder for tomorrow at {{timedate}}|
|tags/skill-reminder/SavingReminderTomorrow.dialog:2|Ustawiłem przypomnienie na jutro o {{timedate}}|I've set a reminder for {{timedate}} tomorrow|
|tags/skill-reminder/SavingReminderTomorrow.dialog:3|Przypomnienie ustawione na jutro o {{timedate}}|Reminder set for tomorrow at {{timedate}}|
|tags/skill-reminder/SnoozeReminder.intent:1|wstrzymaj przypomnienie|snooze( the|) reminder|
|tags/skill-reminder/SnoozeReminder.intent:2|{anything} przypomnij później|{anything} remind me later|
|tags/skill-reminder/SomethingReminder.intent:1|(mógłbyś |)przypomnieć (mi|nam) o czymś|(could you |)remind (me|us) of something|
|tags/skill-reminder/SomethingReminder.intent:2|(mógłbyś |)ustawić przypomnienie (| dla mnie| dla nas)|(could you |)set a reminder(| for me| for us)|
|tags/skill-reminder/SpecifyTime.dialog:1|Dobrze, kiedy?|Okay, when?|
|tags/skill-reminder/SpecifyTime.dialog:2|O której godzinie?|At what time?|
|tags/skill-reminder/SpecifyTime.dialog:5|Kiedy mam Ci przypomnieć?|At what time would you like to be reminded?|
|tags/skill-reminder/ToCancelInstructions.dialog:1|Żeby anulować, powiedz "anuluj przypomnienie"|To cancel, say "cancel the reminder"|
|tags/skill-reminder/UnspecifiedReminderAt.intent:1|(mógłbyś |)przypomnieć mi o {timedate}|(could you |)remind me at {timedate}|
|tags/skill-reminder/UnspecifiedReminderAt.intent:2|(mógłbyś |)dodać przypomnienie o {timedate}|(could you |)add a reminder at {timedate}|
...
|Intention|Command|Msg Id|
| :--- | :--- | :--- |
|tags/game-zork/Delete.voc:1|usuń|delete|
|tags/game-zork/LeavingZork.dialog:1|Opuszczanie tajemniczego królestwa Zork|Leaving the mysterious kingdom of Zork|
|tags/game-zork/LeavingZork.dialog:2|Opuszczam Zork|Now leaving Zork|
|tags/game-zork/LeavingZork.dialog:3|Zamykam Zork|Exiting Zork|
|tags/game-zork/NoSave.dialog:1|Nie ma aktualnego zapisu gry|There's no current savegame|
|tags/game-zork/NoSave.dialog:2|Nie istnieją żadne zapisy gry|No save game exists|
|tags/game-zork/Play.voc:1|graj|play|
|tags/game-zork/Play.voc:2|idź do|goto|
|tags/game-zork/Play.voc:3|idź do|go to|
|tags/game-zork/Save.voc:1|zapis|save|
|tags/game-zork/Save.voc:2|zapis gry|savegame|
|tags/game-zork/Save.voc:3|zapisano|saved|
|tags/game-zork/SaveDeleted.dialog:1|Zapis gry usunięty|Save game deleted|
|tags/game-zork/SaveDeleted.dialog:2|Usunięto zapisaną grę|Removed the save game|
|tags/game-zork/Zork.voc:1|zork|zork|
|tags/game-zork/Zork.voc:2|Skrzynka Pocztowa|mailbox|
|tags/game-zork/Zork.voc:3|biały dom|white house|
